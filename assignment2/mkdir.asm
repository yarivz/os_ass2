...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41e:	0f b6 90 40 0b 00 00 	movzbl 0xb40(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 57d:	75 27                	jne    5a6 <printf+0x11f>
          s = "(null)";
 57f:	c7 45 f4 9b 08 00 00 	movl   $0x89b,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64b:	a1 5c 0b 00 00       	mov    0xb5c,%eax
...
free(void *ap)
{
 ...
 70c:	a3 5c 0b 00 00       	mov    %eax,0xb5c
}
 711:	c9                   	leave  
 712:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 75f:	e8 d8 fe ff ff       	call   63c <free>
  return freep;
 764:	a1 5c 0b 00 00       	mov    0xb5c,%eax
}
 769:	c9                   	leave  
 76a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 77d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 780:	a1 5c 0b 00 00       	mov    0xb5c,%eax
 785:	89 45 f0             	mov    %eax,-0x10(%ebp)
 788:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 78c:	75 23                	jne    7b1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 78e:	c7 45 f0 54 0b 00 00 	movl   $0xb54,-0x10(%ebp)
 795:	8b 45 f0             	mov    -0x10(%ebp),%eax
 798:	a3 5c 0b 00 00       	mov    %eax,0xb5c
 79d:	a1 5c 0b 00 00       	mov    0xb5c,%eax
 7a2:	a3 54 0b 00 00       	mov    %eax,0xb54
    base.s.size = 0;
 7a7:	c7 05 58 0b 00 00 00 	movl   $0x0,0xb58
 7ae:	00 00 00 
  }
 ...
 804:	a3 5c 0b 00 00       	mov    %eax,0xb5c
      return (void*)(p + 1);
 ...
 80f:	eb 38                	jmp    849 <malloc+0xde>
    ...
    if(p == freep)
 811:	a1 5c 0b 00 00       	mov    0xb5c,%eax
