...
main(void)
{
  ...
  10:	00 
  11:	c7 04 24 09 0a 00 00 	movl   $0xa09,(%esp)
  ...
  30:	00 
  31:	c7 04 24 09 0a 00 00 	movl   $0xa09,(%esp)
  38:	e8 83 03 00 00       	call   3c0 <mknod>
    open("console", O_RDWR);
  3d:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  44:	00 
  45:	c7 04 24 09 0a 00 00 	movl   $0xa09,(%esp)
  ...
  6c:	c7 44 24 04 11 0a 00 	movl   $0xa11,0x4(%esp)
  73:	00 
  ...
  90:	c7 44 24 04 24 0a 00 	movl   $0xa24,0x4(%esp)
  97:	00 
  ...
  ae:	75 41                	jne    f1 <main+0xf1>
      exec("sh", argv);
  b0:	c7 44 24 04 fc 0c 00 	movl   $0xcfc,0x4(%esp)
  b7:	00 
  b8:	c7 04 24 06 0a 00 00 	movl   $0xa06,(%esp)
  bf:	e8 ec 02 00 00       	call   3b0 <exec>
      printf(1, "init: exec sh failed\n");
  c4:	c7 44 24 04 37 0a 00 	movl   $0xa37,0x4(%esp)
  cb:	00 
  ...
  d8:	e8 9b 02 00 00       	call   378 <exit>
    ...
    while((wpid=wait()) >= 0 && wpid != pid)
      printf(1, "zombie!\n");
  dd:	c7 44 24 04 4d 0a 00 	movl   $0xa4d,0x4(%esp)
  e4:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c6:	0f b6 90 04 0d 00 00 	movzbl 0xd04(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 625:	75 27                	jne    64e <printf+0x11f>
          s = "(null)";
 627:	c7 45 f4 56 0a 00 00 	movl   $0xa56,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f3:	a1 20 0d 00 00       	mov    0xd20,%eax
...
free(void *ap)
{
 ...
 7b4:	a3 20 0d 00 00       	mov    %eax,0xd20
}
 7b9:	c9                   	leave  
 7ba:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 807:	e8 d8 fe ff ff       	call   6e4 <free>
  return freep;
 80c:	a1 20 0d 00 00       	mov    0xd20,%eax
}
 811:	c9                   	leave  
 812:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 825:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 828:	a1 20 0d 00 00       	mov    0xd20,%eax
 82d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 830:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 834:	75 23                	jne    859 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 836:	c7 45 f0 18 0d 00 00 	movl   $0xd18,-0x10(%ebp)
 83d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 840:	a3 20 0d 00 00       	mov    %eax,0xd20
 845:	a1 20 0d 00 00       	mov    0xd20,%eax
 84a:	a3 18 0d 00 00       	mov    %eax,0xd18
    base.s.size = 0;
 84f:	c7 05 1c 0d 00 00 00 	movl   $0x0,0xd1c
 856:	00 00 00 
  }
 ...
 8ac:	a3 20 0d 00 00       	mov    %eax,0xd20
      return (void*)(p + 1);
 ...
 8b7:	eb 38                	jmp    8f1 <malloc+0xde>
    ...
    if(p == freep)
 8b9:	a1 20 0d 00 00       	mov    0xd20,%eax
...
semaphore_create(int initial_semaphore_value)
{
 ...
 8fa:	c7 04 24 0c 00 00 00 	movl   $0xc,(%esp)
 ...
 94e:	eb 15                	jmp    965 <semaphore_create+0x71>
    }
  }
  free(s);
 950:	8b 45 f4             	mov    -0xc(%ebp),%eax
 953:	89 04 24             	mov    %eax,(%esp)
 956:	e8 89 fd ff ff       	call   6e4 <free>
  s = 0;
 95b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  return s;
...
semaphore_up(struct semaphore* sem )
{
 ...
 9cc:	e8 77 fa ff ff       	call   448 <binary_semaphore_down>
  sem->value++;
