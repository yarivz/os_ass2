...
main(int argc, char *argv[])
{
  ...
  2c:	c7 44 24 04 98 09 00 	movl   $0x998,0x4(%esp)
  33:	00 
  ...
  92:	c7 44 24 04 ab 09 00 	movl   $0x9ab,0x4(%esp)
  99:	00 
...
//    printf(fd, "%d\n", i);
 ...
 126:	e8 15 03 00 00       	call   440 <close>
  ...
  printf(1, "read\n");
 12b:	c7 44 24 04 b5 09 00 	movl   $0x9b5,0x4(%esp)
 132:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 54e:	0f b6 90 60 0c 00 00 	movzbl 0xc60(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 6ad:	75 27                	jne    6d6 <printf+0x11f>
          s = "(null)";
 6af:	c7 45 f4 bb 09 00 00 	movl   $0x9bb,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 77b:	a1 7c 0c 00 00       	mov    0xc7c,%eax
...
free(void *ap)
{
 ...
 83c:	a3 7c 0c 00 00       	mov    %eax,0xc7c
}
 841:	c9                   	leave  
 842:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 88f:	e8 d8 fe ff ff       	call   76c <free>
  return freep;
 894:	a1 7c 0c 00 00       	mov    0xc7c,%eax
}
 899:	c9                   	leave  
 89a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8ad:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8b0:	a1 7c 0c 00 00       	mov    0xc7c,%eax
 8b5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8b8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8bc:	75 23                	jne    8e1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 8be:	c7 45 f0 74 0c 00 00 	movl   $0xc74,-0x10(%ebp)
 8c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8c8:	a3 7c 0c 00 00       	mov    %eax,0xc7c
 8cd:	a1 7c 0c 00 00       	mov    0xc7c,%eax
 8d2:	a3 74 0c 00 00       	mov    %eax,0xc74
    base.s.size = 0;
 8d7:	c7 05 78 0c 00 00 00 	movl   $0x0,0xc78
 8de:	00 00 00 
  }
 ...
 934:	a3 7c 0c 00 00       	mov    %eax,0xc7c
      return (void*)(p + 1);
 ...
 93f:	eb 38                	jmp    979 <malloc+0xde>
    ...
    if(p == freep)
 941:	a1 7c 0c 00 00       	mov    0xc7c,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value)
{
 ...
 982:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
