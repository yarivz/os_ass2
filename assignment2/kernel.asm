...
8010003a:	c7 44 24 04 50 8b 10 	movl   $0x80108b50,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
80100049:	e8 48 53 00 00       	call   80105396 <initlock>
...
801000bd:	e8 f5 52 00 00       	call   801053b7 <acquire>
...
80100104:	e8 10 53 00 00       	call   80105419 <release>
        return b;
...
8010011f:	e8 39 49 00 00       	call   80104a5d <sleep>
      goto loop;
...
8010017c:	e8 98 52 00 00       	call   80105419 <release>
      return b;
...
80100198:	c7 04 24 57 8b 10 80 	movl   $0x80108b57,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 68 8b 10 80 	movl   $0x80108b68,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 6f 8b 10 80 	movl   $0x80108b6f,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
8010023c:	e8 76 51 00 00       	call   801053b7 <acquire>
...
8010029d:	e8 97 48 00 00       	call   80104b39 <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
801002a9:	e8 6b 51 00 00       	call   80105419 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 f6 4f 00 00       	call   801053b7 <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 76 8b 10 80 	movl   $0x80108b76,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 7f 8b 10 80 	movl   $0x80108b7f,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 de 4e 00 00       	call   80105419 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 86 8b 10 80 	movl   $0x80108b86,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 95 8b 10 80 	movl   $0x80108b95,(%esp)
...
80100592:	e8 d1 4e 00 00       	call   80105468 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 97 8b 10 80 	movl   $0x80108b97,(%esp)
...
801006b2:	e8 22 50 00 00       	call   801056d9 <memmove>
    pos -= 80;
...
801006e1:	e8 20 4f 00 00       	call   80105606 <memset>
  }
...
80100776:	e8 3a 6a 00 00       	call   801071b5 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 2e 6a 00 00       	call   801071b5 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 22 6a 00 00       	call   801071b5 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 15 6a 00 00       	call   801071b5 <uartputc>
  cgaputc(c);
...
801007ba:	e8 f8 4b 00 00       	call   801053b7 <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 85 00 00 00       	jmp    8010086f <consoleintr+0xc2>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 f0 43 00 00       	call   80104bdf <procdump>
      break;
...
801008f7:	e8 3d 42 00 00       	call   80104b39 <wakeup>
        }
      }
      break;
...
8010091e:	e8 f6 4a 00 00       	call   80105419 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 6f 4a 00 00       	call   801053b7 <acquire>
  while(n > 0){
...
80100961:	e8 b3 4a 00 00       	call   80105419 <release>
        ilock(ip);
...
8010098a:	e8 ce 40 00 00       	call   80104a5d <sleep>
...
80100a08:	e8 0c 4a 00 00       	call   80105419 <release>
  ilock(ip);
...
80100a3e:	e8 74 49 00 00       	call   801053b7 <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 9c 49 00 00       	call   80105419 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 9b 8b 10 	movl   $0x80108b9b,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100aa2:	e8 ef 48 00 00       	call   80105396 <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 a3 8b 10 	movl   $0x80108ba3,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 c0 ed 10 80 	movl   $0x8010edc0,(%esp)
80100ab6:	e8 db 48 00 00       	call   80105396 <initlock>
...
80100b7b:	e8 79 77 00 00       	call   801082f9 <setupkvm>
...
80100c14:	e8 b2 7a 00 00       	call   801086cb <allocuvm>
...
80100c51:	e8 86 79 00 00       	call   801085dc <loaduvm>
...
80100cbc:	e8 0a 7a 00 00       	call   801086cb <allocuvm>
...
80100ce0:	e8 0a 7c 00 00       	call   801088ef <clearpteu>
  sp = sz;
...
80100d0f:	e8 70 4b 00 00       	call   80105884 <strlen>
...
80100d2d:	e8 52 4b 00 00       	call   80105884 <strlen>
...
80100d57:	e8 47 7d 00 00       	call   80108aa3 <copyout>
...
80100df7:	e8 a7 7c 00 00       	call   80108aa3 <copyout>
...
80100e4e:	e8 e3 49 00 00       	call   80105836 <safestrcpy>
...
80100ea0:	e8 45 75 00 00       	call   801083ea <switchuvm>
  freevm(oldpgdir);
80100ea5:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ea8:	89 04 24             	mov    %eax,(%esp)
80100eab:	e8 b1 79 00 00       	call   80108861 <freevm>
  return 0;
...
80100ee2:	e8 7a 79 00 00       	call   80108861 <freevm>
  if(ip)
...
80100f06:	c7 44 24 04 a9 8b 10 	movl   $0x80108ba9,0x4(%esp)
80100f0d:	80 
80100f0e:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
80100f15:	e8 7c 44 00 00       	call   80105396 <initlock>
}
80100f1a:	c9                   	leave  
80100f1b:	c3                   	ret    
...
80100f29:	e8 89 44 00 00       	call   801053b7 <acquire>
...
80100f52:	e8 c2 44 00 00       	call   80105419 <release>
      return f;
...
80100f70:	e8 a4 44 00 00       	call   80105419 <release>
  return 0;
...
80100f89:	e8 29 44 00 00       	call   801053b7 <acquire>
  if(f->ref < 1)
...
80100f96:	7f 0c                	jg     80100fa4 <filedup+0x28>
    panic("filedup");
80100f98:	c7 04 24 b0 8b 10 80 	movl   $0x80108bb0,(%esp)
...
80100fba:	e8 5a 44 00 00       	call   80105419 <release>
  return f;
...
80100fd1:	e8 e1 43 00 00       	call   801053b7 <acquire>
  if(f->ref < 1)
...
80100fde:	7f 0c                	jg     80100fec <fileclose+0x28>
    panic("fileclose");
80100fe0:	c7 04 24 b8 8b 10 80 	movl   $0x80108bb8,(%esp)
...
8010100c:	e8 08 44 00 00       	call   80105419 <release>
    return;
...
80101056:	e8 be 43 00 00       	call   80105419 <release>
...
80101195:	eb 0c                	jmp    801011a3 <fileread+0xba>
  ...
  panic("fileread");
80101197:	c7 04 24 c2 8b 10 80 	movl   $0x80108bc2,(%esp)
...
801012a3:	c7 04 24 cb 8b 10 80 	movl   $0x80108bcb,(%esp)
...
801012d6:	eb 0c                	jmp    801012e4 <filewrite+0x13f>
  ...
  panic("filewrite");
801012d8:	c7 04 24 db 8b 10 80 	movl   $0x80108bdb,(%esp)
...
80101320:	e8 b4 43 00 00       	call   801056d9 <memmove>
  brelse(bp);
...
80101366:	e8 9b 42 00 00       	call   80105606 <memset>
  log_write(bp);
...
801014c8:	0f 82 e1 fe ff ff    	jb     801013af <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014ce:	c7 04 24 e5 8b 10 80 	movl   $0x80108be5,(%esp)
...
80101565:	c7 04 24 fb 8b 10 80 	movl   $0x80108bfb,(%esp)
...
801015b9:	c7 44 24 04 0e 8c 10 	movl   $0x80108c0e,0x4(%esp)
801015c0:	80 
801015c1:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
801015c8:	e8 c9 3d 00 00       	call   80105396 <initlock>
}
801015cd:	c9                   	leave  
801015ce:	c3                   	ret    
...
8010164a:	e8 b7 3f 00 00       	call   80105606 <memset>
      dip->type = type;
...
8010169a:	0f 82 5a ff ff ff    	jb     801015fa <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016a0:	c7 04 24 15 8c 10 80 	movl   $0x80108c15,(%esp)
...
80101747:	e8 8d 3f 00 00       	call   801056d9 <memmove>
  log_write(bp);
...
80101771:	e8 41 3c 00 00       	call   801053b7 <acquire>
...
801017bb:	e8 59 3c 00 00       	call   80105419 <release>
      return ip;
...
801017ee:	c7 04 24 27 8c 10 80 	movl   $0x80108c27,(%esp)
...
8010182c:	e8 e8 3b 00 00       	call   80105419 <release>
...
80101843:	e8 6f 3b 00 00       	call   801053b7 <acquire>
  ip->ref++;
...
8010185e:	e8 b6 3b 00 00       	call   80105419 <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 37 8c 10 80 	movl   $0x80108c37,(%esp)
80101885:	e8 b3 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101891:	e8 21 3b 00 00       	call   801053b7 <acquire>
...
801018a6:	e8 b2 31 00 00       	call   80104a5d <sleep>
...
801018d0:	e8 44 3b 00 00       	call   80105419 <release>
...
8010197b:	e8 59 3d 00 00       	call   801056d9 <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 3d 8c 10 80 	movl   $0x80108c3d,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 4c 8c 10 80 	movl   $0x80108c4c,(%esp)
801019e0:	e8 58 eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019e5:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
801019ec:	e8 c6 39 00 00       	call   801053b7 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a08:	e8 2c 31 00 00       	call   80104b39 <wakeup>
  release(&icache.lock);
80101a0d:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101a14:	e8 00 3a 00 00       	call   80105419 <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 8a 39 00 00       	call   801053b7 <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 54 8c 10 80 	movl   $0x80108c54,(%esp)
...
80101a8a:	e8 8a 39 00 00       	call   80105419 <release>
    itrunc(ip);
...
80101ab5:	e8 fd 38 00 00       	call   801053b7 <acquire>
    ip->flags = 0;
...
80101aca:	e8 6a 30 00 00       	call   80104b39 <wakeup>
  }
  ip->ref--;
...
80101ae5:	e8 2f 39 00 00       	call   80105419 <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101bfa:	c7 04 24 5e 8c 10 80 	movl   $0x80108c5e,(%esp)
...
80101e92:	e8 42 38 00 00       	call   801056d9 <memmove>
    brelse(bp);
...
80101ff8:	e8 dc 36 00 00       	call   801056d9 <memmove>
    log_write(bp);
...
8010207a:	e8 fe 36 00 00       	call   8010577d <strncmp>
}
8010207f:	c9                   	leave  
80102080:	c3                   	ret    
...
80102094:	c7 04 24 71 8c 10 80 	movl   $0x80108c71,(%esp)
...
801020d0:	74 0c                	je     801020de <dirlookup+0x5d>
      panic("dirlink read");
801020d2:	c7 04 24 83 8c 10 80 	movl   $0x80108c83,(%esp)
...
801021b4:	74 0c                	je     801021c2 <dirlink+0x79>
      panic("dirlink read");
801021b6:	c7 04 24 83 8c 10 80 	movl   $0x80108c83,(%esp)
...
801021fc:	e8 d4 35 00 00       	call   801057d5 <strncpy>
  de.inum = inum;
...
8010222c:	74 0c                	je     8010223a <dirlink+0xf1>
    panic("dirlink");
8010222e:	c7 04 24 90 8c 10 80 	movl   $0x80108c90,(%esp)
...
801022b5:	e8 1f 34 00 00       	call   801056d9 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d0:	e8 04 34 00 00       	call   801056d9 <memmove>
    name[len] = 0;
...
8010252c:	c7 44 24 04 98 8c 10 	movl   $0x80108c98,0x4(%esp)
80102533:	80 
80102534:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
8010253b:	e8 56 2e 00 00       	call   80105396 <initlock>
  picenable(IRQ_IDE);
...
801025d6:	75 0c                	jne    801025e4 <idestart+0x18>
    panic("idestart");
801025d8:	c7 04 24 9c 8c 10 80 	movl   $0x80108c9c,(%esp)
...
801026fe:	e8 b4 2c 00 00       	call   801053b7 <acquire>
  if((b = idequeue) == 0){
...
80102718:	e8 fc 2c 00 00       	call   80105419 <release>
...
8010278b:	e8 a9 23 00 00       	call   80104b39 <wakeup>
...
801027ad:	e8 67 2c 00 00       	call   80105419 <release>
}
801027b2:	c9                   	leave  
801027b3:	c3                   	ret    
...
801027c6:	c7 04 24 a5 8c 10 80 	movl   $0x80108ca5,(%esp)
...
801027df:	c7 04 24 b9 8c 10 80 	movl   $0x80108cb9,(%esp)
...
8010286a:	e8 ee 21 00 00       	call   80104a5d <sleep>
...
80102886:	e8 8e 2b 00 00       	call   80105419 <release>
}
8010288b:	c9                   	leave  
8010288c:	c3                   	ret    
...
80102916:	c7 04 24 ec 8c 10 80 	movl   $0x80108cec,(%esp)
...
801029d7:	c7 44 24 04 1e 8d 10 	movl   $0x80108d1e,0x4(%esp)
801029de:	80 
801029df:	c7 04 24 60 08 11 80 	movl   $0x80110860,(%esp)
801029e6:	e8 ab 29 00 00       	call   80105396 <initlock>
  kmem.use_lock = 0;
...
80102a91:	76 0c                	jbe    80102a9f <kfree+0x39>
    panic("kfree");
80102a93:	c7 04 24 23 8d 10 80 	movl   $0x80108d23,(%esp)
...
80102ab5:	e8 4c 2b 00 00       	call   80105606 <memset>
...
80102aca:	e8 e8 28 00 00       	call   801053b7 <acquire>
  r = (struct run*)v;
...
80102af8:	e8 1c 29 00 00       	call   80105419 <release>
}
80102afd:	c9                   	leave  
80102afe:	c3                   	ret    
...
80102b15:	e8 9d 28 00 00       	call   801053b7 <acquire>
  r = kmem.freelist;
...
80102b42:	e8 d2 28 00 00       	call   80105419 <release>
  return (char*)r;
...
80102ebe:	c7 04 24 2c 8d 10 80 	movl   $0x80108d2c,(%esp)
...
80103016:	c7 44 24 04 58 8d 10 	movl   $0x80108d58,0x4(%esp)
8010301d:	80 
8010301e:	c7 04 24 a0 08 11 80 	movl   $0x801108a0,(%esp)
80103025:	e8 6c 23 00 00       	call   80105396 <initlock>
  readsb(ROOTDEV, &sb);
...
801030d8:	e8 fc 25 00 00       	call   801056d9 <memmove>
...
8010322a:	e8 88 21 00 00       	call   801053b7 <acquire>
  while (log.busy) {
...
80103240:	e8 18 18 00 00       	call   80104a5d <sleep>
...
8010325f:	e8 b5 21 00 00       	call   80105419 <release>
}
80103264:	c9                   	leave  
80103265:	c3                   	ret    
...
801032e0:	c7 04 24 5c 8d 10 80 	movl   $0x80108d5c,(%esp)
...
801032f5:	c7 04 24 72 8d 10 80 	movl   $0x80108d72,(%esp)
...
80103384:	e8 50 23 00 00       	call   801056d9 <memmove>
  bwrite(lbuf);
...
80103424:	e8 8d 4f 00 00       	call   801083b6 <kvmalloc>
...
8010343b:	e8 19 49 00 00       	call   80107d59 <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
80103450:	c7 04 24 89 8d 10 80 	movl   $0x80108d89,(%esp)
...
8010346b:	e8 34 3c 00 00       	call   801070a4 <uartinit>
  pinit();         // process table
80103470:	e8 96 0b 00 00       	call   8010400b <pinit>
  tvinit();        // trap vectors
80103475:	e8 cd 37 00 00       	call   80106c47 <tvinit>
  binit();         // buffer cache
...
80103497:	e8 ee 36 00 00       	call   80106b8a <timerinit>
...
801034b5:	e8 7c 0c 00 00       	call   80104136 <userinit>
...
801034c2:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
801034c5:	e8 03 4f 00 00       	call   801083cd <switchkvm>
  seginit();
801034ca:	e8 8a 48 00 00       	call   80107d59 <seginit>
  lapicinit(cpunum());
...
801034f7:	c7 04 24 a0 8d 10 80 	movl   $0x80108da0,(%esp)
801034fe:	e8 9e ce ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80103503:	e8 b3 38 00 00       	call   80106dbb <idtinit>
...
80103523:	e8 89 13 00 00       	call   801048b1 <scheduler>
...
80103555:	e8 7f 21 00 00       	call   801056d9 <memmove>
...
801036e3:	00 
801036e4:	c7 44 24 04 b4 8d 10 	movl   $0x80108db4,0x4(%esp)
801036eb:	80 
801036ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036ef:	89 04 24             	mov    %eax,(%esp)
801036f2:	e8 86 1f 00 00       	call   8010567d <memcmp>
...
80103824:	00 
80103825:	c7 44 24 04 b9 8d 10 	movl   $0x80108db9,0x4(%esp)
8010382c:	80 
8010382d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103830:	89 04 24             	mov    %eax,(%esp)
80103833:	e8 45 1e 00 00       	call   8010567d <memcmp>
...
801038fe:	8b 04 85 fc 8d 10 80 	mov    -0x7fef7204(,%eax,4),%eax
...
80103937:	c7 04 24 be 8d 10 80 	movl   $0x80108dbe,(%esp)
...
801039ca:	c7 04 24 dc 8d 10 80 	movl   $0x80108ddc,(%esp)
...
80103ccf:	c7 44 24 04 10 8e 10 	movl   $0x80108e10,0x4(%esp)
80103cd6:	80 
80103cd7:	89 04 24             	mov    %eax,(%esp)
80103cda:	e8 b7 16 00 00       	call   80105396 <initlock>
  (*f0)->type = FD_PIPE;
...
80103d87:	e8 2b 16 00 00       	call   801053b7 <acquire>
  if(writable){
...
80103daa:	e8 8a 0d 00 00       	call   80104b39 <wakeup>
...
80103dc9:	e8 6b 0d 00 00       	call   80104b39 <wakeup>
  }
...
80103dee:	e8 26 16 00 00       	call   80105419 <release>
    kfree((char*)p);
...
80103e06:	e8 0e 16 00 00       	call   80105419 <release>
}
80103e0b:	c9                   	leave  
80103e0c:	c3                   	ret    
...
80103e1a:	e8 98 15 00 00       	call   801053b7 <acquire>
  for(i = 0; i < n; i++){
...
80103e4b:	e8 c9 15 00 00       	call   80105419 <release>
        return -1;
...
80103e65:	e8 cf 0c 00 00       	call   80104b39 <wakeup>
...
80103e7d:	e8 db 0b 00 00       	call   80104a5d <sleep>
...
80103ee4:	e8 50 0c 00 00       	call   80104b39 <wakeup>
  release(&p->lock);
80103ee9:	8b 45 08             	mov    0x8(%ebp),%eax
80103eec:	89 04 24             	mov    %eax,(%esp)
80103eef:	e8 25 15 00 00       	call   80105419 <release>
  return n;
...
80103f0a:	e8 a8 14 00 00       	call   801053b7 <acquire>
...
80103f24:	e8 f0 14 00 00       	call   80105419 <release>
      return -1;
...
80103f46:	e8 12 0b 00 00       	call   80104a5d <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103fd6:	e8 5e 0b 00 00       	call   80104b39 <wakeup>
  release(&p->lock);
80103fdb:	8b 45 08             	mov    0x8(%ebp),%eax
80103fde:	89 04 24             	mov    %eax,(%esp)
80103fe1:	e8 33 14 00 00       	call   80105419 <release>
  return i;
...
80104011:	c7 44 24 04 15 8e 10 	movl   $0x80108e15,0x4(%esp)
80104018:	80 
80104019:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104020:	e8 71 13 00 00       	call   80105396 <initlock>
}
80104025:	c9                   	leave  
80104026:	c3                   	ret    
...
80104034:	e8 7e 13 00 00       	call   801053b7 <acquire>
...
8010404a:	74 26                	je     80104072 <allocproc+0x4b>
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010404c:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104053:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
8010405a:	72 e6                	jb     80104042 <allocproc+0x1b>
    if(p->state == UNUSED)
      goto found;
  release(&ptable.lock);
8010405c:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104063:	e8 b1 13 00 00       	call   80105419 <release>
  return 0;
80104068:	b8 00 00 00 00       	mov    $0x0,%eax
8010406d:	e9 c2 00 00 00       	jmp    80104134 <allocproc+0x10d>
  char *sp;
...
80104097:	e8 7d 13 00 00       	call   80105419 <release>
...
801040c0:	eb 72                	jmp    80104134 <allocproc+0x10d>
  }
...
801040e1:	ba fc 6b 10 80       	mov    $0x80106bfc,%edx
...
80104139:	83 ec 28             	sub    $0x28,%esp
  ...
  p = allocproc();
8010413c:	e8 e6 fe ff ff       	call   80104027 <allocproc>
80104141:	89 45 f4             	mov    %eax,-0xc(%ebp)
  initproc = p;
80104144:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104147:	a3 68 c6 10 80       	mov    %eax,0x8010c668
  if((p->pgdir = setupkvm(kalloc)) == 0)
8010414c:	c7 04 24 ff 2a 10 80 	movl   $0x80102aff,(%esp)
80104153:	e8 a1 41 00 00       	call   801082f9 <setupkvm>
...
80104166:	75 0c                	jne    80104174 <userinit+0x3e>
    panic("userinit: out of memory?");
80104168:	c7 04 24 1c 8e 10 80 	movl   $0x80108e1c,(%esp)
8010416f:	e8 c9 c3 ff ff       	call   8010053d <panic>
...
80104183:	c7 44 24 04 00 c5 10 	movl   $0x8010c500,0x4(%esp)
8010418a:	80 
8010418b:	89 04 24             	mov    %eax,(%esp)
8010418e:	e8 be 43 00 00       	call   80108551 <inituvm>
  p->sz = PGSIZE;
...
801041b5:	e8 4c 14 00 00       	call   80105606 <memset>
...
8010422e:	00 
8010422f:	c7 44 24 04 35 8e 10 	movl   $0x80108e35,0x4(%esp)
80104236:	80 
80104237:	89 04 24             	mov    %eax,(%esp)
8010423a:	e8 f7 15 00 00       	call   80105836 <safestrcpy>
  p->cwd = namei("/");
8010423f:	c7 04 24 3e 8e 10 80 	movl   $0x80108e3e,(%esp)
80104246:	e8 bf e1 ff ff       	call   8010240a <namei>
...
80104293:	e8 33 44 00 00       	call   801086cb <allocuvm>
...
801042cd:	e8 d3 44 00 00       	call   801087a5 <deallocuvm>
...
801042f6:	e8 ef 40 00 00       	call   801083ea <switchuvm>
  return 0;
...
80104308:	83 ec 2c             	sub    $0x2c,%esp
  ...
  // Allocate process.
  if((np = allocproc()) == 0)
8010430b:	e8 17 fd ff ff       	call   80104027 <allocproc>
80104310:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104313:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104317:	75 0a                	jne    80104323 <fork+0x21>
    return -1;
80104319:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010431e:	e9 7c 01 00 00       	jmp    8010449f <fork+0x19d>
...
8010433b:	e8 f5 45 00 00       	call   80108935 <copyuvm>
80104340:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104343:	89 42 04             	mov    %eax,0x4(%edx)
80104346:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80104359:	e8 08 e7 ff ff       	call   80102a66 <kfree>
    np->kstack = 0;
...
80104377:	e9 23 01 00 00       	jmp    8010449f <fork+0x19d>
  }
  np->sz = proc->sz;
...
8010438f:	8b 40 7c             	mov    0x7c(%eax),%eax
80104392:	85 c0                	test   %eax,%eax
80104394:	75 0f                	jne    801043a5 <fork+0xa3>
    np->parent = proc;
80104396:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010439d:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043a0:	89 50 14             	mov    %edx,0x14(%eax)
801043a3:	eb 0f                	jmp    801043b4 <fork+0xb2>
  else
    np->parent = proc->parent;
801043a5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043ab:	8b 50 14             	mov    0x14(%eax),%edx
801043ae:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043b1:	89 50 14             	mov    %edx,0x14(%eax)
  *np->tf = *proc->tf;
801043b4:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043b7:	8b 50 18             	mov    0x18(%eax),%edx
801043ba:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801043c0:	8b 40 18             	mov    0x18(%eax),%eax
801043c3:	89 c3                	mov    %eax,%ebx
801043c5:	b8 13 00 00 00       	mov    $0x13,%eax
801043ca:	89 d7                	mov    %edx,%edi
801043cc:	89 de                	mov    %ebx,%esi
801043ce:	89 c1                	mov    %eax,%ecx
801043d0:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  
  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
801043d2:	8b 45 e0             	mov    -0x20(%ebp),%eax
801043d5:	8b 40 18             	mov    0x18(%eax),%eax
801043d8:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)

  for(i = 0; i < NOFILE; i++)
801043df:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801043e6:	eb 3d                	jmp    80104425 <fork+0x123>
    if(proc->ofile[i])
...
801043fa:	74 25                	je     80104421 <fork+0x11f>
      np->ofile[i] = filedup(proc->ofile[i]);
801043fc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104402:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104405:	83 c2 08             	add    $0x8,%edx
80104408:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
8010440c:	89 04 24             	mov    %eax,(%esp)
8010440f:	e8 68 cb ff ff       	call   80100f7c <filedup>
80104414:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104417:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010441a:	83 c1 08             	add    $0x8,%ecx
8010441d:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  *np->tf = *proc->tf;
  ...
  for(i = 0; i < NOFILE; i++)
80104421:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80104425:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104429:	7e bd                	jle    801043e8 <fork+0xe6>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = idup(proc->cwd);
8010442b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104431:	8b 40 68             	mov    0x68(%eax),%eax
80104434:	89 04 24             	mov    %eax,(%esp)
80104437:	e8 fa d3 ff ff       	call   80101836 <idup>
8010443c:	8b 55 e0             	mov    -0x20(%ebp),%edx
8010443f:	89 42 68             	mov    %eax,0x68(%edx)
  np->thread_id = 0;
80104442:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104445:	c7 80 84 00 00 00 00 	movl   $0x0,0x84(%eax)
8010444c:	00 00 00 
  np->isthread = 0;
8010444f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104452:	c7 40 7c 00 00 00 00 	movl   $0x0,0x7c(%eax)
  np->isjoined = 0;
80104459:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010445c:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
80104463:	00 00 00 
  pid = np->pid;
80104466:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104469:	8b 40 10             	mov    0x10(%eax),%eax
8010446c:	89 45 dc             	mov    %eax,-0x24(%ebp)
  np->state = RUNNABLE;
8010446f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104472:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  safestrcpy(np->name, proc->name, sizeof(proc->name));
80104479:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010447f:	8d 50 6c             	lea    0x6c(%eax),%edx
80104482:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104485:	83 c0 6c             	add    $0x6c,%eax
80104488:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
8010448f:	00 
80104490:	89 54 24 04          	mov    %edx,0x4(%esp)
80104494:	89 04 24             	mov    %eax,(%esp)
80104497:	e8 9a 13 00 00       	call   80105836 <safestrcpy>
  return pid;
8010449c:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
8010449f:	83 c4 2c             	add    $0x2c,%esp
801044a2:	5b                   	pop    %ebx
801044a3:	5e                   	pop    %esi
801044a4:	5f                   	pop    %edi
801044a5:	5d                   	pop    %ebp
...
801044b4:	a1 68 c6 10 80       	mov    0x8010c668,%eax
801044b9:	39 c2                	cmp    %eax,%edx
801044bb:	75 0c                	jne    801044c9 <exit+0x22>
    panic("init exiting");
801044bd:	c7 04 24 40 8e 10 80 	movl   $0x80108e40,(%esp)
801044c4:	e8 74 c0 ff ff       	call   8010053d <panic>

  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
801044c9:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
801044d0:	eb 44                	jmp    80104516 <exit+0x6f>
    if(proc->ofile[fd]){
801044d2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044d8:	8b 55 f0             	mov    -0x10(%ebp),%edx
801044db:	83 c2 08             	add    $0x8,%edx
801044de:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801044e2:	85 c0                	test   %eax,%eax
801044e4:	74 2c                	je     80104512 <exit+0x6b>
      fileclose(proc->ofile[fd]);
801044e6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801044ec:	8b 55 f0             	mov    -0x10(%ebp),%edx
801044ef:	83 c2 08             	add    $0x8,%edx
801044f2:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
801044f6:	89 04 24             	mov    %eax,(%esp)
801044f9:	e8 c6 ca ff ff       	call   80100fc4 <fileclose>
      proc->ofile[fd] = 0;
801044fe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104504:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104507:	83 c2 08             	add    $0x8,%edx
8010450a:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80104511:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80104512:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
80104516:	83 7d f0 0f          	cmpl   $0xf,-0x10(%ebp)
8010451a:	7e b6                	jle    801044d2 <exit+0x2b>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
...
80104522:	8b 40 68             	mov    0x68(%eax),%eax
80104525:	89 04 24             	mov    %eax,(%esp)
80104528:	e8 ee d4 ff ff       	call   80101a1b <iput>
  proc->cwd = 0;
8010452d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104533:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
8010453a:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104541:	e8 71 0e 00 00       	call   801053b7 <acquire>
  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
80104546:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010454c:	8b 40 14             	mov    0x14(%eax),%eax
8010454f:	89 04 24             	mov    %eax,(%esp)
80104552:	e8 a1 05 00 00       	call   80104af8 <wakeup1>
  // Pass abandoned children to init.
  
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104557:	c7 45 f4 b4 15 11 80 	movl   $0x801115b4,-0xc(%ebp)
8010455e:	e9 01 01 00 00       	jmp    80104664 <exit+0x1bd>
    if(p->pid == proc->pid && p->state != ZOMBIE){		// for threads
80104563:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104566:	8b 50 10             	mov    0x10(%eax),%edx
80104569:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010456f:	8b 40 10             	mov    0x10(%eax),%eax
80104572:	39 c2                	cmp    %eax,%edx
80104574:	0f 85 a1 00 00 00    	jne    8010461b <exit+0x174>
8010457a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010457d:	8b 40 0c             	mov    0xc(%eax),%eax
80104580:	83 f8 05             	cmp    $0x5,%eax
80104583:	0f 84 92 00 00 00    	je     8010461b <exit+0x174>
        // Found one.
        p->state = ZOMBIE;
80104589:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010458c:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
	if(p->isthread)
80104593:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104596:	8b 40 7c             	mov    0x7c(%eax),%eax
80104599:	85 c0                	test   %eax,%eax
8010459b:	74 4c                	je     801045e9 <exit+0x142>
	{
	  if(p->parent->threadnum)
8010459d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045a0:	8b 40 14             	mov    0x14(%eax),%eax
801045a3:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801045a9:	85 c0                	test   %eax,%eax
801045ab:	74 15                	je     801045c2 <exit+0x11b>
	    p->parent->threadnum--;
801045ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045b0:	8b 40 14             	mov    0x14(%eax),%eax
801045b3:	8b 90 88 00 00 00    	mov    0x88(%eax),%edx
801045b9:	83 ea 01             	sub    $0x1,%edx
801045bc:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
	  if(!p->parent->threadnum)
801045c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045c5:	8b 40 14             	mov    0x14(%eax),%eax
801045c8:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801045ce:	85 c0                	test   %eax,%eax
801045d0:	0f 85 86 00 00 00    	jne    8010465c <exit+0x1b5>
	    wakeup1(p->parent->parent);
801045d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045d9:	8b 40 14             	mov    0x14(%eax),%eax
801045dc:	8b 40 14             	mov    0x14(%eax),%eax
801045df:	89 04 24             	mov    %eax,(%esp)
801045e2:	e8 11 05 00 00       	call   80104af8 <wakeup1>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == proc->pid && p->state != ZOMBIE){		// for threads
        ...
        p->state = ZOMBIE;
	if(p->isthread)
801045e7:	eb 73                	jmp    8010465c <exit+0x1b5>
	  if(!p->parent->threadnum)
	    wakeup1(p->parent->parent);
	}
	else
...
801045ec:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801045f2:	8d 50 ff             	lea    -0x1(%eax),%edx
801045f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045f8:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
	  if(!p->threadnum)
801045fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104601:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80104607:	85 c0                	test   %eax,%eax
80104609:	75 51                	jne    8010465c <exit+0x1b5>
	    wakeup1(p->parent);
8010460b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010460e:	8b 40 14             	mov    0x14(%eax),%eax
80104611:	89 04 24             	mov    %eax,(%esp)
80104614:	e8 df 04 00 00       	call   80104af8 <wakeup1>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == proc->pid && p->state != ZOMBIE){		// for threads
        ...
        p->state = ZOMBIE;
	if(p->isthread)
80104619:	eb 41                	jmp    8010465c <exit+0x1b5>
	  p->threadnum--;
	  if(!p->threadnum)
	    wakeup1(p->parent);
	}
...
8010461e:	8b 50 14             	mov    0x14(%eax),%edx
80104621:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104627:	39 c2                	cmp    %eax,%edx
80104629:	75 32                	jne    8010465d <exit+0x1b6>
8010462b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010462e:	8b 40 7c             	mov    0x7c(%eax),%eax
80104631:	83 f8 01             	cmp    $0x1,%eax
80104634:	74 27                	je     8010465d <exit+0x1b6>
      p->parent = initproc;
80104636:	8b 15 68 c6 10 80    	mov    0x8010c668,%edx
8010463c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010463f:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
80104642:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104645:	8b 40 0c             	mov    0xc(%eax),%eax
80104648:	83 f8 05             	cmp    $0x5,%eax
8010464b:	75 10                	jne    8010465d <exit+0x1b6>
        wakeup1(initproc);
8010464d:	a1 68 c6 10 80       	mov    0x8010c668,%eax
80104652:	89 04 24             	mov    %eax,(%esp)
80104655:	e8 9e 04 00 00       	call   80104af8 <wakeup1>
8010465a:	eb 01                	jmp    8010465d <exit+0x1b6>
...
8010465c:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010465d:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104664:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
8010466b:	0f 82 f2 fe ff ff    	jb     80104563 <exit+0xbc>
        wakeup1(initproc);
    }
  }
...
80104677:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
8010467e:	e8 ca 02 00 00       	call   8010494d <sched>
  panic("zombie exit");
80104683:	c7 04 24 4d 8e 10 80 	movl   $0x80108e4d,(%esp)
8010468a:	e8 ae be ff ff       	call   8010053d <panic>
...
80104692:	83 ec 38             	sub    $0x38,%esp
  struct proc *p;
  int havekids, pid;
  int found = 0, first = 0;
80104695:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
8010469c:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)

  acquire(&ptable.lock);
801046a3:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
801046aa:	e8 08 0d 00 00       	call   801053b7 <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
801046af:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046b6:	c7 45 f4 b4 15 11 80 	movl   $0x801115b4,-0xc(%ebp)
801046bd:	eb 4c                	jmp    8010470b <wait+0x7c>
      if(p->parent != proc)
801046bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046c2:	8b 50 14             	mov    0x14(%eax),%edx
801046c5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801046cb:	39 c2                	cmp    %eax,%edx
801046cd:	75 34                	jne    80104703 <wait+0x74>
        continue;
      havekids = 1;
801046cf:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE && !p->isthread && p->threadnum == 0){
801046d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046d9:	8b 40 0c             	mov    0xc(%eax),%eax
801046dc:	83 f8 05             	cmp    $0x5,%eax
801046df:	75 23                	jne    80104704 <wait+0x75>
801046e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046e4:	8b 40 7c             	mov    0x7c(%eax),%eax
801046e7:	85 c0                	test   %eax,%eax
801046e9:	75 19                	jne    80104704 <wait+0x75>
801046eb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046ee:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801046f4:	85 c0                	test   %eax,%eax
801046f6:	75 0c                	jne    80104704 <wait+0x75>
        found = p->pid;
801046f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046fb:	8b 40 10             	mov    0x10(%eax),%eax
801046fe:	89 45 e8             	mov    %eax,-0x18(%ebp)
	break;
80104701:	eb 11                	jmp    80104714 <wait+0x85>
    // Scan through table looking for zombie children.
    havekids = 0;
...
80104703:	90                   	nop
  ...
  for(;;){
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104704:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
8010470b:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
80104712:	72 ab                	jb     801046bf <wait+0x30>
        found = p->pid;
	break;
      }
    }
    ...
    if(found > 0)
80104714:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80104718:	0f 8e 99 00 00 00    	jle    801047b7 <wait+0x128>
    {
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010471e:	c7 45 f4 b4 15 11 80 	movl   $0x801115b4,-0xc(%ebp)
80104725:	e9 80 00 00 00       	jmp    801047aa <wait+0x11b>
	if(p->pid != found)
8010472a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010472d:	8b 40 10             	mov    0x10(%eax),%eax
80104730:	3b 45 e8             	cmp    -0x18(%ebp),%eax
80104733:	75 6d                	jne    801047a2 <wait+0x113>
	  continue;
			    // we found a child process whom all of his threads are zombies (including himself)
	if(!first)
80104735:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
80104739:	75 15                	jne    80104750 <wait+0xc1>
	{
	 freevm(p->pgdir);
8010473b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010473e:	8b 40 04             	mov    0x4(%eax),%eax
80104741:	89 04 24             	mov    %eax,(%esp)
80104744:	e8 18 41 00 00       	call   80108861 <freevm>
	 first = 1;
80104749:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
	}
	pid = p->pid;
80104750:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104753:	8b 40 10             	mov    0x10(%eax),%eax
80104756:	89 45 ec             	mov    %eax,-0x14(%ebp)
	kfree(p->kstack);
80104759:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010475c:	8b 40 08             	mov    0x8(%eax),%eax
8010475f:	89 04 24             	mov    %eax,(%esp)
80104762:	e8 ff e2 ff ff       	call   80102a66 <kfree>
	p->kstack = 0;
...
8010477e:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
	p->parent = 0;
80104785:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104788:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
	p->name[0] = 0;
8010478f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104792:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
	p->killed = 0;
80104796:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104799:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
801047a0:	eb 01                	jmp    801047a3 <wait+0x114>
...
801047a2:	90                   	nop
    ...
    {
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047a3:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
801047aa:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
801047b1:	0f 82 73 ff ff ff    	jb     8010472a <wait+0x9b>
	p->name[0] = 0;
	p->killed = 0;
      }
    }
    ...
    if(found)
801047b7:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801047bb:	74 11                	je     801047ce <wait+0x13f>
    {
      release(&ptable.lock);
801047bd:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
801047c4:	e8 50 0c 00 00       	call   80105419 <release>
      return pid;
801047c9:	8b 45 ec             	mov    -0x14(%ebp),%eax
801047cc:	eb 41                	jmp    8010480f <wait+0x180>
    }

    // No point waiting if we don't have any children.
    if(!havekids || proc->killed){
801047ce:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801047d2:	74 0d                	je     801047e1 <wait+0x152>
801047d4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047da:	8b 40 24             	mov    0x24(%eax),%eax
801047dd:	85 c0                	test   %eax,%eax
801047df:	74 13                	je     801047f4 <wait+0x165>
      release(&ptable.lock);
801047e1:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
801047e8:	e8 2c 0c 00 00       	call   80105419 <release>
      return -1;
801047ed:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801047f2:	eb 1b                	jmp    8010480f <wait+0x180>
    }

    // Wait for children to exit.  (See wakeup1 call in proc_exit.)
    sleep(proc, &ptable.lock);  //DOC: wait-sleep
801047f4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801047fa:	c7 44 24 04 80 15 11 	movl   $0x80111580,0x4(%esp)
80104801:	80 
80104802:	89 04 24             	mov    %eax,(%esp)
80104805:	e8 53 02 00 00       	call   80104a5d <sleep>
  }
8010480a:	e9 a0 fe ff ff       	jmp    801046af <wait+0x20>
}
8010480f:	c9                   	leave  
80104810:	c3                   	ret    

80104811 <register_handler>:
...
80104814:	83 ec 28             	sub    $0x28,%esp
...
8010482e:	89 54 24 04          	mov    %edx,0x4(%esp)
80104832:	89 04 24             	mov    %eax,(%esp)
80104835:	e8 0c 42 00 00       	call   80108a46 <uva2ka>
8010483a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if ((proc->tf->esp & 0xFFF) == 0)
8010483d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104843:	8b 40 18             	mov    0x18(%eax),%eax
80104846:	8b 40 44             	mov    0x44(%eax),%eax
80104849:	25 ff 0f 00 00       	and    $0xfff,%eax
8010484e:	85 c0                	test   %eax,%eax
80104850:	75 0c                	jne    8010485e <register_handler+0x4d>
    panic("esp_offset == 0");
80104852:	c7 04 24 59 8e 10 80 	movl   $0x80108e59,(%esp)
80104859:	e8 df bc ff ff       	call   8010053d <panic>

    /* open a new frame */
  *(int*)(addr + ((proc->tf->esp - 4) & 0xFFF))
8010485e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104864:	8b 40 18             	mov    0x18(%eax),%eax
80104867:	8b 40 44             	mov    0x44(%eax),%eax
8010486a:	83 e8 04             	sub    $0x4,%eax
8010486d:	25 ff 0f 00 00       	and    $0xfff,%eax
80104872:	03 45 f4             	add    -0xc(%ebp),%eax
          = proc->tf->eip;
80104875:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
8010487c:	8b 52 18             	mov    0x18(%edx),%edx
8010487f:	8b 52 38             	mov    0x38(%edx),%edx
80104882:	89 10                	mov    %edx,(%eax)
  proc->tf->esp -= 4;
80104884:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010488a:	8b 40 18             	mov    0x18(%eax),%eax
8010488d:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104894:	8b 52 18             	mov    0x18(%edx),%edx
80104897:	8b 52 44             	mov    0x44(%edx),%edx
8010489a:	83 ea 04             	sub    $0x4,%edx
8010489d:	89 50 44             	mov    %edx,0x44(%eax)
...
801048ac:	89 50 38             	mov    %edx,0x38(%eax)
}
801048af:	c9                   	leave  
801048b0:	c3                   	ret    
...
801048b4:	83 ec 28             	sub    $0x28,%esp
  ...
  for(;;){
    ...
    sti();
801048b7:	e8 49 f7 ff ff       	call   80104005 <sti>

    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
801048bc:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
801048c3:	e8 ef 0a 00 00       	call   801053b7 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048c8:	c7 45 f4 b4 15 11 80 	movl   $0x801115b4,-0xc(%ebp)
801048cf:	eb 62                	jmp    80104933 <scheduler+0x82>
      if(p->state != RUNNABLE)
801048d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048d4:	8b 40 0c             	mov    0xc(%eax),%eax
801048d7:	83 f8 03             	cmp    $0x3,%eax
801048da:	75 4f                	jne    8010492b <scheduler+0x7a>
        continue;
...
801048df:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
      switchuvm(p);
801048e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048e8:	89 04 24             	mov    %eax,(%esp)
801048eb:	e8 fa 3a 00 00       	call   801083ea <switchuvm>
      p->state = RUNNING;
801048f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801048f3:	c7 40 0c 04 00 00 00 	movl   $0x4,0xc(%eax)
      swtch(&cpu->scheduler, proc->context);
801048fa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104900:	8b 40 1c             	mov    0x1c(%eax),%eax
80104903:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010490a:	83 c2 04             	add    $0x4,%edx
8010490d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104911:	89 14 24             	mov    %edx,(%esp)
80104914:	e8 93 0f 00 00       	call   801058ac <swtch>
      switchkvm();
80104919:	e8 af 3a 00 00       	call   801083cd <switchkvm>

      // Process is done running for now.
      // It should have changed its p->state before coming back.
      proc = 0;
8010491e:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104925:	00 00 00 00 
80104929:	eb 01                	jmp    8010492c <scheduler+0x7b>
...
8010492b:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010492c:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104933:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
8010493a:	72 95                	jb     801048d1 <scheduler+0x20>
    ...
    release(&ptable.lock);
8010493c:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104943:	e8 d1 0a 00 00       	call   80105419 <release>

  }
80104948:	e9 6a ff ff ff       	jmp    801048b7 <scheduler+0x6>
...
80104953:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
8010495a:	e8 76 0b 00 00       	call   801054d5 <holding>
8010495f:	85 c0                	test   %eax,%eax
80104961:	75 0c                	jne    8010496f <sched+0x22>
    panic("sched ptable.lock");
80104963:	c7 04 24 69 8e 10 80 	movl   $0x80108e69,(%esp)
8010496a:	e8 ce bb ff ff       	call   8010053d <panic>
  if(cpu->ncli != 1)
8010496f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104975:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
8010497b:	83 f8 01             	cmp    $0x1,%eax
8010497e:	74 0c                	je     8010498c <sched+0x3f>
    panic("sched locks");
80104980:	c7 04 24 7b 8e 10 80 	movl   $0x80108e7b,(%esp)
80104987:	e8 b1 bb ff ff       	call   8010053d <panic>
  if(proc->state == RUNNING)
8010498c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104992:	8b 40 0c             	mov    0xc(%eax),%eax
80104995:	83 f8 04             	cmp    $0x4,%eax
80104998:	75 0c                	jne    801049a6 <sched+0x59>
    panic("sched running");
8010499a:	c7 04 24 87 8e 10 80 	movl   $0x80108e87,(%esp)
801049a1:	e8 97 bb ff ff       	call   8010053d <panic>
  if(readeflags()&FL_IF)
801049a6:	e8 45 f6 ff ff       	call   80103ff0 <readeflags>
801049ab:	25 00 02 00 00       	and    $0x200,%eax
801049b0:	85 c0                	test   %eax,%eax
801049b2:	74 0c                	je     801049c0 <sched+0x73>
    panic("sched interruptible");
801049b4:	c7 04 24 95 8e 10 80 	movl   $0x80108e95,(%esp)
801049bb:	e8 7d bb ff ff       	call   8010053d <panic>
  intena = cpu->intena;
801049c0:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801049c6:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801049cc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  swtch(&proc->context, cpu->scheduler);
801049cf:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801049d5:	8b 40 04             	mov    0x4(%eax),%eax
801049d8:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801049df:	83 c2 1c             	add    $0x1c,%edx
801049e2:	89 44 24 04          	mov    %eax,0x4(%esp)
801049e6:	89 14 24             	mov    %edx,(%esp)
801049e9:	e8 be 0e 00 00       	call   801058ac <swtch>
  cpu->intena = intena;
801049ee:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801049f4:	8b 55 f4             	mov    -0xc(%ebp),%edx
801049f7:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
801049fd:	c9                   	leave  
801049fe:	c3                   	ret    
...
80104a05:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104a0c:	e8 a6 09 00 00       	call   801053b7 <acquire>
  proc->state = RUNNABLE;
80104a11:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a17:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80104a1e:	e8 2a ff ff ff       	call   8010494d <sched>
  release(&ptable.lock);
80104a23:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104a2a:	e8 ea 09 00 00       	call   80105419 <release>
}
80104a2f:	c9                   	leave  
80104a30:	c3                   	ret    
...
80104a34:	83 ec 18             	sub    $0x18,%esp
  ...
  release(&ptable.lock);
80104a37:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104a3e:	e8 d6 09 00 00       	call   80105419 <release>

  if (first) {
80104a43:	a1 20 c0 10 80       	mov    0x8010c020,%eax
80104a48:	85 c0                	test   %eax,%eax
80104a4a:	74 0f                	je     80104a5b <forkret+0x2a>
    // Some initialization functions must be run in the context
    // of a regular process (e.g., they call sleep), and thus cannot 
    // be run from main().
    first = 0;
80104a4c:	c7 05 20 c0 10 80 00 	movl   $0x0,0x8010c020
80104a53:	00 00 00 
    initlog();
80104a56:	e8 b5 e5 ff ff       	call   80103010 <initlog>
  }
...
80104a6b:	75 0c                	jne    80104a79 <sleep+0x1c>
    panic("sleep");
80104a6d:	c7 04 24 a9 8e 10 80 	movl   $0x80108ea9,(%esp)
80104a74:	e8 c4 ba ff ff       	call   8010053d <panic>

  if(lk == 0)
80104a79:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104a7d:	75 0c                	jne    80104a8b <sleep+0x2e>
    panic("sleep without lk");
80104a7f:	c7 04 24 af 8e 10 80 	movl   $0x80108eaf,(%esp)
80104a86:	e8 b2 ba ff ff       	call   8010053d <panic>
...
80104a8b:	81 7d 0c 80 15 11 80 	cmpl   $0x80111580,0xc(%ebp)
80104a92:	74 17                	je     80104aab <sleep+0x4e>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104a94:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104a9b:	e8 17 09 00 00       	call   801053b7 <acquire>
    release(lk);
80104aa0:	8b 45 0c             	mov    0xc(%ebp),%eax
80104aa3:	89 04 24             	mov    %eax,(%esp)
80104aa6:	e8 6e 09 00 00       	call   80105419 <release>
  }
...
80104abd:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80104ac4:	e8 84 fe ff ff       	call   8010494d <sched>

  // Tidy up.
  proc->chan = 0;
80104ac9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104acf:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

  // Reacquire original lock.
  if(lk != &ptable.lock){  //DOC: sleeplock2
80104ad6:	81 7d 0c 80 15 11 80 	cmpl   $0x80111580,0xc(%ebp)
80104add:	74 17                	je     80104af6 <sleep+0x99>
    release(&ptable.lock);
80104adf:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104ae6:	e8 2e 09 00 00       	call   80105419 <release>
    acquire(lk);
80104aeb:	8b 45 0c             	mov    0xc(%ebp),%eax
80104aee:	89 04 24             	mov    %eax,(%esp)
80104af1:	e8 c1 08 00 00       	call   801053b7 <acquire>
  }
}
80104af6:	c9                   	leave  
80104af7:	c3                   	ret    
...
80104afb:	83 ec 10             	sub    $0x10,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104afe:	c7 45 fc b4 15 11 80 	movl   $0x801115b4,-0x4(%ebp)
80104b05:	eb 27                	jmp    80104b2e <wakeup1+0x36>
    if(p->state == SLEEPING && p->chan == chan)
80104b07:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b0a:	8b 40 0c             	mov    0xc(%eax),%eax
80104b0d:	83 f8 02             	cmp    $0x2,%eax
80104b10:	75 15                	jne    80104b27 <wakeup1+0x2f>
80104b12:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b15:	8b 40 20             	mov    0x20(%eax),%eax
80104b18:	3b 45 08             	cmp    0x8(%ebp),%eax
80104b1b:	75 0a                	jne    80104b27 <wakeup1+0x2f>
      p->state = RUNNABLE;
80104b1d:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b20:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104b27:	81 45 fc 98 00 00 00 	addl   $0x98,-0x4(%ebp)
80104b2e:	81 7d fc b4 3b 11 80 	cmpl   $0x80113bb4,-0x4(%ebp)
80104b35:	72 d0                	jb     80104b07 <wakeup1+0xf>
    if(p->state == SLEEPING && p->chan == chan)
      p->state = RUNNABLE;
}
80104b37:	c9                   	leave  
...
80104b3c:	83 ec 18             	sub    $0x18,%esp
  acquire(&ptable.lock);
80104b3f:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104b46:	e8 6c 08 00 00       	call   801053b7 <acquire>
  wakeup1(chan);
80104b4b:	8b 45 08             	mov    0x8(%ebp),%eax
80104b4e:	89 04 24             	mov    %eax,(%esp)
80104b51:	e8 a2 ff ff ff       	call   80104af8 <wakeup1>
  release(&ptable.lock);
80104b56:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104b5d:	e8 b7 08 00 00       	call   80105419 <release>
}
80104b62:	c9                   	leave  
80104b63:	c3                   	ret    
...
80104b67:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&ptable.lock);
80104b6a:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104b71:	e8 41 08 00 00       	call   801053b7 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b76:	c7 45 f4 b4 15 11 80 	movl   $0x801115b4,-0xc(%ebp)
80104b7d:	eb 44                	jmp    80104bc3 <kill+0x5f>
    if(p->pid == pid){
...
80104ba2:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
      release(&ptable.lock);
80104ba9:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104bb0:	e8 64 08 00 00       	call   80105419 <release>
      return 0;
80104bb5:	b8 00 00 00 00       	mov    $0x0,%eax
80104bba:	eb 21                	jmp    80104bdd <kill+0x79>
kill(int pid)
{
  struct proc *p;
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104bbc:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104bc3:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
80104bca:	72 b3                	jb     80104b7f <kill+0x1b>
        p->state = RUNNABLE;
      release(&ptable.lock);
      return 0;
    }
  ...
  release(&ptable.lock);
80104bcc:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104bd3:	e8 41 08 00 00       	call   80105419 <release>
  return -1;
...
80104be2:	83 ec 58             	sub    $0x58,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104be5:	c7 45 f0 b4 15 11 80 	movl   $0x801115b4,-0x10(%ebp)
80104bec:	e9 db 00 00 00       	jmp    80104ccc <procdump+0xed>
    if(p->state == UNUSED)
80104bf1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104bf4:	8b 40 0c             	mov    0xc(%eax),%eax
80104bf7:	85 c0                	test   %eax,%eax
80104bf9:	0f 84 c5 00 00 00    	je     80104cc4 <procdump+0xe5>
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104bff:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c02:	8b 40 0c             	mov    0xc(%eax),%eax
80104c05:	83 f8 05             	cmp    $0x5,%eax
80104c08:	77 23                	ja     80104c2d <procdump+0x4e>
80104c0a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c0d:	8b 40 0c             	mov    0xc(%eax),%eax
80104c10:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80104c17:	85 c0                	test   %eax,%eax
80104c19:	74 12                	je     80104c2d <procdump+0x4e>
      state = states[p->state];
80104c1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c1e:	8b 40 0c             	mov    0xc(%eax),%eax
80104c21:	8b 04 85 08 c0 10 80 	mov    -0x7fef3ff8(,%eax,4),%eax
80104c28:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104c2b:	eb 07                	jmp    80104c34 <procdump+0x55>
    else
      state = "???";
80104c2d:	c7 45 ec c0 8e 10 80 	movl   $0x80108ec0,-0x14(%ebp)
...
80104c4f:	c7 04 24 c4 8e 10 80 	movl   $0x80108ec4,(%esp)
80104c56:	e8 46 b7 ff ff       	call   801003a1 <cprintf>
    if(p->state == SLEEPING){
80104c5b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c5e:	8b 40 0c             	mov    0xc(%eax),%eax
80104c61:	83 f8 02             	cmp    $0x2,%eax
80104c64:	75 50                	jne    80104cb6 <procdump+0xd7>
...
80104c7c:	e8 e7 07 00 00       	call   80105468 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80104c81:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104c88:	eb 1b                	jmp    80104ca5 <procdump+0xc6>
        cprintf(" %p", pc[i]);
80104c8a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c8d:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104c91:	89 44 24 04          	mov    %eax,0x4(%esp)
80104c95:	c7 04 24 cd 8e 10 80 	movl   $0x80108ecd,(%esp)
80104c9c:	e8 00 b7 ff ff       	call   801003a1 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
...
80104ca9:	7f 0b                	jg     80104cb6 <procdump+0xd7>
80104cab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cae:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104cb2:	85 c0                	test   %eax,%eax
80104cb4:	75 d4                	jne    80104c8a <procdump+0xab>
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
80104cb6:	c7 04 24 d1 8e 10 80 	movl   $0x80108ed1,(%esp)
80104cbd:	e8 df b6 ff ff       	call   801003a1 <cprintf>
80104cc2:	eb 01                	jmp    80104cc5 <procdump+0xe6>
  char *state;
  uint pc[10];
...
80104cc4:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104cc5:	81 45 f0 98 00 00 00 	addl   $0x98,-0x10(%ebp)
80104ccc:	81 7d f0 b4 3b 11 80 	cmpl   $0x80113bb4,-0x10(%ebp)
80104cd3:	0f 82 18 ff ff ff    	jb     80104bf1 <procdump+0x12>
      for(i=0; i<10 && pc[i] != 0; i++)
        cprintf(" %p", pc[i]);
    }
    cprintf("\n");
...
80104cde:	57                   	push   %edi
80104cdf:	56                   	push   %esi
80104ce0:	53                   	push   %ebx
80104ce1:	83 ec 2c             	sub    $0x2c,%esp
  int i, tid;
  struct proc *np;

  // Allocate process.
  if((np = allocproc()) == 0)
80104ce4:	e8 3e f3 ff ff       	call   80104027 <allocproc>
80104ce9:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104cec:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104cf0:	75 0a                	jne    80104cfc <thread_create+0x21>
    return -1;
80104cf2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104cf7:	e9 70 01 00 00       	jmp    80104e6c <thread_create+0x191>

  np->pid = proc->pid;
80104cfc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d02:	8b 50 10             	mov    0x10(%eax),%edx
80104d05:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d08:	89 50 10             	mov    %edx,0x10(%eax)
  // Copy process state from p.
  np->pgdir = proc->pgdir;
80104d0b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d11:	8b 50 04             	mov    0x4(%eax),%edx
80104d14:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d17:	89 50 04             	mov    %edx,0x4(%eax)
  np->sz = proc->sz;
...
80104d2d:	8b 40 7c             	mov    0x7c(%eax),%eax
80104d30:	85 c0                	test   %eax,%eax
80104d32:	74 11                	je     80104d45 <thread_create+0x6a>
    np->parent = proc->parent;
80104d34:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d3a:	8b 50 14             	mov    0x14(%eax),%edx
80104d3d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d40:	89 50 14             	mov    %edx,0x14(%eax)
80104d43:	eb 0d                	jmp    80104d52 <thread_create+0x77>
  else
    np->parent = proc;
80104d45:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104d4c:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d4f:	89 50 14             	mov    %edx,0x14(%eax)
  np->parent->threadnum++;
80104d52:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d55:	8b 40 14             	mov    0x14(%eax),%eax
80104d58:	8b 90 88 00 00 00    	mov    0x88(%eax),%edx
80104d5e:	83 c2 01             	add    $0x1,%edx
80104d61:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)

  np->isthread = 1;
80104d67:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d6a:	c7 40 7c 01 00 00 00 	movl   $0x1,0x7c(%eax)
  np->isjoined = 0;
80104d71:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d74:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
80104d7b:	00 00 00 
  np->thread_id = ++(np->parent->thread_id);
80104d7e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d81:	8b 50 14             	mov    0x14(%eax),%edx
80104d84:	8b 82 84 00 00 00    	mov    0x84(%edx),%eax
80104d8a:	83 c0 01             	add    $0x1,%eax
80104d8d:	89 82 84 00 00 00    	mov    %eax,0x84(%edx)
80104d93:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104d96:	89 82 84 00 00 00    	mov    %eax,0x84(%edx)
  *np->tf = *proc->tf;
80104d9c:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d9f:	8b 50 18             	mov    0x18(%eax),%edx
80104da2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104da8:	8b 40 18             	mov    0x18(%eax),%eax
80104dab:	89 c3                	mov    %eax,%ebx
80104dad:	b8 13 00 00 00       	mov    $0x13,%eax
80104db2:	89 d7                	mov    %edx,%edi
80104db4:	89 de                	mov    %ebx,%esi
80104db6:	89 c1                	mov    %eax,%ecx
80104db8:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->tf->esp = (uint)stack+stack_size;
80104dba:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104dbd:	8b 40 18             	mov    0x18(%eax),%eax
80104dc0:	8b 55 0c             	mov    0xc(%ebp),%edx
80104dc3:	03 55 10             	add    0x10(%ebp),%edx
80104dc6:	89 50 44             	mov    %edx,0x44(%eax)
  np->tf->eip = (uint)start_func;
80104dc9:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104dcc:	8b 40 18             	mov    0x18(%eax),%eax
80104dcf:	8b 55 08             	mov    0x8(%ebp),%edx
80104dd2:	89 50 38             	mov    %edx,0x38(%eax)
  for(i = 0; i < NOFILE; i++)
80104dd5:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104ddc:	eb 3d                	jmp    80104e1b <thread_create+0x140>
    if(proc->ofile[i])
...
80104df0:	74 25                	je     80104e17 <thread_create+0x13c>
      np->ofile[i] = filedup(proc->ofile[i]);
...
80104e05:	e8 72 c1 ff ff       	call   80100f7c <filedup>
80104e0a:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104e0d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104e10:	83 c1 08             	add    $0x8,%ecx
80104e13:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  np->isjoined = 0;
  np->thread_id = ++(np->parent->thread_id);
  *np->tf = *proc->tf;
  np->tf->esp = (uint)stack+stack_size;
  np->tf->eip = (uint)start_func;
  for(i = 0; i < NOFILE; i++)
80104e17:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80104e1b:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104e1f:	7e bd                	jle    80104dde <thread_create+0x103>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = proc->cwd;
80104e21:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e27:	8b 50 68             	mov    0x68(%eax),%edx
80104e2a:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104e2d:	89 50 68             	mov    %edx,0x68(%eax)
  tid = np->thread_id;
80104e30:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104e33:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
80104e39:	89 45 dc             	mov    %eax,-0x24(%ebp)
  np->state = RUNNABLE;
...
80104e52:	83 c0 6c             	add    $0x6c,%eax
80104e55:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104e5c:	00 
80104e5d:	89 54 24 04          	mov    %edx,0x4(%esp)
80104e61:	89 04 24             	mov    %eax,(%esp)
80104e64:	e8 cd 09 00 00       	call   80105836 <safestrcpy>
  return tid;
80104e69:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
80104e6c:	83 c4 2c             	add    $0x2c,%esp
80104e6f:	5b                   	pop    %ebx
80104e70:	5e                   	pop    %esi
80104e71:	5f                   	pop    %edi
80104e72:	5d                   	pop    %ebp
...
80104e7f:	74 1b                	je     80104e9c <thread_getId+0x28>
80104e81:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e87:	8b 40 7c             	mov    0x7c(%eax),%eax
80104e8a:	85 c0                	test   %eax,%eax
80104e8c:	74 0e                	je     80104e9c <thread_getId+0x28>
    return proc->thread_id;
80104e8e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e94:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
80104e9a:	eb 05                	jmp    80104ea1 <thread_getId+0x2d>
  else
    return -1; 
...
80104eae:	74 0b                	je     80104ebb <thread_getProcId+0x18>
    return proc->pid;  
80104eb0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104eb6:	8b 40 10             	mov    0x10(%eax),%eax
80104eb9:	eb 05                	jmp    80104ec0 <thread_getProcId+0x1d>
  else
    return -1;
...
80104ec5:	83 ec 28             	sub    $0x28,%esp
  struct proc *t = 0;
80104ec8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  int found = 0;
80104ecf:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

  acquire(&ptable.lock);
80104ed6:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104edd:	e8 d5 04 00 00       	call   801053b7 <acquire>
  for(t = ptable.proc; t < &ptable.proc[NPROC]; t++)
80104ee2:	c7 45 f4 b4 15 11 80 	movl   $0x801115b4,-0xc(%ebp)
80104ee9:	e9 84 00 00 00       	jmp    80104f72 <thread_join+0xb0>
  {
...
80104eff:	75 6a                	jne    80104f6b <thread_join+0xa9>
80104f01:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f04:	8b 40 7c             	mov    0x7c(%eax),%eax
80104f07:	85 c0                	test   %eax,%eax
80104f09:	74 60                	je     80104f6b <thread_join+0xa9>
80104f0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f0e:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
80104f14:	3b 45 08             	cmp    0x8(%ebp),%eax
80104f17:	75 52                	jne    80104f6b <thread_join+0xa9>
80104f19:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f1f:	39 45 f4             	cmp    %eax,-0xc(%ebp)
80104f22:	74 47                	je     80104f6b <thread_join+0xa9>
    {
      if(t->isjoined)
80104f24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f27:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104f2d:	85 c0                	test   %eax,%eax
80104f2f:	74 07                	je     80104f38 <thread_join+0x76>
	return -2;
80104f31:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
80104f36:	eb 78                	jmp    80104fb0 <thread_join+0xee>
      if(t->state == ZOMBIE){
80104f38:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f3b:	8b 40 0c             	mov    0xc(%eax),%eax
80104f3e:	83 f8 05             	cmp    $0x5,%eax
80104f41:	75 12                	jne    80104f55 <thread_join+0x93>
	ret_val =  &(t->ret_val);
80104f43:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f46:	05 94 00 00 00       	add    $0x94,%eax
80104f4b:	89 45 ec             	mov    %eax,-0x14(%ebp)
	return 0;
80104f4e:	b8 00 00 00 00       	mov    $0x0,%eax
80104f53:	eb 5b                	jmp    80104fb0 <thread_join+0xee>
      }      
      t->isjoined = 1;
80104f55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f58:	c7 80 80 00 00 00 01 	movl   $0x1,0x80(%eax)
80104f5f:	00 00 00 
      found = 1;
80104f62:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      break;
80104f69:	eb 14                	jmp    80104f7f <thread_join+0xbd>
{
  struct proc *t = 0;
  int found = 0;
  ...
  acquire(&ptable.lock);
  for(t = ptable.proc; t < &ptable.proc[NPROC]; t++)
80104f6b:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104f72:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
80104f79:	0f 82 6f ff ff ff    	jb     80104eee <thread_join+0x2c>
      found = 1;
      break;
    }
  }
  ...
  if(!found)
80104f7f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104f83:	75 13                	jne    80104f98 <thread_join+0xd6>
  {
    release(&ptable.lock);
80104f85:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104f8c:	e8 88 04 00 00       	call   80105419 <release>
    return -1;
80104f91:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f96:	eb 18                	jmp    80104fb0 <thread_join+0xee>
  }

  sleep(t,&ptable.lock);
80104f98:	c7 44 24 04 80 15 11 	movl   $0x80111580,0x4(%esp)
80104f9f:	80 
80104fa0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104fa3:	89 04 24             	mov    %eax,(%esp)
80104fa6:	e8 b2 fa ff ff       	call   80104a5d <sleep>
  return 0;
...
80104fbe:	8b 40 7c             	mov    0x7c(%eax),%eax
80104fc1:	85 c0                	test   %eax,%eax
80104fc3:	0f 84 a2 00 00 00    	je     8010506b <thread_exit+0xb9>
  {
...
80104fcf:	8b 40 14             	mov    0x14(%eax),%eax
80104fd2:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80104fd8:	83 f8 01             	cmp    $0x1,%eax
80104fdb:	75 1d                	jne    80104ffa <thread_exit+0x48>
    {
      proc->parent->threadnum--;
80104fdd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fe3:	8b 40 14             	mov    0x14(%eax),%eax
80104fe6:	8b 90 88 00 00 00    	mov    0x88(%eax),%edx
80104fec:	83 ea 01             	sub    $0x1,%edx
80104fef:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
      exit();
80104ff5:	e8 ad f4 ff ff       	call   801044a7 <exit>
    }
...
80105003:	89 90 94 00 00 00    	mov    %edx,0x94(%eax)
    proc->parent->threadnum--;
80105009:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010500f:	8b 40 14             	mov    0x14(%eax),%eax
80105012:	8b 90 88 00 00 00    	mov    0x88(%eax),%edx
80105018:	83 ea 01             	sub    $0x1,%edx
8010501b:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
    proc->state = ZOMBIE;
80105021:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105027:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
    if(proc->isjoined)
8010502e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105034:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
8010503a:	85 c0                	test   %eax,%eax
8010503c:	74 0e                	je     8010504c <thread_exit+0x9a>
      wakeup(proc);
8010503e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105044:	89 04 24             	mov    %eax,(%esp)
80105047:	e8 ed fa ff ff       	call   80104b39 <wakeup>
    acquire(&ptable.lock);  //DOC: yieldlock
8010504c:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80105053:	e8 5f 03 00 00       	call   801053b7 <acquire>
    sched();
80105058:	e8 f0 f8 ff ff       	call   8010494d <sched>
    release(&ptable.lock);
8010505d:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80105064:	e8 b0 03 00 00       	call   80105419 <release>
80105069:	eb 6c                	jmp    801050d7 <thread_exit+0x125>
  }
  else if(proc->threadnum == 1)		// main thread is the last thread of the process
8010506b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105071:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80105077:	83 f8 01             	cmp    $0x1,%eax
8010507a:	75 1c                	jne    80105098 <thread_exit+0xe6>
  {
    proc->threadnum--;
8010507c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105082:	8b 90 88 00 00 00    	mov    0x88(%eax),%edx
80105088:	83 ea 01             	sub    $0x1,%edx
8010508b:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
    exit();
80105091:	e8 11 f4 ff ff       	call   801044a7 <exit>
80105096:	eb 3f                	jmp    801050d7 <thread_exit+0x125>
  }
...
801050b3:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
    acquire(&ptable.lock);  //DOC: yieldlock
801050ba:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
801050c1:	e8 f1 02 00 00       	call   801053b7 <acquire>
    sched();
801050c6:	e8 82 f8 ff ff       	call   8010494d <sched>
    release(&ptable.lock);
801050cb:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
801050d2:	e8 42 03 00 00       	call   80105419 <release>
  }
}
801050d7:	c9                   	leave  
801050d8:	c3                   	ret    

801050d9 <binary_semaphore_create>:
...
801050dc:	83 ec 28             	sub    $0x28,%esp
  struct b_semaphore* sem;
  int i = 0;
801050df:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  acquire(&semtable.lock);
801050e6:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
801050ed:	e8 c5 02 00 00       	call   801053b7 <acquire>
  for(;i<128;i++)
801050f2:	eb 47                	jmp    8010513b <binary_semaphore_create+0x62>
  {
    sem = &semtable.binary_semaphores[i];
801050f4:	8b 55 f4             	mov    -0xc(%ebp),%edx
801050f7:	89 d0                	mov    %edx,%eax
801050f9:	01 c0                	add    %eax,%eax
801050fb:	01 d0                	add    %edx,%eax
801050fd:	c1 e0 02             	shl    $0x2,%eax
80105100:	05 40 0f 11 80       	add    $0x80110f40,%eax
80105105:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(sem->taken)
80105108:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010510b:	8b 40 04             	mov    0x4(%eax),%eax
8010510e:	85 c0                	test   %eax,%eax
80105110:	74 06                	je     80105118 <binary_semaphore_create+0x3f>
binary_semaphore_create(int initial_value)
{
  struct b_semaphore* sem;
  int i = 0;
  acquire(&semtable.lock);
  for(;i<128;i++)
80105112:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80105116:	eb 23                	jmp    8010513b <binary_semaphore_create+0x62>
  {
    sem = &semtable.binary_semaphores[i];
    if(sem->taken)
      continue;
...
8010511b:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
    sem->value = initial_value;
80105122:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105125:	8b 55 08             	mov    0x8(%ebp),%edx
80105128:	89 10                	mov    %edx,(%eax)
    release(&semtable.lock);
8010512a:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
80105131:	e8 e3 02 00 00       	call   80105419 <release>
    return i;
80105136:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105139:	eb 17                	jmp    80105152 <binary_semaphore_create+0x79>
binary_semaphore_create(int initial_value)
{
  struct b_semaphore* sem;
  int i = 0;
  acquire(&semtable.lock);
  for(;i<128;i++)
8010513b:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
8010513f:	7e b3                	jle    801050f4 <binary_semaphore_create+0x1b>
    sem->taken = 1;
    sem->value = initial_value;
    release(&semtable.lock);
    return i;
  ...
  release(&semtable.lock);
80105141:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
80105148:	e8 cc 02 00 00       	call   80105419 <release>
  return -1;
...
80105154 <binary_semaphore_down>:
...
80105157:	83 ec 28             	sub    $0x28,%esp
  acquire(&semtable.lock);
8010515a:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
80105161:	e8 51 02 00 00       	call   801053b7 <acquire>
...
8010516b:	01 c0                	add    %eax,%eax
8010516d:	01 d0                	add    %edx,%eax
8010516f:	c1 e0 02             	shl    $0x2,%eax
80105172:	05 40 0f 11 80       	add    $0x80110f40,%eax
80105177:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(;;)
  {
    cprintf("waiting %d\n",sem->waiting);
8010517a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010517d:	8b 40 08             	mov    0x8(%eax),%eax
80105180:	89 44 24 04          	mov    %eax,0x4(%esp)
80105184:	c7 04 24 d3 8e 10 80 	movl   $0x80108ed3,(%esp)
8010518b:	e8 11 b2 ff ff       	call   801003a1 <cprintf>
    if(sem->taken)
80105190:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105193:	8b 40 04             	mov    0x4(%eax),%eax
80105196:	85 c0                	test   %eax,%eax
80105198:	0f 84 e8 00 00 00    	je     80105286 <binary_semaphore_down+0x132>
    {
      cprintf("thread %d pos %d\n",proc->thread_id,proc->sem_queue_pos);
8010519e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051a4:	8b 90 90 00 00 00    	mov    0x90(%eax),%edx
801051aa:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051b0:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
801051b6:	89 54 24 08          	mov    %edx,0x8(%esp)
801051ba:	89 44 24 04          	mov    %eax,0x4(%esp)
801051be:	c7 04 24 df 8e 10 80 	movl   $0x80108edf,(%esp)
801051c5:	e8 d7 b1 ff ff       	call   801003a1 <cprintf>
      if(sem->value && !proc->sem_queue_pos)
801051ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051cd:	8b 00                	mov    (%eax),%eax
801051cf:	85 c0                	test   %eax,%eax
801051d1:	74 3f                	je     80105212 <binary_semaphore_down+0xbe>
801051d3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801051d9:	8b 80 90 00 00 00    	mov    0x90(%eax),%eax
801051df:	85 c0                	test   %eax,%eax
801051e1:	75 2f                	jne    80105212 <binary_semaphore_down+0xbe>
      {
	sem->value = 0;
...
801051f2:	c7 80 8c 00 00 00 ff 	movl   $0xffffffff,0x8c(%eax)
801051f9:	ff ff ff 
	release(&semtable.lock);
801051fc:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
80105203:	e8 11 02 00 00       	call   80105419 <release>
	return 0;
80105208:	b8 00 00 00 00       	mov    $0x0,%eax
8010520d:	e9 85 00 00 00       	jmp    80105297 <binary_semaphore_down+0x143>
      }
      else
      {
...
8010521b:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
	proc->sem_queue_pos = ++(sem->waiting);
80105221:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105227:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010522a:	8b 52 08             	mov    0x8(%edx),%edx
8010522d:	8d 4a 01             	lea    0x1(%edx),%ecx
80105230:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105233:	89 4a 08             	mov    %ecx,0x8(%edx)
80105236:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105239:	8b 52 08             	mov    0x8(%edx),%edx
8010523c:	89 90 90 00 00 00    	mov    %edx,0x90(%eax)
	cprintf("thread %d pos %d\n",proc->thread_id,proc->sem_queue_pos);
80105242:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105248:	8b 90 90 00 00 00    	mov    0x90(%eax),%edx
8010524e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105254:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
8010525a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010525e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105262:	c7 04 24 df 8e 10 80 	movl   $0x80108edf,(%esp)
80105269:	e8 33 b1 ff ff       	call   801003a1 <cprintf>
	sleep(sem,&semtable.lock);
8010526e:	c7 44 24 04 40 15 11 	movl   $0x80111540,0x4(%esp)
80105275:	80 
80105276:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105279:	89 04 24             	mov    %eax,(%esp)
8010527c:	e8 dc f7 ff ff       	call   80104a5d <sleep>
    else
    {
      release(&semtable.lock);
      return -1;
...
80105281:	e9 f4 fe ff ff       	jmp    8010517a <binary_semaphore_down+0x26>
	sleep(sem,&semtable.lock);
      }
    }
    else
    {
      release(&semtable.lock);
80105286:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
8010528d:	e8 87 01 00 00       	call   80105419 <release>
      return -1;
...
8010529c:	83 ec 28             	sub    $0x28,%esp
  struct b_semaphore* sem = &semtable.binary_semaphores[binary_semaphore_ID];
8010529f:	8b 55 08             	mov    0x8(%ebp),%edx
801052a2:	89 d0                	mov    %edx,%eax
801052a4:	01 c0                	add    %eax,%eax
801052a6:	01 d0                	add    %edx,%eax
801052a8:	c1 e0 02             	shl    $0x2,%eax
801052ab:	05 40 0f 11 80       	add    $0x80110f40,%eax
801052b0:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(sem->taken)
801052b3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801052b6:	8b 40 04             	mov    0x4(%eax),%eax
801052b9:	85 c0                	test   %eax,%eax
801052bb:	0f 84 88 00 00 00    	je     80105349 <binary_semaphore_up+0xb0>
  {     
     struct proc *p;
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
801052c1:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
801052c8:	e8 ea 00 00 00       	call   801053b7 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801052cd:	c7 45 f4 b4 15 11 80 	movl   $0x801115b4,-0xc(%ebp)
801052d4:	eb 2a                	jmp    80105300 <binary_semaphore_up+0x67>
    {
      if(p->waiting_for_semaphore == binary_semaphore_ID)
801052d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052d9:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
801052df:	3b 45 08             	cmp    0x8(%ebp),%eax
801052e2:	75 15                	jne    801052f9 <binary_semaphore_up+0x60>
        p->sem_queue_pos--;
801052e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052e7:	8b 80 90 00 00 00    	mov    0x90(%eax),%eax
801052ed:	8d 50 ff             	lea    -0x1(%eax),%edx
801052f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801052f3:	89 90 90 00 00 00    	mov    %edx,0x90(%eax)
  if(sem->taken)
  {     
     struct proc *p;
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801052f9:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80105300:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
80105307:	72 cd                	jb     801052d6 <binary_semaphore_up+0x3d>
    {
      if(p->waiting_for_semaphore == binary_semaphore_ID)
        p->sem_queue_pos--;
    }
...
8010530c:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    if(sem->waiting>0)
80105312:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105315:	8b 40 08             	mov    0x8(%eax),%eax
80105318:	85 c0                	test   %eax,%eax
8010531a:	7e 0f                	jle    8010532b <binary_semaphore_up+0x92>
      sem->waiting--;
8010531c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010531f:	8b 40 08             	mov    0x8(%eax),%eax
80105322:	8d 50 ff             	lea    -0x1(%eax),%edx
80105325:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105328:	89 50 08             	mov    %edx,0x8(%eax)
    wakeup1(sem);
8010532b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010532e:	89 04 24             	mov    %eax,(%esp)
80105331:	e8 c2 f7 ff ff       	call   80104af8 <wakeup1>
    release(&ptable.lock);
80105336:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
8010533d:	e8 d7 00 00 00       	call   80105419 <release>

    return 0;
80105342:	b8 00 00 00 00       	mov    $0x0,%eax
80105347:	eb 05                	jmp    8010534e <binary_semaphore_up+0xb5>
  }
  else
    return -1;
...
xchg(volatile uint *addr, uint newval)
{
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
80105381:	89 c3                	mov    %eax,%ebx
80105383:	89 d8                	mov    %ebx,%eax
80105385:	f0 87 02             	lock xchg %eax,(%edx)
80105388:	89 c3                	mov    %eax,%ebx
8010538a:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
8010539f:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
801053a2:	8b 45 08             	mov    0x8(%ebp),%eax
801053a5:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
801053ab:	8b 45 08             	mov    0x8(%ebp),%eax
801053ae:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
801053b5:	5d                   	pop    %ebp
801053b6:	c3                   	ret    
...
801053bd:	e8 3d 01 00 00       	call   801054ff <pushcli>
  if(holding(lk))
801053c2:	8b 45 08             	mov    0x8(%ebp),%eax
801053c5:	89 04 24             	mov    %eax,(%esp)
801053c8:	e8 08 01 00 00       	call   801054d5 <holding>
801053cd:	85 c0                	test   %eax,%eax
801053cf:	74 0c                	je     801053dd <acquire+0x26>
    panic("acquire");
801053d1:	c7 04 24 1b 8f 10 80 	movl   $0x80108f1b,(%esp)
801053d8:	e8 60 b1 ff ff       	call   8010053d <panic>
...
801053e1:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801053e8:	00 
801053e9:	89 04 24             	mov    %eax,(%esp)
801053ec:	e8 80 ff ff ff       	call   80105371 <xchg>
801053f1:	85 c0                	test   %eax,%eax
801053f3:	75 e9                	jne    801053de <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
801053f5:	8b 45 08             	mov    0x8(%ebp),%eax
801053f8:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801053ff:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80105402:	8b 45 08             	mov    0x8(%ebp),%eax
80105405:	83 c0 0c             	add    $0xc,%eax
80105408:	89 44 24 04          	mov    %eax,0x4(%esp)
8010540c:	8d 45 08             	lea    0x8(%ebp),%eax
8010540f:	89 04 24             	mov    %eax,(%esp)
80105412:	e8 51 00 00 00       	call   80105468 <getcallerpcs>
}
80105417:	c9                   	leave  
80105418:	c3                   	ret    
...
80105425:	e8 ab 00 00 00       	call   801054d5 <holding>
8010542a:	85 c0                	test   %eax,%eax
8010542c:	75 0c                	jne    8010543a <release+0x21>
    panic("release");
8010542e:	c7 04 24 23 8f 10 80 	movl   $0x80108f23,(%esp)
80105435:	e8 03 b1 ff ff       	call   8010053d <panic>

  lk->pcs[0] = 0;
8010543a:	8b 45 08             	mov    0x8(%ebp),%eax
8010543d:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80105444:	8b 45 08             	mov    0x8(%ebp),%eax
80105447:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
8010545c:	e8 10 ff ff ff       	call   80105371 <xchg>

  popcli();
80105461:	e8 e1 00 00 00       	call   80105547 <popcli>
}
80105466:	c9                   	leave  
80105467:	c3                   	ret    

80105468 <getcallerpcs>:
...
80105471:	83 e8 08             	sub    $0x8,%eax
80105474:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80105477:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
8010547e:	eb 32                	jmp    801054b2 <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105480:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105484:	74 47                	je     801054cd <getcallerpcs+0x65>
80105486:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
8010548d:	76 3e                	jbe    801054cd <getcallerpcs+0x65>
8010548f:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105493:	74 38                	je     801054cd <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105495:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105498:	c1 e0 02             	shl    $0x2,%eax
8010549b:	03 45 0c             	add    0xc(%ebp),%eax
8010549e:	8b 55 fc             	mov    -0x4(%ebp),%edx
801054a1:	8b 52 04             	mov    0x4(%edx),%edx
801054a4:	89 10                	mov    %edx,(%eax)
...
801054ab:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
801054ae:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801054b2:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801054b6:	7e c8                	jle    80105480 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801054b8:	eb 13                	jmp    801054cd <getcallerpcs+0x65>
    pcs[i] = 0;
801054ba:	8b 45 f8             	mov    -0x8(%ebp),%eax
801054bd:	c1 e0 02             	shl    $0x2,%eax
801054c0:	03 45 0c             	add    0xc(%ebp),%eax
801054c3:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801054c9:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801054cd:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801054d1:	7e e7                	jle    801054ba <getcallerpcs+0x52>
    pcs[i] = 0;
}
801054d3:	c9                   	leave  
801054d4:	c3                   	ret    
...
801054df:	74 17                	je     801054f8 <holding+0x23>
801054e1:	8b 45 08             	mov    0x8(%ebp),%eax
801054e4:	8b 50 08             	mov    0x8(%eax),%edx
801054e7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801054ed:	39 c2                	cmp    %eax,%edx
801054ef:	75 07                	jne    801054f8 <holding+0x23>
801054f1:	b8 01 00 00 00       	mov    $0x1,%eax
801054f6:	eb 05                	jmp    801054fd <holding+0x28>
...
80105502:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105505:	e8 46 fe ff ff       	call   80105350 <readeflags>
8010550a:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
8010550d:	e8 53 fe ff ff       	call   80105365 <cli>
  if(cpu->ncli++ == 0)
80105512:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105518:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
8010551e:	85 d2                	test   %edx,%edx
80105520:	0f 94 c1             	sete   %cl
80105523:	83 c2 01             	add    $0x1,%edx
80105526:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
8010552c:	84 c9                	test   %cl,%cl
8010552e:	74 15                	je     80105545 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80105530:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105536:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105539:	81 e2 00 02 00 00    	and    $0x200,%edx
8010553f:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105545:	c9                   	leave  
80105546:	c3                   	ret    
...
8010554a:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
8010554d:	e8 fe fd ff ff       	call   80105350 <readeflags>
80105552:	25 00 02 00 00       	and    $0x200,%eax
80105557:	85 c0                	test   %eax,%eax
80105559:	74 0c                	je     80105567 <popcli+0x20>
    panic("popcli - interruptible");
8010555b:	c7 04 24 2b 8f 10 80 	movl   $0x80108f2b,(%esp)
80105562:	e8 d6 af ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
80105567:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010556d:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105573:	83 ea 01             	sub    $0x1,%edx
80105576:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
8010557c:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105582:	85 c0                	test   %eax,%eax
80105584:	79 0c                	jns    80105592 <popcli+0x4b>
    panic("popcli");
80105586:	c7 04 24 42 8f 10 80 	movl   $0x80108f42,(%esp)
...
801055a0:	75 15                	jne    801055b7 <popcli+0x70>
801055a2:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801055a8:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801055ae:	85 c0                	test   %eax,%eax
801055b0:	74 05                	je     801055b7 <popcli+0x70>
    sti();
801055b2:	e8 b4 fd ff ff       	call   8010536b <sti>
}
801055b7:	c9                   	leave  
801055b8:	c3                   	ret    
...
801055c0:	53                   	push   %ebx
  asm volatile("cld; rep stosb" :
801055c1:	8b 4d 08             	mov    0x8(%ebp),%ecx
801055c4:	8b 55 10             	mov    0x10(%ebp),%edx
801055c7:	8b 45 0c             	mov    0xc(%ebp),%eax
801055ca:	89 cb                	mov    %ecx,%ebx
801055cc:	89 df                	mov    %ebx,%edi
801055ce:	89 d1                	mov    %edx,%ecx
801055d0:	fc                   	cld    
801055d1:	f3 aa                	rep stos %al,%es:(%edi)
801055d3:	89 ca                	mov    %ecx,%edx
801055d5:	89 fb                	mov    %edi,%ebx
801055d7:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
801055e4:	57                   	push   %edi
801055e5:	53                   	push   %ebx
  asm volatile("cld; rep stosl" :
801055e6:	8b 4d 08             	mov    0x8(%ebp),%ecx
801055e9:	8b 55 10             	mov    0x10(%ebp),%edx
801055ec:	8b 45 0c             	mov    0xc(%ebp),%eax
801055ef:	89 cb                	mov    %ecx,%ebx
801055f1:	89 df                	mov    %ebx,%edi
801055f3:	89 d1                	mov    %edx,%ecx
801055f5:	fc                   	cld    
801055f6:	f3 ab                	rep stos %eax,%es:(%edi)
801055f8:	89 ca                	mov    %ecx,%edx
801055fa:	89 fb                	mov    %edi,%ebx
801055fc:	89 5d 08             	mov    %ebx,0x8(%ebp)
...
80105614:	75 49                	jne    8010565f <memset+0x59>
80105616:	8b 45 10             	mov    0x10(%ebp),%eax
80105619:	83 e0 03             	and    $0x3,%eax
8010561c:	85 c0                	test   %eax,%eax
8010561e:	75 3f                	jne    8010565f <memset+0x59>
    c &= 0xFF;
80105620:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105627:	8b 45 10             	mov    0x10(%ebp),%eax
8010562a:	c1 e8 02             	shr    $0x2,%eax
8010562d:	89 c2                	mov    %eax,%edx
8010562f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105632:	89 c1                	mov    %eax,%ecx
80105634:	c1 e1 18             	shl    $0x18,%ecx
80105637:	8b 45 0c             	mov    0xc(%ebp),%eax
8010563a:	c1 e0 10             	shl    $0x10,%eax
8010563d:	09 c1                	or     %eax,%ecx
8010563f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105642:	c1 e0 08             	shl    $0x8,%eax
80105645:	09 c8                	or     %ecx,%eax
80105647:	0b 45 0c             	or     0xc(%ebp),%eax
8010564a:	89 54 24 08          	mov    %edx,0x8(%esp)
8010564e:	89 44 24 04          	mov    %eax,0x4(%esp)
80105652:	8b 45 08             	mov    0x8(%ebp),%eax
80105655:	89 04 24             	mov    %eax,(%esp)
80105658:	e8 84 ff ff ff       	call   801055e1 <stosl>
8010565d:	eb 19                	jmp    80105678 <memset+0x72>
  } else
    stosb(dst, c, n);
8010565f:	8b 45 10             	mov    0x10(%ebp),%eax
80105662:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105673:	e8 44 ff ff ff       	call   801055bc <stosb>
  return dst;
...
8010568c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
8010568f:	eb 32                	jmp    801056c3 <memcmp+0x46>
    if(*s1 != *s2)
...
8010569f:	74 1a                	je     801056bb <memcmp+0x3e>
      return *s1 - *s2;
...
801056b3:	89 d1                	mov    %edx,%ecx
801056b5:	29 c1                	sub    %eax,%ecx
801056b7:	89 c8                	mov    %ecx,%eax
801056b9:	eb 1c                	jmp    801056d7 <memcmp+0x5a>
    s1++, s2++;
...
801056ca:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801056ce:	84 c0                	test   %al,%al
801056d0:	75 bf                	jne    80105691 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
  ...
  return 0;
801056d2:	b8 00 00 00 00       	mov    $0x0,%eax
}
801056d7:	c9                   	leave  
801056d8:	c3                   	ret    
...
801056e8:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801056eb:	8b 45 fc             	mov    -0x4(%ebp),%eax
801056ee:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801056f1:	73 54                	jae    80105747 <memmove+0x6e>
801056f3:	8b 45 10             	mov    0x10(%ebp),%eax
801056f6:	8b 55 fc             	mov    -0x4(%ebp),%edx
801056f9:	01 d0                	add    %edx,%eax
801056fb:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801056fe:	76 47                	jbe    80105747 <memmove+0x6e>
    s += n;
80105700:	8b 45 10             	mov    0x10(%ebp),%eax
80105703:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105706:	8b 45 10             	mov    0x10(%ebp),%eax
80105709:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
8010570c:	eb 13                	jmp    80105721 <memmove+0x48>
      *--d = *--s;
8010570e:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80105712:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
...
8010571f:	88 10                	mov    %dl,(%eax)
  ...
  if(s < d && s + n > d){
    ...
    d += n;
    while(n-- > 0)
80105721:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105725:	0f 95 c0             	setne  %al
80105728:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010572c:	84 c0                	test   %al,%al
8010572e:	75 de                	jne    8010570e <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105730:	eb 25                	jmp    80105757 <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
8010573d:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105741:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105745:	eb 01                	jmp    80105748 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
8010574c:	0f 95 c0             	setne  %al
8010574f:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105753:	84 c0                	test   %al,%al
80105755:	75 db                	jne    80105732 <memmove+0x59>
      *d++ = *s++;
...
80105776:	e8 5e ff ff ff       	call   801056d9 <memmove>
}
8010577b:	c9                   	leave  
8010577c:	c3                   	ret    
...
8010577e:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105780:	eb 0c                	jmp    8010578e <strncmp+0x11>
    n--, p++, q++;
80105782:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105786:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010578a:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
  while(n > 0 && *p && *p == *q)
8010578e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105792:	74 1a                	je     801057ae <strncmp+0x31>
80105794:	8b 45 08             	mov    0x8(%ebp),%eax
80105797:	0f b6 00             	movzbl (%eax),%eax
8010579a:	84 c0                	test   %al,%al
8010579c:	74 10                	je     801057ae <strncmp+0x31>
8010579e:	8b 45 08             	mov    0x8(%ebp),%eax
801057a1:	0f b6 10             	movzbl (%eax),%edx
801057a4:	8b 45 0c             	mov    0xc(%ebp),%eax
801057a7:	0f b6 00             	movzbl (%eax),%eax
801057aa:	38 c2                	cmp    %al,%dl
801057ac:	74 d4                	je     80105782 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801057ae:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801057b2:	75 07                	jne    801057bb <strncmp+0x3e>
    return 0;
801057b4:	b8 00 00 00 00       	mov    $0x0,%eax
801057b9:	eb 18                	jmp    801057d3 <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
801057bb:	8b 45 08             	mov    0x8(%ebp),%eax
801057be:	0f b6 00             	movzbl (%eax),%eax
801057c1:	0f b6 d0             	movzbl %al,%edx
801057c4:	8b 45 0c             	mov    0xc(%ebp),%eax
801057c7:	0f b6 00             	movzbl (%eax),%eax
801057ca:	0f b6 c0             	movzbl %al,%eax
801057cd:	89 d1                	mov    %edx,%ecx
801057cf:	29 c1                	sub    %eax,%ecx
801057d1:	89 c8                	mov    %ecx,%eax
}
801057d3:	5d                   	pop    %ebp
801057d4:	c3                   	ret    
...
801057e6:	0f 9f c0             	setg   %al
801057e9:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801057ed:	84 c0                	test   %al,%al
801057ef:	74 30                	je     80105821 <strncpy+0x4c>
801057f1:	8b 45 0c             	mov    0xc(%ebp),%eax
801057f4:	0f b6 10             	movzbl (%eax),%edx
...
80105804:	0f 95 c0             	setne  %al
80105807:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010580b:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010580f:	84 c0                	test   %al,%al
80105811:	75 cf                	jne    801057e2 <strncpy+0xd>
    ;
  while(n-- > 0)
80105813:	eb 0c                	jmp    80105821 <strncpy+0x4c>
    *s++ = 0;
80105815:	8b 45 08             	mov    0x8(%ebp),%eax
80105818:	c6 00 00             	movb   $0x0,(%eax)
8010581b:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010581f:	eb 01                	jmp    80105822 <strncpy+0x4d>
  char *os;
...
80105826:	0f 9f c0             	setg   %al
80105829:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010582d:	84 c0                	test   %al,%al
8010582f:	75 e4                	jne    80105815 <strncpy+0x40>
    *s++ = 0;
  return os;
...
8010583f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80105842:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105846:	7f 05                	jg     8010584d <safestrcpy+0x17>
    return os;
80105848:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010584b:	eb 35                	jmp    80105882 <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
8010584d:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105851:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105855:	7e 22                	jle    80105879 <safestrcpy+0x43>
80105857:	8b 45 0c             	mov    0xc(%ebp),%eax
8010585a:	0f b6 10             	movzbl (%eax),%edx
...
8010586a:	0f 95 c0             	setne  %al
8010586d:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105871:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105875:	84 c0                	test   %al,%al
80105877:	75 d4                	jne    8010584d <safestrcpy+0x17>
    ;
  *s = 0;
80105879:	8b 45 08             	mov    0x8(%ebp),%eax
8010587c:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
80105891:	eb 04                	jmp    80105897 <strlen+0x13>
80105893:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105897:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010589a:	03 45 08             	add    0x8(%ebp),%eax
8010589d:	0f b6 00             	movzbl (%eax),%eax
801058a0:	84 c0                	test   %al,%al
801058a2:	75 ef                	jne    80105893 <strlen+0xf>
    ;
  return n;
...
801058cc:	3b 45 0c             	cmp    0xc(%ebp),%eax
801058cf:	76 0f                	jbe    801058e0 <fetchint+0x1c>
801058d1:	8b 45 0c             	mov    0xc(%ebp),%eax
801058d4:	8d 50 04             	lea    0x4(%eax),%edx
801058d7:	8b 45 08             	mov    0x8(%ebp),%eax
801058da:	8b 00                	mov    (%eax),%eax
801058dc:	39 c2                	cmp    %eax,%edx
801058de:	76 07                	jbe    801058e7 <fetchint+0x23>
    return -1;
801058e0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058e5:	eb 0f                	jmp    801058f6 <fetchint+0x32>
  *ip = *(int*)(addr);
...
80105903:	3b 45 0c             	cmp    0xc(%ebp),%eax
80105906:	77 07                	ja     8010590f <fetchstr+0x17>
    return -1;
80105908:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010590d:	eb 45                	jmp    80105954 <fetchstr+0x5c>
  *pp = (char*)addr;
...
8010591c:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(s = *pp; s < ep; s++)
8010591f:	8b 45 10             	mov    0x10(%ebp),%eax
80105922:	8b 00                	mov    (%eax),%eax
80105924:	89 45 fc             	mov    %eax,-0x4(%ebp)
80105927:	eb 1e                	jmp    80105947 <fetchstr+0x4f>
    if(*s == 0)
80105929:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010592c:	0f b6 00             	movzbl (%eax),%eax
8010592f:	84 c0                	test   %al,%al
80105931:	75 10                	jne    80105943 <fetchstr+0x4b>
      return s - *pp;
...
80105941:	eb 11                	jmp    80105954 <fetchstr+0x5c>
  ...
  *pp = (char*)addr;
  ep = (char*)p->sz;
  for(s = *pp; s < ep; s++)
80105943:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105947:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010594a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010594d:	72 da                	jb     80105929 <fetchstr+0x31>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105962:	8b 40 18             	mov    0x18(%eax),%eax
80105965:	8b 50 44             	mov    0x44(%eax),%edx
80105968:	8b 45 08             	mov    0x8(%ebp),%eax
8010596b:	c1 e0 02             	shl    $0x2,%eax
8010596e:	01 d0                	add    %edx,%eax
80105970:	8d 48 04             	lea    0x4(%eax),%ecx
80105973:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105979:	8b 55 0c             	mov    0xc(%ebp),%edx
8010597c:	89 54 24 08          	mov    %edx,0x8(%esp)
80105980:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80105984:	89 04 24             	mov    %eax,(%esp)
80105987:	e8 38 ff ff ff       	call   801058c4 <fetchint>
}
8010598c:	c9                   	leave  
8010598d:	c3                   	ret    
...
801059c0:	73 16                	jae    801059d8 <argptr+0x4a>
801059c2:	8b 45 fc             	mov    -0x4(%ebp),%eax
801059c5:	89 c2                	mov    %eax,%edx
801059c7:	8b 45 10             	mov    0x10(%ebp),%eax
801059ca:	01 c2                	add    %eax,%edx
801059cc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059d2:	8b 00                	mov    (%eax),%eax
801059d4:	39 c2                	cmp    %eax,%edx
801059d6:	76 07                	jbe    801059df <argptr+0x51>
    return -1;
801059d8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059dd:	eb 0f                	jmp    801059ee <argptr+0x60>
  *pp = (char*)i;
...
80105a36:	53                   	push   %ebx
80105a37:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
80105a3a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a40:	8b 40 18             	mov    0x18(%eax),%eax
80105a43:	8b 40 1c             	mov    0x1c(%eax),%eax
80105a46:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num >= 0 && num < SYS_open && syscalls[num]) {
80105a49:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a4d:	78 2e                	js     80105a7d <syscall+0x4a>
80105a4f:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105a53:	7f 28                	jg     80105a7d <syscall+0x4a>
80105a55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a58:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105a5f:	85 c0                	test   %eax,%eax
80105a61:	74 1a                	je     80105a7d <syscall+0x4a>
    proc->tf->eax = syscalls[num]();
80105a63:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a69:	8b 58 18             	mov    0x18(%eax),%ebx
80105a6c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a6f:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105a76:	ff d0                	call   *%eax
80105a78:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105a7b:	eb 73                	jmp    80105af0 <syscall+0xbd>
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
80105a7d:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105a81:	7e 30                	jle    80105ab3 <syscall+0x80>
80105a83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a86:	83 f8 1d             	cmp    $0x1d,%eax
80105a89:	77 28                	ja     80105ab3 <syscall+0x80>
80105a8b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a8e:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105a95:	85 c0                	test   %eax,%eax
80105a97:	74 1a                	je     80105ab3 <syscall+0x80>
    proc->tf->eax = syscalls[num]();
80105a99:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a9f:	8b 58 18             	mov    0x18(%eax),%ebx
80105aa2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105aa5:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105aac:	ff d0                	call   *%eax
80105aae:	89 43 1c             	mov    %eax,0x1c(%ebx)
80105ab1:	eb 3d                	jmp    80105af0 <syscall+0xbd>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
80105ab3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ab9:	8d 48 6c             	lea    0x6c(%eax),%ecx
80105abc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  if(num >= 0 && num < SYS_open && syscalls[num]) {
    proc->tf->eax = syscalls[num]();
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
    proc->tf->eax = syscalls[num]();
    ...
    cprintf("%d %s: unknown sys call %d\n",
80105ac2:	8b 40 10             	mov    0x10(%eax),%eax
80105ac5:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105ac8:	89 54 24 0c          	mov    %edx,0xc(%esp)
80105acc:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105ad0:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ad4:	c7 04 24 49 8f 10 80 	movl   $0x80108f49,(%esp)
80105adb:	e8 c1 a8 ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105ae0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105ae6:	8b 40 18             	mov    0x18(%eax),%eax
80105ae9:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105af0:	83 c4 24             	add    $0x24,%esp
80105af3:	5b                   	pop    %ebx
80105af4:	5d                   	pop    %ebp
80105af5:	c3                   	ret    
	...
...
80105b0b:	e8 46 fe ff ff       	call   80105956 <argint>
80105b10:	85 c0                	test   %eax,%eax
80105b12:	79 07                	jns    80105b1b <argfd+0x23>
    return -1;
80105b14:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b19:	eb 50                	jmp    80105b6b <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105b1b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b1e:	85 c0                	test   %eax,%eax
80105b20:	78 21                	js     80105b43 <argfd+0x4b>
80105b22:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b25:	83 f8 0f             	cmp    $0xf,%eax
80105b28:	7f 19                	jg     80105b43 <argfd+0x4b>
...
80105b3d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105b41:	75 07                	jne    80105b4a <argfd+0x52>
    return -1;
80105b43:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b48:	eb 21                	jmp    80105b6b <argfd+0x73>
  if(pfd)
80105b4a:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80105b4e:	74 08                	je     80105b58 <argfd+0x60>
    *pfd = fd;
80105b50:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105b53:	8b 45 0c             	mov    0xc(%ebp),%eax
80105b56:	89 10                	mov    %edx,(%eax)
  if(pf)
80105b58:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105b5c:	74 08                	je     80105b66 <argfd+0x6e>
    *pf = f;
80105b5e:	8b 45 10             	mov    0x10(%ebp),%eax
80105b61:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105b64:	89 10                	mov    %edx,(%eax)
  return 0;
80105b66:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105b6b:	c9                   	leave  
80105b6c:	c3                   	ret    
...
80105b70:	83 ec 10             	sub    $0x10,%esp
  int fd;

  for(fd = 0; fd < NOFILE; fd++){
80105b73:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105b7a:	eb 30                	jmp    80105bac <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105b7c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b82:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105b85:	83 c2 08             	add    $0x8,%edx
80105b88:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105b8c:	85 c0                	test   %eax,%eax
80105b8e:	75 18                	jne    80105ba8 <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105b90:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105b96:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105b99:	8d 4a 08             	lea    0x8(%edx),%ecx
80105b9c:	8b 55 08             	mov    0x8(%ebp),%edx
80105b9f:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105ba3:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105ba6:	eb 0f                	jmp    80105bb7 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
...
80105bac:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105bb0:	7e ca                	jle    80105b7c <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105c99:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105ca0:	00 
80105ca1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105ca8:	e8 4b fe ff ff       	call   80105af8 <argfd>
80105cad:	85 c0                	test   %eax,%eax
80105caf:	78 35                	js     80105ce6 <sys_write+0x5a>
80105cb1:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105cb4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105cb8:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105cbf:	e8 92 fc ff ff       	call   80105956 <argint>
80105cc4:	85 c0                	test   %eax,%eax
80105cc6:	78 1e                	js     80105ce6 <sys_write+0x5a>
80105cc8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ccb:	89 44 24 08          	mov    %eax,0x8(%esp)
80105ccf:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105cd2:	89 44 24 04          	mov    %eax,0x4(%esp)
80105cd6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105cdd:	e8 ac fc ff ff       	call   8010598e <argptr>
80105ce2:	85 c0                	test   %eax,%eax
80105ce4:	79 07                	jns    80105ced <sys_write+0x61>
    return -1;
80105ce6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ceb:	eb 19                	jmp    80105d06 <sys_write+0x7a>
  return filewrite(f, p, n);
80105ced:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105cf0:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105cf3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cf6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105cfa:	89 54 24 04          	mov    %edx,0x4(%esp)
80105cfe:	89 04 24             	mov    %eax,(%esp)
80105d01:	e8 9f b4 ff ff       	call   801011a5 <filewrite>
}
80105d06:	c9                   	leave  
80105d07:	c3                   	ret    
...
80105d23:	e8 d0 fd ff ff       	call   80105af8 <argfd>
80105d28:	85 c0                	test   %eax,%eax
80105d2a:	79 07                	jns    80105d33 <sys_close+0x2b>
    return -1;
80105d2c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d31:	eb 24                	jmp    80105d57 <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105d33:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105d39:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105d3c:	83 c2 08             	add    $0x8,%edx
80105d3f:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105d46:	00 
  fileclose(f);
80105d47:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d4a:	89 04 24             	mov    %eax,(%esp)
80105d4d:	e8 72 b2 ff ff       	call   80100fc4 <fileclose>
  return 0;
...
80105d5f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105d62:	89 44 24 08          	mov    %eax,0x8(%esp)
80105d66:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105d6d:	00 
80105d6e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105d75:	e8 7e fd ff ff       	call   80105af8 <argfd>
80105d7a:	85 c0                	test   %eax,%eax
80105d7c:	78 1f                	js     80105d9d <sys_fstat+0x44>
80105d7e:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105d85:	00 
80105d86:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105d89:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d8d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d94:	e8 f5 fb ff ff       	call   8010598e <argptr>
80105d99:	85 c0                	test   %eax,%eax
80105d9b:	79 07                	jns    80105da4 <sys_fstat+0x4b>
    return -1;
80105d9d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105da2:	eb 12                	jmp    80105db6 <sys_fstat+0x5d>
  return filestat(f, st);
80105da4:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105da7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105daa:	89 54 24 04          	mov    %edx,0x4(%esp)
80105dae:	89 04 24             	mov    %eax,(%esp)
80105db1:	e8 e4 b2 ff ff       	call   8010109a <filestat>
}
80105db6:	c9                   	leave  
80105db7:	c3                   	ret    
...
80105dbe:	8d 45 d8             	lea    -0x28(%ebp),%eax
80105dc1:	89 44 24 04          	mov    %eax,0x4(%esp)
80105dc5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105dcc:	e8 1f fc ff ff       	call   801059f0 <argstr>
80105dd1:	85 c0                	test   %eax,%eax
80105dd3:	78 17                	js     80105dec <sys_link+0x34>
80105dd5:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105dd8:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ddc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105de3:	e8 08 fc ff ff       	call   801059f0 <argstr>
80105de8:	85 c0                	test   %eax,%eax
80105dea:	79 0a                	jns    80105df6 <sys_link+0x3e>
    return -1;
80105dec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105df1:	e9 3c 01 00 00       	jmp    80105f32 <sys_link+0x17a>
  if((ip = namei(old)) == 0)
80105df6:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105df9:	89 04 24             	mov    %eax,(%esp)
80105dfc:	e8 09 c6 ff ff       	call   8010240a <namei>
80105e01:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105e04:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105e08:	75 0a                	jne    80105e14 <sys_link+0x5c>
    return -1;
80105e0a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e0f:	e9 1e 01 00 00       	jmp    80105f32 <sys_link+0x17a>

  begin_trans();
80105e14:	e8 04 d4 ff ff       	call   8010321d <begin_trans>

  ilock(ip);
80105e19:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e1c:	89 04 24             	mov    %eax,(%esp)
80105e1f:	e8 44 ba ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
80105e24:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e27:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e2b:	66 83 f8 01          	cmp    $0x1,%ax
80105e2f:	75 1a                	jne    80105e4b <sys_link+0x93>
    iunlockput(ip);
80105e31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e34:	89 04 24             	mov    %eax,(%esp)
80105e37:	e8 b0 bc ff ff       	call   80101aec <iunlockput>
    commit_trans();
80105e3c:	e8 25 d4 ff ff       	call   80103266 <commit_trans>
    return -1;
80105e41:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e46:	e9 e7 00 00 00       	jmp    80105f32 <sys_link+0x17a>
  }

  ip->nlink++;
80105e4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e4e:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105e52:	8d 50 01             	lea    0x1(%eax),%edx
80105e55:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e58:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105e5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e5f:	89 04 24             	mov    %eax,(%esp)
80105e62:	e8 45 b8 ff ff       	call   801016ac <iupdate>
  iunlock(ip);
80105e67:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e6a:	89 04 24             	mov    %eax,(%esp)
80105e6d:	e8 44 bb ff ff       	call   801019b6 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105e72:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105e75:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105e78:	89 54 24 04          	mov    %edx,0x4(%esp)
80105e7c:	89 04 24             	mov    %eax,(%esp)
80105e7f:	e8 a8 c5 ff ff       	call   8010242c <nameiparent>
80105e84:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e87:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e8b:	74 68                	je     80105ef5 <sys_link+0x13d>
    goto bad;
  ilock(dp);
80105e8d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e90:	89 04 24             	mov    %eax,(%esp)
80105e93:	e8 d0 b9 ff ff       	call   80101868 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105e98:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e9b:	8b 10                	mov    (%eax),%edx
80105e9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ea0:	8b 00                	mov    (%eax),%eax
80105ea2:	39 c2                	cmp    %eax,%edx
80105ea4:	75 20                	jne    80105ec6 <sys_link+0x10e>
80105ea6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ea9:	8b 40 04             	mov    0x4(%eax),%eax
80105eac:	89 44 24 08          	mov    %eax,0x8(%esp)
80105eb0:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105eb3:	89 44 24 04          	mov    %eax,0x4(%esp)
80105eb7:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eba:	89 04 24             	mov    %eax,(%esp)
80105ebd:	e8 87 c2 ff ff       	call   80102149 <dirlink>
80105ec2:	85 c0                	test   %eax,%eax
80105ec4:	79 0d                	jns    80105ed3 <sys_link+0x11b>
    iunlockput(dp);
80105ec6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ec9:	89 04 24             	mov    %eax,(%esp)
80105ecc:	e8 1b bc ff ff       	call   80101aec <iunlockput>
    goto bad;
80105ed1:	eb 23                	jmp    80105ef6 <sys_link+0x13e>
  }
  iunlockput(dp);
80105ed3:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ed6:	89 04 24             	mov    %eax,(%esp)
80105ed9:	e8 0e bc ff ff       	call   80101aec <iunlockput>
  iput(ip);
80105ede:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ee1:	89 04 24             	mov    %eax,(%esp)
80105ee4:	e8 32 bb ff ff       	call   80101a1b <iput>

  commit_trans();
80105ee9:	e8 78 d3 ff ff       	call   80103266 <commit_trans>

  return 0;
80105eee:	b8 00 00 00 00       	mov    $0x0,%eax
80105ef3:	eb 3d                	jmp    80105f32 <sys_link+0x17a>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
80105f18:	e8 8f b7 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
...
80105f3a:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105f41:	eb 4b                	jmp    80105f8e <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105f43:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f46:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105f4d:	00 
80105f4e:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105f5f:	e8 fa bd ff ff       	call   80101d5e <readi>
80105f64:	83 f8 10             	cmp    $0x10,%eax
80105f67:	74 0c                	je     80105f75 <isdirempty+0x41>
      panic("isdirempty: readi");
80105f69:	c7 04 24 65 8f 10 80 	movl   $0x80108f65,(%esp)
80105f70:	e8 c8 a5 ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80105f75:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105f79:	66 85 c0             	test   %ax,%ax
80105f7c:	74 07                	je     80105f85 <isdirempty+0x51>
      return 0;
80105f7e:	b8 00 00 00 00       	mov    $0x0,%eax
80105f83:	eb 1b                	jmp    80105fa0 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105f88:	83 c0 10             	add    $0x10,%eax
80105f8b:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f8e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f91:	8b 45 08             	mov    0x8(%ebp),%eax
80105f94:	8b 40 18             	mov    0x18(%eax),%eax
80105f97:	39 c2                	cmp    %eax,%edx
80105f99:	72 a8                	jb     80105f43 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80105fa5:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105fa8:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105fab:	89 44 24 04          	mov    %eax,0x4(%esp)
80105faf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105fb6:	e8 35 fa ff ff       	call   801059f0 <argstr>
80105fbb:	85 c0                	test   %eax,%eax
80105fbd:	79 0a                	jns    80105fc9 <sys_unlink+0x27>
    return -1;
80105fbf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fc4:	e9 aa 01 00 00       	jmp    80106173 <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80105fc9:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105fcc:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105fcf:	89 54 24 04          	mov    %edx,0x4(%esp)
80105fd3:	89 04 24             	mov    %eax,(%esp)
80105fd6:	e8 51 c4 ff ff       	call   8010242c <nameiparent>
80105fdb:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105fde:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105fe2:	75 0a                	jne    80105fee <sys_unlink+0x4c>
    return -1;
80105fe4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fe9:	e9 85 01 00 00       	jmp    80106173 <sys_unlink+0x1d1>

  begin_trans();
80105fee:	e8 2a d2 ff ff       	call   8010321d <begin_trans>

  ilock(dp);
80105ff3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ff6:	89 04 24             	mov    %eax,(%esp)
80105ff9:	e8 6a b8 ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105ffe:	c7 44 24 04 77 8f 10 	movl   $0x80108f77,0x4(%esp)
80106005:	80 
80106006:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106009:	89 04 24             	mov    %eax,(%esp)
8010600c:	e8 4e c0 ff ff       	call   8010205f <namecmp>
80106011:	85 c0                	test   %eax,%eax
80106013:	0f 84 45 01 00 00    	je     8010615e <sys_unlink+0x1bc>
80106019:	c7 44 24 04 79 8f 10 	movl   $0x80108f79,0x4(%esp)
80106020:	80 
80106021:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80106024:	89 04 24             	mov    %eax,(%esp)
80106027:	e8 33 c0 ff ff       	call   8010205f <namecmp>
8010602c:	85 c0                	test   %eax,%eax
8010602e:	0f 84 2a 01 00 00    	je     8010615e <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80106034:	8d 45 c8             	lea    -0x38(%ebp),%eax
80106037:	89 44 24 08          	mov    %eax,0x8(%esp)
8010603b:	8d 45 d2             	lea    -0x2e(%ebp),%eax
8010603e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106042:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106045:	89 04 24             	mov    %eax,(%esp)
80106048:	e8 34 c0 ff ff       	call   80102081 <dirlookup>
8010604d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106050:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106054:	0f 84 03 01 00 00    	je     8010615d <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
8010605a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010605d:	89 04 24             	mov    %eax,(%esp)
80106060:	e8 03 b8 ff ff       	call   80101868 <ilock>

  if(ip->nlink < 1)
80106065:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106068:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010606c:	66 85 c0             	test   %ax,%ax
8010606f:	7f 0c                	jg     8010607d <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80106071:	c7 04 24 7c 8f 10 80 	movl   $0x80108f7c,(%esp)
80106078:	e8 c0 a4 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
8010607d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106080:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106084:	66 83 f8 01          	cmp    $0x1,%ax
80106088:	75 1f                	jne    801060a9 <sys_unlink+0x107>
8010608a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010608d:	89 04 24             	mov    %eax,(%esp)
80106090:	e8 9f fe ff ff       	call   80105f34 <isdirempty>
80106095:	85 c0                	test   %eax,%eax
80106097:	75 10                	jne    801060a9 <sys_unlink+0x107>
    iunlockput(ip);
80106099:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010609c:	89 04 24             	mov    %eax,(%esp)
8010609f:	e8 48 ba ff ff       	call   80101aec <iunlockput>
    goto bad;
801060a4:	e9 b5 00 00 00       	jmp    8010615e <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
801060a9:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801060b0:	00 
801060b1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801060b8:	00 
801060b9:	8d 45 e0             	lea    -0x20(%ebp),%eax
801060bc:	89 04 24             	mov    %eax,(%esp)
801060bf:	e8 42 f5 ff ff       	call   80105606 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801060c4:	8b 45 c8             	mov    -0x38(%ebp),%eax
801060c7:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
801060ce:	00 
...
801060e0:	e8 e4 bd ff ff       	call   80101ec9 <writei>
801060e5:	83 f8 10             	cmp    $0x10,%eax
801060e8:	74 0c                	je     801060f6 <sys_unlink+0x154>
    panic("unlink: writei");
801060ea:	c7 04 24 8e 8f 10 80 	movl   $0x80108f8e,(%esp)
801060f1:	e8 47 a4 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
801060f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060f9:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801060fd:	66 83 f8 01          	cmp    $0x1,%ax
80106101:	75 1c                	jne    8010611f <sys_unlink+0x17d>
    dp->nlink--;
...
8010611a:	e8 8d b5 ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
8010611f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106122:	89 04 24             	mov    %eax,(%esp)
80106125:	e8 c2 b9 ff ff       	call   80101aec <iunlockput>

  ip->nlink--;
8010612a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010612d:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106131:	8d 50 ff             	lea    -0x1(%eax),%edx
80106134:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106137:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
8010613b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010613e:	89 04 24             	mov    %eax,(%esp)
80106141:	e8 66 b5 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80106146:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106149:	89 04 24             	mov    %eax,(%esp)
8010614c:	e8 9b b9 ff ff       	call   80101aec <iunlockput>

  commit_trans();
80106151:	e8 10 d1 ff ff       	call   80103266 <commit_trans>

  return 0;
80106156:	b8 00 00 00 00       	mov    $0x0,%eax
8010615b:	eb 16                	jmp    80106173 <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80106164:	e8 83 b9 ff ff       	call   80101aec <iunlockput>
  commit_trans();
80106169:	e8 f8 d0 ff ff       	call   80103266 <commit_trans>
  return -1;
...
80106178:	83 ec 48             	sub    $0x48,%esp
8010617b:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010617e:	8b 55 10             	mov    0x10(%ebp),%edx
80106181:	8b 45 14             	mov    0x14(%ebp),%eax
80106184:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80106188:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
8010618c:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80106190:	8d 45 de             	lea    -0x22(%ebp),%eax
80106193:	89 44 24 04          	mov    %eax,0x4(%esp)
80106197:	8b 45 08             	mov    0x8(%ebp),%eax
8010619a:	89 04 24             	mov    %eax,(%esp)
8010619d:	e8 8a c2 ff ff       	call   8010242c <nameiparent>
801061a2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801061a5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801061a9:	75 0a                	jne    801061b5 <create+0x40>
    return 0;
801061ab:	b8 00 00 00 00       	mov    $0x0,%eax
801061b0:	e9 7e 01 00 00       	jmp    80106333 <create+0x1be>
  ilock(dp);
801061b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061b8:	89 04 24             	mov    %eax,(%esp)
801061bb:	e8 a8 b6 ff ff       	call   80101868 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801061c0:	8d 45 ec             	lea    -0x14(%ebp),%eax
801061c3:	89 44 24 08          	mov    %eax,0x8(%esp)
801061c7:	8d 45 de             	lea    -0x22(%ebp),%eax
801061ca:	89 44 24 04          	mov    %eax,0x4(%esp)
801061ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061d1:	89 04 24             	mov    %eax,(%esp)
801061d4:	e8 a8 be ff ff       	call   80102081 <dirlookup>
801061d9:	89 45 f0             	mov    %eax,-0x10(%ebp)
801061dc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801061e0:	74 47                	je     80106229 <create+0xb4>
    iunlockput(dp);
801061e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061e5:	89 04 24             	mov    %eax,(%esp)
801061e8:	e8 ff b8 ff ff       	call   80101aec <iunlockput>
    ilock(ip);
801061ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061f0:	89 04 24             	mov    %eax,(%esp)
801061f3:	e8 70 b6 ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801061f8:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801061fd:	75 15                	jne    80106214 <create+0x9f>
801061ff:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106202:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106206:	66 83 f8 02          	cmp    $0x2,%ax
8010620a:	75 08                	jne    80106214 <create+0x9f>
      return ip;
8010620c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010620f:	e9 1f 01 00 00       	jmp    80106333 <create+0x1be>
    iunlockput(ip);
80106214:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106217:	89 04 24             	mov    %eax,(%esp)
8010621a:	e8 cd b8 ff ff       	call   80101aec <iunlockput>
    return 0;
8010621f:	b8 00 00 00 00       	mov    $0x0,%eax
80106224:	e9 0a 01 00 00       	jmp    80106333 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80106229:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
...
80106239:	e8 91 b3 ff ff       	call   801015cf <ialloc>
8010623e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106241:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106245:	75 0c                	jne    80106253 <create+0xde>
    panic("create: ialloc");
80106247:	c7 04 24 9d 8f 10 80 	movl   $0x80108f9d,(%esp)
8010624e:	e8 ea a2 ff ff       	call   8010053d <panic>

  ilock(ip);
80106253:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106256:	89 04 24             	mov    %eax,(%esp)
80106259:	e8 0a b6 ff ff       	call   80101868 <ilock>
  ip->major = major;
8010625e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106261:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80106265:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80106269:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010626c:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80106270:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80106274:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106277:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
8010627d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106280:	89 04 24             	mov    %eax,(%esp)
80106283:	e8 24 b4 ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80106288:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
8010628d:	75 6a                	jne    801062f9 <create+0x184>
    dp->nlink++;  // for ".."
8010628f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106292:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80106296:	8d 50 01             	lea    0x1(%eax),%edx
...
801062a6:	e8 01 b4 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801062ab:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062ae:	8b 40 04             	mov    0x4(%eax),%eax
801062b1:	89 44 24 08          	mov    %eax,0x8(%esp)
801062b5:	c7 44 24 04 77 8f 10 	movl   $0x80108f77,0x4(%esp)
801062bc:	80 
801062bd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062c0:	89 04 24             	mov    %eax,(%esp)
801062c3:	e8 81 be ff ff       	call   80102149 <dirlink>
801062c8:	85 c0                	test   %eax,%eax
801062ca:	78 21                	js     801062ed <create+0x178>
801062cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062cf:	8b 40 04             	mov    0x4(%eax),%eax
801062d2:	89 44 24 08          	mov    %eax,0x8(%esp)
801062d6:	c7 44 24 04 79 8f 10 	movl   $0x80108f79,0x4(%esp)
801062dd:	80 
801062de:	8b 45 f0             	mov    -0x10(%ebp),%eax
801062e1:	89 04 24             	mov    %eax,(%esp)
801062e4:	e8 60 be ff ff       	call   80102149 <dirlink>
801062e9:	85 c0                	test   %eax,%eax
801062eb:	79 0c                	jns    801062f9 <create+0x184>
      panic("create dots");
801062ed:	c7 04 24 ac 8f 10 80 	movl   $0x80108fac,(%esp)
801062f4:	e8 44 a2 ff ff       	call   8010053d <panic>
  }
...
80106303:	8d 45 de             	lea    -0x22(%ebp),%eax
80106306:	89 44 24 04          	mov    %eax,0x4(%esp)
8010630a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010630d:	89 04 24             	mov    %eax,(%esp)
80106310:	e8 34 be ff ff       	call   80102149 <dirlink>
80106315:	85 c0                	test   %eax,%eax
80106317:	79 0c                	jns    80106325 <create+0x1b0>
    panic("create: dirlink");
80106319:	c7 04 24 b8 8f 10 80 	movl   $0x80108fb8,(%esp)
80106320:	e8 18 a2 ff ff       	call   8010053d <panic>

  iunlockput(dp);
80106325:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106328:	89 04 24             	mov    %eax,(%esp)
8010632b:	e8 bc b7 ff ff       	call   80101aec <iunlockput>
...
80106349:	e8 a2 f6 ff ff       	call   801059f0 <argstr>
8010634e:	85 c0                	test   %eax,%eax
80106350:	78 17                	js     80106369 <sys_open+0x34>
80106352:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106355:	89 44 24 04          	mov    %eax,0x4(%esp)
80106359:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106360:	e8 f1 f5 ff ff       	call   80105956 <argint>
80106365:	85 c0                	test   %eax,%eax
80106367:	79 0a                	jns    80106373 <sys_open+0x3e>
    return -1;
80106369:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010636e:	e9 46 01 00 00       	jmp    801064b9 <sys_open+0x184>
  if(omode & O_CREATE){
80106373:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106376:	25 00 02 00 00       	and    $0x200,%eax
8010637b:	85 c0                	test   %eax,%eax
8010637d:	74 40                	je     801063bf <sys_open+0x8a>
    begin_trans();
8010637f:	e8 99 ce ff ff       	call   8010321d <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80106384:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106387:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
8010638e:	00 
8010638f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80106396:	00 
80106397:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
8010639e:	00 
8010639f:	89 04 24             	mov    %eax,(%esp)
801063a2:	e8 ce fd ff ff       	call   80106175 <create>
801063a7:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
801063aa:	e8 b7 ce ff ff       	call   80103266 <commit_trans>
    if(ip == 0)
801063af:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801063b3:	75 5c                	jne    80106411 <sys_open+0xdc>
      return -1;
801063b5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063ba:	e9 fa 00 00 00       	jmp    801064b9 <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
801063bf:	8b 45 e8             	mov    -0x18(%ebp),%eax
801063c2:	89 04 24             	mov    %eax,(%esp)
801063c5:	e8 40 c0 ff ff       	call   8010240a <namei>
801063ca:	89 45 f4             	mov    %eax,-0xc(%ebp)
801063cd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801063d1:	75 0a                	jne    801063dd <sys_open+0xa8>
      return -1;
801063d3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063d8:	e9 dc 00 00 00       	jmp    801064b9 <sys_open+0x184>
    ilock(ip);
801063dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063e0:	89 04 24             	mov    %eax,(%esp)
801063e3:	e8 80 b4 ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801063e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063eb:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801063ef:	66 83 f8 01          	cmp    $0x1,%ax
801063f3:	75 1c                	jne    80106411 <sys_open+0xdc>
801063f5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801063f8:	85 c0                	test   %eax,%eax
801063fa:	74 15                	je     80106411 <sys_open+0xdc>
      iunlockput(ip);
801063fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063ff:	89 04 24             	mov    %eax,(%esp)
80106402:	e8 e5 b6 ff ff       	call   80101aec <iunlockput>
      return -1;
80106407:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010640c:	e9 a8 00 00 00       	jmp    801064b9 <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106411:	e8 06 ab ff ff       	call   80100f1c <filealloc>
80106416:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106419:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010641d:	74 14                	je     80106433 <sys_open+0xfe>
8010641f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106422:	89 04 24             	mov    %eax,(%esp)
80106425:	e8 43 f7 ff ff       	call   80105b6d <fdalloc>
8010642a:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010642d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106431:	79 23                	jns    80106456 <sys_open+0x121>
    if(f)
80106433:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106437:	74 0b                	je     80106444 <sys_open+0x10f>
      fileclose(f);
80106439:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010643c:	89 04 24             	mov    %eax,(%esp)
8010643f:	e8 80 ab ff ff       	call   80100fc4 <fileclose>
    iunlockput(ip);
...
80106454:	eb 63                	jmp    801064b9 <sys_open+0x184>
  }
  iunlock(ip);
80106456:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106459:	89 04 24             	mov    %eax,(%esp)
8010645c:	e8 55 b5 ff ff       	call   801019b6 <iunlock>

  f->type = FD_INODE;
80106461:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106464:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
8010646a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010646d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106470:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80106473:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106476:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
8010647d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106480:	83 e0 01             	and    $0x1,%eax
80106483:	85 c0                	test   %eax,%eax
80106485:	0f 94 c2             	sete   %dl
80106488:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010648b:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010648e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106491:	83 e0 01             	and    $0x1,%eax
80106494:	84 c0                	test   %al,%al
80106496:	75 0a                	jne    801064a2 <sys_open+0x16d>
80106498:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010649b:	83 e0 02             	and    $0x2,%eax
8010649e:	85 c0                	test   %eax,%eax
801064a0:	74 07                	je     801064a9 <sys_open+0x174>
801064a2:	b8 01 00 00 00       	mov    $0x1,%eax
801064a7:	eb 05                	jmp    801064ae <sys_open+0x179>
801064a9:	b8 00 00 00 00       	mov    $0x0,%eax
801064ae:	89 c2                	mov    %eax,%edx
801064b0:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064b3:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
801064be:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_trans();
801064c1:	e8 57 cd ff ff       	call   8010321d <begin_trans>
...
801064d4:	e8 17 f5 ff ff       	call   801059f0 <argstr>
801064d9:	85 c0                	test   %eax,%eax
801064db:	78 2c                	js     80106509 <sys_mkdir+0x4e>
801064dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064e0:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801064e7:	00 
801064e8:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801064ef:	00 
801064f0:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801064f7:	00 
801064f8:	89 04 24             	mov    %eax,(%esp)
801064fb:	e8 75 fc ff ff       	call   80106175 <create>
80106500:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106503:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106507:	75 0c                	jne    80106515 <sys_mkdir+0x5a>
    commit_trans();
80106509:	e8 58 cd ff ff       	call   80103266 <commit_trans>
    return -1;
8010650e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106513:	eb 15                	jmp    8010652a <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106515:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106518:	89 04 24             	mov    %eax,(%esp)
8010651b:	e8 cc b5 ff ff       	call   80101aec <iunlockput>
  commit_trans();
80106520:	e8 41 cd ff ff       	call   80103266 <commit_trans>
  return 0;
...
8010652f:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_trans();
80106532:	e8 e6 cc ff ff       	call   8010321d <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
80106537:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010653a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010653e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106545:	e8 a6 f4 ff ff       	call   801059f0 <argstr>
8010654a:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010654d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106551:	78 5e                	js     801065b1 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80106553:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106556:	89 44 24 04          	mov    %eax,0x4(%esp)
8010655a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106561:	e8 f0 f3 ff ff       	call   80105956 <argint>
  char *path;
  int len;
  int major, minor;
...
80106568:	78 47                	js     801065b1 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010656a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010656d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106571:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106578:	e8 d9 f3 ff ff       	call   80105956 <argint>
  int len;
  int major, minor;
...
8010657f:	78 30                	js     801065b1 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106581:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106584:	0f bf c8             	movswl %ax,%ecx
80106587:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010658a:	0f bf d0             	movswl %ax,%edx
8010658d:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106590:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106594:	89 54 24 08          	mov    %edx,0x8(%esp)
80106598:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010659f:	00 
801065a0:	89 04 24             	mov    %eax,(%esp)
801065a3:	e8 cd fb ff ff       	call   80106175 <create>
801065a8:	89 45 f0             	mov    %eax,-0x10(%ebp)
801065ab:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801065af:	75 0c                	jne    801065bd <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
801065b1:	e8 b0 cc ff ff       	call   80103266 <commit_trans>
    return -1;
801065b6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065bb:	eb 15                	jmp    801065d2 <sys_mknod+0xa6>
  }
  iunlockput(ip);
801065bd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065c0:	89 04 24             	mov    %eax,(%esp)
801065c3:	e8 24 b5 ff ff       	call   80101aec <iunlockput>
  commit_trans();
801065c8:	e8 99 cc ff ff       	call   80103266 <commit_trans>
  return 0;
...
801065e8:	e8 03 f4 ff ff       	call   801059f0 <argstr>
801065ed:	85 c0                	test   %eax,%eax
801065ef:	78 14                	js     80106605 <sys_chdir+0x31>
801065f1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801065f4:	89 04 24             	mov    %eax,(%esp)
801065f7:	e8 0e be ff ff       	call   8010240a <namei>
801065fc:	89 45 f4             	mov    %eax,-0xc(%ebp)
801065ff:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106603:	75 07                	jne    8010660c <sys_chdir+0x38>
    return -1;
80106605:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010660a:	eb 57                	jmp    80106663 <sys_chdir+0x8f>
  ilock(ip);
8010660c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010660f:	89 04 24             	mov    %eax,(%esp)
80106612:	e8 51 b2 ff ff       	call   80101868 <ilock>
  if(ip->type != T_DIR){
80106617:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010661a:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010661e:	66 83 f8 01          	cmp    $0x1,%ax
80106622:	74 12                	je     80106636 <sys_chdir+0x62>
    iunlockput(ip);
80106624:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106627:	89 04 24             	mov    %eax,(%esp)
8010662a:	e8 bd b4 ff ff       	call   80101aec <iunlockput>
    return -1;
8010662f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106634:	eb 2d                	jmp    80106663 <sys_chdir+0x8f>
  }
  iunlock(ip);
80106636:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106639:	89 04 24             	mov    %eax,(%esp)
8010663c:	e8 75 b3 ff ff       	call   801019b6 <iunlock>
  iput(proc->cwd);
80106641:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106647:	8b 40 68             	mov    0x68(%eax),%eax
8010664a:	89 04 24             	mov    %eax,(%esp)
8010664d:	e8 c9 b3 ff ff       	call   80101a1b <iput>
  proc->cwd = ip;
80106652:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106658:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010665b:	89 50 68             	mov    %edx,0x68(%eax)
  return 0;
...
80106668:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
8010667c:	e8 6f f3 ff ff       	call   801059f0 <argstr>
80106681:	85 c0                	test   %eax,%eax
80106683:	78 1a                	js     8010669f <sys_exec+0x3a>
80106685:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
8010668b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010668f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106696:	e8 bb f2 ff ff       	call   80105956 <argint>
8010669b:	85 c0                	test   %eax,%eax
8010669d:	79 0a                	jns    801066a9 <sys_exec+0x44>
    return -1;
8010669f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066a4:	e9 e2 00 00 00       	jmp    8010678b <sys_exec+0x126>
  }
  memset(argv, 0, sizeof(argv));
801066a9:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801066b0:	00 
801066b1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801066b8:	00 
801066b9:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801066bf:	89 04 24             	mov    %eax,(%esp)
801066c2:	e8 3f ef ff ff       	call   80105606 <memset>
  for(i=0;; i++){
801066c7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801066ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066d1:	83 f8 1f             	cmp    $0x1f,%eax
801066d4:	76 0a                	jbe    801066e0 <sys_exec+0x7b>
      return -1;
801066d6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066db:	e9 ab 00 00 00       	jmp    8010678b <sys_exec+0x126>
    if(fetchint(proc, uargv+4*i, (int*)&uarg) < 0)
801066e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066e3:	c1 e0 02             	shl    $0x2,%eax
801066e6:	89 c2                	mov    %eax,%edx
801066e8:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801066ee:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
801066f1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801066f7:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
801066fd:	89 54 24 08          	mov    %edx,0x8(%esp)
80106701:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80106705:	89 04 24             	mov    %eax,(%esp)
80106708:	e8 b7 f1 ff ff       	call   801058c4 <fetchint>
8010670d:	85 c0                	test   %eax,%eax
8010670f:	79 07                	jns    80106718 <sys_exec+0xb3>
      return -1;
80106711:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106716:	eb 73                	jmp    8010678b <sys_exec+0x126>
    if(uarg == 0){
80106718:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
8010671e:	85 c0                	test   %eax,%eax
80106720:	75 26                	jne    80106748 <sys_exec+0xe3>
      argv[i] = 0;
80106722:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106725:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
8010672c:	00 00 00 00 
      break;
80106730:	90                   	nop
    }
...
80106734:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
8010673a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010673e:	89 04 24             	mov    %eax,(%esp)
80106741:	e8 b6 a3 ff ff       	call   80100afc <exec>
80106746:	eb 43                	jmp    8010678b <sys_exec+0x126>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
8010674b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80106752:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80106758:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
8010675b:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
80106761:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106767:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010676b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010676f:	89 04 24             	mov    %eax,(%esp)
80106772:	e8 81 f1 ff ff       	call   801058f8 <fetchstr>
80106777:	85 c0                	test   %eax,%eax
80106779:	79 07                	jns    80106782 <sys_exec+0x11d>
      return -1;
8010677b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106780:	eb 09                	jmp    8010678b <sys_exec+0x126>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80106782:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(proc, uarg, &argv[i]) < 0)
...
80106786:	e9 43 ff ff ff       	jmp    801066ce <sys_exec+0x69>
  return exec(path, argv);
}
8010678b:	c9                   	leave  
8010678c:	c3                   	ret    
...
80106790:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106793:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
8010679a:	00 
8010679b:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010679e:	89 44 24 04          	mov    %eax,0x4(%esp)
801067a2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801067a9:	e8 e0 f1 ff ff       	call   8010598e <argptr>
801067ae:	85 c0                	test   %eax,%eax
801067b0:	79 0a                	jns    801067bc <sys_pipe+0x2f>
    return -1;
801067b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067b7:	e9 9b 00 00 00       	jmp    80106857 <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
801067bc:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801067bf:	89 44 24 04          	mov    %eax,0x4(%esp)
801067c3:	8d 45 e8             	lea    -0x18(%ebp),%eax
801067c6:	89 04 24             	mov    %eax,(%esp)
801067c9:	e8 6a d4 ff ff       	call   80103c38 <pipealloc>
801067ce:	85 c0                	test   %eax,%eax
801067d0:	79 07                	jns    801067d9 <sys_pipe+0x4c>
    return -1;
801067d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067d7:	eb 7e                	jmp    80106857 <sys_pipe+0xca>
  fd0 = -1;
...
801067e6:	e8 82 f3 ff ff       	call   80105b6d <fdalloc>
801067eb:	89 45 f4             	mov    %eax,-0xc(%ebp)
801067ee:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801067f2:	78 14                	js     80106808 <sys_pipe+0x7b>
801067f4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801067f7:	89 04 24             	mov    %eax,(%esp)
801067fa:	e8 6e f3 ff ff       	call   80105b6d <fdalloc>
801067ff:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106802:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106806:	79 37                	jns    8010683f <sys_pipe+0xb2>
    if(fd0 >= 0)
80106808:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010680c:	78 14                	js     80106822 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
8010680e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106814:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106817:	83 c2 08             	add    $0x8,%edx
8010681a:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106821:	00 
    fileclose(rf);
80106822:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106825:	89 04 24             	mov    %eax,(%esp)
80106828:	e8 97 a7 ff ff       	call   80100fc4 <fileclose>
    fileclose(wf);
8010682d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106830:	89 04 24             	mov    %eax,(%esp)
80106833:	e8 8c a7 ff ff       	call   80100fc4 <fileclose>
    return -1;
80106838:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010683d:	eb 18                	jmp    80106857 <sys_pipe+0xca>
  }
  fd[0] = fd0;
8010683f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106842:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106845:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
80106847:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010684a:	8d 50 04             	lea    0x4(%eax),%edx
8010684d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106850:	89 02                	mov    %eax,(%edx)
  return 0;
80106852:	b8 00 00 00 00       	mov    $0x0,%eax
}
80106857:	c9                   	leave  
80106858:	c3                   	ret    
80106859:	00 00                	add    %al,(%eax)
	...
...
8010685f:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106862:	e8 9b da ff ff       	call   80104302 <fork>
}
80106867:	c9                   	leave  
80106868:	c3                   	ret    
...
8010686c:	83 ec 08             	sub    $0x8,%esp
  exit();
8010686f:	e8 33 dc ff ff       	call   801044a7 <exit>
...
8010687e:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106881:	e8 09 de ff ff       	call   8010468f <wait>
}
80106886:	c9                   	leave  
80106887:	c3                   	ret    
...
8010688b:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &pid) < 0)
8010688e:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106891:	89 44 24 04          	mov    %eax,0x4(%esp)
80106895:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010689c:	e8 b5 f0 ff ff       	call   80105956 <argint>
801068a1:	85 c0                	test   %eax,%eax
801068a3:	79 07                	jns    801068ac <sys_kill+0x24>
    return -1;
801068a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068aa:	eb 0b                	jmp    801068b7 <sys_kill+0x2f>
  return kill(pid);
801068ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801068af:	89 04 24             	mov    %eax,(%esp)
801068b2:	e8 ad e2 ff ff       	call   80104b64 <kill>
}
801068b7:	c9                   	leave  
801068b8:	c3                   	ret    
...
801068c2:	8b 40 10             	mov    0x10(%eax),%eax
}
801068c5:	5d                   	pop    %ebp
801068c6:	c3                   	ret    
...
801068db:	e8 76 f0 ff ff       	call   80105956 <argint>
801068e0:	85 c0                	test   %eax,%eax
801068e2:	79 07                	jns    801068eb <sys_sbrk+0x24>
    return -1;
801068e4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801068e9:	eb 24                	jmp    8010690f <sys_sbrk+0x48>
  addr = proc->sz;
801068eb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801068f1:	8b 00                	mov    (%eax),%eax
801068f3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(growproc(n) < 0)
801068f6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801068f9:	89 04 24             	mov    %eax,(%esp)
801068fc:	e8 5c d9 ff ff       	call   8010425d <growproc>
80106901:	85 c0                	test   %eax,%eax
80106903:	79 07                	jns    8010690c <sys_sbrk+0x45>
    return -1;
80106905:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010690a:	eb 03                	jmp    8010690f <sys_sbrk+0x48>
  return addr;
...
80106914:	83 ec 28             	sub    $0x28,%esp
  ...
  if(argint(0, &n) < 0)
80106917:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010691a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010691e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106925:	e8 2c f0 ff ff       	call   80105956 <argint>
8010692a:	85 c0                	test   %eax,%eax
8010692c:	79 07                	jns    80106935 <sys_sleep+0x24>
    return -1;
8010692e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106933:	eb 6c                	jmp    801069a1 <sys_sleep+0x90>
  acquire(&tickslock);
80106935:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
8010693c:	e8 76 ea ff ff       	call   801053b7 <acquire>
  ticks0 = ticks;
80106941:	a1 00 44 11 80       	mov    0x80114400,%eax
80106946:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106949:	eb 34                	jmp    8010697f <sys_sleep+0x6e>
    if(proc->killed){
8010694b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106951:	8b 40 24             	mov    0x24(%eax),%eax
80106954:	85 c0                	test   %eax,%eax
80106956:	74 13                	je     8010696b <sys_sleep+0x5a>
      release(&tickslock);
80106958:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
8010695f:	e8 b5 ea ff ff       	call   80105419 <release>
      return -1;
80106964:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106969:	eb 36                	jmp    801069a1 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
8010696b:	c7 44 24 04 c0 3b 11 	movl   $0x80113bc0,0x4(%esp)
80106972:	80 
80106973:	c7 04 24 00 44 11 80 	movl   $0x80114400,(%esp)
8010697a:	e8 de e0 ff ff       	call   80104a5d <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010697f:	a1 00 44 11 80       	mov    0x80114400,%eax
80106984:	89 c2                	mov    %eax,%edx
80106986:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106989:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010698c:	39 c2                	cmp    %eax,%edx
8010698e:	72 bb                	jb     8010694b <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106990:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
80106997:	e8 7d ea ff ff       	call   80105419 <release>
  return 0;
...
801069a6:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801069a9:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
801069b0:	e8 02 ea ff ff       	call   801053b7 <acquire>
  xticks = ticks;
801069b5:	a1 00 44 11 80       	mov    0x80114400,%eax
801069ba:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801069bd:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
801069c4:	e8 50 ea ff ff       	call   80105419 <release>
  return xticks;
...
801069d4:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801069db:	00 
801069dc:	8d 45 f4             	lea    -0xc(%ebp),%eax
801069df:	89 44 24 04          	mov    %eax,0x4(%esp)
801069e3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069ea:	e8 9f ef ff ff       	call   8010598e <argptr>
  argptr(1, &stack , sizeof(stack ));
801069ef:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801069f6:	00 
801069f7:	8d 45 f0             	lea    -0x10(%ebp),%eax
801069fa:	89 44 24 04          	mov    %eax,0x4(%esp)
801069fe:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106a05:	e8 84 ef ff ff       	call   8010598e <argptr>
  argptr(2, &stack_size, sizeof(stack_size));
80106a0a:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106a11:	00 
80106a12:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106a15:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a19:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106a20:	e8 69 ef ff ff       	call   8010598e <argptr>
  return thread_create( (start_func_def ) start_func ,(void*) stack, (uint)stack_size);
80106a25:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106a28:	89 c1                	mov    %eax,%ecx
80106a2a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80106a2d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a30:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106a34:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a38:	89 04 24             	mov    %eax,(%esp)
80106a3b:	e8 9b e2 ff ff       	call   80104cdb <thread_create>
}
80106a40:	c9                   	leave  
80106a41:	c3                   	ret    

80106a42 <sys_thread_getId>:
...
80106a4b:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
}
80106a51:	5d                   	pop    %ebp
80106a52:	c3                   	ret    

80106a53 <sys_thread_getProcId>:
...
80106a5c:	8b 40 10             	mov    0x10(%eax),%eax
}
80106a5f:	5d                   	pop    %ebp
80106a60:	c3                   	ret    

80106a61 <sys_thread_join>:
...
80106aaa:	e8 13 e4 ff ff       	call   80104ec2 <thread_join>
}
80106aaf:	c9                   	leave  
80106ab0:	c3                   	ret    

80106ab1 <sys_thread_exit>:
...
80106acd:	e8 bc ee ff ff       	call   8010598e <argptr>
  return thread_exit((void*) ret_val);
80106ad2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ad5:	89 04 24             	mov    %eax,(%esp)
80106ad8:	e8 d5 e4 ff ff       	call   80104fb2 <thread_exit>
}
80106add:	c9                   	leave  
80106ade:	c3                   	ret    

80106adf <sys_binary_semaphore_create>:
...
80106afb:	e8 8e ee ff ff       	call   8010598e <argptr>
  return binary_semaphore_create((int) initial_value);
80106b00:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b03:	89 04 24             	mov    %eax,(%esp)
80106b06:	e8 ce e5 ff ff       	call   801050d9 <binary_semaphore_create>
}
80106b0b:	c9                   	leave  
80106b0c:	c3                   	ret    

80106b0d <sys_binary_semaphore_down>:
...
80106b13:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106b1a:	00 
80106b1b:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106b1e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b22:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b29:	e8 60 ee ff ff       	call   8010598e <argptr>
  return binary_semaphore_down((int) binary_semaphore_ID);
80106b2e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b31:	89 04 24             	mov    %eax,(%esp)
80106b34:	e8 1b e6 ff ff       	call   80105154 <binary_semaphore_down>
}
80106b39:	c9                   	leave  
80106b3a:	c3                   	ret    

80106b3b <sys_binary_semaphore_up>:
...
80106b3e:	83 ec 28             	sub    $0x28,%esp
  char* binary_semaphore_ID;
  argptr(0,&binary_semaphore_ID,sizeof(binary_semaphore_ID));
80106b41:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106b48:	00 
80106b49:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106b4c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b50:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b57:	e8 32 ee ff ff       	call   8010598e <argptr>
  return binary_semaphore_up((int) binary_semaphore_ID);
80106b5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b5f:	89 04 24             	mov    %eax,(%esp)
80106b62:	e8 32 e7 ff ff       	call   80105299 <binary_semaphore_up>
}
80106b67:	c9                   	leave  
80106b68:	c3                   	ret    
80106b69:	00 00                	add    %al,(%eax)
	...
...
80106b8d:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
80106b90:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106b97:	00 
80106b98:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106b9f:	e8 c8 ff ff ff       	call   80106b6c <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106ba4:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106bab:	00 
80106bac:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106bb3:	e8 b4 ff ff ff       	call   80106b6c <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106bb8:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106bbf:	00 
80106bc0:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106bc7:	e8 a0 ff ff ff       	call   80106b6c <outb>
  picenable(IRQ_TIMER);
80106bcc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
...
80106bdd:	06                   	push   %es
  pushl %fs
80106bde:	0f a0                	push   %fs
  pushl %gs
80106be0:	0f a8                	push   %gs
  pushal
80106be2:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106be3:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106be7:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106be9:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106beb:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106bef:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106bf1:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106bf3:	54                   	push   %esp
  call trap
80106bf4:	e8 de 01 00 00       	call   80106dd7 <trap>
  addl $4, %esp
...
80106bfc:	61                   	popa   
  popl %gs
80106bfd:	0f a9                	pop    %gs
  popl %fs
80106bff:	0f a1                	pop    %fs
  popl %es
80106c01:	07                   	pop    %es
  popl %ds
80106c02:	1f                   	pop    %ds
...
80106c11:	83 e8 01             	sub    $0x1,%eax
80106c14:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106c18:	8b 45 08             	mov    0x8(%ebp),%eax
80106c1b:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106c1f:	8b 45 08             	mov    0x8(%ebp),%eax
80106c22:	c1 e8 10             	shr    $0x10,%eax
80106c25:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106c29:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106c2c:	0f 01 18             	lidtl  (%eax)
}
80106c2f:	c9                   	leave  
80106c30:	c3                   	ret    
...
80106c38:	0f 20 d3             	mov    %cr2,%ebx
80106c3b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
80106c3e:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80106c54:	e9 c3 00 00 00       	jmp    80106d1c <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106c59:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c5c:	8b 04 85 b8 c0 10 80 	mov    -0x7fef3f48(,%eax,4),%eax
80106c63:	89 c2                	mov    %eax,%edx
80106c65:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c68:	66 89 14 c5 00 3c 11 	mov    %dx,-0x7feec400(,%eax,8)
80106c6f:	80 
80106c70:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c73:	66 c7 04 c5 02 3c 11 	movw   $0x8,-0x7feec3fe(,%eax,8)
80106c7a:	80 08 00 
80106c7d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c80:	0f b6 14 c5 04 3c 11 	movzbl -0x7feec3fc(,%eax,8),%edx
80106c87:	80 
80106c88:	83 e2 e0             	and    $0xffffffe0,%edx
80106c8b:	88 14 c5 04 3c 11 80 	mov    %dl,-0x7feec3fc(,%eax,8)
80106c92:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c95:	0f b6 14 c5 04 3c 11 	movzbl -0x7feec3fc(,%eax,8),%edx
80106c9c:	80 
80106c9d:	83 e2 1f             	and    $0x1f,%edx
80106ca0:	88 14 c5 04 3c 11 80 	mov    %dl,-0x7feec3fc(,%eax,8)
80106ca7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106caa:	0f b6 14 c5 05 3c 11 	movzbl -0x7feec3fb(,%eax,8),%edx
80106cb1:	80 
80106cb2:	83 e2 f0             	and    $0xfffffff0,%edx
80106cb5:	83 ca 0e             	or     $0xe,%edx
80106cb8:	88 14 c5 05 3c 11 80 	mov    %dl,-0x7feec3fb(,%eax,8)
80106cbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cc2:	0f b6 14 c5 05 3c 11 	movzbl -0x7feec3fb(,%eax,8),%edx
80106cc9:	80 
80106cca:	83 e2 ef             	and    $0xffffffef,%edx
80106ccd:	88 14 c5 05 3c 11 80 	mov    %dl,-0x7feec3fb(,%eax,8)
80106cd4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cd7:	0f b6 14 c5 05 3c 11 	movzbl -0x7feec3fb(,%eax,8),%edx
80106cde:	80 
80106cdf:	83 e2 9f             	and    $0xffffff9f,%edx
80106ce2:	88 14 c5 05 3c 11 80 	mov    %dl,-0x7feec3fb(,%eax,8)
80106ce9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106cec:	0f b6 14 c5 05 3c 11 	movzbl -0x7feec3fb(,%eax,8),%edx
80106cf3:	80 
80106cf4:	83 ca 80             	or     $0xffffff80,%edx
80106cf7:	88 14 c5 05 3c 11 80 	mov    %dl,-0x7feec3fb(,%eax,8)
80106cfe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d01:	8b 04 85 b8 c0 10 80 	mov    -0x7fef3f48(,%eax,4),%eax
80106d08:	c1 e8 10             	shr    $0x10,%eax
80106d0b:	89 c2                	mov    %eax,%edx
80106d0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d10:	66 89 14 c5 06 3c 11 	mov    %dx,-0x7feec3fa(,%eax,8)
80106d17:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
80106d18:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106d1c:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106d23:	0f 8e 30 ff ff ff    	jle    80106c59 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106d29:	a1 b8 c1 10 80       	mov    0x8010c1b8,%eax
80106d2e:	66 a3 00 3e 11 80    	mov    %ax,0x80113e00
80106d34:	66 c7 05 02 3e 11 80 	movw   $0x8,0x80113e02
80106d3b:	08 00 
80106d3d:	0f b6 05 04 3e 11 80 	movzbl 0x80113e04,%eax
80106d44:	83 e0 e0             	and    $0xffffffe0,%eax
80106d47:	a2 04 3e 11 80       	mov    %al,0x80113e04
80106d4c:	0f b6 05 04 3e 11 80 	movzbl 0x80113e04,%eax
80106d53:	83 e0 1f             	and    $0x1f,%eax
80106d56:	a2 04 3e 11 80       	mov    %al,0x80113e04
80106d5b:	0f b6 05 05 3e 11 80 	movzbl 0x80113e05,%eax
80106d62:	83 c8 0f             	or     $0xf,%eax
80106d65:	a2 05 3e 11 80       	mov    %al,0x80113e05
80106d6a:	0f b6 05 05 3e 11 80 	movzbl 0x80113e05,%eax
80106d71:	83 e0 ef             	and    $0xffffffef,%eax
80106d74:	a2 05 3e 11 80       	mov    %al,0x80113e05
80106d79:	0f b6 05 05 3e 11 80 	movzbl 0x80113e05,%eax
80106d80:	83 c8 60             	or     $0x60,%eax
80106d83:	a2 05 3e 11 80       	mov    %al,0x80113e05
80106d88:	0f b6 05 05 3e 11 80 	movzbl 0x80113e05,%eax
80106d8f:	83 c8 80             	or     $0xffffff80,%eax
80106d92:	a2 05 3e 11 80       	mov    %al,0x80113e05
80106d97:	a1 b8 c1 10 80       	mov    0x8010c1b8,%eax
80106d9c:	c1 e8 10             	shr    $0x10,%eax
80106d9f:	66 a3 06 3e 11 80    	mov    %ax,0x80113e06
  
  initlock(&tickslock, "time");
80106da5:	c7 44 24 04 c8 8f 10 	movl   $0x80108fc8,0x4(%esp)
80106dac:	80 
80106dad:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
80106db4:	e8 dd e5 ff ff       	call   80105396 <initlock>
}
80106db9:	c9                   	leave  
80106dba:	c3                   	ret    
...
80106dbe:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106dc1:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106dc8:	00 
80106dc9:	c7 04 24 00 3c 11 80 	movl   $0x80113c00,(%esp)
80106dd0:	e8 33 fe ff ff       	call   80106c08 <lidt>
}
80106dd5:	c9                   	leave  
80106dd6:	c3                   	ret    
...
80106e35:	0f 87 bc 00 00 00    	ja     80106ef7 <trap+0x120>
80106e3b:	8b 04 85 70 90 10 80 	mov    -0x7fef6f90(,%eax,4),%eax
80106e42:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106e44:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106e4a:	0f b6 00             	movzbl (%eax),%eax
80106e4d:	84 c0                	test   %al,%al
80106e4f:	75 31                	jne    80106e82 <trap+0xab>
      acquire(&tickslock);
80106e51:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
80106e58:	e8 5a e5 ff ff       	call   801053b7 <acquire>
      ticks++;
80106e5d:	a1 00 44 11 80       	mov    0x80114400,%eax
80106e62:	83 c0 01             	add    $0x1,%eax
80106e65:	a3 00 44 11 80       	mov    %eax,0x80114400
      wakeup(&ticks);
80106e6a:	c7 04 24 00 44 11 80 	movl   $0x80114400,(%esp)
80106e71:	e8 c3 dc ff ff       	call   80104b39 <wakeup>
      release(&tickslock);
80106e76:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
80106e7d:	e8 97 e5 ff ff       	call   80105419 <release>
    }
    lapiceoi();
80106e82:	e8 62 c0 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106e87:	e9 41 01 00 00       	jmp    80106fcd <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106e8c:	e8 60 b8 ff ff       	call   801026f1 <ideintr>
    lapiceoi();
80106e91:	e8 53 c0 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106e96:	e9 32 01 00 00       	jmp    80106fcd <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106e9b:	e8 27 be ff ff       	call   80102cc7 <kbdintr>
    lapiceoi();
80106ea0:	e8 44 c0 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106ea5:	e9 23 01 00 00       	jmp    80106fcd <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106eaa:	e8 a9 03 00 00       	call   80107258 <uartintr>
    lapiceoi();
80106eaf:	e8 35 c0 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106eb4:	e9 14 01 00 00       	jmp    80106fcd <trap+0x1f6>
  case T_IRQ0 + 7:
...
80106eb9:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106ebc:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
80106ebf:	8b 45 08             	mov    0x8(%ebp),%eax
80106ec2:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106ec6:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106ec9:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
...
80106ed9:	89 54 24 08          	mov    %edx,0x8(%esp)
80106edd:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ee1:	c7 04 24 d0 8f 10 80 	movl   $0x80108fd0,(%esp)
80106ee8:	e8 b4 94 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106eed:	e8 f7 bf ff ff       	call   80102ee9 <lapiceoi>
    break;
80106ef2:	e9 d6 00 00 00       	jmp    80106fcd <trap+0x1f6>
...
80106eff:	74 11                	je     80106f12 <trap+0x13b>
80106f01:	8b 45 08             	mov    0x8(%ebp),%eax
80106f04:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106f08:	0f b7 c0             	movzwl %ax,%eax
80106f0b:	83 e0 03             	and    $0x3,%eax
80106f0e:	85 c0                	test   %eax,%eax
80106f10:	75 46                	jne    80106f58 <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106f12:	e8 1a fd ff ff       	call   80106c31 <rcr2>
              tf->trapno, cpu->id, tf->eip, rcr2());
80106f17:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106f1a:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106f1d:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106f24:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106f27:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106f2a:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106f2d:	8b 52 30             	mov    0x30(%edx),%edx
80106f30:	89 44 24 10          	mov    %eax,0x10(%esp)
80106f34:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106f38:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106f3c:	89 54 24 04          	mov    %edx,0x4(%esp)
80106f40:	c7 04 24 f4 8f 10 80 	movl   $0x80108ff4,(%esp)
80106f47:	e8 55 94 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106f4c:	c7 04 24 26 90 10 80 	movl   $0x80109026,(%esp)
80106f53:	e8 e5 95 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106f58:	e8 d4 fc ff ff       	call   80106c31 <rcr2>
...
80106f5f:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106f62:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106f65:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106f6b:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106f6e:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106f71:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106f74:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106f77:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106f7a:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106f7d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f83:	83 c0 6c             	add    $0x6c,%eax
...
80106f89:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106f8f:	8b 40 10             	mov    0x10(%eax),%eax
80106f92:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106f96:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106f9a:	89 74 24 14          	mov    %esi,0x14(%esp)
80106f9e:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106fa2:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106fa6:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106fa9:	89 54 24 08          	mov    %edx,0x8(%esp)
80106fad:	89 44 24 04          	mov    %eax,0x4(%esp)
80106fb1:	c7 04 24 2c 90 10 80 	movl   $0x8010902c,(%esp)
80106fb8:	e8 e4 93 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106fbd:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106fc3:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106fca:	eb 01                	jmp    80106fcd <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106fd5:	74 24                	je     80106ffb <trap+0x224>
80106fd7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106fdd:	8b 40 24             	mov    0x24(%eax),%eax
80106fe0:	85 c0                	test   %eax,%eax
80106fe2:	74 17                	je     80106ffb <trap+0x224>
...
80106ff1:	83 f8 03             	cmp    $0x3,%eax
80106ff4:	75 05                	jne    80106ffb <trap+0x224>
    exit();
80106ff6:	e8 ac d4 ff ff       	call   801044a7 <exit>

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(proc && proc->state == RUNNING && tf->trapno == T_IRQ0+IRQ_TIMER)
80106ffb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107001:	85 c0                	test   %eax,%eax
80107003:	74 1e                	je     80107023 <trap+0x24c>
80107005:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010700b:	8b 40 0c             	mov    0xc(%eax),%eax
8010700e:	83 f8 04             	cmp    $0x4,%eax
80107011:	75 10                	jne    80107023 <trap+0x24c>
80107013:	8b 45 08             	mov    0x8(%ebp),%eax
80107016:	8b 40 30             	mov    0x30(%eax),%eax
80107019:	83 f8 20             	cmp    $0x20,%eax
8010701c:	75 05                	jne    80107023 <trap+0x24c>
    yield();
8010701e:	e8 dc d9 ff ff       	call   801049ff <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80107023:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107029:	85 c0                	test   %eax,%eax
8010702b:	74 27                	je     80107054 <trap+0x27d>
8010702d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80107033:	8b 40 24             	mov    0x24(%eax),%eax
80107036:	85 c0                	test   %eax,%eax
80107038:	74 1a                	je     80107054 <trap+0x27d>
8010703a:	8b 45 08             	mov    0x8(%ebp),%eax
8010703d:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80107041:	0f b7 c0             	movzwl %ax,%eax
80107044:	83 e0 03             	and    $0x3,%eax
80107047:	83 f8 03             	cmp    $0x3,%eax
8010704a:	75 08                	jne    80107054 <trap+0x27d>
    exit();
8010704c:	e8 56 d4 ff ff       	call   801044a7 <exit>
80107051:	eb 01                	jmp    80107054 <trap+0x27d>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80107054:	83 c4 3c             	add    $0x3c,%esp
80107057:	5b                   	pop    %ebx
80107058:	5e                   	pop    %esi
80107059:	5f                   	pop    %edi
8010705a:	5d                   	pop    %ebp
...
80107060:	83 ec 14             	sub    $0x14,%esp
80107063:	8b 45 08             	mov    0x8(%ebp),%eax
80107066:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010706a:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
8010706e:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80107072:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
80107076:	ec                   	in     (%dx),%al
80107077:	89 c3                	mov    %eax,%ebx
80107079:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
8010707c:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80107080:	83 c4 14             	add    $0x14,%esp
80107083:	5b                   	pop    %ebx
80107084:	5d                   	pop    %ebp
80107085:	c3                   	ret    
...
80107096:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80107099:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
8010709d:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801070a1:	ee                   	out    %al,(%dx)
}
801070a2:	c9                   	leave  
801070a3:	c3                   	ret    
...
801070a7:	83 ec 28             	sub    $0x28,%esp
  char *p;

  // Turn off the FIFO
  outb(COM1+2, 0);
801070aa:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801070b1:	00 
801070b2:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801070b9:	e8 c8 ff ff ff       	call   80107086 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
801070be:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
801070c5:	00 
801070c6:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
801070cd:	e8 b4 ff ff ff       	call   80107086 <outb>
  outb(COM1+0, 115200/9600);
801070d2:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
801070d9:	00 
801070da:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801070e1:	e8 a0 ff ff ff       	call   80107086 <outb>
  outb(COM1+1, 0);
801070e6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801070ed:	00 
801070ee:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
801070f5:	e8 8c ff ff ff       	call   80107086 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
801070fa:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80107101:	00 
80107102:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80107109:	e8 78 ff ff ff       	call   80107086 <outb>
  outb(COM1+4, 0);
8010710e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107115:	00 
80107116:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
8010711d:	e8 64 ff ff ff       	call   80107086 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80107122:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80107129:	00 
8010712a:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107131:	e8 50 ff ff ff       	call   80107086 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80107136:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
8010713d:	e8 1a ff ff ff       	call   8010705c <inb>
80107142:	3c ff                	cmp    $0xff,%al
80107144:	74 6c                	je     801071b2 <uartinit+0x10e>
    return;
  uart = 1;
80107146:	c7 05 6c c6 10 80 01 	movl   $0x1,0x8010c66c
8010714d:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107150:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80107157:	e8 00 ff ff ff       	call   8010705c <inb>
  inb(COM1+0);
8010715c:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107163:	e8 f4 fe ff ff       	call   8010705c <inb>
  picenable(IRQ_COM1);
80107168:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
8010716f:	e8 4d c9 ff ff       	call   80103ac1 <picenable>
  ioapicenable(IRQ_COM1, 0);
80107174:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010717b:	00 
8010717c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107183:	e8 ee b7 ff ff       	call   80102976 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80107188:	c7 45 f4 f0 90 10 80 	movl   $0x801090f0,-0xc(%ebp)
8010718f:	eb 15                	jmp    801071a6 <uartinit+0x102>
    uartputc(*p);
80107191:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107194:	0f b6 00             	movzbl (%eax),%eax
80107197:	0f be c0             	movsbl %al,%eax
8010719a:	89 04 24             	mov    %eax,(%esp)
8010719d:	e8 13 00 00 00       	call   801071b5 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801071a2:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801071a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801071a9:	0f b6 00             	movzbl (%eax),%eax
801071ac:	84 c0                	test   %al,%al
801071ae:	75 e1                	jne    80107191 <uartinit+0xed>
801071b0:	eb 01                	jmp    801071b3 <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
801071b8:	83 ec 28             	sub    $0x28,%esp
  ...
  if(!uart)
801071bb:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
801071c0:	85 c0                	test   %eax,%eax
801071c2:	74 4d                	je     80107211 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801071c4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801071cb:	eb 10                	jmp    801071dd <uartputc+0x28>
    microdelay(10);
801071cd:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801071d4:	e8 35 bd ff ff       	call   80102f0e <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801071d9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801071dd:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801071e1:	7f 16                	jg     801071f9 <uartputc+0x44>
801071e3:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801071ea:	e8 6d fe ff ff       	call   8010705c <inb>
801071ef:	0f b6 c0             	movzbl %al,%eax
801071f2:	83 e0 20             	and    $0x20,%eax
801071f5:	85 c0                	test   %eax,%eax
801071f7:	74 d4                	je     801071cd <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
801071f9:	8b 45 08             	mov    0x8(%ebp),%eax
801071fc:	0f b6 c0             	movzbl %al,%eax
801071ff:	89 44 24 04          	mov    %eax,0x4(%esp)
80107203:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010720a:	e8 77 fe ff ff       	call   80107086 <outb>
8010720f:	eb 01                	jmp    80107212 <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
80107217:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
8010721a:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
8010721f:	85 c0                	test   %eax,%eax
80107221:	75 07                	jne    8010722a <uartgetc+0x16>
    return -1;
80107223:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107228:	eb 2c                	jmp    80107256 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
8010722a:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107231:	e8 26 fe ff ff       	call   8010705c <inb>
80107236:	0f b6 c0             	movzbl %al,%eax
80107239:	83 e0 01             	and    $0x1,%eax
8010723c:	85 c0                	test   %eax,%eax
8010723e:	75 07                	jne    80107247 <uartgetc+0x33>
    return -1;
80107240:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107245:	eb 0f                	jmp    80107256 <uartgetc+0x42>
  return inb(COM1+0);
80107247:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010724e:	e8 09 fe ff ff       	call   8010705c <inb>
...
8010725b:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
8010725e:	c7 04 24 14 72 10 80 	movl   $0x80107214,(%esp)
80107265:	e8 43 95 ff ff       	call   801007ad <consoleintr>
}
8010726a:	c9                   	leave  
8010726b:	c3                   	ret    
...
8010726e:	6a 00                	push   $0x0
  jmp alltraps
80107270:	e9 67 f9 ff ff       	jmp    80106bdc <alltraps>
...
80107275:	6a 00                	push   $0x0
  pushl $1
80107277:	6a 01                	push   $0x1
  jmp alltraps
80107279:	e9 5e f9 ff ff       	jmp    80106bdc <alltraps>
...
8010727e:	6a 00                	push   $0x0
  pushl $2
80107280:	6a 02                	push   $0x2
  jmp alltraps
80107282:	e9 55 f9 ff ff       	jmp    80106bdc <alltraps>
...
80107287:	6a 00                	push   $0x0
  pushl $3
80107289:	6a 03                	push   $0x3
  jmp alltraps
8010728b:	e9 4c f9 ff ff       	jmp    80106bdc <alltraps>
...
80107290:	6a 00                	push   $0x0
  pushl $4
80107292:	6a 04                	push   $0x4
  jmp alltraps
80107294:	e9 43 f9 ff ff       	jmp    80106bdc <alltraps>
...
80107299:	6a 00                	push   $0x0
  pushl $5
8010729b:	6a 05                	push   $0x5
  jmp alltraps
8010729d:	e9 3a f9 ff ff       	jmp    80106bdc <alltraps>
...
801072a2:	6a 00                	push   $0x0
  pushl $6
801072a4:	6a 06                	push   $0x6
  jmp alltraps
801072a6:	e9 31 f9 ff ff       	jmp    80106bdc <alltraps>
...
801072ab:	6a 00                	push   $0x0
  pushl $7
801072ad:	6a 07                	push   $0x7
  jmp alltraps
801072af:	e9 28 f9 ff ff       	jmp    80106bdc <alltraps>

801072b4 <vector8>:
.globl vector8
vector8:
  pushl $8
801072b4:	6a 08                	push   $0x8
  jmp alltraps
801072b6:	e9 21 f9 ff ff       	jmp    80106bdc <alltraps>
...
801072bb:	6a 00                	push   $0x0
  pushl $9
801072bd:	6a 09                	push   $0x9
  jmp alltraps
801072bf:	e9 18 f9 ff ff       	jmp    80106bdc <alltraps>

801072c4 <vector10>:
.globl vector10
vector10:
  pushl $10
801072c4:	6a 0a                	push   $0xa
  jmp alltraps
801072c6:	e9 11 f9 ff ff       	jmp    80106bdc <alltraps>

801072cb <vector11>:
.globl vector11
vector11:
  pushl $11
801072cb:	6a 0b                	push   $0xb
  jmp alltraps
801072cd:	e9 0a f9 ff ff       	jmp    80106bdc <alltraps>

801072d2 <vector12>:
.globl vector12
vector12:
  pushl $12
801072d2:	6a 0c                	push   $0xc
  jmp alltraps
801072d4:	e9 03 f9 ff ff       	jmp    80106bdc <alltraps>

801072d9 <vector13>:
.globl vector13
vector13:
  pushl $13
801072d9:	6a 0d                	push   $0xd
  jmp alltraps
801072db:	e9 fc f8 ff ff       	jmp    80106bdc <alltraps>

801072e0 <vector14>:
.globl vector14
vector14:
  pushl $14
801072e0:	6a 0e                	push   $0xe
  jmp alltraps
801072e2:	e9 f5 f8 ff ff       	jmp    80106bdc <alltraps>
...
801072e7:	6a 00                	push   $0x0
  pushl $15
801072e9:	6a 0f                	push   $0xf
  jmp alltraps
801072eb:	e9 ec f8 ff ff       	jmp    80106bdc <alltraps>
...
801072f0:	6a 00                	push   $0x0
  pushl $16
801072f2:	6a 10                	push   $0x10
  jmp alltraps
801072f4:	e9 e3 f8 ff ff       	jmp    80106bdc <alltraps>

801072f9 <vector17>:
.globl vector17
vector17:
  pushl $17
801072f9:	6a 11                	push   $0x11
  jmp alltraps
801072fb:	e9 dc f8 ff ff       	jmp    80106bdc <alltraps>
...
80107300:	6a 00                	push   $0x0
  pushl $18
80107302:	6a 12                	push   $0x12
  jmp alltraps
80107304:	e9 d3 f8 ff ff       	jmp    80106bdc <alltraps>
...
80107309:	6a 00                	push   $0x0
  pushl $19
8010730b:	6a 13                	push   $0x13
  jmp alltraps
8010730d:	e9 ca f8 ff ff       	jmp    80106bdc <alltraps>
...
80107312:	6a 00                	push   $0x0
  pushl $20
80107314:	6a 14                	push   $0x14
  jmp alltraps
80107316:	e9 c1 f8 ff ff       	jmp    80106bdc <alltraps>
...
8010731b:	6a 00                	push   $0x0
  pushl $21
8010731d:	6a 15                	push   $0x15
  jmp alltraps
8010731f:	e9 b8 f8 ff ff       	jmp    80106bdc <alltraps>
...
80107324:	6a 00                	push   $0x0
  pushl $22
80107326:	6a 16                	push   $0x16
  jmp alltraps
80107328:	e9 af f8 ff ff       	jmp    80106bdc <alltraps>
...
8010732d:	6a 00                	push   $0x0
  pushl $23
8010732f:	6a 17                	push   $0x17
  jmp alltraps
80107331:	e9 a6 f8 ff ff       	jmp    80106bdc <alltraps>
...
80107336:	6a 00                	push   $0x0
  pushl $24
80107338:	6a 18                	push   $0x18
  jmp alltraps
8010733a:	e9 9d f8 ff ff       	jmp    80106bdc <alltraps>
...
8010733f:	6a 00                	push   $0x0
  pushl $25
80107341:	6a 19                	push   $0x19
  jmp alltraps
80107343:	e9 94 f8 ff ff       	jmp    80106bdc <alltraps>
...
80107348:	6a 00                	push   $0x0
  pushl $26
8010734a:	6a 1a                	push   $0x1a
  jmp alltraps
8010734c:	e9 8b f8 ff ff       	jmp    80106bdc <alltraps>
...
80107351:	6a 00                	push   $0x0
  pushl $27
80107353:	6a 1b                	push   $0x1b
  jmp alltraps
80107355:	e9 82 f8 ff ff       	jmp    80106bdc <alltraps>
...
8010735a:	6a 00                	push   $0x0
  pushl $28
8010735c:	6a 1c                	push   $0x1c
  jmp alltraps
8010735e:	e9 79 f8 ff ff       	jmp    80106bdc <alltraps>
...
80107363:	6a 00                	push   $0x0
  pushl $29
80107365:	6a 1d                	push   $0x1d
  jmp alltraps
80107367:	e9 70 f8 ff ff       	jmp    80106bdc <alltraps>
...
8010736c:	6a 00                	push   $0x0
  pushl $30
8010736e:	6a 1e                	push   $0x1e
  jmp alltraps
80107370:	e9 67 f8 ff ff       	jmp    80106bdc <alltraps>
...
80107375:	6a 00                	push   $0x0
  pushl $31
80107377:	6a 1f                	push   $0x1f
  jmp alltraps
80107379:	e9 5e f8 ff ff       	jmp    80106bdc <alltraps>
...
8010737e:	6a 00                	push   $0x0
  pushl $32
80107380:	6a 20                	push   $0x20
  jmp alltraps
80107382:	e9 55 f8 ff ff       	jmp    80106bdc <alltraps>
...
80107387:	6a 00                	push   $0x0
  pushl $33
80107389:	6a 21                	push   $0x21
  jmp alltraps
8010738b:	e9 4c f8 ff ff       	jmp    80106bdc <alltraps>
...
80107390:	6a 00                	push   $0x0
  pushl $34
80107392:	6a 22                	push   $0x22
  jmp alltraps
80107394:	e9 43 f8 ff ff       	jmp    80106bdc <alltraps>
...
80107399:	6a 00                	push   $0x0
  pushl $35
8010739b:	6a 23                	push   $0x23
  jmp alltraps
8010739d:	e9 3a f8 ff ff       	jmp    80106bdc <alltraps>
...
801073a2:	6a 00                	push   $0x0
  pushl $36
801073a4:	6a 24                	push   $0x24
  jmp alltraps
801073a6:	e9 31 f8 ff ff       	jmp    80106bdc <alltraps>
...
801073ab:	6a 00                	push   $0x0
  pushl $37
801073ad:	6a 25                	push   $0x25
  jmp alltraps
801073af:	e9 28 f8 ff ff       	jmp    80106bdc <alltraps>
...
801073b4:	6a 00                	push   $0x0
  pushl $38
801073b6:	6a 26                	push   $0x26
  jmp alltraps
801073b8:	e9 1f f8 ff ff       	jmp    80106bdc <alltraps>
...
801073bd:	6a 00                	push   $0x0
  pushl $39
801073bf:	6a 27                	push   $0x27
  jmp alltraps
801073c1:	e9 16 f8 ff ff       	jmp    80106bdc <alltraps>
...
801073c6:	6a 00                	push   $0x0
  pushl $40
801073c8:	6a 28                	push   $0x28
  jmp alltraps
801073ca:	e9 0d f8 ff ff       	jmp    80106bdc <alltraps>
...
801073cf:	6a 00                	push   $0x0
  pushl $41
801073d1:	6a 29                	push   $0x29
  jmp alltraps
801073d3:	e9 04 f8 ff ff       	jmp    80106bdc <alltraps>
...
801073d8:	6a 00                	push   $0x0
  pushl $42
801073da:	6a 2a                	push   $0x2a
  jmp alltraps
801073dc:	e9 fb f7 ff ff       	jmp    80106bdc <alltraps>
...
801073e1:	6a 00                	push   $0x0
  pushl $43
801073e3:	6a 2b                	push   $0x2b
  jmp alltraps
801073e5:	e9 f2 f7 ff ff       	jmp    80106bdc <alltraps>
...
801073ea:	6a 00                	push   $0x0
  pushl $44
801073ec:	6a 2c                	push   $0x2c
  jmp alltraps
801073ee:	e9 e9 f7 ff ff       	jmp    80106bdc <alltraps>
...
801073f3:	6a 00                	push   $0x0
  pushl $45
801073f5:	6a 2d                	push   $0x2d
  jmp alltraps
801073f7:	e9 e0 f7 ff ff       	jmp    80106bdc <alltraps>
...
801073fc:	6a 00                	push   $0x0
  pushl $46
801073fe:	6a 2e                	push   $0x2e
  jmp alltraps
80107400:	e9 d7 f7 ff ff       	jmp    80106bdc <alltraps>
...
80107405:	6a 00                	push   $0x0
  pushl $47
80107407:	6a 2f                	push   $0x2f
  jmp alltraps
80107409:	e9 ce f7 ff ff       	jmp    80106bdc <alltraps>
...
8010740e:	6a 00                	push   $0x0
  pushl $48
80107410:	6a 30                	push   $0x30
  jmp alltraps
80107412:	e9 c5 f7 ff ff       	jmp    80106bdc <alltraps>
...
80107417:	6a 00                	push   $0x0
  pushl $49
80107419:	6a 31                	push   $0x31
  jmp alltraps
8010741b:	e9 bc f7 ff ff       	jmp    80106bdc <alltraps>
...
80107420:	6a 00                	push   $0x0
  pushl $50
80107422:	6a 32                	push   $0x32
  jmp alltraps
80107424:	e9 b3 f7 ff ff       	jmp    80106bdc <alltraps>
...
80107429:	6a 00                	push   $0x0
  pushl $51
8010742b:	6a 33                	push   $0x33
  jmp alltraps
8010742d:	e9 aa f7 ff ff       	jmp    80106bdc <alltraps>
...
80107432:	6a 00                	push   $0x0
  pushl $52
80107434:	6a 34                	push   $0x34
  jmp alltraps
80107436:	e9 a1 f7 ff ff       	jmp    80106bdc <alltraps>
...
8010743b:	6a 00                	push   $0x0
  pushl $53
8010743d:	6a 35                	push   $0x35
  jmp alltraps
8010743f:	e9 98 f7 ff ff       	jmp    80106bdc <alltraps>
...
80107444:	6a 00                	push   $0x0
  pushl $54
80107446:	6a 36                	push   $0x36
  jmp alltraps
80107448:	e9 8f f7 ff ff       	jmp    80106bdc <alltraps>
...
8010744d:	6a 00                	push   $0x0
  pushl $55
8010744f:	6a 37                	push   $0x37
  jmp alltraps
80107451:	e9 86 f7 ff ff       	jmp    80106bdc <alltraps>
...
80107456:	6a 00                	push   $0x0
  pushl $56
80107458:	6a 38                	push   $0x38
  jmp alltraps
8010745a:	e9 7d f7 ff ff       	jmp    80106bdc <alltraps>
...
8010745f:	6a 00                	push   $0x0
  pushl $57
80107461:	6a 39                	push   $0x39
  jmp alltraps
80107463:	e9 74 f7 ff ff       	jmp    80106bdc <alltraps>
...
80107468:	6a 00                	push   $0x0
  pushl $58
8010746a:	6a 3a                	push   $0x3a
  jmp alltraps
8010746c:	e9 6b f7 ff ff       	jmp    80106bdc <alltraps>
...
80107471:	6a 00                	push   $0x0
  pushl $59
80107473:	6a 3b                	push   $0x3b
  jmp alltraps
80107475:	e9 62 f7 ff ff       	jmp    80106bdc <alltraps>
...
8010747a:	6a 00                	push   $0x0
  pushl $60
8010747c:	6a 3c                	push   $0x3c
  jmp alltraps
8010747e:	e9 59 f7 ff ff       	jmp    80106bdc <alltraps>
...
80107483:	6a 00                	push   $0x0
  pushl $61
80107485:	6a 3d                	push   $0x3d
  jmp alltraps
80107487:	e9 50 f7 ff ff       	jmp    80106bdc <alltraps>
...
8010748c:	6a 00                	push   $0x0
  pushl $62
8010748e:	6a 3e                	push   $0x3e
  jmp alltraps
80107490:	e9 47 f7 ff ff       	jmp    80106bdc <alltraps>
...
80107495:	6a 00                	push   $0x0
  pushl $63
80107497:	6a 3f                	push   $0x3f
  jmp alltraps
80107499:	e9 3e f7 ff ff       	jmp    80106bdc <alltraps>
...
8010749e:	6a 00                	push   $0x0
  pushl $64
801074a0:	6a 40                	push   $0x40
  jmp alltraps
801074a2:	e9 35 f7 ff ff       	jmp    80106bdc <alltraps>
...
801074a7:	6a 00                	push   $0x0
  pushl $65
801074a9:	6a 41                	push   $0x41
  jmp alltraps
801074ab:	e9 2c f7 ff ff       	jmp    80106bdc <alltraps>
...
801074b0:	6a 00                	push   $0x0
  pushl $66
801074b2:	6a 42                	push   $0x42
  jmp alltraps
801074b4:	e9 23 f7 ff ff       	jmp    80106bdc <alltraps>
...
801074b9:	6a 00                	push   $0x0
  pushl $67
801074bb:	6a 43                	push   $0x43
  jmp alltraps
801074bd:	e9 1a f7 ff ff       	jmp    80106bdc <alltraps>
...
801074c2:	6a 00                	push   $0x0
  pushl $68
801074c4:	6a 44                	push   $0x44
  jmp alltraps
801074c6:	e9 11 f7 ff ff       	jmp    80106bdc <alltraps>
...
801074cb:	6a 00                	push   $0x0
  pushl $69
801074cd:	6a 45                	push   $0x45
  jmp alltraps
801074cf:	e9 08 f7 ff ff       	jmp    80106bdc <alltraps>
...
801074d4:	6a 00                	push   $0x0
  pushl $70
801074d6:	6a 46                	push   $0x46
  jmp alltraps
801074d8:	e9 ff f6 ff ff       	jmp    80106bdc <alltraps>
...
801074dd:	6a 00                	push   $0x0
  pushl $71
801074df:	6a 47                	push   $0x47
  jmp alltraps
801074e1:	e9 f6 f6 ff ff       	jmp    80106bdc <alltraps>
...
801074e6:	6a 00                	push   $0x0
  pushl $72
801074e8:	6a 48                	push   $0x48
  jmp alltraps
801074ea:	e9 ed f6 ff ff       	jmp    80106bdc <alltraps>
...
801074ef:	6a 00                	push   $0x0
  pushl $73
801074f1:	6a 49                	push   $0x49
  jmp alltraps
801074f3:	e9 e4 f6 ff ff       	jmp    80106bdc <alltraps>
...
801074f8:	6a 00                	push   $0x0
  pushl $74
801074fa:	6a 4a                	push   $0x4a
  jmp alltraps
801074fc:	e9 db f6 ff ff       	jmp    80106bdc <alltraps>
...
80107501:	6a 00                	push   $0x0
  pushl $75
80107503:	6a 4b                	push   $0x4b
  jmp alltraps
80107505:	e9 d2 f6 ff ff       	jmp    80106bdc <alltraps>
...
8010750a:	6a 00                	push   $0x0
  pushl $76
8010750c:	6a 4c                	push   $0x4c
  jmp alltraps
8010750e:	e9 c9 f6 ff ff       	jmp    80106bdc <alltraps>
...
80107513:	6a 00                	push   $0x0
  pushl $77
80107515:	6a 4d                	push   $0x4d
  jmp alltraps
80107517:	e9 c0 f6 ff ff       	jmp    80106bdc <alltraps>
...
8010751c:	6a 00                	push   $0x0
  pushl $78
8010751e:	6a 4e                	push   $0x4e
  jmp alltraps
80107520:	e9 b7 f6 ff ff       	jmp    80106bdc <alltraps>
...
80107525:	6a 00                	push   $0x0
  pushl $79
80107527:	6a 4f                	push   $0x4f
  jmp alltraps
80107529:	e9 ae f6 ff ff       	jmp    80106bdc <alltraps>
...
8010752e:	6a 00                	push   $0x0
  pushl $80
80107530:	6a 50                	push   $0x50
  jmp alltraps
80107532:	e9 a5 f6 ff ff       	jmp    80106bdc <alltraps>
...
80107537:	6a 00                	push   $0x0
  pushl $81
80107539:	6a 51                	push   $0x51
  jmp alltraps
8010753b:	e9 9c f6 ff ff       	jmp    80106bdc <alltraps>
...
80107540:	6a 00                	push   $0x0
  pushl $82
80107542:	6a 52                	push   $0x52
  jmp alltraps
80107544:	e9 93 f6 ff ff       	jmp    80106bdc <alltraps>
...
80107549:	6a 00                	push   $0x0
  pushl $83
8010754b:	6a 53                	push   $0x53
  jmp alltraps
8010754d:	e9 8a f6 ff ff       	jmp    80106bdc <alltraps>
...
80107552:	6a 00                	push   $0x0
  pushl $84
80107554:	6a 54                	push   $0x54
  jmp alltraps
80107556:	e9 81 f6 ff ff       	jmp    80106bdc <alltraps>
...
8010755b:	6a 00                	push   $0x0
  pushl $85
8010755d:	6a 55                	push   $0x55
  jmp alltraps
8010755f:	e9 78 f6 ff ff       	jmp    80106bdc <alltraps>
...
80107564:	6a 00                	push   $0x0
  pushl $86
80107566:	6a 56                	push   $0x56
  jmp alltraps
80107568:	e9 6f f6 ff ff       	jmp    80106bdc <alltraps>
...
8010756d:	6a 00                	push   $0x0
  pushl $87
8010756f:	6a 57                	push   $0x57
  jmp alltraps
80107571:	e9 66 f6 ff ff       	jmp    80106bdc <alltraps>
...
80107576:	6a 00                	push   $0x0
  pushl $88
80107578:	6a 58                	push   $0x58
  jmp alltraps
8010757a:	e9 5d f6 ff ff       	jmp    80106bdc <alltraps>
...
8010757f:	6a 00                	push   $0x0
  pushl $89
80107581:	6a 59                	push   $0x59
  jmp alltraps
80107583:	e9 54 f6 ff ff       	jmp    80106bdc <alltraps>
...
80107588:	6a 00                	push   $0x0
  pushl $90
8010758a:	6a 5a                	push   $0x5a
  jmp alltraps
8010758c:	e9 4b f6 ff ff       	jmp    80106bdc <alltraps>
...
80107591:	6a 00                	push   $0x0
  pushl $91
80107593:	6a 5b                	push   $0x5b
  jmp alltraps
80107595:	e9 42 f6 ff ff       	jmp    80106bdc <alltraps>
...
8010759a:	6a 00                	push   $0x0
  pushl $92
8010759c:	6a 5c                	push   $0x5c
  jmp alltraps
8010759e:	e9 39 f6 ff ff       	jmp    80106bdc <alltraps>
...
801075a3:	6a 00                	push   $0x0
  pushl $93
801075a5:	6a 5d                	push   $0x5d
  jmp alltraps
801075a7:	e9 30 f6 ff ff       	jmp    80106bdc <alltraps>
...
801075ac:	6a 00                	push   $0x0
  pushl $94
801075ae:	6a 5e                	push   $0x5e
  jmp alltraps
801075b0:	e9 27 f6 ff ff       	jmp    80106bdc <alltraps>
...
801075b5:	6a 00                	push   $0x0
  pushl $95
801075b7:	6a 5f                	push   $0x5f
  jmp alltraps
801075b9:	e9 1e f6 ff ff       	jmp    80106bdc <alltraps>
...
801075be:	6a 00                	push   $0x0
  pushl $96
801075c0:	6a 60                	push   $0x60
  jmp alltraps
801075c2:	e9 15 f6 ff ff       	jmp    80106bdc <alltraps>
...
801075c7:	6a 00                	push   $0x0
  pushl $97
801075c9:	6a 61                	push   $0x61
  jmp alltraps
801075cb:	e9 0c f6 ff ff       	jmp    80106bdc <alltraps>
...
801075d0:	6a 00                	push   $0x0
  pushl $98
801075d2:	6a 62                	push   $0x62
  jmp alltraps
801075d4:	e9 03 f6 ff ff       	jmp    80106bdc <alltraps>
...
801075d9:	6a 00                	push   $0x0
  pushl $99
801075db:	6a 63                	push   $0x63
  jmp alltraps
801075dd:	e9 fa f5 ff ff       	jmp    80106bdc <alltraps>
...
801075e2:	6a 00                	push   $0x0
  pushl $100
801075e4:	6a 64                	push   $0x64
  jmp alltraps
801075e6:	e9 f1 f5 ff ff       	jmp    80106bdc <alltraps>
...
801075eb:	6a 00                	push   $0x0
  pushl $101
801075ed:	6a 65                	push   $0x65
  jmp alltraps
801075ef:	e9 e8 f5 ff ff       	jmp    80106bdc <alltraps>
...
801075f4:	6a 00                	push   $0x0
  pushl $102
801075f6:	6a 66                	push   $0x66
  jmp alltraps
801075f8:	e9 df f5 ff ff       	jmp    80106bdc <alltraps>
...
801075fd:	6a 00                	push   $0x0
  pushl $103
801075ff:	6a 67                	push   $0x67
  jmp alltraps
80107601:	e9 d6 f5 ff ff       	jmp    80106bdc <alltraps>
...
80107606:	6a 00                	push   $0x0
  pushl $104
80107608:	6a 68                	push   $0x68
  jmp alltraps
8010760a:	e9 cd f5 ff ff       	jmp    80106bdc <alltraps>
...
8010760f:	6a 00                	push   $0x0
  pushl $105
80107611:	6a 69                	push   $0x69
  jmp alltraps
80107613:	e9 c4 f5 ff ff       	jmp    80106bdc <alltraps>
...
80107618:	6a 00                	push   $0x0
  pushl $106
8010761a:	6a 6a                	push   $0x6a
  jmp alltraps
8010761c:	e9 bb f5 ff ff       	jmp    80106bdc <alltraps>
...
80107621:	6a 00                	push   $0x0
  pushl $107
80107623:	6a 6b                	push   $0x6b
  jmp alltraps
80107625:	e9 b2 f5 ff ff       	jmp    80106bdc <alltraps>
...
8010762a:	6a 00                	push   $0x0
  pushl $108
8010762c:	6a 6c                	push   $0x6c
  jmp alltraps
8010762e:	e9 a9 f5 ff ff       	jmp    80106bdc <alltraps>
...
80107633:	6a 00                	push   $0x0
  pushl $109
80107635:	6a 6d                	push   $0x6d
  jmp alltraps
80107637:	e9 a0 f5 ff ff       	jmp    80106bdc <alltraps>
...
8010763c:	6a 00                	push   $0x0
  pushl $110
8010763e:	6a 6e                	push   $0x6e
  jmp alltraps
80107640:	e9 97 f5 ff ff       	jmp    80106bdc <alltraps>
...
80107645:	6a 00                	push   $0x0
  pushl $111
80107647:	6a 6f                	push   $0x6f
  jmp alltraps
80107649:	e9 8e f5 ff ff       	jmp    80106bdc <alltraps>
...
8010764e:	6a 00                	push   $0x0
  pushl $112
80107650:	6a 70                	push   $0x70
  jmp alltraps
80107652:	e9 85 f5 ff ff       	jmp    80106bdc <alltraps>
...
80107657:	6a 00                	push   $0x0
  pushl $113
80107659:	6a 71                	push   $0x71
  jmp alltraps
8010765b:	e9 7c f5 ff ff       	jmp    80106bdc <alltraps>
...
80107660:	6a 00                	push   $0x0
  pushl $114
80107662:	6a 72                	push   $0x72
  jmp alltraps
80107664:	e9 73 f5 ff ff       	jmp    80106bdc <alltraps>
...
80107669:	6a 00                	push   $0x0
  pushl $115
8010766b:	6a 73                	push   $0x73
  jmp alltraps
8010766d:	e9 6a f5 ff ff       	jmp    80106bdc <alltraps>
...
80107672:	6a 00                	push   $0x0
  pushl $116
80107674:	6a 74                	push   $0x74
  jmp alltraps
80107676:	e9 61 f5 ff ff       	jmp    80106bdc <alltraps>
...
8010767b:	6a 00                	push   $0x0
  pushl $117
8010767d:	6a 75                	push   $0x75
  jmp alltraps
8010767f:	e9 58 f5 ff ff       	jmp    80106bdc <alltraps>
...
80107684:	6a 00                	push   $0x0
  pushl $118
80107686:	6a 76                	push   $0x76
  jmp alltraps
80107688:	e9 4f f5 ff ff       	jmp    80106bdc <alltraps>
...
8010768d:	6a 00                	push   $0x0
  pushl $119
8010768f:	6a 77                	push   $0x77
  jmp alltraps
80107691:	e9 46 f5 ff ff       	jmp    80106bdc <alltraps>
...
80107696:	6a 00                	push   $0x0
  pushl $120
80107698:	6a 78                	push   $0x78
  jmp alltraps
8010769a:	e9 3d f5 ff ff       	jmp    80106bdc <alltraps>
...
8010769f:	6a 00                	push   $0x0
  pushl $121
801076a1:	6a 79                	push   $0x79
  jmp alltraps
801076a3:	e9 34 f5 ff ff       	jmp    80106bdc <alltraps>
...
801076a8:	6a 00                	push   $0x0
  pushl $122
801076aa:	6a 7a                	push   $0x7a
  jmp alltraps
801076ac:	e9 2b f5 ff ff       	jmp    80106bdc <alltraps>
...
801076b1:	6a 00                	push   $0x0
  pushl $123
801076b3:	6a 7b                	push   $0x7b
  jmp alltraps
801076b5:	e9 22 f5 ff ff       	jmp    80106bdc <alltraps>
...
801076ba:	6a 00                	push   $0x0
  pushl $124
801076bc:	6a 7c                	push   $0x7c
  jmp alltraps
801076be:	e9 19 f5 ff ff       	jmp    80106bdc <alltraps>
...
801076c3:	6a 00                	push   $0x0
  pushl $125
801076c5:	6a 7d                	push   $0x7d
  jmp alltraps
801076c7:	e9 10 f5 ff ff       	jmp    80106bdc <alltraps>
...
801076cc:	6a 00                	push   $0x0
  pushl $126
801076ce:	6a 7e                	push   $0x7e
  jmp alltraps
801076d0:	e9 07 f5 ff ff       	jmp    80106bdc <alltraps>
...
801076d5:	6a 00                	push   $0x0
  pushl $127
801076d7:	6a 7f                	push   $0x7f
  jmp alltraps
801076d9:	e9 fe f4 ff ff       	jmp    80106bdc <alltraps>
...
801076de:	6a 00                	push   $0x0
  pushl $128
801076e0:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801076e5:	e9 f2 f4 ff ff       	jmp    80106bdc <alltraps>
...
801076ea:	6a 00                	push   $0x0
  pushl $129
801076ec:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801076f1:	e9 e6 f4 ff ff       	jmp    80106bdc <alltraps>
...
801076f6:	6a 00                	push   $0x0
  pushl $130
801076f8:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801076fd:	e9 da f4 ff ff       	jmp    80106bdc <alltraps>
...
80107702:	6a 00                	push   $0x0
  pushl $131
80107704:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107709:	e9 ce f4 ff ff       	jmp    80106bdc <alltraps>
...
8010770e:	6a 00                	push   $0x0
  pushl $132
80107710:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107715:	e9 c2 f4 ff ff       	jmp    80106bdc <alltraps>
...
8010771a:	6a 00                	push   $0x0
  pushl $133
8010771c:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107721:	e9 b6 f4 ff ff       	jmp    80106bdc <alltraps>
...
80107726:	6a 00                	push   $0x0
  pushl $134
80107728:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010772d:	e9 aa f4 ff ff       	jmp    80106bdc <alltraps>
...
80107732:	6a 00                	push   $0x0
  pushl $135
80107734:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107739:	e9 9e f4 ff ff       	jmp    80106bdc <alltraps>
...
8010773e:	6a 00                	push   $0x0
  pushl $136
80107740:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107745:	e9 92 f4 ff ff       	jmp    80106bdc <alltraps>
...
8010774a:	6a 00                	push   $0x0
  pushl $137
8010774c:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107751:	e9 86 f4 ff ff       	jmp    80106bdc <alltraps>
...
80107756:	6a 00                	push   $0x0
  pushl $138
80107758:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010775d:	e9 7a f4 ff ff       	jmp    80106bdc <alltraps>
...
80107762:	6a 00                	push   $0x0
  pushl $139
80107764:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107769:	e9 6e f4 ff ff       	jmp    80106bdc <alltraps>
...
8010776e:	6a 00                	push   $0x0
  pushl $140
80107770:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107775:	e9 62 f4 ff ff       	jmp    80106bdc <alltraps>
...
8010777a:	6a 00                	push   $0x0
  pushl $141
8010777c:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107781:	e9 56 f4 ff ff       	jmp    80106bdc <alltraps>
...
80107786:	6a 00                	push   $0x0
  pushl $142
80107788:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010778d:	e9 4a f4 ff ff       	jmp    80106bdc <alltraps>
...
80107792:	6a 00                	push   $0x0
  pushl $143
80107794:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107799:	e9 3e f4 ff ff       	jmp    80106bdc <alltraps>
...
8010779e:	6a 00                	push   $0x0
  pushl $144
801077a0:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801077a5:	e9 32 f4 ff ff       	jmp    80106bdc <alltraps>
...
801077aa:	6a 00                	push   $0x0
  pushl $145
801077ac:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801077b1:	e9 26 f4 ff ff       	jmp    80106bdc <alltraps>
...
801077b6:	6a 00                	push   $0x0
  pushl $146
801077b8:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801077bd:	e9 1a f4 ff ff       	jmp    80106bdc <alltraps>
...
801077c2:	6a 00                	push   $0x0
  pushl $147
801077c4:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801077c9:	e9 0e f4 ff ff       	jmp    80106bdc <alltraps>
...
801077ce:	6a 00                	push   $0x0
  pushl $148
801077d0:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801077d5:	e9 02 f4 ff ff       	jmp    80106bdc <alltraps>
...
801077da:	6a 00                	push   $0x0
  pushl $149
801077dc:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801077e1:	e9 f6 f3 ff ff       	jmp    80106bdc <alltraps>
...
801077e6:	6a 00                	push   $0x0
  pushl $150
801077e8:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801077ed:	e9 ea f3 ff ff       	jmp    80106bdc <alltraps>
...
801077f2:	6a 00                	push   $0x0
  pushl $151
801077f4:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801077f9:	e9 de f3 ff ff       	jmp    80106bdc <alltraps>
...
801077fe:	6a 00                	push   $0x0
  pushl $152
80107800:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107805:	e9 d2 f3 ff ff       	jmp    80106bdc <alltraps>
...
8010780a:	6a 00                	push   $0x0
  pushl $153
8010780c:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107811:	e9 c6 f3 ff ff       	jmp    80106bdc <alltraps>
...
80107816:	6a 00                	push   $0x0
  pushl $154
80107818:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010781d:	e9 ba f3 ff ff       	jmp    80106bdc <alltraps>
...
80107822:	6a 00                	push   $0x0
  pushl $155
80107824:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107829:	e9 ae f3 ff ff       	jmp    80106bdc <alltraps>
...
8010782e:	6a 00                	push   $0x0
  pushl $156
80107830:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107835:	e9 a2 f3 ff ff       	jmp    80106bdc <alltraps>
...
8010783a:	6a 00                	push   $0x0
  pushl $157
8010783c:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107841:	e9 96 f3 ff ff       	jmp    80106bdc <alltraps>
...
80107846:	6a 00                	push   $0x0
  pushl $158
80107848:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010784d:	e9 8a f3 ff ff       	jmp    80106bdc <alltraps>
...
80107852:	6a 00                	push   $0x0
  pushl $159
80107854:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107859:	e9 7e f3 ff ff       	jmp    80106bdc <alltraps>
...
8010785e:	6a 00                	push   $0x0
  pushl $160
80107860:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107865:	e9 72 f3 ff ff       	jmp    80106bdc <alltraps>
...
8010786a:	6a 00                	push   $0x0
  pushl $161
8010786c:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107871:	e9 66 f3 ff ff       	jmp    80106bdc <alltraps>
...
80107876:	6a 00                	push   $0x0
  pushl $162
80107878:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010787d:	e9 5a f3 ff ff       	jmp    80106bdc <alltraps>
...
80107882:	6a 00                	push   $0x0
  pushl $163
80107884:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107889:	e9 4e f3 ff ff       	jmp    80106bdc <alltraps>
...
8010788e:	6a 00                	push   $0x0
  pushl $164
80107890:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107895:	e9 42 f3 ff ff       	jmp    80106bdc <alltraps>
...
8010789a:	6a 00                	push   $0x0
  pushl $165
8010789c:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801078a1:	e9 36 f3 ff ff       	jmp    80106bdc <alltraps>
...
801078a6:	6a 00                	push   $0x0
  pushl $166
801078a8:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801078ad:	e9 2a f3 ff ff       	jmp    80106bdc <alltraps>
...
801078b2:	6a 00                	push   $0x0
  pushl $167
801078b4:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801078b9:	e9 1e f3 ff ff       	jmp    80106bdc <alltraps>
...
801078be:	6a 00                	push   $0x0
  pushl $168
801078c0:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801078c5:	e9 12 f3 ff ff       	jmp    80106bdc <alltraps>
...
801078ca:	6a 00                	push   $0x0
  pushl $169
801078cc:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801078d1:	e9 06 f3 ff ff       	jmp    80106bdc <alltraps>
...
801078d6:	6a 00                	push   $0x0
  pushl $170
801078d8:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801078dd:	e9 fa f2 ff ff       	jmp    80106bdc <alltraps>
...
801078e2:	6a 00                	push   $0x0
  pushl $171
801078e4:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801078e9:	e9 ee f2 ff ff       	jmp    80106bdc <alltraps>
...
801078ee:	6a 00                	push   $0x0
  pushl $172
801078f0:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801078f5:	e9 e2 f2 ff ff       	jmp    80106bdc <alltraps>
...
801078fa:	6a 00                	push   $0x0
  pushl $173
801078fc:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107901:	e9 d6 f2 ff ff       	jmp    80106bdc <alltraps>
...
80107906:	6a 00                	push   $0x0
  pushl $174
80107908:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010790d:	e9 ca f2 ff ff       	jmp    80106bdc <alltraps>
...
80107912:	6a 00                	push   $0x0
  pushl $175
80107914:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107919:	e9 be f2 ff ff       	jmp    80106bdc <alltraps>
...
8010791e:	6a 00                	push   $0x0
  pushl $176
80107920:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107925:	e9 b2 f2 ff ff       	jmp    80106bdc <alltraps>
...
8010792a:	6a 00                	push   $0x0
  pushl $177
8010792c:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107931:	e9 a6 f2 ff ff       	jmp    80106bdc <alltraps>
...
80107936:	6a 00                	push   $0x0
  pushl $178
80107938:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010793d:	e9 9a f2 ff ff       	jmp    80106bdc <alltraps>
...
80107942:	6a 00                	push   $0x0
  pushl $179
80107944:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107949:	e9 8e f2 ff ff       	jmp    80106bdc <alltraps>
...
8010794e:	6a 00                	push   $0x0
  pushl $180
80107950:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107955:	e9 82 f2 ff ff       	jmp    80106bdc <alltraps>
...
8010795a:	6a 00                	push   $0x0
  pushl $181
8010795c:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107961:	e9 76 f2 ff ff       	jmp    80106bdc <alltraps>
...
80107966:	6a 00                	push   $0x0
  pushl $182
80107968:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010796d:	e9 6a f2 ff ff       	jmp    80106bdc <alltraps>
...
80107972:	6a 00                	push   $0x0
  pushl $183
80107974:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107979:	e9 5e f2 ff ff       	jmp    80106bdc <alltraps>
...
8010797e:	6a 00                	push   $0x0
  pushl $184
80107980:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107985:	e9 52 f2 ff ff       	jmp    80106bdc <alltraps>
...
8010798a:	6a 00                	push   $0x0
  pushl $185
8010798c:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107991:	e9 46 f2 ff ff       	jmp    80106bdc <alltraps>
...
80107996:	6a 00                	push   $0x0
  pushl $186
80107998:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
8010799d:	e9 3a f2 ff ff       	jmp    80106bdc <alltraps>
...
801079a2:	6a 00                	push   $0x0
  pushl $187
801079a4:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801079a9:	e9 2e f2 ff ff       	jmp    80106bdc <alltraps>
...
801079ae:	6a 00                	push   $0x0
  pushl $188
801079b0:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801079b5:	e9 22 f2 ff ff       	jmp    80106bdc <alltraps>
...
801079ba:	6a 00                	push   $0x0
  pushl $189
801079bc:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801079c1:	e9 16 f2 ff ff       	jmp    80106bdc <alltraps>
...
801079c6:	6a 00                	push   $0x0
  pushl $190
801079c8:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801079cd:	e9 0a f2 ff ff       	jmp    80106bdc <alltraps>
...
801079d2:	6a 00                	push   $0x0
  pushl $191
801079d4:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801079d9:	e9 fe f1 ff ff       	jmp    80106bdc <alltraps>
...
801079de:	6a 00                	push   $0x0
  pushl $192
801079e0:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801079e5:	e9 f2 f1 ff ff       	jmp    80106bdc <alltraps>
...
801079ea:	6a 00                	push   $0x0
  pushl $193
801079ec:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801079f1:	e9 e6 f1 ff ff       	jmp    80106bdc <alltraps>
...
801079f6:	6a 00                	push   $0x0
  pushl $194
801079f8:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801079fd:	e9 da f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a02:	6a 00                	push   $0x0
  pushl $195
80107a04:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107a09:	e9 ce f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a0e:	6a 00                	push   $0x0
  pushl $196
80107a10:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107a15:	e9 c2 f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a1a:	6a 00                	push   $0x0
  pushl $197
80107a1c:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107a21:	e9 b6 f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a26:	6a 00                	push   $0x0
  pushl $198
80107a28:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107a2d:	e9 aa f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a32:	6a 00                	push   $0x0
  pushl $199
80107a34:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107a39:	e9 9e f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a3e:	6a 00                	push   $0x0
  pushl $200
80107a40:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107a45:	e9 92 f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a4a:	6a 00                	push   $0x0
  pushl $201
80107a4c:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107a51:	e9 86 f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a56:	6a 00                	push   $0x0
  pushl $202
80107a58:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107a5d:	e9 7a f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a62:	6a 00                	push   $0x0
  pushl $203
80107a64:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107a69:	e9 6e f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a6e:	6a 00                	push   $0x0
  pushl $204
80107a70:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107a75:	e9 62 f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a7a:	6a 00                	push   $0x0
  pushl $205
80107a7c:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107a81:	e9 56 f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a86:	6a 00                	push   $0x0
  pushl $206
80107a88:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107a8d:	e9 4a f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a92:	6a 00                	push   $0x0
  pushl $207
80107a94:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107a99:	e9 3e f1 ff ff       	jmp    80106bdc <alltraps>
...
80107a9e:	6a 00                	push   $0x0
  pushl $208
80107aa0:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107aa5:	e9 32 f1 ff ff       	jmp    80106bdc <alltraps>
...
80107aaa:	6a 00                	push   $0x0
  pushl $209
80107aac:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107ab1:	e9 26 f1 ff ff       	jmp    80106bdc <alltraps>
...
80107ab6:	6a 00                	push   $0x0
  pushl $210
80107ab8:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107abd:	e9 1a f1 ff ff       	jmp    80106bdc <alltraps>
...
80107ac2:	6a 00                	push   $0x0
  pushl $211
80107ac4:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107ac9:	e9 0e f1 ff ff       	jmp    80106bdc <alltraps>
...
80107ace:	6a 00                	push   $0x0
  pushl $212
80107ad0:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107ad5:	e9 02 f1 ff ff       	jmp    80106bdc <alltraps>
...
80107ada:	6a 00                	push   $0x0
  pushl $213
80107adc:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107ae1:	e9 f6 f0 ff ff       	jmp    80106bdc <alltraps>
...
80107ae6:	6a 00                	push   $0x0
  pushl $214
80107ae8:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107aed:	e9 ea f0 ff ff       	jmp    80106bdc <alltraps>
...
80107af2:	6a 00                	push   $0x0
  pushl $215
80107af4:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107af9:	e9 de f0 ff ff       	jmp    80106bdc <alltraps>
...
80107afe:	6a 00                	push   $0x0
  pushl $216
80107b00:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107b05:	e9 d2 f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b0a:	6a 00                	push   $0x0
  pushl $217
80107b0c:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107b11:	e9 c6 f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b16:	6a 00                	push   $0x0
  pushl $218
80107b18:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107b1d:	e9 ba f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b22:	6a 00                	push   $0x0
  pushl $219
80107b24:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107b29:	e9 ae f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b2e:	6a 00                	push   $0x0
  pushl $220
80107b30:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107b35:	e9 a2 f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b3a:	6a 00                	push   $0x0
  pushl $221
80107b3c:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107b41:	e9 96 f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b46:	6a 00                	push   $0x0
  pushl $222
80107b48:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107b4d:	e9 8a f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b52:	6a 00                	push   $0x0
  pushl $223
80107b54:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107b59:	e9 7e f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b5e:	6a 00                	push   $0x0
  pushl $224
80107b60:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107b65:	e9 72 f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b6a:	6a 00                	push   $0x0
  pushl $225
80107b6c:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107b71:	e9 66 f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b76:	6a 00                	push   $0x0
  pushl $226
80107b78:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107b7d:	e9 5a f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b82:	6a 00                	push   $0x0
  pushl $227
80107b84:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107b89:	e9 4e f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b8e:	6a 00                	push   $0x0
  pushl $228
80107b90:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107b95:	e9 42 f0 ff ff       	jmp    80106bdc <alltraps>
...
80107b9a:	6a 00                	push   $0x0
  pushl $229
80107b9c:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107ba1:	e9 36 f0 ff ff       	jmp    80106bdc <alltraps>
...
80107ba6:	6a 00                	push   $0x0
  pushl $230
80107ba8:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107bad:	e9 2a f0 ff ff       	jmp    80106bdc <alltraps>
...
80107bb2:	6a 00                	push   $0x0
  pushl $231
80107bb4:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107bb9:	e9 1e f0 ff ff       	jmp    80106bdc <alltraps>
...
80107bbe:	6a 00                	push   $0x0
  pushl $232
80107bc0:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107bc5:	e9 12 f0 ff ff       	jmp    80106bdc <alltraps>
...
80107bca:	6a 00                	push   $0x0
  pushl $233
80107bcc:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107bd1:	e9 06 f0 ff ff       	jmp    80106bdc <alltraps>
...
80107bd6:	6a 00                	push   $0x0
  pushl $234
80107bd8:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107bdd:	e9 fa ef ff ff       	jmp    80106bdc <alltraps>
...
80107be2:	6a 00                	push   $0x0
  pushl $235
80107be4:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107be9:	e9 ee ef ff ff       	jmp    80106bdc <alltraps>
...
80107bee:	6a 00                	push   $0x0
  pushl $236
80107bf0:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107bf5:	e9 e2 ef ff ff       	jmp    80106bdc <alltraps>
...
80107bfa:	6a 00                	push   $0x0
  pushl $237
80107bfc:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107c01:	e9 d6 ef ff ff       	jmp    80106bdc <alltraps>
...
80107c06:	6a 00                	push   $0x0
  pushl $238
80107c08:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107c0d:	e9 ca ef ff ff       	jmp    80106bdc <alltraps>
...
80107c12:	6a 00                	push   $0x0
  pushl $239
80107c14:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107c19:	e9 be ef ff ff       	jmp    80106bdc <alltraps>
...
80107c1e:	6a 00                	push   $0x0
  pushl $240
80107c20:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107c25:	e9 b2 ef ff ff       	jmp    80106bdc <alltraps>
...
80107c2a:	6a 00                	push   $0x0
  pushl $241
80107c2c:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107c31:	e9 a6 ef ff ff       	jmp    80106bdc <alltraps>
...
80107c36:	6a 00                	push   $0x0
  pushl $242
80107c38:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107c3d:	e9 9a ef ff ff       	jmp    80106bdc <alltraps>
...
80107c42:	6a 00                	push   $0x0
  pushl $243
80107c44:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107c49:	e9 8e ef ff ff       	jmp    80106bdc <alltraps>
...
80107c4e:	6a 00                	push   $0x0
  pushl $244
80107c50:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107c55:	e9 82 ef ff ff       	jmp    80106bdc <alltraps>
...
80107c5a:	6a 00                	push   $0x0
  pushl $245
80107c5c:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107c61:	e9 76 ef ff ff       	jmp    80106bdc <alltraps>
...
80107c66:	6a 00                	push   $0x0
  pushl $246
80107c68:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107c6d:	e9 6a ef ff ff       	jmp    80106bdc <alltraps>
...
80107c72:	6a 00                	push   $0x0
  pushl $247
80107c74:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107c79:	e9 5e ef ff ff       	jmp    80106bdc <alltraps>
...
80107c7e:	6a 00                	push   $0x0
  pushl $248
80107c80:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107c85:	e9 52 ef ff ff       	jmp    80106bdc <alltraps>
...
80107c8a:	6a 00                	push   $0x0
  pushl $249
80107c8c:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107c91:	e9 46 ef ff ff       	jmp    80106bdc <alltraps>
...
80107c96:	6a 00                	push   $0x0
  pushl $250
80107c98:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107c9d:	e9 3a ef ff ff       	jmp    80106bdc <alltraps>
...
80107ca2:	6a 00                	push   $0x0
  pushl $251
80107ca4:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107ca9:	e9 2e ef ff ff       	jmp    80106bdc <alltraps>
...
80107cae:	6a 00                	push   $0x0
  pushl $252
80107cb0:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107cb5:	e9 22 ef ff ff       	jmp    80106bdc <alltraps>
...
80107cba:	6a 00                	push   $0x0
  pushl $253
80107cbc:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107cc1:	e9 16 ef ff ff       	jmp    80106bdc <alltraps>
...
80107cc6:	6a 00                	push   $0x0
  pushl $254
80107cc8:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107ccd:	e9 0a ef ff ff       	jmp    80106bdc <alltraps>
...
80107cd2:	6a 00                	push   $0x0
  pushl $255
80107cd4:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107cd9:	e9 fe ee ff ff       	jmp    80106bdc <alltraps>
	...
...
80107d5d:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107d60:	e8 28 b1 ff ff       	call   80102e8d <cpunum>
80107d65:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107d6b:	05 40 09 11 80       	add    $0x80110940,%eax
...
801081db:	c1 e0 02             	shl    $0x2,%eax
801081de:	03 45 08             	add    0x8(%ebp),%eax
...
801081ec:	84 c0                	test   %al,%al
801081ee:	74 17                	je     80108207 <walkpgdir+0x38>
...
801081fd:	e8 4a fb ff ff       	call   80107d4c <p2v>
80108202:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108205:	eb 4b                	jmp    80108252 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80108207:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010820b:	74 0e                	je     8010821b <walkpgdir+0x4c>
8010820d:	e8 ed a8 ff ff       	call   80102aff <kalloc>
80108212:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108215:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108219:	75 07                	jne    80108222 <walkpgdir+0x53>
      return 0;
8010821b:	b8 00 00 00 00       	mov    $0x0,%eax
80108220:	eb 41                	jmp    80108263 <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80108222:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108229:	00 
8010822a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108231:	00 
80108232:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108235:	89 04 24             	mov    %eax,(%esp)
80108238:	e8 c9 d3 ff ff       	call   80105606 <memset>
...
8010825d:	c1 e0 02             	shl    $0x2,%eax
80108260:	03 45 f4             	add    -0xc(%ebp),%eax
}
80108263:	c9                   	leave  
80108264:	c3                   	ret    
...
80108268:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
  
  a = (char*)PGROUNDDOWN((uint)va);
8010826b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010826e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108273:	89 45 f4             	mov    %eax,-0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80108276:	8b 45 0c             	mov    0xc(%ebp),%eax
80108279:	03 45 10             	add    0x10(%ebp),%eax
8010827c:	83 e8 01             	sub    $0x1,%eax
8010827f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108284:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80108287:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
8010828e:	00 
8010828f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108292:	89 44 24 04          	mov    %eax,0x4(%esp)
80108296:	8b 45 08             	mov    0x8(%ebp),%eax
80108299:	89 04 24             	mov    %eax,(%esp)
8010829c:	e8 2e ff ff ff       	call   801081cf <walkpgdir>
801082a1:	89 45 ec             	mov    %eax,-0x14(%ebp)
801082a4:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801082a8:	75 07                	jne    801082b1 <mappages+0x4c>
      return -1;
801082aa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801082af:	eb 46                	jmp    801082f7 <mappages+0x92>
    if(*pte & PTE_P)
801082b1:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082b4:	8b 00                	mov    (%eax),%eax
801082b6:	83 e0 01             	and    $0x1,%eax
801082b9:	84 c0                	test   %al,%al
801082bb:	74 0c                	je     801082c9 <mappages+0x64>
      panic("remap");
801082bd:	c7 04 24 f8 90 10 80 	movl   $0x801090f8,(%esp)
801082c4:	e8 74 82 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
801082c9:	8b 45 18             	mov    0x18(%ebp),%eax
801082cc:	0b 45 14             	or     0x14(%ebp),%eax
801082cf:	89 c2                	mov    %eax,%edx
801082d1:	83 ca 01             	or     $0x1,%edx
801082d4:	8b 45 ec             	mov    -0x14(%ebp),%eax
801082d7:	89 10                	mov    %edx,(%eax)
    if(a == last)
801082d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082dc:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801082df:	74 10                	je     801082f1 <mappages+0x8c>
      break;
    a += PGSIZE;
801082e1:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
801082e8:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
801082ef:	eb 96                	jmp    80108287 <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
801082fd:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80108300:	e8 fa a7 ff ff       	call   80102aff <kalloc>
80108305:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108308:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010830c:	75 0a                	jne    80108318 <setupkvm+0x1f>
    return 0;
8010830e:	b8 00 00 00 00       	mov    $0x0,%eax
80108313:	e9 98 00 00 00       	jmp    801083b0 <setupkvm+0xb7>
...
8010832e:	e8 d3 d2 ff ff       	call   80105606 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80108333:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
8010833a:	e8 0d fa ff ff       	call   80107d4c <p2v>
8010833f:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80108344:	76 0c                	jbe    80108352 <setupkvm+0x59>
    panic("PHYSTOP too high");
80108346:	c7 04 24 fe 90 10 80 	movl   $0x801090fe,(%esp)
8010834d:	e8 eb 81 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108352:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
80108359:	eb 49                	jmp    801083a4 <setupkvm+0xab>
...
8010835b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
8010835e:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
...
80108390:	e8 d0 fe ff ff       	call   80108265 <mappages>
80108395:	85 c0                	test   %eax,%eax
80108397:	79 07                	jns    801083a0 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80108399:	b8 00 00 00 00       	mov    $0x0,%eax
8010839e:	eb 10                	jmp    801083b0 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801083a0:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
801083a4:	81 7d f4 00 c5 10 80 	cmpl   $0x8010c500,-0xc(%ebp)
801083ab:	72 ae                	jb     8010835b <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
801083ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
801083b0:	83 c4 34             	add    $0x34,%esp
801083b3:	5b                   	pop    %ebx
801083b4:	5d                   	pop    %ebp
801083b5:	c3                   	ret    
...
801083b9:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801083bc:	e8 38 ff ff ff       	call   801082f9 <setupkvm>
801083c1:	a3 58 44 11 80       	mov    %eax,0x80114458
  switchkvm();
801083c6:	e8 02 00 00 00       	call   801083cd <switchkvm>
}
801083cb:	c9                   	leave  
801083cc:	c3                   	ret    
...
801083d3:	a1 58 44 11 80       	mov    0x80114458,%eax
801083d8:	89 04 24             	mov    %eax,(%esp)
801083db:	e8 5f f9 ff ff       	call   80107d3f <v2p>
801083e0:	89 04 24             	mov    %eax,(%esp)
801083e3:	e8 4c f9 ff ff       	call   80107d34 <lcr3>
}
801083e8:	c9                   	leave  
801083e9:	c3                   	ret    
...
801083ee:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801083f1:	e8 09 d1 ff ff       	call   801054ff <pushcli>
...
80108406:	89 d3                	mov    %edx,%ebx
80108408:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010840f:	83 c2 08             	add    $0x8,%edx
80108412:	c1 ea 10             	shr    $0x10,%edx
80108415:	89 d1                	mov    %edx,%ecx
80108417:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010841e:	83 c2 08             	add    $0x8,%edx
80108421:	c1 ea 18             	shr    $0x18,%edx
80108424:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
8010842b:	67 00 
8010842d:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80108434:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
8010843a:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108441:	83 e1 f0             	and    $0xfffffff0,%ecx
80108444:	83 c9 09             	or     $0x9,%ecx
80108447:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010844d:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108454:	83 c9 10             	or     $0x10,%ecx
80108457:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010845d:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108464:	83 e1 9f             	and    $0xffffff9f,%ecx
80108467:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010846d:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108474:	83 c9 80             	or     $0xffffff80,%ecx
80108477:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
8010847d:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108484:	83 e1 f0             	and    $0xfffffff0,%ecx
80108487:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010848d:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108494:	83 e1 ef             	and    $0xffffffef,%ecx
80108497:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
8010849d:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801084a4:	83 e1 df             	and    $0xffffffdf,%ecx
801084a7:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801084ad:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801084b4:	83 c9 40             	or     $0x40,%ecx
801084b7:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801084bd:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801084c4:	83 e1 7f             	and    $0x7f,%ecx
801084c7:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801084cd:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
801084d3:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801084d9:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
801084e0:	83 e2 ef             	and    $0xffffffef,%edx
801084e3:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
801084e9:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801084ef:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
801084f5:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801084fb:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80108502:	8b 52 08             	mov    0x8(%edx),%edx
80108505:	81 c2 00 10 00 00    	add    $0x1000,%edx
8010850b:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
8010850e:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80108515:	e8 ef f7 ff ff       	call   80107d09 <ltr>
  if(p->pgdir == 0)
8010851a:	8b 45 08             	mov    0x8(%ebp),%eax
8010851d:	8b 40 04             	mov    0x4(%eax),%eax
80108520:	85 c0                	test   %eax,%eax
80108522:	75 0c                	jne    80108530 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80108524:	c7 04 24 0f 91 10 80 	movl   $0x8010910f,(%esp)
8010852b:	e8 0d 80 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80108530:	8b 45 08             	mov    0x8(%ebp),%eax
80108533:	8b 40 04             	mov    0x4(%eax),%eax
80108536:	89 04 24             	mov    %eax,(%esp)
80108539:	e8 01 f8 ff ff       	call   80107d3f <v2p>
8010853e:	89 04 24             	mov    %eax,(%esp)
80108541:	e8 ee f7 ff ff       	call   80107d34 <lcr3>
  popcli();
80108546:	e8 fc cf ff ff       	call   80105547 <popcli>
}
8010854b:	83 c4 14             	add    $0x14,%esp
8010854e:	5b                   	pop    %ebx
8010854f:	5d                   	pop    %ebp
80108550:	c3                   	ret    
...
80108554:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80108557:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
8010855e:	76 0c                	jbe    8010856c <inituvm+0x1b>
    panic("inituvm: more than a page");
80108560:	c7 04 24 23 91 10 80 	movl   $0x80109123,(%esp)
80108567:	e8 d1 7f ff ff       	call   8010053d <panic>
  mem = kalloc();
8010856c:	e8 8e a5 ff ff       	call   80102aff <kalloc>
80108571:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80108574:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010857b:	00 
8010857c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108583:	00 
80108584:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108587:	89 04 24             	mov    %eax,(%esp)
8010858a:	e8 77 d0 ff ff       	call   80105606 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
8010858f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108592:	89 04 24             	mov    %eax,(%esp)
80108595:	e8 a5 f7 ff ff       	call   80107d3f <v2p>
8010859a:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801085a1:	00 
801085a2:	89 44 24 0c          	mov    %eax,0xc(%esp)
801085a6:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801085ad:	00 
801085ae:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801085b5:	00 
801085b6:	8b 45 08             	mov    0x8(%ebp),%eax
801085b9:	89 04 24             	mov    %eax,(%esp)
801085bc:	e8 a4 fc ff ff       	call   80108265 <mappages>
  memmove(mem, init, sz);
801085c1:	8b 45 10             	mov    0x10(%ebp),%eax
801085c4:	89 44 24 08          	mov    %eax,0x8(%esp)
801085c8:	8b 45 0c             	mov    0xc(%ebp),%eax
801085cb:	89 44 24 04          	mov    %eax,0x4(%esp)
801085cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801085d2:	89 04 24             	mov    %eax,(%esp)
801085d5:	e8 ff d0 ff ff       	call   801056d9 <memmove>
}
801085da:	c9                   	leave  
801085db:	c3                   	ret    
...
801085e0:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
801085e3:	8b 45 0c             	mov    0xc(%ebp),%eax
801085e6:	25 ff 0f 00 00       	and    $0xfff,%eax
801085eb:	85 c0                	test   %eax,%eax
801085ed:	74 0c                	je     801085fb <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
801085ef:	c7 04 24 40 91 10 80 	movl   $0x80109140,(%esp)
801085f6:	e8 42 7f ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
801085fb:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108602:	e9 ad 00 00 00       	jmp    801086b4 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80108607:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010860a:	8b 55 0c             	mov    0xc(%ebp),%edx
8010860d:	01 d0                	add    %edx,%eax
8010860f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108616:	00 
80108617:	89 44 24 04          	mov    %eax,0x4(%esp)
8010861b:	8b 45 08             	mov    0x8(%ebp),%eax
8010861e:	89 04 24             	mov    %eax,(%esp)
80108621:	e8 a9 fb ff ff       	call   801081cf <walkpgdir>
80108626:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108629:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010862d:	75 0c                	jne    8010863b <loaduvm+0x5f>
      panic("loaduvm: address should exist");
8010862f:	c7 04 24 63 91 10 80 	movl   $0x80109163,(%esp)
80108636:	e8 02 7f ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
8010863b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010863e:	8b 00                	mov    (%eax),%eax
80108640:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108645:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108648:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010864b:	8b 55 18             	mov    0x18(%ebp),%edx
8010864e:	89 d1                	mov    %edx,%ecx
80108650:	29 c1                	sub    %eax,%ecx
80108652:	89 c8                	mov    %ecx,%eax
80108654:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80108659:	77 11                	ja     8010866c <loaduvm+0x90>
      n = sz - i;
8010865b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010865e:	8b 55 18             	mov    0x18(%ebp),%edx
80108661:	89 d1                	mov    %edx,%ecx
80108663:	29 c1                	sub    %eax,%ecx
80108665:	89 c8                	mov    %ecx,%eax
80108667:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010866a:	eb 07                	jmp    80108673 <loaduvm+0x97>
    else
      n = PGSIZE;
8010866c:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80108673:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108676:	8b 55 14             	mov    0x14(%ebp),%edx
80108679:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
8010867c:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010867f:	89 04 24             	mov    %eax,(%esp)
80108682:	e8 c5 f6 ff ff       	call   80107d4c <p2v>
80108687:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010868a:	89 54 24 0c          	mov    %edx,0xc(%esp)
8010868e:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80108692:	89 44 24 04          	mov    %eax,0x4(%esp)
80108696:	8b 45 10             	mov    0x10(%ebp),%eax
80108699:	89 04 24             	mov    %eax,(%esp)
8010869c:	e8 bd 96 ff ff       	call   80101d5e <readi>
801086a1:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801086a4:	74 07                	je     801086ad <loaduvm+0xd1>
      return -1;
801086a6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801086ab:	eb 18                	jmp    801086c5 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801086ad:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
801086b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086b7:	3b 45 18             	cmp    0x18(%ebp),%eax
801086ba:	0f 82 47 ff ff ff    	jb     80108607 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
801086c5:	83 c4 24             	add    $0x24,%esp
801086c8:	5b                   	pop    %ebx
801086c9:	5d                   	pop    %ebp
801086ca:	c3                   	ret    
...
801086ce:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
801086d6:	79 0a                	jns    801086e2 <allocuvm+0x17>
    return 0;
801086d8:	b8 00 00 00 00       	mov    $0x0,%eax
801086dd:	e9 c1 00 00 00       	jmp    801087a3 <allocuvm+0xd8>
  if(newsz < oldsz)
801086e2:	8b 45 10             	mov    0x10(%ebp),%eax
801086e5:	3b 45 0c             	cmp    0xc(%ebp),%eax
801086e8:	73 08                	jae    801086f2 <allocuvm+0x27>
    return oldsz;
801086ea:	8b 45 0c             	mov    0xc(%ebp),%eax
801086ed:	e9 b1 00 00 00       	jmp    801087a3 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
801086f2:	8b 45 0c             	mov    0xc(%ebp),%eax
801086f5:	05 ff 0f 00 00       	add    $0xfff,%eax
801086fa:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801086ff:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80108702:	e9 8d 00 00 00       	jmp    80108794 <allocuvm+0xc9>
    mem = kalloc();
80108707:	e8 f3 a3 ff ff       	call   80102aff <kalloc>
8010870c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
8010870f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108713:	75 2c                	jne    80108741 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108715:	c7 04 24 81 91 10 80 	movl   $0x80109181,(%esp)
8010871c:	e8 80 7c ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80108721:	8b 45 0c             	mov    0xc(%ebp),%eax
80108724:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80108735:	e8 6b 00 00 00       	call   801087a5 <deallocuvm>
      return 0;
8010873a:	b8 00 00 00 00       	mov    $0x0,%eax
8010873f:	eb 62                	jmp    801087a3 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
...
80108757:	e8 aa ce ff ff       	call   80105606 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
8010875c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010875f:	89 04 24             	mov    %eax,(%esp)
80108762:	e8 d8 f5 ff ff       	call   80107d3f <v2p>
80108767:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010876a:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108771:	00 
80108772:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108776:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010877d:	00 
8010877e:	89 54 24 04          	mov    %edx,0x4(%esp)
80108782:	8b 45 08             	mov    0x8(%ebp),%eax
80108785:	89 04 24             	mov    %eax,(%esp)
80108788:	e8 d8 fa ff ff       	call   80108265 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
8010878d:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108794:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108797:	3b 45 10             	cmp    0x10(%ebp),%eax
8010879a:	0f 82 67 ff ff ff    	jb     80108707 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
801087a8:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
801087ab:	8b 45 10             	mov    0x10(%ebp),%eax
801087ae:	3b 45 0c             	cmp    0xc(%ebp),%eax
801087b1:	72 08                	jb     801087bb <deallocuvm+0x16>
    return oldsz;
801087b3:	8b 45 0c             	mov    0xc(%ebp),%eax
801087b6:	e9 a4 00 00 00       	jmp    8010885f <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
801087bb:	8b 45 10             	mov    0x10(%ebp),%eax
801087be:	05 ff 0f 00 00       	add    $0xfff,%eax
801087c3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801087c8:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801087cb:	e9 80 00 00 00       	jmp    80108850 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
801087d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087d3:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801087da:	00 
801087db:	89 44 24 04          	mov    %eax,0x4(%esp)
801087df:	8b 45 08             	mov    0x8(%ebp),%eax
801087e2:	89 04 24             	mov    %eax,(%esp)
801087e5:	e8 e5 f9 ff ff       	call   801081cf <walkpgdir>
801087ea:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801087ed:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801087f1:	75 09                	jne    801087fc <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801087f3:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
801087fa:	eb 4d                	jmp    80108849 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
801087fc:	8b 45 f0             	mov    -0x10(%ebp),%eax
801087ff:	8b 00                	mov    (%eax),%eax
80108801:	83 e0 01             	and    $0x1,%eax
80108804:	84 c0                	test   %al,%al
80108806:	74 41                	je     80108849 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
80108808:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010880b:	8b 00                	mov    (%eax),%eax
8010880d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108812:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108815:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108819:	75 0c                	jne    80108827 <deallocuvm+0x82>
        panic("kfree");
8010881b:	c7 04 24 99 91 10 80 	movl   $0x80109199,(%esp)
80108822:	e8 16 7d ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
80108827:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010882a:	89 04 24             	mov    %eax,(%esp)
8010882d:	e8 1a f5 ff ff       	call   80107d4c <p2v>
80108832:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108835:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108838:	89 04 24             	mov    %eax,(%esp)
8010883b:	e8 26 a2 ff ff       	call   80102a66 <kfree>
      *pte = 0;
...
80108856:	0f 82 74 ff ff ff    	jb     801087d0 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
80108864:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
80108867:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010886b:	75 0c                	jne    80108879 <freevm+0x18>
    panic("freevm: no pgdir");
8010886d:	c7 04 24 9f 91 10 80 	movl   $0x8010919f,(%esp)
80108874:	e8 c4 7c ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
80108879:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108880:	00 
80108881:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80108888:	80 
80108889:	8b 45 08             	mov    0x8(%ebp),%eax
8010888c:	89 04 24             	mov    %eax,(%esp)
8010888f:	e8 11 ff ff ff       	call   801087a5 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108894:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010889b:	eb 3c                	jmp    801088d9 <freevm+0x78>
    if(pgdir[i] & PTE_P){
8010889d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801088a0:	c1 e0 02             	shl    $0x2,%eax
801088a3:	03 45 08             	add    0x8(%ebp),%eax
801088a6:	8b 00                	mov    (%eax),%eax
801088a8:	83 e0 01             	and    $0x1,%eax
801088ab:	84 c0                	test   %al,%al
801088ad:	74 26                	je     801088d5 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
801088af:	8b 45 f4             	mov    -0xc(%ebp),%eax
801088b2:	c1 e0 02             	shl    $0x2,%eax
801088b5:	03 45 08             	add    0x8(%ebp),%eax
801088b8:	8b 00                	mov    (%eax),%eax
801088ba:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801088bf:	89 04 24             	mov    %eax,(%esp)
801088c2:	e8 85 f4 ff ff       	call   80107d4c <p2v>
801088c7:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
801088ca:	8b 45 f0             	mov    -0x10(%ebp),%eax
801088cd:	89 04 24             	mov    %eax,(%esp)
801088d0:	e8 91 a1 ff ff       	call   80102a66 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801088d5:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801088d9:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801088e0:	76 bb                	jbe    8010889d <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
  ...
  kfree((char*)pgdir);
801088e2:	8b 45 08             	mov    0x8(%ebp),%eax
801088e5:	89 04 24             	mov    %eax,(%esp)
801088e8:	e8 79 a1 ff ff       	call   80102a66 <kfree>
}
801088ed:	c9                   	leave  
801088ee:	c3                   	ret    
...
801088f2:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
801088f5:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801088fc:	00 
...
8010890a:	e8 c0 f8 ff ff       	call   801081cf <walkpgdir>
8010890f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108912:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108916:	75 0c                	jne    80108924 <clearpteu+0x35>
    panic("clearpteu");
80108918:	c7 04 24 b0 91 10 80 	movl   $0x801091b0,(%esp)
8010891f:	e8 19 7c ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
80108924:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108927:	8b 00                	mov    (%eax),%eax
80108929:	89 c2                	mov    %eax,%edx
8010892b:	83 e2 fb             	and    $0xfffffffb,%edx
8010892e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108931:	89 10                	mov    %edx,(%eax)
}
80108933:	c9                   	leave  
80108934:	c3                   	ret    
...
80108938:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010893b:	e8 b9 f9 ff ff       	call   801082f9 <setupkvm>
80108940:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108943:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108947:	75 0a                	jne    80108953 <copyuvm+0x1e>
    return 0;
80108949:	b8 00 00 00 00       	mov    $0x0,%eax
8010894e:	e9 f1 00 00 00       	jmp    80108a44 <copyuvm+0x10f>
  for(i = 0; i < sz; i += PGSIZE){
80108953:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010895a:	e9 c0 00 00 00       	jmp    80108a1f <copyuvm+0xea>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010895f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108962:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108969:	00 
8010896a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010896e:	8b 45 08             	mov    0x8(%ebp),%eax
80108971:	89 04 24             	mov    %eax,(%esp)
80108974:	e8 56 f8 ff ff       	call   801081cf <walkpgdir>
80108979:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010897c:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108980:	75 0c                	jne    8010898e <copyuvm+0x59>
      panic("copyuvm: pte should exist");
80108982:	c7 04 24 ba 91 10 80 	movl   $0x801091ba,(%esp)
80108989:	e8 af 7b ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
8010898e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108991:	8b 00                	mov    (%eax),%eax
80108993:	83 e0 01             	and    $0x1,%eax
80108996:	85 c0                	test   %eax,%eax
80108998:	75 0c                	jne    801089a6 <copyuvm+0x71>
      panic("copyuvm: page not present");
8010899a:	c7 04 24 d4 91 10 80 	movl   $0x801091d4,(%esp)
801089a1:	e8 97 7b ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
801089a6:	8b 45 ec             	mov    -0x14(%ebp),%eax
801089a9:	8b 00                	mov    (%eax),%eax
801089ab:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801089b0:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if((mem = kalloc()) == 0)
801089b3:	e8 47 a1 ff ff       	call   80102aff <kalloc>
801089b8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801089bb:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
801089bf:	74 6f                	je     80108a30 <copyuvm+0xfb>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
801089c1:	8b 45 e8             	mov    -0x18(%ebp),%eax
801089c4:	89 04 24             	mov    %eax,(%esp)
801089c7:	e8 80 f3 ff ff       	call   80107d4c <p2v>
801089cc:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801089d3:	00 
801089d4:	89 44 24 04          	mov    %eax,0x4(%esp)
801089d8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801089db:	89 04 24             	mov    %eax,(%esp)
801089de:	e8 f6 cc ff ff       	call   801056d9 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
801089e3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801089e6:	89 04 24             	mov    %eax,(%esp)
801089e9:	e8 51 f3 ff ff       	call   80107d3f <v2p>
801089ee:	8b 55 f4             	mov    -0xc(%ebp),%edx
801089f1:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801089f8:	00 
801089f9:	89 44 24 0c          	mov    %eax,0xc(%esp)
801089fd:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108a04:	00 
80108a05:	89 54 24 04          	mov    %edx,0x4(%esp)
80108a09:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a0c:	89 04 24             	mov    %eax,(%esp)
80108a0f:	e8 51 f8 ff ff       	call   80108265 <mappages>
80108a14:	85 c0                	test   %eax,%eax
80108a16:	78 1b                	js     80108a33 <copyuvm+0xfe>
  uint pa, i;
  char *mem;
...
80108a25:	0f 82 34 ff ff ff    	jb     8010895f <copyuvm+0x2a>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
...
80108a2e:	eb 14                	jmp    80108a44 <copyuvm+0x10f>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108a30:	90                   	nop
80108a31:	eb 01                	jmp    80108a34 <copyuvm+0xff>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
80108a33:	90                   	nop
...
80108a3a:	e8 22 fe ff ff       	call   80108861 <freevm>
  return 0;
...
80108a49:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108a4c:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108a53:	00 
...
80108a61:	e8 69 f7 ff ff       	call   801081cf <walkpgdir>
80108a66:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
80108a69:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a6c:	8b 00                	mov    (%eax),%eax
80108a6e:	83 e0 01             	and    $0x1,%eax
80108a71:	85 c0                	test   %eax,%eax
80108a73:	75 07                	jne    80108a7c <uva2ka+0x36>
    return 0;
80108a75:	b8 00 00 00 00       	mov    $0x0,%eax
80108a7a:	eb 25                	jmp    80108aa1 <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
80108a7c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108a7f:	8b 00                	mov    (%eax),%eax
80108a81:	83 e0 04             	and    $0x4,%eax
80108a84:	85 c0                	test   %eax,%eax
80108a86:	75 07                	jne    80108a8f <uva2ka+0x49>
    return 0;
80108a88:	b8 00 00 00 00       	mov    $0x0,%eax
80108a8d:	eb 12                	jmp    80108aa1 <uva2ka+0x5b>
...
80108a9c:	e8 ab f2 ff ff       	call   80107d4c <p2v>
}
80108aa1:	c9                   	leave  
80108aa2:	c3                   	ret    
...
80108aa6:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
80108aa9:	8b 45 10             	mov    0x10(%ebp),%eax
80108aac:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
80108aaf:	e9 8b 00 00 00       	jmp    80108b3f <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
80108ab4:	8b 45 0c             	mov    0xc(%ebp),%eax
80108ab7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108abc:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108abf:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108ac2:	89 44 24 04          	mov    %eax,0x4(%esp)
80108ac6:	8b 45 08             	mov    0x8(%ebp),%eax
80108ac9:	89 04 24             	mov    %eax,(%esp)
80108acc:	e8 75 ff ff ff       	call   80108a46 <uva2ka>
80108ad1:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108ad4:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108ad8:	75 07                	jne    80108ae1 <copyout+0x3e>
      return -1;
80108ada:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108adf:	eb 6d                	jmp    80108b4e <copyout+0xab>
    n = PGSIZE - (va - va0);
80108ae1:	8b 45 0c             	mov    0xc(%ebp),%eax
80108ae4:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108ae7:	89 d1                	mov    %edx,%ecx
80108ae9:	29 c1                	sub    %eax,%ecx
80108aeb:	89 c8                	mov    %ecx,%eax
80108aed:	05 00 10 00 00       	add    $0x1000,%eax
80108af2:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108af5:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108af8:	3b 45 14             	cmp    0x14(%ebp),%eax
80108afb:	76 06                	jbe    80108b03 <copyout+0x60>
      n = len;
80108afd:	8b 45 14             	mov    0x14(%ebp),%eax
80108b00:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108b03:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b06:	8b 55 0c             	mov    0xc(%ebp),%edx
80108b09:	89 d1                	mov    %edx,%ecx
80108b0b:	29 c1                	sub    %eax,%ecx
80108b0d:	89 c8                	mov    %ecx,%eax
80108b0f:	03 45 e8             	add    -0x18(%ebp),%eax
80108b12:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108b15:	89 54 24 08          	mov    %edx,0x8(%esp)
80108b19:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108b1c:	89 54 24 04          	mov    %edx,0x4(%esp)
80108b20:	89 04 24             	mov    %eax,(%esp)
80108b23:	e8 b1 cb ff ff       	call   801056d9 <memmove>
    len -= n;
80108b28:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b2b:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108b2e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108b31:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108b34:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108b37:	05 00 10 00 00       	add    $0x1000,%eax
80108b3c:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108b3f:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108b43:	0f 85 6b ff ff ff    	jne    80108ab4 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
