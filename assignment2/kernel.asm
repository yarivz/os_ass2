...
8010003a:	c7 44 24 04 54 8a 10 	movl   $0x80108a54,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
80100049:	e8 4c 52 00 00       	call   8010529a <initlock>
...
801000bd:	e8 f9 51 00 00       	call   801052bb <acquire>
...
80100104:	e8 14 52 00 00       	call   8010531d <release>
        return b;
...
8010017c:	e8 9c 51 00 00       	call   8010531d <release>
      return b;
...
80100198:	c7 04 24 5b 8a 10 80 	movl   $0x80108a5b,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 6c 8a 10 80 	movl   $0x80108a6c,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 73 8a 10 80 	movl   $0x80108a73,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 80 d6 10 80 	movl   $0x8010d680,(%esp)
8010023c:	e8 7a 50 00 00       	call   801052bb <acquire>
...
801002a9:	e8 6f 50 00 00       	call   8010531d <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 fa 4e 00 00       	call   801052bb <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 7a 8a 10 80 	movl   $0x80108a7a,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec 83 8a 10 80 	movl   $0x80108a83,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 e2 4d 00 00       	call   8010531d <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 8a 8a 10 80 	movl   $0x80108a8a,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 99 8a 10 80 	movl   $0x80108a99,(%esp)
...
80100592:	e8 d5 4d 00 00       	call   8010536c <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 9b 8a 10 80 	movl   $0x80108a9b,(%esp)
...
801006b2:	e8 26 4f 00 00       	call   801055dd <memmove>
    pos -= 80;
...
801006e1:	e8 24 4e 00 00       	call   8010550a <memset>
  }
...
80100776:	e8 3e 69 00 00       	call   801070b9 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 32 69 00 00       	call   801070b9 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 26 69 00 00       	call   801070b9 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 19 69 00 00       	call   801070b9 <uartputc>
  cgaputc(c);
...
801007ba:	e8 fc 4a 00 00       	call   801052bb <acquire>
  while((c = getc()) >= 0){
...
8010091e:	e8 fa 49 00 00       	call   8010531d <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 73 49 00 00       	call   801052bb <acquire>
  while(n > 0){
...
80100961:	e8 b7 49 00 00       	call   8010531d <release>
        ilock(ip);
...
80100a08:	e8 10 49 00 00       	call   8010531d <release>
  ilock(ip);
...
80100a3e:	e8 78 48 00 00       	call   801052bb <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 a0 48 00 00       	call   8010531d <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 9f 8a 10 	movl   $0x80108a9f,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 e0 c5 10 80 	movl   $0x8010c5e0,(%esp)
80100aa2:	e8 f3 47 00 00       	call   8010529a <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 a7 8a 10 	movl   $0x80108aa7,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 c0 ed 10 80 	movl   $0x8010edc0,(%esp)
80100ab6:	e8 df 47 00 00       	call   8010529a <initlock>
...
80100b7b:	e8 7d 76 00 00       	call   801081fd <setupkvm>
...
80100c14:	e8 b6 79 00 00       	call   801085cf <allocuvm>
...
80100c51:	e8 8a 78 00 00       	call   801084e0 <loaduvm>
...
80100cbc:	e8 0e 79 00 00       	call   801085cf <allocuvm>
...
80100ce0:	e8 0e 7b 00 00       	call   801087f3 <clearpteu>
  sp = sz;
...
80100d0f:	e8 74 4a 00 00       	call   80105788 <strlen>
...
80100d2d:	e8 56 4a 00 00       	call   80105788 <strlen>
...
80100d57:	e8 4b 7c 00 00       	call   801089a7 <copyout>
...
80100df7:	e8 ab 7b 00 00       	call   801089a7 <copyout>
...
80100e4e:	e8 e7 48 00 00       	call   8010573a <safestrcpy>
...
80100ea0:	e8 49 74 00 00       	call   801082ee <switchuvm>
  freevm(oldpgdir);
80100ea5:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ea8:	89 04 24             	mov    %eax,(%esp)
80100eab:	e8 b5 78 00 00       	call   80108765 <freevm>
  return 0;
...
80100ee2:	e8 7e 78 00 00       	call   80108765 <freevm>
  if(ip)
...
80100f06:	c7 44 24 04 ad 8a 10 	movl   $0x80108aad,0x4(%esp)
80100f0d:	80 
80100f0e:	c7 04 24 80 ee 10 80 	movl   $0x8010ee80,(%esp)
80100f15:	e8 80 43 00 00       	call   8010529a <initlock>
}
80100f1a:	c9                   	leave  
80100f1b:	c3                   	ret    
...
80100f29:	e8 8d 43 00 00       	call   801052bb <acquire>
...
80100f52:	e8 c6 43 00 00       	call   8010531d <release>
      return f;
...
80100f70:	e8 a8 43 00 00       	call   8010531d <release>
  return 0;
...
80100f89:	e8 2d 43 00 00       	call   801052bb <acquire>
  if(f->ref < 1)
...
80100f96:	7f 0c                	jg     80100fa4 <filedup+0x28>
    panic("filedup");
80100f98:	c7 04 24 b4 8a 10 80 	movl   $0x80108ab4,(%esp)
...
80100fba:	e8 5e 43 00 00       	call   8010531d <release>
  return f;
...
80100fd1:	e8 e5 42 00 00       	call   801052bb <acquire>
  if(f->ref < 1)
...
80100fde:	7f 0c                	jg     80100fec <fileclose+0x28>
    panic("fileclose");
80100fe0:	c7 04 24 bc 8a 10 80 	movl   $0x80108abc,(%esp)
...
8010100c:	e8 0c 43 00 00       	call   8010531d <release>
    return;
...
80101056:	e8 c2 42 00 00       	call   8010531d <release>
...
80101195:	eb 0c                	jmp    801011a3 <fileread+0xba>
  ...
  panic("fileread");
80101197:	c7 04 24 c6 8a 10 80 	movl   $0x80108ac6,(%esp)
...
801012a3:	c7 04 24 cf 8a 10 80 	movl   $0x80108acf,(%esp)
...
801012d6:	eb 0c                	jmp    801012e4 <filewrite+0x13f>
  ...
  panic("filewrite");
801012d8:	c7 04 24 df 8a 10 80 	movl   $0x80108adf,(%esp)
...
80101320:	e8 b8 42 00 00       	call   801055dd <memmove>
  brelse(bp);
...
80101366:	e8 9f 41 00 00       	call   8010550a <memset>
  log_write(bp);
...
801014c8:	0f 82 e1 fe ff ff    	jb     801013af <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014ce:	c7 04 24 e9 8a 10 80 	movl   $0x80108ae9,(%esp)
...
80101565:	c7 04 24 ff 8a 10 80 	movl   $0x80108aff,(%esp)
...
801015b9:	c7 44 24 04 12 8b 10 	movl   $0x80108b12,0x4(%esp)
801015c0:	80 
801015c1:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
801015c8:	e8 cd 3c 00 00       	call   8010529a <initlock>
}
801015cd:	c9                   	leave  
801015ce:	c3                   	ret    
...
8010164a:	e8 bb 3e 00 00       	call   8010550a <memset>
      dip->type = type;
...
8010169a:	0f 82 5a ff ff ff    	jb     801015fa <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
801016a0:	c7 04 24 19 8b 10 80 	movl   $0x80108b19,(%esp)
...
80101747:	e8 91 3e 00 00       	call   801055dd <memmove>
  log_write(bp);
...
80101771:	e8 45 3b 00 00       	call   801052bb <acquire>
...
801017bb:	e8 5d 3b 00 00       	call   8010531d <release>
      return ip;
...
801017ee:	c7 04 24 2b 8b 10 80 	movl   $0x80108b2b,(%esp)
...
8010182c:	e8 ec 3a 00 00       	call   8010531d <release>
...
80101843:	e8 73 3a 00 00       	call   801052bb <acquire>
  ip->ref++;
...
8010185e:	e8 ba 3a 00 00       	call   8010531d <release>
  return ip;
...
8010187c:	7f 0c                	jg     8010188a <ilock+0x22>
    panic("ilock");
8010187e:	c7 04 24 3b 8b 10 80 	movl   $0x80108b3b,(%esp)
80101885:	e8 b3 ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
8010188a:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
80101891:	e8 25 3a 00 00       	call   801052bb <acquire>
...
801018d0:	e8 48 3a 00 00       	call   8010531d <release>
...
8010197b:	e8 5d 3c 00 00       	call   801055dd <memmove>
    brelse(bp);
...
801019a6:	75 0c                	jne    801019b4 <ilock+0x14c>
      panic("ilock: no type");
801019a8:	c7 04 24 41 8b 10 80 	movl   $0x80108b41,(%esp)
...
801019d7:	7f 0c                	jg     801019e5 <iunlock+0x2f>
    panic("iunlock");
801019d9:	c7 04 24 50 8b 10 80 	movl   $0x80108b50,(%esp)
801019e0:	e8 58 eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019e5:	c7 04 24 80 f8 10 80 	movl   $0x8010f880,(%esp)
801019ec:	e8 ca 38 00 00       	call   801052bb <acquire>
  ip->flags &= ~I_BUSY;
...
80101a14:	e8 04 39 00 00       	call   8010531d <release>
}
80101a19:	c9                   	leave  
80101a1a:	c3                   	ret    
...
80101a28:	e8 8e 38 00 00       	call   801052bb <acquire>
...
80101a64:	74 0c                	je     80101a72 <iput+0x57>
      panic("iput busy");
80101a66:	c7 04 24 58 8b 10 80 	movl   $0x80108b58,(%esp)
...
80101a8a:	e8 8e 38 00 00       	call   8010531d <release>
    itrunc(ip);
...
80101ab5:	e8 01 38 00 00       	call   801052bb <acquire>
    ip->flags = 0;
...
80101ae5:	e8 33 38 00 00       	call   8010531d <release>
}
80101aea:	c9                   	leave  
80101aeb:	c3                   	ret    
...
80101bfa:	c7 04 24 62 8b 10 80 	movl   $0x80108b62,(%esp)
...
80101e92:	e8 46 37 00 00       	call   801055dd <memmove>
    brelse(bp);
...
80101ff8:	e8 e0 35 00 00       	call   801055dd <memmove>
    log_write(bp);
...
8010207a:	e8 02 36 00 00       	call   80105681 <strncmp>
}
8010207f:	c9                   	leave  
80102080:	c3                   	ret    
...
80102094:	c7 04 24 75 8b 10 80 	movl   $0x80108b75,(%esp)
...
801020d0:	74 0c                	je     801020de <dirlookup+0x5d>
      panic("dirlink read");
801020d2:	c7 04 24 87 8b 10 80 	movl   $0x80108b87,(%esp)
...
801021b4:	74 0c                	je     801021c2 <dirlink+0x79>
      panic("dirlink read");
801021b6:	c7 04 24 87 8b 10 80 	movl   $0x80108b87,(%esp)
...
801021fc:	e8 d8 34 00 00       	call   801056d9 <strncpy>
  de.inum = inum;
...
8010222c:	74 0c                	je     8010223a <dirlink+0xf1>
    panic("dirlink");
8010222e:	c7 04 24 94 8b 10 80 	movl   $0x80108b94,(%esp)
...
801022b5:	e8 23 33 00 00       	call   801055dd <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022d0:	e8 08 33 00 00       	call   801055dd <memmove>
    name[len] = 0;
...
8010252c:	c7 44 24 04 9c 8b 10 	movl   $0x80108b9c,0x4(%esp)
80102533:	80 
80102534:	c7 04 24 20 c6 10 80 	movl   $0x8010c620,(%esp)
8010253b:	e8 5a 2d 00 00       	call   8010529a <initlock>
  picenable(IRQ_IDE);
...
801025d6:	75 0c                	jne    801025e4 <idestart+0x18>
    panic("idestart");
801025d8:	c7 04 24 a0 8b 10 80 	movl   $0x80108ba0,(%esp)
...
801026fe:	e8 b8 2b 00 00       	call   801052bb <acquire>
  if((b = idequeue) == 0){
...
80102718:	e8 00 2c 00 00       	call   8010531d <release>
...
801027ad:	e8 6b 2b 00 00       	call   8010531d <release>
}
801027b2:	c9                   	leave  
801027b3:	c3                   	ret    
...
801027c6:	c7 04 24 a9 8b 10 80 	movl   $0x80108ba9,(%esp)
...
801027df:	c7 04 24 bd 8b 10 80 	movl   $0x80108bbd,(%esp)
...
80102886:	e8 92 2a 00 00       	call   8010531d <release>
}
8010288b:	c9                   	leave  
8010288c:	c3                   	ret    
...
80102916:	c7 04 24 f0 8b 10 80 	movl   $0x80108bf0,(%esp)
...
801029d7:	c7 44 24 04 22 8c 10 	movl   $0x80108c22,0x4(%esp)
801029de:	80 
801029df:	c7 04 24 60 08 11 80 	movl   $0x80110860,(%esp)
801029e6:	e8 af 28 00 00       	call   8010529a <initlock>
  kmem.use_lock = 0;
...
80102a91:	76 0c                	jbe    80102a9f <kfree+0x39>
    panic("kfree");
80102a93:	c7 04 24 27 8c 10 80 	movl   $0x80108c27,(%esp)
...
80102ab5:	e8 50 2a 00 00       	call   8010550a <memset>
...
80102aca:	e8 ec 27 00 00       	call   801052bb <acquire>
  r = (struct run*)v;
...
80102af8:	e8 20 28 00 00       	call   8010531d <release>
}
80102afd:	c9                   	leave  
80102afe:	c3                   	ret    
...
80102b15:	e8 a1 27 00 00       	call   801052bb <acquire>
  r = kmem.freelist;
...
80102b42:	e8 d6 27 00 00       	call   8010531d <release>
  return (char*)r;
...
80102ebe:	c7 04 24 30 8c 10 80 	movl   $0x80108c30,(%esp)
...
80103016:	c7 44 24 04 5c 8c 10 	movl   $0x80108c5c,0x4(%esp)
8010301d:	80 
8010301e:	c7 04 24 a0 08 11 80 	movl   $0x801108a0,(%esp)
80103025:	e8 70 22 00 00       	call   8010529a <initlock>
  readsb(ROOTDEV, &sb);
...
801030d8:	e8 00 25 00 00       	call   801055dd <memmove>
...
8010322a:	e8 8c 20 00 00       	call   801052bb <acquire>
  while (log.busy) {
...
8010325f:	e8 b9 20 00 00       	call   8010531d <release>
}
80103264:	c9                   	leave  
80103265:	c3                   	ret    
...
80103295:	e8 21 20 00 00       	call   801052bb <acquire>
  log.busy = 0;
...
801032b7:	e8 61 20 00 00       	call   8010531d <release>
}
801032bc:	c9                   	leave  
801032bd:	c3                   	ret    
...
801032e0:	c7 04 24 60 8c 10 80 	movl   $0x80108c60,(%esp)
...
801032f5:	c7 04 24 76 8c 10 80 	movl   $0x80108c76,(%esp)
...
80103384:	e8 54 22 00 00       	call   801055dd <memmove>
  bwrite(lbuf);
...
80103424:	e8 91 4e 00 00       	call   801082ba <kvmalloc>
...
8010343b:	e8 1d 48 00 00       	call   80107c5d <seginit>
  cprintf("\ncpu%d: starting xv6\n\n", cpu->id);
...
80103450:	c7 04 24 8d 8c 10 80 	movl   $0x80108c8d,(%esp)
...
8010346b:	e8 38 3b 00 00       	call   80106fa8 <uartinit>
  pinit();         // process table
80103470:	e8 96 0b 00 00       	call   8010400b <pinit>
  tvinit();        // trap vectors
80103475:	e8 d1 36 00 00       	call   80106b4b <tvinit>
  binit();         // buffer cache
...
80103497:	e8 f2 35 00 00       	call   80106a8e <timerinit>
...
801034c2:	83 ec 18             	sub    $0x18,%esp
  switchkvm(); 
801034c5:	e8 07 4e 00 00       	call   801082d1 <switchkvm>
  seginit();
801034ca:	e8 8e 47 00 00       	call   80107c5d <seginit>
  lapicinit(cpunum());
...
801034f7:	c7 04 24 a4 8c 10 80 	movl   $0x80108ca4,(%esp)
801034fe:	e8 9e ce ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
80103503:	e8 b7 37 00 00       	call   80106cbf <idtinit>
...
80103555:	e8 83 20 00 00       	call   801055dd <memmove>
...
801036e3:	00 
801036e4:	c7 44 24 04 b8 8c 10 	movl   $0x80108cb8,0x4(%esp)
801036eb:	80 
801036ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036ef:	89 04 24             	mov    %eax,(%esp)
801036f2:	e8 8a 1e 00 00       	call   80105581 <memcmp>
...
80103824:	00 
80103825:	c7 44 24 04 bd 8c 10 	movl   $0x80108cbd,0x4(%esp)
8010382c:	80 
8010382d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103830:	89 04 24             	mov    %eax,(%esp)
80103833:	e8 49 1d 00 00       	call   80105581 <memcmp>
...
801038fe:	8b 04 85 00 8d 10 80 	mov    -0x7fef7300(,%eax,4),%eax
...
80103937:	c7 04 24 c2 8c 10 80 	movl   $0x80108cc2,(%esp)
...
801039ca:	c7 04 24 e0 8c 10 80 	movl   $0x80108ce0,(%esp)
...
80103ccf:	c7 44 24 04 14 8d 10 	movl   $0x80108d14,0x4(%esp)
80103cd6:	80 
80103cd7:	89 04 24             	mov    %eax,(%esp)
80103cda:	e8 bb 15 00 00       	call   8010529a <initlock>
  (*f0)->type = FD_PIPE;
...
80103d87:	e8 2f 15 00 00       	call   801052bb <acquire>
  if(writable){
...
80103dee:	e8 2a 15 00 00       	call   8010531d <release>
    kfree((char*)p);
...
80103e06:	e8 12 15 00 00       	call   8010531d <release>
}
80103e0b:	c9                   	leave  
80103e0c:	c3                   	ret    
...
80103e1a:	e8 9c 14 00 00       	call   801052bb <acquire>
  for(i = 0; i < n; i++){
...
80103e4b:	e8 cd 14 00 00       	call   8010531d <release>
        return -1;
...
80103eef:	e8 29 14 00 00       	call   8010531d <release>
  return n;
...
80103f0a:	e8 ac 13 00 00       	call   801052bb <acquire>
...
80103f24:	e8 f4 13 00 00       	call   8010531d <release>
      return -1;
...
80103fe1:	e8 37 13 00 00       	call   8010531d <release>
  return i;
...
80104011:	c7 44 24 04 19 8d 10 	movl   $0x80108d19,0x4(%esp)
80104018:	80 
80104019:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104020:	e8 75 12 00 00       	call   8010529a <initlock>
}
80104025:	c9                   	leave  
80104026:	c3                   	ret    
...
80104034:	e8 82 12 00 00       	call   801052bb <acquire>
...
80104063:	e8 b5 12 00 00       	call   8010531d <release>
  return 0;
...
80104097:	e8 81 12 00 00       	call   8010531d <release>
...
801040e1:	ba 00 6b 10 80       	mov    $0x80106b00,%edx
...
80104111:	e8 f4 13 00 00       	call   8010550a <memset>
...
80104153:	e8 a5 40 00 00       	call   801081fd <setupkvm>
...
80104168:	c7 04 24 20 8d 10 80 	movl   $0x80108d20,(%esp)
...
8010418e:	e8 c2 42 00 00       	call   80108455 <inituvm>
  p->sz = PGSIZE;
...
801041b5:	e8 50 13 00 00       	call   8010550a <memset>
...
8010422e:	00 
8010422f:	c7 44 24 04 39 8d 10 	movl   $0x80108d39,0x4(%esp)
80104236:	80 
80104237:	89 04 24             	mov    %eax,(%esp)
8010423a:	e8 fb 14 00 00       	call   8010573a <safestrcpy>
  p->cwd = namei("/");
8010423f:	c7 04 24 42 8d 10 80 	movl   $0x80108d42,(%esp)
...
80104293:	e8 37 43 00 00       	call   801085cf <allocuvm>
...
801042cd:	e8 d7 43 00 00       	call   801086a9 <deallocuvm>
...
801042f6:	e8 f3 3f 00 00       	call   801082ee <switchuvm>
  return 0;
...
8010433b:	e8 f9 44 00 00       	call   80108839 <copyuvm>
...
80104497:	e8 9e 12 00 00       	call   8010573a <safestrcpy>
  return pid;
...
801044bb:	75 0c                	jne    801044c9 <exit+0x22>
    panic("init exiting");
801044bd:	c7 04 24 44 8d 10 80 	movl   $0x80108d44,(%esp)
...
80104574:	75 4d                	jne    801045c3 <exit+0x11c>
80104576:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104579:	8b 40 0c             	mov    0xc(%eax),%eax
8010457c:	83 f8 05             	cmp    $0x5,%eax
8010457f:	74 42                	je     801045c3 <exit+0x11c>
        // Found one.
        p->state = ZOMBIE;
80104581:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104584:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
	if(p->isthread)
8010458b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010458e:	8b 40 7c             	mov    0x7c(%eax),%eax
80104591:	85 c0                	test   %eax,%eax
80104593:	74 17                	je     801045ac <exit+0x105>
	  p->parent->threadnum--;
80104595:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104598:	8b 40 14             	mov    0x14(%eax),%eax
8010459b:	8b 90 88 00 00 00    	mov    0x88(%eax),%edx
801045a1:	83 ea 01             	sub    $0x1,%edx
801045a4:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == proc->pid && p->state != ZOMBIE){		// for threads
        ...
        p->state = ZOMBIE;
	if(p->isthread)
801045aa:	eb 56                	jmp    80104602 <exit+0x15b>
	  p->parent->threadnum--;
	else
	  p->threadnum--;
801045ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045af:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
801045b5:	8d 50 ff             	lea    -0x1(%eax),%edx
801045b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045bb:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == proc->pid && p->state != ZOMBIE){		// for threads
        ...
        p->state = ZOMBIE;
	if(p->isthread)
801045c1:	eb 3f                	jmp    80104602 <exit+0x15b>
	  p->parent->threadnum--;
	else
	  p->threadnum--;
      }
...
801045c6:	8b 50 14             	mov    0x14(%eax),%edx
801045c9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801045cf:	39 c2                	cmp    %eax,%edx
801045d1:	75 2f                	jne    80104602 <exit+0x15b>
801045d3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045d6:	8b 40 7c             	mov    0x7c(%eax),%eax
801045d9:	83 f8 01             	cmp    $0x1,%eax
801045dc:	74 24                	je     80104602 <exit+0x15b>
      p->parent = initproc;
801045de:	8b 15 68 c6 10 80    	mov    0x8010c668,%edx
801045e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045e7:	89 50 14             	mov    %edx,0x14(%eax)
      if(p->state == ZOMBIE)
801045ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801045ed:	8b 40 0c             	mov    0xc(%eax),%eax
801045f0:	83 f8 05             	cmp    $0x5,%eax
801045f3:	75 0d                	jne    80104602 <exit+0x15b>
        wakeup1(initproc);
801045f5:	a1 68 c6 10 80       	mov    0x8010c668,%eax
801045fa:	89 04 24             	mov    %eax,(%esp)
801045fd:	e8 9b 04 00 00       	call   80104a9d <wakeup1>
  acquire(&ptable.lock);
  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
  // Pass abandoned children to init.
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104602:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104609:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
80104610:	0f 82 4d ff ff ff    	jb     80104563 <exit+0xbc>
        wakeup1(initproc);
    }
  }
...
8010461c:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
  sched();
80104623:	e8 ca 02 00 00       	call   801048f2 <sched>
  panic("zombie exit");
80104628:	c7 04 24 51 8d 10 80 	movl   $0x80108d51,(%esp)
8010462f:	e8 09 bf ff ff       	call   8010053d <panic>
...
80104637:	83 ec 38             	sub    $0x38,%esp
  struct proc *p;
  int havekids, pid;
  int found = 0, first = 0;
8010463a:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
80104641:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)

  acquire(&ptable.lock);
80104648:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
8010464f:	e8 67 0c 00 00       	call   801052bb <acquire>
  for(;;){
    // Scan through table looking for zombie children.
    havekids = 0;
80104654:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010465b:	c7 45 f4 b4 15 11 80 	movl   $0x801115b4,-0xc(%ebp)
80104662:	eb 4c                	jmp    801046b0 <wait+0x7c>
      if(p->parent != proc)
80104664:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104667:	8b 50 14             	mov    0x14(%eax),%edx
8010466a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104670:	39 c2                	cmp    %eax,%edx
80104672:	75 34                	jne    801046a8 <wait+0x74>
        continue;
      havekids = 1;
80104674:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      if(p->state == ZOMBIE && !p->isthread && p->threadnum == 0){
8010467b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010467e:	8b 40 0c             	mov    0xc(%eax),%eax
80104681:	83 f8 05             	cmp    $0x5,%eax
80104684:	75 23                	jne    801046a9 <wait+0x75>
80104686:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104689:	8b 40 7c             	mov    0x7c(%eax),%eax
8010468c:	85 c0                	test   %eax,%eax
8010468e:	75 19                	jne    801046a9 <wait+0x75>
80104690:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104693:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80104699:	85 c0                	test   %eax,%eax
8010469b:	75 0c                	jne    801046a9 <wait+0x75>
        found = p->pid;
8010469d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046a0:	8b 40 10             	mov    0x10(%eax),%eax
801046a3:	89 45 e8             	mov    %eax,-0x18(%ebp)
	break;
801046a6:	eb 11                	jmp    801046b9 <wait+0x85>
    // Scan through table looking for zombie children.
    havekids = 0;
...
801046a8:	90                   	nop
  ...
  for(;;){
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046a9:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
801046b0:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
801046b7:	72 ab                	jb     80104664 <wait+0x30>
	break;
      }
    }
    ...
    if(found)
801046b9:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801046bd:	0f 84 99 00 00 00    	je     8010475c <wait+0x128>
    {
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046c3:	c7 45 f4 b4 15 11 80 	movl   $0x801115b4,-0xc(%ebp)
801046ca:	e9 80 00 00 00       	jmp    8010474f <wait+0x11b>
	if(p->pid != found)
801046cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046d2:	8b 40 10             	mov    0x10(%eax),%eax
801046d5:	3b 45 e8             	cmp    -0x18(%ebp),%eax
801046d8:	75 6d                	jne    80104747 <wait+0x113>
	  continue;
			    // we found a child process whom all of his threads are zombies (including himself)
	if(!first)
801046da:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
801046de:	75 15                	jne    801046f5 <wait+0xc1>
	{
	 freevm(p->pgdir);
801046e0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046e3:	8b 40 04             	mov    0x4(%eax),%eax
801046e6:	89 04 24             	mov    %eax,(%esp)
801046e9:	e8 77 40 00 00       	call   80108765 <freevm>
	 first = 1;
801046ee:	c7 45 e4 01 00 00 00 	movl   $0x1,-0x1c(%ebp)
	}
	pid = p->pid;
801046f5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046f8:	8b 40 10             	mov    0x10(%eax),%eax
801046fb:	89 45 ec             	mov    %eax,-0x14(%ebp)
	kfree(p->kstack);
801046fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104701:	8b 40 08             	mov    0x8(%eax),%eax
80104704:	89 04 24             	mov    %eax,(%esp)
80104707:	e8 5a e3 ff ff       	call   80102a66 <kfree>
	p->kstack = 0;
8010470c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010470f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
	p->state = UNUSED;
80104716:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104719:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
	p->pid = 0;
80104720:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104723:	c7 40 10 00 00 00 00 	movl   $0x0,0x10(%eax)
	p->parent = 0;
8010472a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010472d:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
	p->name[0] = 0;
80104734:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104737:	c6 40 6c 00          	movb   $0x0,0x6c(%eax)
	p->killed = 0;
8010473b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010473e:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
80104745:	eb 01                	jmp    80104748 <wait+0x114>
...
80104747:	90                   	nop
    ...
    {
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104748:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
8010474f:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
80104756:	0f 82 73 ff ff ff    	jb     801046cf <wait+0x9b>
	p->name[0] = 0;
	p->killed = 0;
      }
    }
    ...
    if(found)
8010475c:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80104760:	74 11                	je     80104773 <wait+0x13f>
    {
      release(&ptable.lock);
80104762:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104769:	e8 af 0b 00 00       	call   8010531d <release>
      return pid;
8010476e:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104771:	eb 41                	jmp    801047b4 <wait+0x180>
    }
...
801047af:	e9 a0 fe ff ff       	jmp    80104654 <wait+0x20>
}
801047b4:	c9                   	leave  
801047b5:	c3                   	ret    
...
801047da:	e8 6b 41 00 00       	call   8010894a <uva2ka>
...
801047f5:	75 0c                	jne    80104803 <register_handler+0x4d>
    panic("esp_offset == 0");
801047f7:	c7 04 24 5d 8d 10 80 	movl   $0x80108d5d,(%esp)
...
80104868:	e8 4e 0a 00 00       	call   801052bb <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104890:	e8 59 3a 00 00       	call   801082ee <switchuvm>
      p->state = RUNNING;
...
801048b9:	e8 f2 0e 00 00       	call   801057b0 <swtch>
      switchkvm();
801048be:	e8 0e 3a 00 00       	call   801082d1 <switchkvm>
...
801048d0:	90                   	nop
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048d1:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
801048d8:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
...
801048e8:	e8 30 0a 00 00       	call   8010531d <release>
...
801048ff:	e8 d5 0a 00 00       	call   801053d9 <holding>
80104904:	85 c0                	test   %eax,%eax
80104906:	75 0c                	jne    80104914 <sched+0x22>
    panic("sched ptable.lock");
80104908:	c7 04 24 6d 8d 10 80 	movl   $0x80108d6d,(%esp)
...
80104923:	74 0c                	je     80104931 <sched+0x3f>
    panic("sched locks");
80104925:	c7 04 24 7f 8d 10 80 	movl   $0x80108d7f,(%esp)
...
8010493d:	75 0c                	jne    8010494b <sched+0x59>
    panic("sched running");
8010493f:	c7 04 24 8b 8d 10 80 	movl   $0x80108d8b,(%esp)
...
80104959:	c7 04 24 99 8d 10 80 	movl   $0x80108d99,(%esp)
...
8010498e:	e8 1d 0e 00 00       	call   801057b0 <swtch>
  cpu->intena = intena;
...
801049b1:	e8 05 09 00 00       	call   801052bb <acquire>
  proc->state = RUNNABLE;
...
801049cf:	e8 49 09 00 00       	call   8010531d <release>
}
801049d4:	c9                   	leave  
801049d5:	c3                   	ret    
...
801049e3:	e8 35 09 00 00       	call   8010531d <release>
...
80104a10:	75 0c                	jne    80104a1e <sleep+0x1c>
    panic("sleep");
80104a12:	c7 04 24 ad 8d 10 80 	movl   $0x80108dad,(%esp)
...
80104a24:	c7 04 24 b3 8d 10 80 	movl   $0x80108db3,(%esp)
...
80104a40:	e8 76 08 00 00       	call   801052bb <acquire>
    release(lk);
80104a45:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a48:	89 04 24             	mov    %eax,(%esp)
80104a4b:	e8 cd 08 00 00       	call   8010531d <release>
  }
...
80104a8b:	e8 8d 08 00 00       	call   8010531d <release>
    acquire(lk);
80104a90:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a93:	89 04 24             	mov    %eax,(%esp)
80104a96:	e8 20 08 00 00       	call   801052bb <acquire>
  }
}
80104a9b:	c9                   	leave  
80104a9c:	c3                   	ret    
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104acc:	81 45 fc 98 00 00 00 	addl   $0x98,-0x4(%ebp)
80104ad3:	81 7d fc b4 3b 11 80 	cmpl   $0x80113bb4,-0x4(%ebp)
...
80104aeb:	e8 cb 07 00 00       	call   801052bb <acquire>
  wakeup1(chan);
...
80104b02:	e8 16 08 00 00       	call   8010531d <release>
}
80104b07:	c9                   	leave  
80104b08:	c3                   	ret    
...
80104b16:	e8 a0 07 00 00       	call   801052bb <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104b55:	e8 c3 07 00 00       	call   8010531d <release>
      return 0;
...
kill(int pid)
{
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b61:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104b68:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
...
80104b78:	e8 a0 07 00 00       	call   8010531d <release>
  return -1;
...
80104bd0:	eb 07                	jmp    80104bd9 <procdump+0x55>
      ...
      state = "???";
80104bd2:	c7 45 ec c4 8d 10 80 	movl   $0x80108dc4,-0x14(%ebp)
...
80104bf4:	c7 04 24 c8 8d 10 80 	movl   $0x80108dc8,(%esp)
...
80104c21:	e8 46 07 00 00       	call   8010536c <getcallerpcs>
...
80104c3a:	c7 04 24 d1 8d 10 80 	movl   $0x80108dd1,(%esp)
...
80104c59:	75 d4                	jne    80104c2f <procdump+0xab>
    ...
    cprintf("\n");
80104c5b:	c7 04 24 d5 8d 10 80 	movl   $0x80108dd5,(%esp)
...
80104c69:	90                   	nop
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c6a:	81 45 f0 98 00 00 00 	addl   $0x98,-0x10(%ebp)
80104c71:	81 7d f0 b4 3b 11 80 	cmpl   $0x80113bb4,-0x10(%ebp)
...
80104c86:	83 ec 2c             	sub    $0x2c,%esp
  ...
  // Allocate process.
  if((np = allocproc()) == 0)
80104c89:	e8 99 f3 ff ff       	call   80104027 <allocproc>
80104c8e:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104c91:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104c95:	75 0a                	jne    80104ca1 <thread_create+0x21>
    return -1;
80104c97:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c9c:	e9 70 01 00 00       	jmp    80104e11 <thread_create+0x191>

  np->pid = proc->pid;
80104ca1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ca7:	8b 50 10             	mov    0x10(%eax),%edx
80104caa:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104cad:	89 50 10             	mov    %edx,0x10(%eax)
  // Copy process state from p.
  np->pgdir = proc->pgdir;
80104cb0:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cb6:	8b 50 04             	mov    0x4(%eax),%edx
80104cb9:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104cbc:	89 50 04             	mov    %edx,0x4(%eax)
  np->sz = proc->sz;
80104cbf:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cc5:	8b 10                	mov    (%eax),%edx
80104cc7:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104cca:	89 10                	mov    %edx,(%eax)
  if(proc->isthread)
80104ccc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cd2:	8b 40 7c             	mov    0x7c(%eax),%eax
80104cd5:	85 c0                	test   %eax,%eax
80104cd7:	74 11                	je     80104cea <thread_create+0x6a>
    np->parent = proc->parent;
80104cd9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104cdf:	8b 50 14             	mov    0x14(%eax),%edx
80104ce2:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104ce5:	89 50 14             	mov    %edx,0x14(%eax)
80104ce8:	eb 0d                	jmp    80104cf7 <thread_create+0x77>
  else
    np->parent = proc;
80104cea:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104cf1:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104cf4:	89 50 14             	mov    %edx,0x14(%eax)
  np->parent->threadnum++;
80104cf7:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104cfa:	8b 40 14             	mov    0x14(%eax),%eax
80104cfd:	8b 90 88 00 00 00    	mov    0x88(%eax),%edx
80104d03:	83 c2 01             	add    $0x1,%edx
80104d06:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)

  np->isthread = 1;
80104d0c:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d0f:	c7 40 7c 01 00 00 00 	movl   $0x1,0x7c(%eax)
  np->isjoined = 0;
80104d16:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d19:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
80104d20:	00 00 00 
  np->thread_id = ++(np->parent->thread_id);
80104d23:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d26:	8b 50 14             	mov    0x14(%eax),%edx
80104d29:	8b 82 84 00 00 00    	mov    0x84(%edx),%eax
80104d2f:	83 c0 01             	add    $0x1,%eax
80104d32:	89 82 84 00 00 00    	mov    %eax,0x84(%edx)
80104d38:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104d3b:	89 82 84 00 00 00    	mov    %eax,0x84(%edx)
  *np->tf = *proc->tf;
80104d41:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d44:	8b 50 18             	mov    0x18(%eax),%edx
80104d47:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d4d:	8b 40 18             	mov    0x18(%eax),%eax
80104d50:	89 c3                	mov    %eax,%ebx
80104d52:	b8 13 00 00 00       	mov    $0x13,%eax
80104d57:	89 d7                	mov    %edx,%edi
80104d59:	89 de                	mov    %ebx,%esi
80104d5b:	89 c1                	mov    %eax,%ecx
80104d5d:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->tf->esp = (uint)stack+stack_size;
80104d5f:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d62:	8b 40 18             	mov    0x18(%eax),%eax
80104d65:	8b 55 0c             	mov    0xc(%ebp),%edx
80104d68:	03 55 10             	add    0x10(%ebp),%edx
80104d6b:	89 50 44             	mov    %edx,0x44(%eax)
  np->tf->eip = (uint)start_func;
80104d6e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104d71:	8b 40 18             	mov    0x18(%eax),%eax
80104d74:	8b 55 08             	mov    0x8(%ebp),%edx
80104d77:	89 50 38             	mov    %edx,0x38(%eax)
  for(i = 0; i < NOFILE; i++)
80104d7a:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104d81:	eb 3d                	jmp    80104dc0 <thread_create+0x140>
    if(proc->ofile[i])
80104d83:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d89:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104d8c:	83 c2 08             	add    $0x8,%edx
80104d8f:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104d93:	85 c0                	test   %eax,%eax
80104d95:	74 25                	je     80104dbc <thread_create+0x13c>
      np->ofile[i] = filedup(proc->ofile[i]);
80104d97:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104d9d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104da0:	83 c2 08             	add    $0x8,%edx
80104da3:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80104da7:	89 04 24             	mov    %eax,(%esp)
80104daa:	e8 cd c1 ff ff       	call   80100f7c <filedup>
80104daf:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104db2:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80104db5:	83 c1 08             	add    $0x8,%ecx
80104db8:	89 44 8a 08          	mov    %eax,0x8(%edx,%ecx,4)
  np->isjoined = 0;
  np->thread_id = ++(np->parent->thread_id);
  *np->tf = *proc->tf;
  np->tf->esp = (uint)stack+stack_size;
  np->tf->eip = (uint)start_func;
  for(i = 0; i < NOFILE; i++)
80104dbc:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80104dc0:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104dc4:	7e bd                	jle    80104d83 <thread_create+0x103>
    if(proc->ofile[i])
      np->ofile[i] = filedup(proc->ofile[i]);
  np->cwd = proc->cwd;
80104dc6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104dcc:	8b 50 68             	mov    0x68(%eax),%edx
80104dcf:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104dd2:	89 50 68             	mov    %edx,0x68(%eax)
  tid = np->thread_id;
80104dd5:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104dd8:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
80104dde:	89 45 dc             	mov    %eax,-0x24(%ebp)
  np->state = RUNNABLE;
80104de1:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104de4:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  safestrcpy(np->name, proc->name, sizeof(proc->name));
80104deb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104df1:	8d 50 6c             	lea    0x6c(%eax),%edx
80104df4:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104df7:	83 c0 6c             	add    $0x6c,%eax
80104dfa:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80104e01:	00 
80104e02:	89 54 24 04          	mov    %edx,0x4(%esp)
80104e06:	89 04 24             	mov    %eax,(%esp)
80104e09:	e8 2c 09 00 00       	call   8010573a <safestrcpy>
  return tid;
80104e0e:	8b 45 dc             	mov    -0x24(%ebp),%eax
}
80104e11:	83 c4 2c             	add    $0x2c,%esp
80104e14:	5b                   	pop    %ebx
80104e15:	5e                   	pop    %esi
80104e16:	5f                   	pop    %edi
80104e17:	5d                   	pop    %ebp
...
80104e24:	74 1b                	je     80104e41 <thread_getId+0x28>
80104e26:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e2c:	8b 40 7c             	mov    0x7c(%eax),%eax
80104e2f:	85 c0                	test   %eax,%eax
80104e31:	74 0e                	je     80104e41 <thread_getId+0x28>
    return proc->thread_id;
80104e33:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e39:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
80104e3f:	eb 05                	jmp    80104e46 <thread_getId+0x2d>
  else
    return -1; 
...
80104e53:	74 0b                	je     80104e60 <thread_getProcId+0x18>
    return proc->pid;  
80104e55:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e5b:	8b 40 10             	mov    0x10(%eax),%eax
80104e5e:	eb 05                	jmp    80104e65 <thread_getProcId+0x1d>
  else
    return -1;
...
80104e6a:	83 ec 28             	sub    $0x28,%esp
  struct proc *t = 0;
80104e6d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  int found = 0;
80104e74:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)

  acquire(&ptable.lock);
80104e7b:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104e82:	e8 34 04 00 00       	call   801052bb <acquire>
  for(t = ptable.proc; t < &ptable.proc[NPROC]; t++)
80104e87:	c7 45 f4 b4 15 11 80 	movl   $0x801115b4,-0xc(%ebp)
80104e8e:	e9 84 00 00 00       	jmp    80104f17 <thread_join+0xb0>
  {
    if(t->pid == proc->pid && t->isthread && t->thread_id == thread_id && t != proc)
80104e93:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e96:	8b 50 10             	mov    0x10(%eax),%edx
80104e99:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e9f:	8b 40 10             	mov    0x10(%eax),%eax
80104ea2:	39 c2                	cmp    %eax,%edx
80104ea4:	75 6a                	jne    80104f10 <thread_join+0xa9>
80104ea6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ea9:	8b 40 7c             	mov    0x7c(%eax),%eax
80104eac:	85 c0                	test   %eax,%eax
80104eae:	74 60                	je     80104f10 <thread_join+0xa9>
80104eb0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104eb3:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
80104eb9:	3b 45 08             	cmp    0x8(%ebp),%eax
80104ebc:	75 52                	jne    80104f10 <thread_join+0xa9>
80104ebe:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ec4:	39 45 f4             	cmp    %eax,-0xc(%ebp)
80104ec7:	74 47                	je     80104f10 <thread_join+0xa9>
    {
      if(t->isjoined)
80104ec9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ecc:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104ed2:	85 c0                	test   %eax,%eax
80104ed4:	74 07                	je     80104edd <thread_join+0x76>
	return -2;
80104ed6:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
80104edb:	eb 78                	jmp    80104f55 <thread_join+0xee>
      if(t->state == ZOMBIE){
80104edd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ee0:	8b 40 0c             	mov    0xc(%eax),%eax
80104ee3:	83 f8 05             	cmp    $0x5,%eax
80104ee6:	75 12                	jne    80104efa <thread_join+0x93>
	ret_val =  &(t->ret_val);
80104ee8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104eeb:	05 94 00 00 00       	add    $0x94,%eax
80104ef0:	89 45 ec             	mov    %eax,-0x14(%ebp)
	return 0;
80104ef3:	b8 00 00 00 00       	mov    $0x0,%eax
80104ef8:	eb 5b                	jmp    80104f55 <thread_join+0xee>
      }      
      t->isjoined = 1;
80104efa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104efd:	c7 80 80 00 00 00 01 	movl   $0x1,0x80(%eax)
80104f04:	00 00 00 
      found = 1;
80104f07:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
      break;
80104f0e:	eb 14                	jmp    80104f24 <thread_join+0xbd>
{
  struct proc *t = 0;
  int found = 0;
  ...
  acquire(&ptable.lock);
  for(t = ptable.proc; t < &ptable.proc[NPROC]; t++)
80104f10:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80104f17:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
80104f1e:	0f 82 6f ff ff ff    	jb     80104e93 <thread_join+0x2c>
      found = 1;
      break;
    }
  }
  ...
  if(!found)
80104f24:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80104f28:	75 13                	jne    80104f3d <thread_join+0xd6>
  {
    release(&ptable.lock);
80104f2a:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80104f31:	e8 e7 03 00 00       	call   8010531d <release>
    return -1;
80104f36:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104f3b:	eb 18                	jmp    80104f55 <thread_join+0xee>
  }

  sleep(t,&ptable.lock);
80104f3d:	c7 44 24 04 80 15 11 	movl   $0x80111580,0x4(%esp)
80104f44:	80 
80104f45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104f48:	89 04 24             	mov    %eax,(%esp)
80104f4b:	e8 b2 fa ff ff       	call   80104a02 <sleep>
  return 0;
...
80104f63:	8b 40 7c             	mov    0x7c(%eax),%eax
80104f66:	85 c0                	test   %eax,%eax
80104f68:	0f 84 8a 00 00 00    	je     80104ff8 <thread_exit+0xa1>
  {
    if(proc->parent->threadnum == 1)		// when main thread already commited thread_exit
80104f6e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104f74:	8b 40 14             	mov    0x14(%eax),%eax
80104f77:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80104f7d:	83 f8 01             	cmp    $0x1,%eax
80104f80:	75 1d                	jne    80104f9f <thread_exit+0x48>
    {
...
80104f91:	83 ea 01             	sub    $0x1,%edx
80104f94:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
      exit();
80104f9a:	e8 08 f5 ff ff       	call   801044a7 <exit>
    }
...
80104fa8:	89 90 94 00 00 00    	mov    %edx,0x94(%eax)
    proc->parent->threadnum--;
80104fae:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fb4:	8b 40 14             	mov    0x14(%eax),%eax
80104fb7:	8b 90 88 00 00 00    	mov    0x88(%eax),%edx
80104fbd:	83 ea 01             	sub    $0x1,%edx
80104fc0:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
    proc->state = ZOMBIE;
80104fc6:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fcc:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
    if(proc->isjoined)
80104fd3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fd9:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104fdf:	85 c0                	test   %eax,%eax
80104fe1:	74 0e                	je     80104ff1 <thread_exit+0x9a>
      wakeup(proc);
80104fe3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104fe9:	89 04 24             	mov    %eax,(%esp)
80104fec:	e8 ed fa ff ff       	call   80104ade <wakeup>
    yield();
80104ff1:	e8 ae f9 ff ff       	call   801049a4 <yield>
80104ff6:	eb 54                	jmp    8010504c <thread_exit+0xf5>
  }
  else if(proc->threadnum == 1)		// main thread is the last thread of the process
80104ff8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104ffe:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80105004:	83 f8 01             	cmp    $0x1,%eax
80105007:	75 1c                	jne    80105025 <thread_exit+0xce>
  {
    proc->threadnum--;
80105009:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010500f:	8b 90 88 00 00 00    	mov    0x88(%eax),%edx
80105015:	83 ea 01             	sub    $0x1,%edx
80105018:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
    exit();
8010501e:	e8 84 f4 ff ff       	call   801044a7 <exit>
80105023:	eb 27                	jmp    8010504c <thread_exit+0xf5>
  }
...
80105031:	83 ea 01             	sub    $0x1,%edx
80105034:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
    proc->state = ZOMBIE;
8010503a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105040:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
    
    yield();
80105047:	e8 58 f9 ff ff       	call   801049a4 <yield>
  }
}
8010504c:	c9                   	leave  
8010504d:	c3                   	ret    

8010504e <binary_semaphore_create>:
...
80105051:	83 ec 28             	sub    $0x28,%esp
  struct b_semaphore* sem;
  int i = 0;
80105054:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  acquire(&semtable.lock);
8010505b:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
80105062:	e8 54 02 00 00       	call   801052bb <acquire>
  for(;i<128;i++)
80105067:	eb 47                	jmp    801050b0 <binary_semaphore_create+0x62>
  {
    sem = &semtable.binary_semaphores[i];
80105069:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010506c:	89 d0                	mov    %edx,%eax
8010506e:	01 c0                	add    %eax,%eax
80105070:	01 d0                	add    %edx,%eax
80105072:	c1 e0 02             	shl    $0x2,%eax
80105075:	05 40 0f 11 80       	add    $0x80110f40,%eax
8010507a:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(sem->taken)
8010507d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105080:	8b 40 04             	mov    0x4(%eax),%eax
80105083:	85 c0                	test   %eax,%eax
80105085:	74 06                	je     8010508d <binary_semaphore_create+0x3f>
binary_semaphore_create(int initial_value)
{
  struct b_semaphore* sem;
  int i = 0;
  acquire(&semtable.lock);
  for(;i<128;i++)
80105087:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010508b:	eb 23                	jmp    801050b0 <binary_semaphore_create+0x62>
  {
    sem = &semtable.binary_semaphores[i];
    if(sem->taken)
      continue;
...
80105090:	c7 40 04 01 00 00 00 	movl   $0x1,0x4(%eax)
    sem->value = initial_value;
80105097:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010509a:	8b 55 08             	mov    0x8(%ebp),%edx
8010509d:	89 10                	mov    %edx,(%eax)
    release(&semtable.lock);
8010509f:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
801050a6:	e8 72 02 00 00       	call   8010531d <release>
    return i;
801050ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
801050ae:	eb 17                	jmp    801050c7 <binary_semaphore_create+0x79>
binary_semaphore_create(int initial_value)
{
  struct b_semaphore* sem;
  int i = 0;
  acquire(&semtable.lock);
  for(;i<128;i++)
801050b0:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801050b4:	7e b3                	jle    80105069 <binary_semaphore_create+0x1b>
    sem->taken = 1;
    sem->value = initial_value;
    release(&semtable.lock);
    return i;
  ...
  release(&semtable.lock);
801050b6:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
801050bd:	e8 5b 02 00 00       	call   8010531d <release>
  return -1;
...
801050c9 <binary_semaphore_down>:
...
801050cc:	83 ec 28             	sub    $0x28,%esp
  acquire(&semtable.lock);
801050cf:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
801050d6:	e8 e0 01 00 00       	call   801052bb <acquire>
  for(;;)
  {
...
801050e0:	01 c0                	add    %eax,%eax
801050e2:	01 d0                	add    %edx,%eax
801050e4:	c1 e0 02             	shl    $0x2,%eax
801050e7:	05 40 0f 11 80       	add    $0x80110f40,%eax
...
801050f7:	0f 85 8d 00 00 00    	jne    8010518a <binary_semaphore_down+0xc1>
    {
      if(!sem->value && !proc->sem_queue_pos)
801050fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105100:	8b 00                	mov    (%eax),%eax
80105102:	85 c0                	test   %eax,%eax
80105104:	75 3c                	jne    80105142 <binary_semaphore_down+0x79>
80105106:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010510c:	8b 80 90 00 00 00    	mov    0x90(%eax),%eax
80105112:	85 c0                	test   %eax,%eax
80105114:	75 2c                	jne    80105142 <binary_semaphore_down+0x79>
      {
	sem->value = 1;
80105116:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105119:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
	proc->waiting_for_semaphore = -1;
8010511f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105125:	c7 80 8c 00 00 00 ff 	movl   $0xffffffff,0x8c(%eax)
8010512c:	ff ff ff 
	release(&semtable.lock);
8010512f:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
80105136:	e8 e2 01 00 00       	call   8010531d <release>
	return 0;
8010513b:	b8 00 00 00 00       	mov    $0x0,%eax
80105140:	eb 59                	jmp    8010519b <binary_semaphore_down+0xd2>
      }
      else
      {
...
8010514b:	89 90 8c 00 00 00    	mov    %edx,0x8c(%eax)
	proc->sem_queue_pos = ++(sem->waiting);
80105151:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105157:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010515a:	8b 52 08             	mov    0x8(%edx),%edx
8010515d:	8d 4a 01             	lea    0x1(%edx),%ecx
80105160:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105163:	89 4a 08             	mov    %ecx,0x8(%edx)
80105166:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105169:	8b 52 08             	mov    0x8(%edx),%edx
8010516c:	89 90 90 00 00 00    	mov    %edx,0x90(%eax)
	sleep(sem,&semtable.lock);
80105172:	c7 44 24 04 40 15 11 	movl   $0x80111540,0x4(%esp)
80105179:	80 
8010517a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010517d:	89 04 24             	mov    %eax,(%esp)
80105180:	e8 7d f8 ff ff       	call   80104a02 <sleep>
    else
    {
      release(&semtable.lock);
      return -1;
...
80105185:	e9 51 ff ff ff       	jmp    801050db <binary_semaphore_down+0x12>
	sleep(sem,&semtable.lock);
      }
    }
    else
    {
      release(&semtable.lock);
8010518a:	c7 04 24 40 15 11 80 	movl   $0x80111540,(%esp)
80105191:	e8 87 01 00 00       	call   8010531d <release>
      return -1;
...
801051a0:	83 ec 28             	sub    $0x28,%esp
  struct b_semaphore* sem = &semtable.binary_semaphores[binary_semaphore_ID];
801051a3:	8b 55 08             	mov    0x8(%ebp),%edx
801051a6:	89 d0                	mov    %edx,%eax
801051a8:	01 c0                	add    %eax,%eax
801051aa:	01 d0                	add    %edx,%eax
801051ac:	c1 e0 02             	shl    $0x2,%eax
801051af:	05 40 0f 11 80       	add    $0x80110f40,%eax
801051b4:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(!sem->taken)
801051b7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801051ba:	8b 40 04             	mov    0x4(%eax),%eax
801051bd:	85 c0                	test   %eax,%eax
801051bf:	0f 85 88 00 00 00    	jne    8010524d <binary_semaphore_up+0xb0>
  {     
     struct proc *p;
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
801051c5:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
801051cc:	e8 ea 00 00 00       	call   801052bb <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801051d1:	c7 45 f4 b4 15 11 80 	movl   $0x801115b4,-0xc(%ebp)
801051d8:	eb 2a                	jmp    80105204 <binary_semaphore_up+0x67>
    {
      if(p->waiting_for_semaphore == binary_semaphore_ID)
801051da:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051dd:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
801051e3:	3b 45 08             	cmp    0x8(%ebp),%eax
801051e6:	75 15                	jne    801051fd <binary_semaphore_up+0x60>
        p->sem_queue_pos--;
801051e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051eb:	8b 80 90 00 00 00    	mov    0x90(%eax),%eax
801051f1:	8d 50 ff             	lea    -0x1(%eax),%edx
801051f4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051f7:	89 90 90 00 00 00    	mov    %edx,0x90(%eax)
  if(!sem->taken)
  {     
     struct proc *p;
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801051fd:	81 45 f4 98 00 00 00 	addl   $0x98,-0xc(%ebp)
80105204:	81 7d f4 b4 3b 11 80 	cmpl   $0x80113bb4,-0xc(%ebp)
8010520b:	72 cd                	jb     801051da <binary_semaphore_up+0x3d>
    {
      if(p->waiting_for_semaphore == binary_semaphore_ID)
        p->sem_queue_pos--;
    }
...
80105210:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    if(sem->waiting>0)
80105216:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105219:	8b 40 08             	mov    0x8(%eax),%eax
8010521c:	85 c0                	test   %eax,%eax
8010521e:	7e 0f                	jle    8010522f <binary_semaphore_up+0x92>
      sem->waiting--;
80105220:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105223:	8b 40 08             	mov    0x8(%eax),%eax
80105226:	8d 50 ff             	lea    -0x1(%eax),%edx
80105229:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010522c:	89 50 08             	mov    %edx,0x8(%eax)
    wakeup1(sem);
8010522f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105232:	89 04 24             	mov    %eax,(%esp)
80105235:	e8 63 f8 ff ff       	call   80104a9d <wakeup1>
    release(&ptable.lock);
8010523a:	c7 04 24 80 15 11 80 	movl   $0x80111580,(%esp)
80105241:	e8 d7 00 00 00       	call   8010531d <release>

    return 0;
80105246:	b8 00 00 00 00       	mov    $0x0,%eax
8010524b:	eb 05                	jmp    80105252 <binary_semaphore_up+0xb5>
  }
  else
    return -1;
...
80105289:	f0 87 02             	lock xchg %eax,(%edx)
8010528c:	89 c3                	mov    %eax,%ebx
8010528e:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
80105291:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
801052a0:	8b 55 0c             	mov    0xc(%ebp),%edx
801052a3:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
...
801052c1:	e8 3d 01 00 00       	call   80105403 <pushcli>
  if(holding(lk))
801052c6:	8b 45 08             	mov    0x8(%ebp),%eax
801052c9:	89 04 24             	mov    %eax,(%esp)
801052cc:	e8 08 01 00 00       	call   801053d9 <holding>
801052d1:	85 c0                	test   %eax,%eax
801052d3:	74 0c                	je     801052e1 <acquire+0x26>
    panic("acquire");
801052d5:	c7 04 24 01 8e 10 80 	movl   $0x80108e01,(%esp)
801052dc:	e8 5c b2 ff ff       	call   8010053d <panic>
...
801052e5:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801052ec:	00 
801052ed:	89 04 24             	mov    %eax,(%esp)
801052f0:	e8 80 ff ff ff       	call   80105275 <xchg>
801052f5:	85 c0                	test   %eax,%eax
801052f7:	75 e9                	jne    801052e2 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
801052f9:	8b 45 08             	mov    0x8(%ebp),%eax
801052fc:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80105303:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80105306:	8b 45 08             	mov    0x8(%ebp),%eax
80105309:	83 c0 0c             	add    $0xc,%eax
8010530c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105310:	8d 45 08             	lea    0x8(%ebp),%eax
80105313:	89 04 24             	mov    %eax,(%esp)
80105316:	e8 51 00 00 00       	call   8010536c <getcallerpcs>
}
8010531b:	c9                   	leave  
8010531c:	c3                   	ret    
...
80105329:	e8 ab 00 00 00       	call   801053d9 <holding>
8010532e:	85 c0                	test   %eax,%eax
80105330:	75 0c                	jne    8010533e <release+0x21>
    panic("release");
80105332:	c7 04 24 09 8e 10 80 	movl   $0x80108e09,(%esp)
80105339:	e8 ff b1 ff ff       	call   8010053d <panic>

  lk->pcs[0] = 0;
8010533e:	8b 45 08             	mov    0x8(%ebp),%eax
80105341:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80105348:	8b 45 08             	mov    0x8(%ebp),%eax
8010534b:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80105360:	e8 10 ff ff ff       	call   80105275 <xchg>

  popcli();
80105365:	e8 e1 00 00 00       	call   8010544b <popcli>
}
8010536a:	c9                   	leave  
8010536b:	c3                   	ret    

8010536c <getcallerpcs>:
...
80105382:	eb 32                	jmp    801053b6 <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105384:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80105388:	74 47                	je     801053d1 <getcallerpcs+0x65>
8010538a:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80105391:	76 3e                	jbe    801053d1 <getcallerpcs+0x65>
80105393:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80105397:	74 38                	je     801053d1 <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80105399:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010539c:	c1 e0 02             	shl    $0x2,%eax
8010539f:	03 45 0c             	add    0xc(%ebp),%eax
801053a2:	8b 55 fc             	mov    -0x4(%ebp),%edx
801053a5:	8b 52 04             	mov    0x4(%edx),%edx
801053a8:	89 10                	mov    %edx,(%eax)
    ebp = (uint*)ebp[0]; // saved %ebp
801053aa:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053ad:	8b 00                	mov    (%eax),%eax
801053af:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
801053b2:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801053b6:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801053ba:	7e c8                	jle    80105384 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801053bc:	eb 13                	jmp    801053d1 <getcallerpcs+0x65>
    pcs[i] = 0;
801053be:	8b 45 f8             	mov    -0x8(%ebp),%eax
801053c1:	c1 e0 02             	shl    $0x2,%eax
801053c4:	03 45 0c             	add    0xc(%ebp),%eax
801053c7:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
801053cd:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
801053d1:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
801053d5:	7e e7                	jle    801053be <getcallerpcs+0x52>
    pcs[i] = 0;
}
801053d7:	c9                   	leave  
801053d8:	c3                   	ret    
...
801053e3:	74 17                	je     801053fc <holding+0x23>
801053e5:	8b 45 08             	mov    0x8(%ebp),%eax
801053e8:	8b 50 08             	mov    0x8(%eax),%edx
801053eb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801053f1:	39 c2                	cmp    %eax,%edx
801053f3:	75 07                	jne    801053fc <holding+0x23>
801053f5:	b8 01 00 00 00       	mov    $0x1,%eax
801053fa:	eb 05                	jmp    80105401 <holding+0x28>
...
80105406:	83 ec 10             	sub    $0x10,%esp
  int eflags;
  
  eflags = readeflags();
80105409:	e8 46 fe ff ff       	call   80105254 <readeflags>
8010540e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105411:	e8 53 fe ff ff       	call   80105269 <cli>
  if(cpu->ncli++ == 0)
80105416:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010541c:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105422:	85 d2                	test   %edx,%edx
80105424:	0f 94 c1             	sete   %cl
80105427:	83 c2 01             	add    $0x1,%edx
8010542a:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105430:	84 c9                	test   %cl,%cl
80105432:	74 15                	je     80105449 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80105434:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010543a:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010543d:	81 e2 00 02 00 00    	and    $0x200,%edx
80105443:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105449:	c9                   	leave  
8010544a:	c3                   	ret    
...
8010544e:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80105451:	e8 fe fd ff ff       	call   80105254 <readeflags>
80105456:	25 00 02 00 00       	and    $0x200,%eax
8010545b:	85 c0                	test   %eax,%eax
8010545d:	74 0c                	je     8010546b <popcli+0x20>
    panic("popcli - interruptible");
8010545f:	c7 04 24 11 8e 10 80 	movl   $0x80108e11,(%esp)
80105466:	e8 d2 b0 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
8010546b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105471:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80105477:	83 ea 01             	sub    $0x1,%edx
8010547a:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80105480:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80105486:	85 c0                	test   %eax,%eax
80105488:	79 0c                	jns    80105496 <popcli+0x4b>
    panic("popcli");
8010548a:	c7 04 24 28 8e 10 80 	movl   $0x80108e28,(%esp)
80105491:	e8 a7 b0 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
80105496:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010549c:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801054a2:	85 c0                	test   %eax,%eax
801054a4:	75 15                	jne    801054bb <popcli+0x70>
801054a6:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801054ac:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801054b2:	85 c0                	test   %eax,%eax
801054b4:	74 05                	je     801054bb <popcli+0x70>
    sti();
801054b6:	e8 b4 fd ff ff       	call   8010526f <sti>
}
801054bb:	c9                   	leave  
801054bc:	c3                   	ret    
801054bd:	00 00                	add    %al,(%eax)
	...
...
801054d4:	fc                   	cld    
801054d5:	f3 aa                	rep stos %al,%es:(%edi)
...
801054f9:	fc                   	cld    
801054fa:	f3 ab                	rep stos %eax,%es:(%edi)
...
80105513:	83 e0 03             	and    $0x3,%eax
80105516:	85 c0                	test   %eax,%eax
80105518:	75 49                	jne    80105563 <memset+0x59>
8010551a:	8b 45 10             	mov    0x10(%ebp),%eax
8010551d:	83 e0 03             	and    $0x3,%eax
80105520:	85 c0                	test   %eax,%eax
80105522:	75 3f                	jne    80105563 <memset+0x59>
    c &= 0xFF;
80105524:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010552b:	8b 45 10             	mov    0x10(%ebp),%eax
8010552e:	c1 e8 02             	shr    $0x2,%eax
80105531:	89 c2                	mov    %eax,%edx
80105533:	8b 45 0c             	mov    0xc(%ebp),%eax
80105536:	89 c1                	mov    %eax,%ecx
80105538:	c1 e1 18             	shl    $0x18,%ecx
8010553b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010553e:	c1 e0 10             	shl    $0x10,%eax
80105541:	09 c1                	or     %eax,%ecx
80105543:	8b 45 0c             	mov    0xc(%ebp),%eax
80105546:	c1 e0 08             	shl    $0x8,%eax
80105549:	09 c8                	or     %ecx,%eax
8010554b:	0b 45 0c             	or     0xc(%ebp),%eax
8010554e:	89 54 24 08          	mov    %edx,0x8(%esp)
80105552:	89 44 24 04          	mov    %eax,0x4(%esp)
80105556:	8b 45 08             	mov    0x8(%ebp),%eax
80105559:	89 04 24             	mov    %eax,(%esp)
8010555c:	e8 84 ff ff ff       	call   801054e5 <stosl>
80105561:	eb 19                	jmp    8010557c <memset+0x72>
  } else
    stosb(dst, c, n);
80105563:	8b 45 10             	mov    0x10(%ebp),%eax
80105566:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80105577:	e8 44 ff ff ff       	call   801054c0 <stosb>
  return dst;
...
80105590:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
80105593:	eb 32                	jmp    801055c7 <memcmp+0x46>
    if(*s1 != *s2)
80105595:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105598:	0f b6 10             	movzbl (%eax),%edx
8010559b:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010559e:	0f b6 00             	movzbl (%eax),%eax
801055a1:	38 c2                	cmp    %al,%dl
801055a3:	74 1a                	je     801055bf <memcmp+0x3e>
      return *s1 - *s2;
801055a5:	8b 45 fc             	mov    -0x4(%ebp),%eax
801055a8:	0f b6 00             	movzbl (%eax),%eax
801055ab:	0f b6 d0             	movzbl %al,%edx
801055ae:	8b 45 f8             	mov    -0x8(%ebp),%eax
801055b1:	0f b6 00             	movzbl (%eax),%eax
801055b4:	0f b6 c0             	movzbl %al,%eax
801055b7:	89 d1                	mov    %edx,%ecx
801055b9:	29 c1                	sub    %eax,%ecx
801055bb:	89 c8                	mov    %ecx,%eax
801055bd:	eb 1c                	jmp    801055db <memcmp+0x5a>
    s1++, s2++;
801055bf:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801055c3:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
  ...
  s2 = v2;
  while(n-- > 0){
801055c7:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801055cb:	0f 95 c0             	setne  %al
801055ce:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801055d2:	84 c0                	test   %al,%al
801055d4:	75 bf                	jne    80105595 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
801055ec:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
801055ef:	8b 45 fc             	mov    -0x4(%ebp),%eax
801055f2:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801055f5:	73 54                	jae    8010564b <memmove+0x6e>
...
80105602:	76 47                	jbe    8010564b <memmove+0x6e>
    s += n;
80105604:	8b 45 10             	mov    0x10(%ebp),%eax
80105607:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
8010560a:	8b 45 10             	mov    0x10(%ebp),%eax
8010560d:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105610:	eb 13                	jmp    80105625 <memmove+0x48>
      *--d = *--s;
80105612:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80105616:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
8010561a:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010561d:	0f b6 10             	movzbl (%eax),%edx
...
80105629:	0f 95 c0             	setne  %al
8010562c:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105630:	84 c0                	test   %al,%al
80105632:	75 de                	jne    80105612 <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105634:	eb 25                	jmp    8010565b <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
80105649:	eb 01                	jmp    8010564c <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
80105650:	0f 95 c0             	setne  %al
80105653:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105657:	84 c0                	test   %al,%al
80105659:	75 db                	jne    80105636 <memmove+0x59>
      *d++ = *s++;
...
8010567a:	e8 5e ff ff ff       	call   801055dd <memmove>
}
8010567f:	c9                   	leave  
80105680:	c3                   	ret    
...
80105682:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
80105684:	eb 0c                	jmp    80105692 <strncmp+0x11>
    n--, p++, q++;
80105686:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010568a:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010568e:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
{
  while(n > 0 && *p && *p == *q)
80105692:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105696:	74 1a                	je     801056b2 <strncmp+0x31>
80105698:	8b 45 08             	mov    0x8(%ebp),%eax
8010569b:	0f b6 00             	movzbl (%eax),%eax
8010569e:	84 c0                	test   %al,%al
801056a0:	74 10                	je     801056b2 <strncmp+0x31>
...
801056ae:	38 c2                	cmp    %al,%dl
801056b0:	74 d4                	je     80105686 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801056b2:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801056b6:	75 07                	jne    801056bf <strncmp+0x3e>
    return 0;
801056b8:	b8 00 00 00 00       	mov    $0x0,%eax
801056bd:	eb 18                	jmp    801056d7 <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
801056bf:	8b 45 08             	mov    0x8(%ebp),%eax
801056c2:	0f b6 00             	movzbl (%eax),%eax
801056c5:	0f b6 d0             	movzbl %al,%edx
801056c8:	8b 45 0c             	mov    0xc(%ebp),%eax
801056cb:	0f b6 00             	movzbl (%eax),%eax
801056ce:	0f b6 c0             	movzbl %al,%eax
801056d1:	89 d1                	mov    %edx,%ecx
801056d3:	29 c1                	sub    %eax,%ecx
801056d5:	89 c8                	mov    %ecx,%eax
}
801056d7:	5d                   	pop    %ebp
801056d8:	c3                   	ret    
...
801056ea:	0f 9f c0             	setg   %al
801056ed:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801056f1:	84 c0                	test   %al,%al
801056f3:	74 30                	je     80105725 <strncpy+0x4c>
...
80105706:	84 c0                	test   %al,%al
80105708:	0f 95 c0             	setne  %al
8010570b:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010570f:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105713:	84 c0                	test   %al,%al
80105715:	75 cf                	jne    801056e6 <strncpy+0xd>
    ;
  while(n-- > 0)
80105717:	eb 0c                	jmp    80105725 <strncpy+0x4c>
    *s++ = 0;
80105719:	8b 45 08             	mov    0x8(%ebp),%eax
8010571c:	c6 00 00             	movb   $0x0,(%eax)
8010571f:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105723:	eb 01                	jmp    80105726 <strncpy+0x4d>
  char *os;
...
80105733:	75 e4                	jne    80105719 <strncpy+0x40>
    *s++ = 0;
  return os;
80105735:	8b 45 fc             	mov    -0x4(%ebp),%eax
}
80105738:	c9                   	leave  
80105739:	c3                   	ret    
...
8010574a:	7f 05                	jg     80105751 <safestrcpy+0x17>
    return os;
8010574c:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010574f:	eb 35                	jmp    80105786 <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
80105751:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105755:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105759:	7e 22                	jle    8010577d <safestrcpy+0x43>
8010575b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010575e:	0f b6 10             	movzbl (%eax),%edx
80105761:	8b 45 08             	mov    0x8(%ebp),%eax
80105764:	88 10                	mov    %dl,(%eax)
80105766:	8b 45 08             	mov    0x8(%ebp),%eax
80105769:	0f b6 00             	movzbl (%eax),%eax
8010576c:	84 c0                	test   %al,%al
8010576e:	0f 95 c0             	setne  %al
80105771:	83 45 08 01          	addl   $0x1,0x8(%ebp)
80105775:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80105779:	84 c0                	test   %al,%al
8010577b:	75 d4                	jne    80105751 <safestrcpy+0x17>
    ;
  *s = 0;
8010577d:	8b 45 08             	mov    0x8(%ebp),%eax
80105780:	c6 00 00             	movb   $0x0,(%eax)
  return os;
...
80105795:	eb 04                	jmp    8010579b <strlen+0x13>
80105797:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010579b:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010579e:	03 45 08             	add    0x8(%ebp),%eax
801057a1:	0f b6 00             	movzbl (%eax),%eax
801057a4:	84 c0                	test   %al,%al
801057a6:	75 ef                	jne    80105797 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
801057b0:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
801057b4:	8b 54 24 08          	mov    0x8(%esp),%edx
...
801057b9:	53                   	push   %ebx
  pushl %esi
801057ba:	56                   	push   %esi
  pushl %edi
801057bb:	57                   	push   %edi

  # Switch stacks
  movl %esp, (%eax)
801057bc:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
801057be:	89 d4                	mov    %edx,%esp
...
801057d0:	3b 45 0c             	cmp    0xc(%ebp),%eax
801057d3:	76 0f                	jbe    801057e4 <fetchint+0x1c>
801057d5:	8b 45 0c             	mov    0xc(%ebp),%eax
801057d8:	8d 50 04             	lea    0x4(%eax),%edx
801057db:	8b 45 08             	mov    0x8(%ebp),%eax
801057de:	8b 00                	mov    (%eax),%eax
801057e0:	39 c2                	cmp    %eax,%edx
801057e2:	76 07                	jbe    801057eb <fetchint+0x23>
    return -1;
801057e4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057e9:	eb 0f                	jmp    801057fa <fetchint+0x32>
  *ip = *(int*)(addr);
801057eb:	8b 45 0c             	mov    0xc(%ebp),%eax
801057ee:	8b 10                	mov    (%eax),%edx
801057f0:	8b 45 10             	mov    0x10(%ebp),%eax
...
80105807:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010580a:	77 07                	ja     80105813 <fetchstr+0x17>
    return -1;
8010580c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105811:	eb 45                	jmp    80105858 <fetchstr+0x5c>
  *pp = (char*)addr;
80105813:	8b 55 0c             	mov    0xc(%ebp),%edx
80105816:	8b 45 10             	mov    0x10(%ebp),%eax
80105819:	89 10                	mov    %edx,(%eax)
  ep = (char*)p->sz;
...
8010584e:	3b 45 f8             	cmp    -0x8(%ebp),%eax
80105851:	72 da                	jb     8010582d <fetchstr+0x31>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105866:	8b 40 18             	mov    0x18(%eax),%eax
80105869:	8b 50 44             	mov    0x44(%eax),%edx
8010586c:	8b 45 08             	mov    0x8(%ebp),%eax
8010586f:	c1 e0 02             	shl    $0x2,%eax
80105872:	01 d0                	add    %edx,%eax
80105874:	8d 48 04             	lea    0x4(%eax),%ecx
80105877:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010587d:	8b 55 0c             	mov    0xc(%ebp),%edx
80105880:	89 54 24 08          	mov    %edx,0x8(%esp)
80105884:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80105888:	89 04 24             	mov    %eax,(%esp)
8010588b:	e8 38 ff ff ff       	call   801057c8 <fetchint>
}
80105890:	c9                   	leave  
80105891:	c3                   	ret    
...
8010593b:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
8010593e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105944:	8b 40 18             	mov    0x18(%eax),%eax
80105947:	8b 40 1c             	mov    0x1c(%eax),%eax
8010594a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num >= 0 && num < SYS_open && syscalls[num]) {
8010594d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105951:	78 2e                	js     80105981 <syscall+0x4a>
80105953:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105957:	7f 28                	jg     80105981 <syscall+0x4a>
80105959:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010595c:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105963:	85 c0                	test   %eax,%eax
80105965:	74 1a                	je     80105981 <syscall+0x4a>
    proc->tf->eax = syscalls[num]();
80105967:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010596d:	8b 58 18             	mov    0x18(%eax),%ebx
80105970:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105973:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
8010597a:	ff d0                	call   *%eax
8010597c:	89 43 1c             	mov    %eax,0x1c(%ebx)
8010597f:	eb 73                	jmp    801059f4 <syscall+0xbd>
  } else if (num >= SYS_open && num < NELEM(syscalls) && syscalls[num]) {
80105981:	83 7d f4 0e          	cmpl   $0xe,-0xc(%ebp)
80105985:	7e 30                	jle    801059b7 <syscall+0x80>
80105987:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010598a:	83 f8 1d             	cmp    $0x1d,%eax
8010598d:	77 28                	ja     801059b7 <syscall+0x80>
8010598f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105992:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
80105999:	85 c0                	test   %eax,%eax
8010599b:	74 1a                	je     801059b7 <syscall+0x80>
    proc->tf->eax = syscalls[num]();
8010599d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059a3:	8b 58 18             	mov    0x18(%eax),%ebx
801059a6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059a9:	8b 04 85 40 c0 10 80 	mov    -0x7fef3fc0(,%eax,4),%eax
801059b0:	ff d0                	call   *%eax
801059b2:	89 43 1c             	mov    %eax,0x1c(%ebx)
801059b5:	eb 3d                	jmp    801059f4 <syscall+0xbd>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801059b7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059bd:	8d 48 6c             	lea    0x6c(%eax),%ecx
...
801059cc:	89 54 24 0c          	mov    %edx,0xc(%esp)
801059d0:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801059d4:	89 44 24 04          	mov    %eax,0x4(%esp)
801059d8:	c7 04 24 2f 8e 10 80 	movl   $0x80108e2f,(%esp)
801059df:	e8 bd a9 ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801059e4:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801059ea:	8b 40 18             	mov    0x18(%eax),%eax
801059ed:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
801059f4:	83 c4 24             	add    $0x24,%esp
801059f7:	5b                   	pop    %ebx
801059f8:	5d                   	pop    %ebp
801059f9:	c3                   	ret    
	...
...
80105a74:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105a77:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105a7e:	eb 30                	jmp    80105ab0 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105a80:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a86:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105a89:	83 c2 08             	add    $0x8,%edx
80105a8c:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105a90:	85 c0                	test   %eax,%eax
80105a92:	75 18                	jne    80105aac <fdalloc+0x3b>
      proc->ofile[fd] = f;
80105a94:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105a9a:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105a9d:	8d 4a 08             	lea    0x8(%edx),%ecx
80105aa0:	8b 55 08             	mov    0x8(%ebp),%edx
80105aa3:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
80105aa7:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105aaa:	eb 0f                	jmp    80105abb <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105aac:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105ab0:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
80105ab4:	7e ca                	jle    80105a80 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
80105b30:	e8 c7 fe ff ff       	call   801059fc <argfd>
80105b35:	85 c0                	test   %eax,%eax
80105b37:	78 35                	js     80105b6e <sys_read+0x5a>
80105b39:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105b3c:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b40:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105b47:	e8 0e fd ff ff       	call   8010585a <argint>
80105b4c:	85 c0                	test   %eax,%eax
80105b4e:	78 1e                	js     80105b6e <sys_read+0x5a>
80105b50:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b53:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b57:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105b5a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105b65:	e8 28 fd ff ff       	call   80105892 <argptr>
80105b6a:	85 c0                	test   %eax,%eax
80105b6c:	79 07                	jns    80105b75 <sys_read+0x61>
    return -1;
80105b6e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105b73:	eb 19                	jmp    80105b8e <sys_read+0x7a>
  return fileread(f, p, n);
80105b75:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105b78:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105b7b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b7e:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80105b82:	89 54 24 04          	mov    %edx,0x4(%esp)
80105b86:	89 04 24             	mov    %eax,(%esp)
80105b89:	e8 5b b5 ff ff       	call   801010e9 <fileread>
}
80105b8e:	c9                   	leave  
80105b8f:	c3                   	ret    
...
80105bac:	e8 4b fe ff ff       	call   801059fc <argfd>
80105bb1:	85 c0                	test   %eax,%eax
80105bb3:	78 35                	js     80105bea <sys_write+0x5a>
80105bb5:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105bb8:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bbc:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105bc3:	e8 92 fc ff ff       	call   8010585a <argint>
80105bc8:	85 c0                	test   %eax,%eax
80105bca:	78 1e                	js     80105bea <sys_write+0x5a>
...
80105be1:	e8 ac fc ff ff       	call   80105892 <argptr>
80105be6:	85 c0                	test   %eax,%eax
80105be8:	79 07                	jns    80105bf1 <sys_write+0x61>
    return -1;
80105bea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105bef:	eb 19                	jmp    80105c0a <sys_write+0x7a>
...
80105c05:	e8 9b b5 ff ff       	call   801011a5 <filewrite>
}
80105c0a:	c9                   	leave  
80105c0b:	c3                   	ret    
...
80105c20:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105c27:	e8 d0 fd ff ff       	call   801059fc <argfd>
80105c2c:	85 c0                	test   %eax,%eax
80105c2e:	79 07                	jns    80105c37 <sys_close+0x2b>
    return -1;
80105c30:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105c35:	eb 24                	jmp    80105c5b <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105c37:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
...
80105c51:	e8 6e b3 ff ff       	call   80100fc4 <fileclose>
  return 0;
...
80105c63:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105c66:	89 44 24 08          	mov    %eax,0x8(%esp)
80105c6a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105c71:	00 
80105c72:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105c79:	e8 7e fd ff ff       	call   801059fc <argfd>
80105c7e:	85 c0                	test   %eax,%eax
80105c80:	78 1f                	js     80105ca1 <sys_fstat+0x44>
80105c82:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105c89:	00 
80105c8a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105c8d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105c91:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105c98:	e8 f5 fb ff ff       	call   80105892 <argptr>
80105c9d:	85 c0                	test   %eax,%eax
80105c9f:	79 07                	jns    80105ca8 <sys_fstat+0x4b>
    return -1;
80105ca1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ca6:	eb 12                	jmp    80105cba <sys_fstat+0x5d>
...
80105cb5:	e8 e0 b3 ff ff       	call   8010109a <filestat>
}
80105cba:	c9                   	leave  
80105cbb:	c3                   	ret    
...
80105cbf:	83 ec 38             	sub    $0x38,%esp
...
80105cd0:	e8 1f fc ff ff       	call   801058f4 <argstr>
80105cd5:	85 c0                	test   %eax,%eax
80105cd7:	78 17                	js     80105cf0 <sys_link+0x34>
80105cd9:	8d 45 dc             	lea    -0x24(%ebp),%eax
80105cdc:	89 44 24 04          	mov    %eax,0x4(%esp)
80105ce0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105ce7:	e8 08 fc ff ff       	call   801058f4 <argstr>
80105cec:	85 c0                	test   %eax,%eax
80105cee:	79 0a                	jns    80105cfa <sys_link+0x3e>
    return -1;
80105cf0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105cf5:	e9 3c 01 00 00       	jmp    80105e36 <sys_link+0x17a>
  if((ip = namei(old)) == 0)
80105cfa:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105cfd:	89 04 24             	mov    %eax,(%esp)
80105d00:	e8 05 c7 ff ff       	call   8010240a <namei>
80105d05:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105d08:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105d0c:	75 0a                	jne    80105d18 <sys_link+0x5c>
    return -1;
80105d0e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d13:	e9 1e 01 00 00       	jmp    80105e36 <sys_link+0x17a>

  begin_trans();
80105d18:	e8 00 d5 ff ff       	call   8010321d <begin_trans>

  ilock(ip);
80105d1d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d20:	89 04 24             	mov    %eax,(%esp)
80105d23:	e8 40 bb ff ff       	call   80101868 <ilock>
  if(ip->type == T_DIR){
80105d28:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d2b:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105d2f:	66 83 f8 01          	cmp    $0x1,%ax
80105d33:	75 1a                	jne    80105d4f <sys_link+0x93>
    iunlockput(ip);
80105d35:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d38:	89 04 24             	mov    %eax,(%esp)
80105d3b:	e8 ac bd ff ff       	call   80101aec <iunlockput>
    commit_trans();
80105d40:	e8 21 d5 ff ff       	call   80103266 <commit_trans>
    return -1;
80105d45:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d4a:	e9 e7 00 00 00       	jmp    80105e36 <sys_link+0x17a>
  }
...
80105d66:	e8 41 b9 ff ff       	call   801016ac <iupdate>
  iunlock(ip);
80105d6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d6e:	89 04 24             	mov    %eax,(%esp)
80105d71:	e8 40 bc ff ff       	call   801019b6 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105d76:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105d79:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105d7c:	89 54 24 04          	mov    %edx,0x4(%esp)
80105d80:	89 04 24             	mov    %eax,(%esp)
80105d83:	e8 a4 c6 ff ff       	call   8010242c <nameiparent>
80105d88:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105d8b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d8f:	74 68                	je     80105df9 <sys_link+0x13d>
    goto bad;
  ilock(dp);
...
80105e00:	e8 63 ba ff ff       	call   80101868 <ilock>
  ip->nlink--;
...
80105e1c:	e8 8b b8 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
80105e21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e24:	89 04 24             	mov    %eax,(%esp)
80105e27:	e8 c0 bc ff ff       	call   80101aec <iunlockput>
  commit_trans();
80105e2c:	e8 35 d4 ff ff       	call   80103266 <commit_trans>
  return -1;
...
80105e3b:	83 ec 38             	sub    $0x38,%esp
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
80105e3e:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105e45:	eb 4b                	jmp    80105e92 <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105e47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e4a:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105e51:	00 
80105e52:	89 44 24 08          	mov    %eax,0x8(%esp)
80105e56:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105e59:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e5d:	8b 45 08             	mov    0x8(%ebp),%eax
80105e60:	89 04 24             	mov    %eax,(%esp)
80105e63:	e8 f6 be ff ff       	call   80101d5e <readi>
80105e68:	83 f8 10             	cmp    $0x10,%eax
80105e6b:	74 0c                	je     80105e79 <isdirempty+0x41>
      panic("isdirempty: readi");
80105e6d:	c7 04 24 4b 8e 10 80 	movl   $0x80108e4b,(%esp)
80105e74:	e8 c4 a6 ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80105e79:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105e7d:	66 85 c0             	test   %ax,%ax
80105e80:	74 07                	je     80105e89 <isdirempty+0x51>
      return 0;
80105e82:	b8 00 00 00 00       	mov    $0x0,%eax
80105e87:	eb 1b                	jmp    80105ea4 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105e92:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105e95:	8b 45 08             	mov    0x8(%ebp),%eax
80105e98:	8b 40 18             	mov    0x18(%eax),%eax
80105e9b:	39 c2                	cmp    %eax,%edx
80105e9d:	72 a8                	jb     80105e47 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
...
80105ea9:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105eac:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105eaf:	89 44 24 04          	mov    %eax,0x4(%esp)
80105eb3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105eba:	e8 35 fa ff ff       	call   801058f4 <argstr>
80105ebf:	85 c0                	test   %eax,%eax
80105ec1:	79 0a                	jns    80105ecd <sys_unlink+0x27>
    return -1;
80105ec3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ec8:	e9 aa 01 00 00       	jmp    80106077 <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80105ecd:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105ed0:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105ed3:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ed7:	89 04 24             	mov    %eax,(%esp)
80105eda:	e8 4d c5 ff ff       	call   8010242c <nameiparent>
80105edf:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ee2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ee6:	75 0a                	jne    80105ef2 <sys_unlink+0x4c>
    return -1;
80105ee8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105eed:	e9 85 01 00 00       	jmp    80106077 <sys_unlink+0x1d1>

  begin_trans();
80105ef2:	e8 26 d3 ff ff       	call   8010321d <begin_trans>

  ilock(dp);
80105ef7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105efa:	89 04 24             	mov    %eax,(%esp)
80105efd:	e8 66 b9 ff ff       	call   80101868 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105f02:	c7 44 24 04 5d 8e 10 	movl   $0x80108e5d,0x4(%esp)
80105f09:	80 
80105f0a:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105f0d:	89 04 24             	mov    %eax,(%esp)
80105f10:	e8 4a c1 ff ff       	call   8010205f <namecmp>
80105f15:	85 c0                	test   %eax,%eax
80105f17:	0f 84 45 01 00 00    	je     80106062 <sys_unlink+0x1bc>
80105f1d:	c7 44 24 04 5f 8e 10 	movl   $0x80108e5f,0x4(%esp)
80105f24:	80 
80105f25:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105f28:	89 04 24             	mov    %eax,(%esp)
80105f2b:	e8 2f c1 ff ff       	call   8010205f <namecmp>
80105f30:	85 c0                	test   %eax,%eax
80105f32:	0f 84 2a 01 00 00    	je     80106062 <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105f38:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105f3b:	89 44 24 08          	mov    %eax,0x8(%esp)
80105f3f:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105f42:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f46:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f49:	89 04 24             	mov    %eax,(%esp)
80105f4c:	e8 30 c1 ff ff       	call   80102081 <dirlookup>
80105f51:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f54:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f58:	0f 84 03 01 00 00    	je     80106061 <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80105f5e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f61:	89 04 24             	mov    %eax,(%esp)
80105f64:	e8 ff b8 ff ff       	call   80101868 <ilock>

  if(ip->nlink < 1)
80105f69:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f6c:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105f70:	66 85 c0             	test   %ax,%ax
80105f73:	7f 0c                	jg     80105f81 <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80105f75:	c7 04 24 62 8e 10 80 	movl   $0x80108e62,(%esp)
80105f7c:	e8 bc a5 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105f81:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f84:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105f88:	66 83 f8 01          	cmp    $0x1,%ax
80105f8c:	75 1f                	jne    80105fad <sys_unlink+0x107>
80105f8e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f91:	89 04 24             	mov    %eax,(%esp)
80105f94:	e8 9f fe ff ff       	call   80105e38 <isdirempty>
80105f99:	85 c0                	test   %eax,%eax
80105f9b:	75 10                	jne    80105fad <sys_unlink+0x107>
    iunlockput(ip);
80105f9d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fa0:	89 04 24             	mov    %eax,(%esp)
80105fa3:	e8 44 bb ff ff       	call   80101aec <iunlockput>
    goto bad;
80105fa8:	e9 b5 00 00 00       	jmp    80106062 <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80105fad:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105fb4:	00 
80105fb5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105fbc:	00 
80105fbd:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105fc0:	89 04 24             	mov    %eax,(%esp)
80105fc3:	e8 42 f5 ff ff       	call   8010550a <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105fc8:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105fcb:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105fd2:	00 
...
80105fe4:	e8 e0 be ff ff       	call   80101ec9 <writei>
80105fe9:	83 f8 10             	cmp    $0x10,%eax
80105fec:	74 0c                	je     80105ffa <sys_unlink+0x154>
    panic("unlink: writei");
80105fee:	c7 04 24 74 8e 10 80 	movl   $0x80108e74,(%esp)
80105ff5:	e8 43 a5 ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80105ffa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ffd:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106001:	66 83 f8 01          	cmp    $0x1,%ax
80106005:	75 1c                	jne    80106023 <sys_unlink+0x17d>
    dp->nlink--;
80106007:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010600a:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010600e:	8d 50 ff             	lea    -0x1(%eax),%edx
...
8010601e:	e8 89 b6 ff ff       	call   801016ac <iupdate>
  }
  iunlockput(dp);
80106023:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106026:	89 04 24             	mov    %eax,(%esp)
80106029:	e8 be ba ff ff       	call   80101aec <iunlockput>
...
80106045:	e8 62 b6 ff ff       	call   801016ac <iupdate>
  iunlockput(ip);
8010604a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010604d:	89 04 24             	mov    %eax,(%esp)
80106050:	e8 97 ba ff ff       	call   80101aec <iunlockput>

  commit_trans();
80106055:	e8 0c d2 ff ff       	call   80103266 <commit_trans>

  return 0;
8010605a:	b8 00 00 00 00       	mov    $0x0,%eax
8010605f:	eb 16                	jmp    80106077 <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80106068:	e8 7f ba ff ff       	call   80101aec <iunlockput>
  commit_trans();
8010606d:	e8 f4 d1 ff ff       	call   80103266 <commit_trans>
  return -1;
...
8010607c:	83 ec 48             	sub    $0x48,%esp
8010607f:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106082:	8b 55 10             	mov    0x10(%ebp),%edx
80106085:	8b 45 14             	mov    0x14(%ebp),%eax
80106088:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
8010608c:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80106090:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80106094:	8d 45 de             	lea    -0x22(%ebp),%eax
80106097:	89 44 24 04          	mov    %eax,0x4(%esp)
8010609b:	8b 45 08             	mov    0x8(%ebp),%eax
8010609e:	89 04 24             	mov    %eax,(%esp)
801060a1:	e8 86 c3 ff ff       	call   8010242c <nameiparent>
801060a6:	89 45 f4             	mov    %eax,-0xc(%ebp)
801060a9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801060ad:	75 0a                	jne    801060b9 <create+0x40>
    return 0;
801060af:	b8 00 00 00 00       	mov    $0x0,%eax
801060b4:	e9 7e 01 00 00       	jmp    80106237 <create+0x1be>
  ilock(dp);
801060b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060bc:	89 04 24             	mov    %eax,(%esp)
801060bf:	e8 a4 b7 ff ff       	call   80101868 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801060c4:	8d 45 ec             	lea    -0x14(%ebp),%eax
...
801060d8:	e8 a4 bf ff ff       	call   80102081 <dirlookup>
801060dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
801060e0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801060e4:	74 47                	je     8010612d <create+0xb4>
    iunlockput(dp);
...
801060f7:	e8 6c b7 ff ff       	call   80101868 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801060fc:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80106101:	75 15                	jne    80106118 <create+0x9f>
80106103:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106106:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010610a:	66 83 f8 02          	cmp    $0x2,%ax
8010610e:	75 08                	jne    80106118 <create+0x9f>
      return ip;
80106110:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106113:	e9 1f 01 00 00       	jmp    80106237 <create+0x1be>
    iunlockput(ip);
...
80106128:	e9 0a 01 00 00       	jmp    80106237 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
8010612d:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80106131:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106134:	8b 00                	mov    (%eax),%eax
80106136:	89 54 24 04          	mov    %edx,0x4(%esp)
8010613a:	89 04 24             	mov    %eax,(%esp)
8010613d:	e8 8d b4 ff ff       	call   801015cf <ialloc>
80106142:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106145:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106149:	75 0c                	jne    80106157 <create+0xde>
    panic("create: ialloc");
8010614b:	c7 04 24 83 8e 10 80 	movl   $0x80108e83,(%esp)
80106152:	e8 e6 a3 ff ff       	call   8010053d <panic>

  ilock(ip);
80106157:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010615a:	89 04 24             	mov    %eax,(%esp)
8010615d:	e8 06 b7 ff ff       	call   80101868 <ilock>
  ip->major = major;
80106162:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106165:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80106169:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
8010616d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106170:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80106174:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80106178:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010617b:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80106181:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106184:	89 04 24             	mov    %eax,(%esp)
80106187:	e8 20 b5 ff ff       	call   801016ac <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
8010618c:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80106191:	75 6a                	jne    801061fd <create+0x184>
    dp->nlink++;  // for ".."
80106193:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106196:	0f b7 40 16          	movzwl 0x16(%eax),%eax
8010619a:	8d 50 01             	lea    0x1(%eax),%edx
...
801061aa:	e8 fd b4 ff ff       	call   801016ac <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801061af:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061b2:	8b 40 04             	mov    0x4(%eax),%eax
801061b5:	89 44 24 08          	mov    %eax,0x8(%esp)
801061b9:	c7 44 24 04 5d 8e 10 	movl   $0x80108e5d,0x4(%esp)
801061c0:	80 
801061c1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061c4:	89 04 24             	mov    %eax,(%esp)
801061c7:	e8 7d bf ff ff       	call   80102149 <dirlink>
801061cc:	85 c0                	test   %eax,%eax
801061ce:	78 21                	js     801061f1 <create+0x178>
801061d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061d3:	8b 40 04             	mov    0x4(%eax),%eax
801061d6:	89 44 24 08          	mov    %eax,0x8(%esp)
801061da:	c7 44 24 04 5f 8e 10 	movl   $0x80108e5f,0x4(%esp)
801061e1:	80 
801061e2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801061e5:	89 04 24             	mov    %eax,(%esp)
801061e8:	e8 5c bf ff ff       	call   80102149 <dirlink>
801061ed:	85 c0                	test   %eax,%eax
801061ef:	79 0c                	jns    801061fd <create+0x184>
      panic("create dots");
801061f1:	c7 04 24 92 8e 10 80 	movl   $0x80108e92,(%esp)
801061f8:	e8 40 a3 ff ff       	call   8010053d <panic>
  }
...
80106207:	8d 45 de             	lea    -0x22(%ebp),%eax
8010620a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010620e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106211:	89 04 24             	mov    %eax,(%esp)
80106214:	e8 30 bf ff ff       	call   80102149 <dirlink>
80106219:	85 c0                	test   %eax,%eax
8010621b:	79 0c                	jns    80106229 <create+0x1b0>
    panic("create: dirlink");
8010621d:	c7 04 24 9e 8e 10 80 	movl   $0x80108e9e,(%esp)
80106224:	e8 14 a3 ff ff       	call   8010053d <panic>

  iunlockput(dp);
80106229:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010622c:	89 04 24             	mov    %eax,(%esp)
8010622f:	e8 b8 b8 ff ff       	call   80101aec <iunlockput>
...
8010623f:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106242:	89 44 24 04          	mov    %eax,0x4(%esp)
80106246:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010624d:	e8 a2 f6 ff ff       	call   801058f4 <argstr>
80106252:	85 c0                	test   %eax,%eax
80106254:	78 17                	js     8010626d <sys_open+0x34>
80106256:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106259:	89 44 24 04          	mov    %eax,0x4(%esp)
8010625d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106264:	e8 f1 f5 ff ff       	call   8010585a <argint>
80106269:	85 c0                	test   %eax,%eax
8010626b:	79 0a                	jns    80106277 <sys_open+0x3e>
    return -1;
8010626d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106272:	e9 46 01 00 00       	jmp    801063bd <sys_open+0x184>
  if(omode & O_CREATE){
80106277:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010627a:	25 00 02 00 00       	and    $0x200,%eax
8010627f:	85 c0                	test   %eax,%eax
80106281:	74 40                	je     801062c3 <sys_open+0x8a>
    begin_trans();
80106283:	e8 95 cf ff ff       	call   8010321d <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80106288:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010628b:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80106292:	00 
80106293:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010629a:	00 
8010629b:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
801062a2:	00 
801062a3:	89 04 24             	mov    %eax,(%esp)
801062a6:	e8 ce fd ff ff       	call   80106079 <create>
801062ab:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
801062ae:	e8 b3 cf ff ff       	call   80103266 <commit_trans>
    if(ip == 0)
801062b3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062b7:	75 5c                	jne    80106315 <sys_open+0xdc>
      return -1;
801062b9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062be:	e9 fa 00 00 00       	jmp    801063bd <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
801062c3:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062c6:	89 04 24             	mov    %eax,(%esp)
801062c9:	e8 3c c1 ff ff       	call   8010240a <namei>
801062ce:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062d1:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062d5:	75 0a                	jne    801062e1 <sys_open+0xa8>
      return -1;
801062d7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062dc:	e9 dc 00 00 00       	jmp    801063bd <sys_open+0x184>
    ilock(ip);
801062e1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062e4:	89 04 24             	mov    %eax,(%esp)
801062e7:	e8 7c b5 ff ff       	call   80101868 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801062ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062ef:	0f b7 40 10          	movzwl 0x10(%eax),%eax
801062f3:	66 83 f8 01          	cmp    $0x1,%ax
801062f7:	75 1c                	jne    80106315 <sys_open+0xdc>
801062f9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062fc:	85 c0                	test   %eax,%eax
801062fe:	74 15                	je     80106315 <sys_open+0xdc>
      iunlockput(ip);
80106300:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106303:	89 04 24             	mov    %eax,(%esp)
80106306:	e8 e1 b7 ff ff       	call   80101aec <iunlockput>
      return -1;
8010630b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106310:	e9 a8 00 00 00       	jmp    801063bd <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80106315:	e8 02 ac ff ff       	call   80100f1c <filealloc>
8010631a:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010631d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80106321:	74 14                	je     80106337 <sys_open+0xfe>
80106323:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106326:	89 04 24             	mov    %eax,(%esp)
80106329:	e8 43 f7 ff ff       	call   80105a71 <fdalloc>
8010632e:	89 45 ec             	mov    %eax,-0x14(%ebp)
80106331:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80106335:	79 23                	jns    8010635a <sys_open+0x121>
    if(f)
80106337:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010633b:	74 0b                	je     80106348 <sys_open+0x10f>
      fileclose(f);
8010633d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106340:	89 04 24             	mov    %eax,(%esp)
80106343:	e8 7c ac ff ff       	call   80100fc4 <fileclose>
    iunlockput(ip);
80106348:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010634b:	89 04 24             	mov    %eax,(%esp)
8010634e:	e8 99 b7 ff ff       	call   80101aec <iunlockput>
    return -1;
80106353:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106358:	eb 63                	jmp    801063bd <sys_open+0x184>
  }
  iunlock(ip);
8010635a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010635d:	89 04 24             	mov    %eax,(%esp)
80106360:	e8 51 b6 ff ff       	call   801019b6 <iunlock>

  f->type = FD_INODE;
80106365:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106368:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
8010636e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106371:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106374:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80106377:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010637a:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80106381:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106384:	83 e0 01             	and    $0x1,%eax
80106387:	85 c0                	test   %eax,%eax
80106389:	0f 94 c2             	sete   %dl
8010638c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010638f:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106392:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106395:	83 e0 01             	and    $0x1,%eax
80106398:	84 c0                	test   %al,%al
8010639a:	75 0a                	jne    801063a6 <sys_open+0x16d>
8010639c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010639f:	83 e0 02             	and    $0x2,%eax
801063a2:	85 c0                	test   %eax,%eax
801063a4:	74 07                	je     801063ad <sys_open+0x174>
801063a6:	b8 01 00 00 00       	mov    $0x1,%eax
801063ab:	eb 05                	jmp    801063b2 <sys_open+0x179>
801063ad:	b8 00 00 00 00       	mov    $0x0,%eax
801063b2:	89 c2                	mov    %eax,%edx
801063b4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063b7:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
...
801063c2:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_trans();
801063c5:	e8 53 ce ff ff       	call   8010321d <begin_trans>
...
801063d8:	e8 17 f5 ff ff       	call   801058f4 <argstr>
801063dd:	85 c0                	test   %eax,%eax
801063df:	78 2c                	js     8010640d <sys_mkdir+0x4e>
801063e1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801063e4:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
801063eb:	00 
801063ec:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801063f3:	00 
801063f4:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
801063fb:	00 
801063fc:	89 04 24             	mov    %eax,(%esp)
801063ff:	e8 75 fc ff ff       	call   80106079 <create>
80106404:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106407:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010640b:	75 0c                	jne    80106419 <sys_mkdir+0x5a>
    commit_trans();
8010640d:	e8 54 ce ff ff       	call   80103266 <commit_trans>
    return -1;
80106412:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106417:	eb 15                	jmp    8010642e <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106419:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010641c:	89 04 24             	mov    %eax,(%esp)
8010641f:	e8 c8 b6 ff ff       	call   80101aec <iunlockput>
  commit_trans();
80106424:	e8 3d ce ff ff       	call   80103266 <commit_trans>
  return 0;
...
80106433:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
...
8010646c:	78 47                	js     801064b5 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010646e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106471:	89 44 24 04          	mov    %eax,0x4(%esp)
80106475:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010647c:	e8 d9 f3 ff ff       	call   8010585a <argint>
  int len;
  int major, minor;
...
80106483:	78 30                	js     801064b5 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106485:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106488:	0f bf c8             	movswl %ax,%ecx
8010648b:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010648e:	0f bf d0             	movswl %ax,%edx
80106491:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106494:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106498:	89 54 24 08          	mov    %edx,0x8(%esp)
8010649c:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
801064a3:	00 
801064a4:	89 04 24             	mov    %eax,(%esp)
801064a7:	e8 cd fb ff ff       	call   80106079 <create>
801064ac:	89 45 f0             	mov    %eax,-0x10(%ebp)
801064af:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801064b3:	75 0c                	jne    801064c1 <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
801064b5:	e8 ac cd ff ff       	call   80103266 <commit_trans>
    return -1;
801064ba:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064bf:	eb 15                	jmp    801064d6 <sys_mknod+0xa6>
  }
  iunlockput(ip);
801064c1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064c4:	89 04 24             	mov    %eax,(%esp)
801064c7:	e8 20 b6 ff ff       	call   80101aec <iunlockput>
  commit_trans();
801064cc:	e8 95 cd ff ff       	call   80103266 <commit_trans>
  return 0;
...
801064db:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0)
801064de:	8d 45 f0             	lea    -0x10(%ebp),%eax
801064e1:	89 44 24 04          	mov    %eax,0x4(%esp)
801064e5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801064ec:	e8 03 f4 ff ff       	call   801058f4 <argstr>
801064f1:	85 c0                	test   %eax,%eax
801064f3:	78 14                	js     80106509 <sys_chdir+0x31>
801064f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801064f8:	89 04 24             	mov    %eax,(%esp)
801064fb:	e8 0a bf ff ff       	call   8010240a <namei>
80106500:	89 45 f4             	mov    %eax,-0xc(%ebp)
80106503:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106507:	75 07                	jne    80106510 <sys_chdir+0x38>
    return -1;
80106509:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010650e:	eb 57                	jmp    80106567 <sys_chdir+0x8f>
  ilock(ip);
80106510:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106513:	89 04 24             	mov    %eax,(%esp)
80106516:	e8 4d b3 ff ff       	call   80101868 <ilock>
  if(ip->type != T_DIR){
8010651b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010651e:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80106522:	66 83 f8 01          	cmp    $0x1,%ax
80106526:	74 12                	je     8010653a <sys_chdir+0x62>
    iunlockput(ip);
...
8010656c:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106580:	e8 6f f3 ff ff       	call   801058f4 <argstr>
80106585:	85 c0                	test   %eax,%eax
80106587:	78 1a                	js     801065a3 <sys_exec+0x3a>
...
8010659a:	e8 bb f2 ff ff       	call   8010585a <argint>
8010659f:	85 c0                	test   %eax,%eax
801065a1:	79 0a                	jns    801065ad <sys_exec+0x44>
    return -1;
801065a3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065a8:	e9 e2 00 00 00       	jmp    8010668f <sys_exec+0x126>
  }
  memset(argv, 0, sizeof(argv));
801065ad:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801065b4:	00 
801065b5:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801065bc:	00 
801065bd:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801065c3:	89 04 24             	mov    %eax,(%esp)
801065c6:	e8 3f ef ff ff       	call   8010550a <memset>
  for(i=0;; i++){
801065cb:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801065d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065d5:	83 f8 1f             	cmp    $0x1f,%eax
801065d8:	76 0a                	jbe    801065e4 <sys_exec+0x7b>
      return -1;
801065da:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801065df:	e9 ab 00 00 00       	jmp    8010668f <sys_exec+0x126>
    if(fetchint(proc, uargv+4*i, (int*)&uarg) < 0)
801065e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801065e7:	c1 e0 02             	shl    $0x2,%eax
801065ea:	89 c2                	mov    %eax,%edx
801065ec:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801065f2:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
801065f5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801065fb:	8d 95 68 ff ff ff    	lea    -0x98(%ebp),%edx
80106601:	89 54 24 08          	mov    %edx,0x8(%esp)
80106605:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80106609:	89 04 24             	mov    %eax,(%esp)
8010660c:	e8 b7 f1 ff ff       	call   801057c8 <fetchint>
80106611:	85 c0                	test   %eax,%eax
80106613:	79 07                	jns    8010661c <sys_exec+0xb3>
      return -1;
80106615:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010661a:	eb 73                	jmp    8010668f <sys_exec+0x126>
    if(uarg == 0){
8010661c:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106622:	85 c0                	test   %eax,%eax
80106624:	75 26                	jne    8010664c <sys_exec+0xe3>
      argv[i] = 0;
80106626:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106629:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106630:	00 00 00 00 
      break;
80106634:	90                   	nop
    }
...
80106638:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
8010663e:	89 54 24 04          	mov    %edx,0x4(%esp)
80106642:	89 04 24             	mov    %eax,(%esp)
80106645:	e8 b2 a4 ff ff       	call   80100afc <exec>
8010664a:	eb 43                	jmp    8010668f <sys_exec+0x126>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
8010664f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80106656:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010665c:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
8010665f:	8b 95 68 ff ff ff    	mov    -0x98(%ebp),%edx
80106665:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010666b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010666f:	89 54 24 04          	mov    %edx,0x4(%esp)
80106673:	89 04 24             	mov    %eax,(%esp)
80106676:	e8 81 f1 ff ff       	call   801057fc <fetchstr>
8010667b:	85 c0                	test   %eax,%eax
8010667d:	79 07                	jns    80106686 <sys_exec+0x11d>
      return -1;
8010667f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106684:	eb 09                	jmp    8010668f <sys_exec+0x126>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80106686:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(proc, uarg, &argv[i]) < 0)
...
8010668a:	e9 43 ff ff ff       	jmp    801065d2 <sys_exec+0x69>
  return exec(path, argv);
}
8010668f:	c9                   	leave  
80106690:	c3                   	ret    
...
80106694:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106697:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
8010669e:	00 
8010669f:	8d 45 ec             	lea    -0x14(%ebp),%eax
801066a2:	89 44 24 04          	mov    %eax,0x4(%esp)
801066a6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801066ad:	e8 e0 f1 ff ff       	call   80105892 <argptr>
801066b2:	85 c0                	test   %eax,%eax
801066b4:	79 0a                	jns    801066c0 <sys_pipe+0x2f>
    return -1;
801066b6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066bb:	e9 9b 00 00 00       	jmp    8010675b <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
801066c0:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801066c3:	89 44 24 04          	mov    %eax,0x4(%esp)
801066c7:	8d 45 e8             	lea    -0x18(%ebp),%eax
801066ca:	89 04 24             	mov    %eax,(%esp)
801066cd:	e8 66 d5 ff ff       	call   80103c38 <pipealloc>
801066d2:	85 c0                	test   %eax,%eax
801066d4:	79 07                	jns    801066dd <sys_pipe+0x4c>
    return -1;
801066d6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801066db:	eb 7e                	jmp    8010675b <sys_pipe+0xca>
  fd0 = -1;
801066dd:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801066e4:	8b 45 e8             	mov    -0x18(%ebp),%eax
801066e7:	89 04 24             	mov    %eax,(%esp)
801066ea:	e8 82 f3 ff ff       	call   80105a71 <fdalloc>
801066ef:	89 45 f4             	mov    %eax,-0xc(%ebp)
801066f2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801066f6:	78 14                	js     8010670c <sys_pipe+0x7b>
801066f8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801066fb:	89 04 24             	mov    %eax,(%esp)
801066fe:	e8 6e f3 ff ff       	call   80105a71 <fdalloc>
80106703:	89 45 f0             	mov    %eax,-0x10(%ebp)
80106706:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010670a:	79 37                	jns    80106743 <sys_pipe+0xb2>
    if(fd0 >= 0)
8010670c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106710:	78 14                	js     80106726 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
80106712:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106718:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010671b:	83 c2 08             	add    $0x8,%edx
8010671e:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80106725:	00 
    fileclose(rf);
80106726:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106729:	89 04 24             	mov    %eax,(%esp)
8010672c:	e8 93 a8 ff ff       	call   80100fc4 <fileclose>
    fileclose(wf);
80106731:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106734:	89 04 24             	mov    %eax,(%esp)
80106737:	e8 88 a8 ff ff       	call   80100fc4 <fileclose>
    return -1;
8010673c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106741:	eb 18                	jmp    8010675b <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106743:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106746:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106749:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
8010674b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010674e:	8d 50 04             	lea    0x4(%eax),%edx
80106751:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106754:	89 02                	mov    %eax,(%edx)
  return 0;
80106756:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010675b:	c9                   	leave  
8010675c:	c3                   	ret    
8010675d:	00 00                	add    %al,(%eax)
	...
...
80106763:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106766:	e8 97 db ff ff       	call   80104302 <fork>
}
8010676b:	c9                   	leave  
8010676c:	c3                   	ret    
...
80106770:	83 ec 08             	sub    $0x8,%esp
  exit();
80106773:	e8 2f dd ff ff       	call   801044a7 <exit>
...
80106782:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106785:	e8 aa de ff ff       	call   80104634 <wait>
}
8010678a:	c9                   	leave  
8010678b:	c3                   	ret    
...
801067a0:	e8 b5 f0 ff ff       	call   8010585a <argint>
801067a5:	85 c0                	test   %eax,%eax
801067a7:	79 07                	jns    801067b0 <sys_kill+0x24>
    return -1;
801067a9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067ae:	eb 0b                	jmp    801067bb <sys_kill+0x2f>
  return kill(pid);
801067b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801067b3:	89 04 24             	mov    %eax,(%esp)
801067b6:	e8 4e e3 ff ff       	call   80104b09 <kill>
}
801067bb:	c9                   	leave  
801067bc:	c3                   	ret    
...
801067c6:	8b 40 10             	mov    0x10(%eax),%eax
}
801067c9:	5d                   	pop    %ebp
801067ca:	c3                   	ret    
...
801067ce:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;
...
801067df:	e8 76 f0 ff ff       	call   8010585a <argint>
801067e4:	85 c0                	test   %eax,%eax
801067e6:	79 07                	jns    801067ef <sys_sbrk+0x24>
    return -1;
801067e8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801067ed:	eb 24                	jmp    80106813 <sys_sbrk+0x48>
  addr = proc->sz;
...
80106800:	e8 58 da ff ff       	call   8010425d <growproc>
80106805:	85 c0                	test   %eax,%eax
80106807:	79 07                	jns    80106810 <sys_sbrk+0x45>
    return -1;
80106809:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010680e:	eb 03                	jmp    80106813 <sys_sbrk+0x48>
  return addr;
...
80106829:	e8 2c f0 ff ff       	call   8010585a <argint>
8010682e:	85 c0                	test   %eax,%eax
80106830:	79 07                	jns    80106839 <sys_sleep+0x24>
    return -1;
80106832:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106837:	eb 6c                	jmp    801068a5 <sys_sleep+0x90>
  acquire(&tickslock);
80106839:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
80106840:	e8 76 ea ff ff       	call   801052bb <acquire>
  ticks0 = ticks;
80106845:	a1 00 44 11 80       	mov    0x80114400,%eax
8010684a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
8010684d:	eb 34                	jmp    80106883 <sys_sleep+0x6e>
    if(proc->killed){
8010684f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106855:	8b 40 24             	mov    0x24(%eax),%eax
80106858:	85 c0                	test   %eax,%eax
8010685a:	74 13                	je     8010686f <sys_sleep+0x5a>
      release(&tickslock);
8010685c:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
80106863:	e8 b5 ea ff ff       	call   8010531d <release>
      return -1;
80106868:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010686d:	eb 36                	jmp    801068a5 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
8010686f:	c7 44 24 04 c0 3b 11 	movl   $0x80113bc0,0x4(%esp)
80106876:	80 
80106877:	c7 04 24 00 44 11 80 	movl   $0x80114400,(%esp)
8010687e:	e8 7f e1 ff ff       	call   80104a02 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106883:	a1 00 44 11 80       	mov    0x80114400,%eax
80106888:	89 c2                	mov    %eax,%edx
8010688a:	2b 55 f4             	sub    -0xc(%ebp),%edx
8010688d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106890:	39 c2                	cmp    %eax,%edx
80106892:	72 bb                	jb     8010684f <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106894:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
8010689b:	e8 7d ea ff ff       	call   8010531d <release>
  return 0;
...
801068aa:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
801068ad:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
801068b4:	e8 02 ea ff ff       	call   801052bb <acquire>
  xticks = ticks;
801068b9:	a1 00 44 11 80       	mov    0x80114400,%eax
801068be:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801068c1:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
801068c8:	e8 50 ea ff ff       	call   8010531d <release>
  return xticks;
...
801068d5:	83 ec 28             	sub    $0x28,%esp
  char* start_func;
  char* stack;
  char* stack_size;
...
801068ee:	e8 9f ef ff ff       	call   80105892 <argptr>
...
8010694f:	8b 80 84 00 00 00    	mov    0x84(%eax),%eax
}
80106955:	5d                   	pop    %ebp
80106956:	c3                   	ret    

80106957 <sys_thread_getProcId>:
...
80106960:	8b 40 10             	mov    0x10(%eax),%eax
}
80106963:	5d                   	pop    %ebp
80106964:	c3                   	ret    

80106965 <sys_thread_join>:
...
80106968:	83 ec 28             	sub    $0x28,%esp
  char* thread_id;
  char* ret_val;
  argptr(0, &thread_id, sizeof(thread_id));
8010696b:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106972:	00 
80106973:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106976:	89 44 24 04          	mov    %eax,0x4(%esp)
8010697a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106981:	e8 0c ef ff ff       	call   80105892 <argptr>
  argptr(1, &ret_val , sizeof(ret_val));
80106986:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
8010698d:	00 
8010698e:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106991:	89 44 24 04          	mov    %eax,0x4(%esp)
80106995:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010699c:	e8 f1 ee ff ff       	call   80105892 <argptr>
...
801069ae:	e8 b4 e4 ff ff       	call   80104e67 <thread_join>
}
801069b3:	c9                   	leave  
801069b4:	c3                   	ret    

801069b5 <sys_thread_exit>:
...
801069bb:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801069c2:	00 
801069c3:	8d 45 f4             	lea    -0xc(%ebp),%eax
801069c6:	89 44 24 04          	mov    %eax,0x4(%esp)
801069ca:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069d1:	e8 bc ee ff ff       	call   80105892 <argptr>
  return thread_exit((void*) ret_val);
801069d6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069d9:	89 04 24             	mov    %eax,(%esp)
801069dc:	e8 76 e5 ff ff       	call   80104f57 <thread_exit>
}
801069e1:	c9                   	leave  
801069e2:	c3                   	ret    

801069e3 <sys_binary_semaphore_create>:
...
801069f8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069ff:	e8 8e ee ff ff       	call   80105892 <argptr>
  return binary_semaphore_create((int) initial_value);
80106a04:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a07:	89 04 24             	mov    %eax,(%esp)
80106a0a:	e8 3f e6 ff ff       	call   8010504e <binary_semaphore_create>
}
80106a0f:	c9                   	leave  
80106a10:	c3                   	ret    

80106a11 <sys_binary_semaphore_down>:
...
80106a42:	83 ec 28             	sub    $0x28,%esp
  char* binary_semaphore_ID;
  argptr(0,&binary_semaphore_ID,sizeof(binary_semaphore_ID));
80106a45:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80106a4c:	00 
80106a4d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106a50:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a54:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a5b:	e8 32 ee ff ff       	call   80105892 <argptr>
  return binary_semaphore_up((int) binary_semaphore_ID);
80106a60:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a63:	89 04 24             	mov    %eax,(%esp)
80106a66:	e8 32 e7 ff ff       	call   8010519d <binary_semaphore_up>
}
80106a6b:	c9                   	leave  
80106a6c:	c3                   	ret    
80106a6d:	00 00                	add    %al,(%eax)
	...
...
80106a7c:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106a80:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106a83:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106a87:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106a8b:	ee                   	out    %al,(%dx)
}
80106a8c:	c9                   	leave  
80106a8d:	c3                   	ret    
...
80106a91:	83 ec 18             	sub    $0x18,%esp
  // Interrupt 100 times/sec.
  outb(TIMER_MODE, TIMER_SEL0 | TIMER_RATEGEN | TIMER_16BIT);
80106a94:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106a9b:	00 
80106a9c:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
80106aa3:	e8 c8 ff ff ff       	call   80106a70 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106aa8:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106aaf:	00 
80106ab0:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106ab7:	e8 b4 ff ff ff       	call   80106a70 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106abc:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
80106ac3:	00 
80106ac4:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106acb:	e8 a0 ff ff ff       	call   80106a70 <outb>
  picenable(IRQ_TIMER);
80106ad0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106ad7:	e8 e5 cf ff ff       	call   80103ac1 <picenable>
}
80106adc:	c9                   	leave  
80106add:	c3                   	ret    
	...
...
80106ae1:	06                   	push   %es
  pushl %fs
80106ae2:	0f a0                	push   %fs
  pushl %gs
80106ae4:	0f a8                	push   %gs
  pushal
80106ae6:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80106ae7:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106aeb:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106aed:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106aef:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80106af3:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80106af5:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80106af7:	54                   	push   %esp
  call trap
80106af8:	e8 de 01 00 00       	call   80106cdb <trap>
  addl $4, %esp
80106afd:	83 c4 04             	add    $0x4,%esp
...
80106b00:	61                   	popa   
  popl %gs
80106b01:	0f a9                	pop    %gs
  popl %fs
80106b03:	0f a1                	pop    %fs
  popl %es
80106b05:	07                   	pop    %es
  popl %ds
80106b06:	1f                   	pop    %ds
...
80106b0f:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
80106b12:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b15:	83 e8 01             	sub    $0x1,%eax
80106b18:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80106b1c:	8b 45 08             	mov    0x8(%ebp),%eax
80106b1f:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106b23:	8b 45 08             	mov    0x8(%ebp),%eax
80106b26:	c1 e8 10             	shr    $0x10,%eax
80106b29:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80106b2d:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106b30:	0f 01 18             	lidtl  (%eax)
}
80106b33:	c9                   	leave  
80106b34:	c3                   	ret    
...
80106b39:	83 ec 10             	sub    $0x10,%esp
  uint val;
  asm volatile("movl %%cr2,%0" : "=r" (val));
80106b3c:	0f 20 d3             	mov    %cr2,%ebx
80106b3f:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
...
80106b4e:	83 ec 28             	sub    $0x28,%esp
  ...
  for(i = 0; i < 256; i++)
80106b51:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106b58:	e9 c3 00 00 00       	jmp    80106c20 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106b5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b60:	8b 04 85 b8 c0 10 80 	mov    -0x7fef3f48(,%eax,4),%eax
80106b67:	89 c2                	mov    %eax,%edx
80106b69:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b6c:	66 89 14 c5 00 3c 11 	mov    %dx,-0x7feec400(,%eax,8)
80106b73:	80 
80106b74:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b77:	66 c7 04 c5 02 3c 11 	movw   $0x8,-0x7feec3fe(,%eax,8)
80106b7e:	80 08 00 
80106b81:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b84:	0f b6 14 c5 04 3c 11 	movzbl -0x7feec3fc(,%eax,8),%edx
80106b8b:	80 
80106b8c:	83 e2 e0             	and    $0xffffffe0,%edx
80106b8f:	88 14 c5 04 3c 11 80 	mov    %dl,-0x7feec3fc(,%eax,8)
80106b96:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106b99:	0f b6 14 c5 04 3c 11 	movzbl -0x7feec3fc(,%eax,8),%edx
80106ba0:	80 
80106ba1:	83 e2 1f             	and    $0x1f,%edx
80106ba4:	88 14 c5 04 3c 11 80 	mov    %dl,-0x7feec3fc(,%eax,8)
80106bab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bae:	0f b6 14 c5 05 3c 11 	movzbl -0x7feec3fb(,%eax,8),%edx
80106bb5:	80 
80106bb6:	83 e2 f0             	and    $0xfffffff0,%edx
80106bb9:	83 ca 0e             	or     $0xe,%edx
80106bbc:	88 14 c5 05 3c 11 80 	mov    %dl,-0x7feec3fb(,%eax,8)
80106bc3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bc6:	0f b6 14 c5 05 3c 11 	movzbl -0x7feec3fb(,%eax,8),%edx
80106bcd:	80 
80106bce:	83 e2 ef             	and    $0xffffffef,%edx
80106bd1:	88 14 c5 05 3c 11 80 	mov    %dl,-0x7feec3fb(,%eax,8)
80106bd8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bdb:	0f b6 14 c5 05 3c 11 	movzbl -0x7feec3fb(,%eax,8),%edx
80106be2:	80 
80106be3:	83 e2 9f             	and    $0xffffff9f,%edx
80106be6:	88 14 c5 05 3c 11 80 	mov    %dl,-0x7feec3fb(,%eax,8)
80106bed:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bf0:	0f b6 14 c5 05 3c 11 	movzbl -0x7feec3fb(,%eax,8),%edx
80106bf7:	80 
80106bf8:	83 ca 80             	or     $0xffffff80,%edx
80106bfb:	88 14 c5 05 3c 11 80 	mov    %dl,-0x7feec3fb(,%eax,8)
80106c02:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c05:	8b 04 85 b8 c0 10 80 	mov    -0x7fef3f48(,%eax,4),%eax
80106c0c:	c1 e8 10             	shr    $0x10,%eax
80106c0f:	89 c2                	mov    %eax,%edx
80106c11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c14:	66 89 14 c5 06 3c 11 	mov    %dx,-0x7feec3fa(,%eax,8)
80106c1b:	80 
void
tvinit(void)
{
...
80106c20:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106c27:	0f 8e 30 ff ff ff    	jle    80106b5d <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106c2d:	a1 b8 c1 10 80       	mov    0x8010c1b8,%eax
80106c32:	66 a3 00 3e 11 80    	mov    %ax,0x80113e00
80106c38:	66 c7 05 02 3e 11 80 	movw   $0x8,0x80113e02
80106c3f:	08 00 
80106c41:	0f b6 05 04 3e 11 80 	movzbl 0x80113e04,%eax
80106c48:	83 e0 e0             	and    $0xffffffe0,%eax
80106c4b:	a2 04 3e 11 80       	mov    %al,0x80113e04
80106c50:	0f b6 05 04 3e 11 80 	movzbl 0x80113e04,%eax
80106c57:	83 e0 1f             	and    $0x1f,%eax
80106c5a:	a2 04 3e 11 80       	mov    %al,0x80113e04
80106c5f:	0f b6 05 05 3e 11 80 	movzbl 0x80113e05,%eax
80106c66:	83 c8 0f             	or     $0xf,%eax
80106c69:	a2 05 3e 11 80       	mov    %al,0x80113e05
80106c6e:	0f b6 05 05 3e 11 80 	movzbl 0x80113e05,%eax
80106c75:	83 e0 ef             	and    $0xffffffef,%eax
80106c78:	a2 05 3e 11 80       	mov    %al,0x80113e05
80106c7d:	0f b6 05 05 3e 11 80 	movzbl 0x80113e05,%eax
80106c84:	83 c8 60             	or     $0x60,%eax
80106c87:	a2 05 3e 11 80       	mov    %al,0x80113e05
80106c8c:	0f b6 05 05 3e 11 80 	movzbl 0x80113e05,%eax
80106c93:	83 c8 80             	or     $0xffffff80,%eax
80106c96:	a2 05 3e 11 80       	mov    %al,0x80113e05
80106c9b:	a1 b8 c1 10 80       	mov    0x8010c1b8,%eax
80106ca0:	c1 e8 10             	shr    $0x10,%eax
80106ca3:	66 a3 06 3e 11 80    	mov    %ax,0x80113e06
  
  initlock(&tickslock, "time");
80106ca9:	c7 44 24 04 b0 8e 10 	movl   $0x80108eb0,0x4(%esp)
80106cb0:	80 
80106cb1:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
80106cb8:	e8 dd e5 ff ff       	call   8010529a <initlock>
}
80106cbd:	c9                   	leave  
80106cbe:	c3                   	ret    
...
80106cc2:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
80106cc5:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106ccc:	00 
80106ccd:	c7 04 24 00 3c 11 80 	movl   $0x80113c00,(%esp)
80106cd4:	e8 33 fe ff ff       	call   80106b0c <lidt>
}
80106cd9:	c9                   	leave  
80106cda:	c3                   	ret    
...
80106cde:	57                   	push   %edi
80106cdf:	56                   	push   %esi
80106ce0:	53                   	push   %ebx
80106ce1:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106ce4:	8b 45 08             	mov    0x8(%ebp),%eax
80106ce7:	8b 40 30             	mov    0x30(%eax),%eax
80106cea:	83 f8 40             	cmp    $0x40,%eax
80106ced:	75 3e                	jne    80106d2d <trap+0x52>
    if(proc->killed)
80106cef:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106cf5:	8b 40 24             	mov    0x24(%eax),%eax
80106cf8:	85 c0                	test   %eax,%eax
80106cfa:	74 05                	je     80106d01 <trap+0x26>
      exit();
80106cfc:	e8 a6 d7 ff ff       	call   801044a7 <exit>
    proc->tf = tf;
80106d01:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106d07:	8b 55 08             	mov    0x8(%ebp),%edx
80106d0a:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106d0d:	e8 25 ec ff ff       	call   80105937 <syscall>
    if(proc->killed)
80106d12:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106d18:	8b 40 24             	mov    0x24(%eax),%eax
80106d1b:	85 c0                	test   %eax,%eax
80106d1d:	0f 84 34 02 00 00    	je     80106f57 <trap+0x27c>
      exit();
80106d23:	e8 7f d7 ff ff       	call   801044a7 <exit>
    return;
80106d28:	e9 2a 02 00 00       	jmp    80106f57 <trap+0x27c>
  }

  switch(tf->trapno){
80106d2d:	8b 45 08             	mov    0x8(%ebp),%eax
80106d30:	8b 40 30             	mov    0x30(%eax),%eax
80106d33:	83 e8 20             	sub    $0x20,%eax
80106d36:	83 f8 1f             	cmp    $0x1f,%eax
80106d39:	0f 87 bc 00 00 00    	ja     80106dfb <trap+0x120>
80106d3f:	8b 04 85 58 8f 10 80 	mov    -0x7fef70a8(,%eax,4),%eax
80106d46:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106d48:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106d4e:	0f b6 00             	movzbl (%eax),%eax
80106d51:	84 c0                	test   %al,%al
80106d53:	75 31                	jne    80106d86 <trap+0xab>
      acquire(&tickslock);
80106d55:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
80106d5c:	e8 5a e5 ff ff       	call   801052bb <acquire>
      ticks++;
80106d61:	a1 00 44 11 80       	mov    0x80114400,%eax
80106d66:	83 c0 01             	add    $0x1,%eax
80106d69:	a3 00 44 11 80       	mov    %eax,0x80114400
      wakeup(&ticks);
80106d6e:	c7 04 24 00 44 11 80 	movl   $0x80114400,(%esp)
80106d75:	e8 64 dd ff ff       	call   80104ade <wakeup>
      release(&tickslock);
80106d7a:	c7 04 24 c0 3b 11 80 	movl   $0x80113bc0,(%esp)
80106d81:	e8 97 e5 ff ff       	call   8010531d <release>
    }
    lapiceoi();
80106d86:	e8 5e c1 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106d8b:	e9 41 01 00 00       	jmp    80106ed1 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80106d90:	e8 5c b9 ff ff       	call   801026f1 <ideintr>
    lapiceoi();
80106d95:	e8 4f c1 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106d9a:	e9 32 01 00 00       	jmp    80106ed1 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106d9f:	e8 23 bf ff ff       	call   80102cc7 <kbdintr>
    lapiceoi();
80106da4:	e8 40 c1 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106da9:	e9 23 01 00 00       	jmp    80106ed1 <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106dae:	e8 a9 03 00 00       	call   8010715c <uartintr>
    lapiceoi();
80106db3:	e8 31 c1 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106db8:	e9 14 01 00 00       	jmp    80106ed1 <trap+0x1f6>
  case T_IRQ0 + 7:
...
80106dbd:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106dc0:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
...
80106dc6:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106dca:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
...
80106dd3:	0f b6 00             	movzbl (%eax),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106dd6:	0f b6 c0             	movzbl %al,%eax
80106dd9:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106ddd:	89 54 24 08          	mov    %edx,0x8(%esp)
80106de1:	89 44 24 04          	mov    %eax,0x4(%esp)
80106de5:	c7 04 24 b8 8e 10 80 	movl   $0x80108eb8,(%esp)
80106dec:	e8 b0 95 ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106df1:	e8 f3 c0 ff ff       	call   80102ee9 <lapiceoi>
    break;
80106df6:	e9 d6 00 00 00       	jmp    80106ed1 <trap+0x1f6>
...
80106e03:	74 11                	je     80106e16 <trap+0x13b>
80106e05:	8b 45 08             	mov    0x8(%ebp),%eax
80106e08:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106e0c:	0f b7 c0             	movzwl %ax,%eax
80106e0f:	83 e0 03             	and    $0x3,%eax
80106e12:	85 c0                	test   %eax,%eax
80106e14:	75 46                	jne    80106e5c <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106e16:	e8 1a fd ff ff       	call   80106b35 <rcr2>
...
80106e1b:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106e1e:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106e21:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106e28:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106e2b:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
...
80106e34:	89 44 24 10          	mov    %eax,0x10(%esp)
80106e38:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106e3c:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106e40:	89 54 24 04          	mov    %edx,0x4(%esp)
80106e44:	c7 04 24 dc 8e 10 80 	movl   $0x80108edc,(%esp)
80106e4b:	e8 51 95 ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106e50:	c7 04 24 0e 8f 10 80 	movl   $0x80108f0e,(%esp)
80106e57:	e8 e1 96 ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e5c:	e8 d4 fc ff ff       	call   80106b35 <rcr2>
...
80106e63:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e66:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
...
80106e6f:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e72:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e75:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e78:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e7b:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e7e:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106e81:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106e87:	83 c0 6c             	add    $0x6c,%eax
80106e8a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e8d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106e93:	8b 40 10             	mov    0x10(%eax),%eax
80106e96:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106e9a:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106e9e:	89 74 24 14          	mov    %esi,0x14(%esp)
80106ea2:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80106ea6:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106eaa:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106ead:	89 54 24 08          	mov    %edx,0x8(%esp)
80106eb1:	89 44 24 04          	mov    %eax,0x4(%esp)
80106eb5:	c7 04 24 14 8f 10 80 	movl   $0x80108f14,(%esp)
80106ebc:	e8 e0 94 ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106ec1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106ec7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106ece:	eb 01                	jmp    80106ed1 <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106ed9:	74 24                	je     80106eff <trap+0x224>
80106edb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106ee1:	8b 40 24             	mov    0x24(%eax),%eax
80106ee4:	85 c0                	test   %eax,%eax
80106ee6:	74 17                	je     80106eff <trap+0x224>
...
80106ef5:	83 f8 03             	cmp    $0x3,%eax
80106ef8:	75 05                	jne    80106eff <trap+0x224>
    exit();
80106efa:	e8 a8 d5 ff ff       	call   801044a7 <exit>
...
80106f07:	74 1e                	je     80106f27 <trap+0x24c>
80106f09:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f0f:	8b 40 0c             	mov    0xc(%eax),%eax
80106f12:	83 f8 04             	cmp    $0x4,%eax
80106f15:	75 10                	jne    80106f27 <trap+0x24c>
80106f17:	8b 45 08             	mov    0x8(%ebp),%eax
80106f1a:	8b 40 30             	mov    0x30(%eax),%eax
80106f1d:	83 f8 20             	cmp    $0x20,%eax
80106f20:	75 05                	jne    80106f27 <trap+0x24c>
    yield();
80106f22:	e8 7d da ff ff       	call   801049a4 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106f27:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f2d:	85 c0                	test   %eax,%eax
80106f2f:	74 27                	je     80106f58 <trap+0x27d>
80106f31:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106f37:	8b 40 24             	mov    0x24(%eax),%eax
80106f3a:	85 c0                	test   %eax,%eax
80106f3c:	74 1a                	je     80106f58 <trap+0x27d>
80106f3e:	8b 45 08             	mov    0x8(%ebp),%eax
80106f41:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106f45:	0f b7 c0             	movzwl %ax,%eax
80106f48:	83 e0 03             	and    $0x3,%eax
80106f4b:	83 f8 03             	cmp    $0x3,%eax
80106f4e:	75 08                	jne    80106f58 <trap+0x27d>
    exit();
80106f50:	e8 52 d5 ff ff       	call   801044a7 <exit>
80106f55:	eb 01                	jmp    80106f58 <trap+0x27d>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
80106f58:	83 c4 3c             	add    $0x3c,%esp
80106f5b:	5b                   	pop    %ebx
80106f5c:	5e                   	pop    %esi
80106f5d:	5f                   	pop    %edi
80106f5e:	5d                   	pop    %ebp
...
80106f64:	83 ec 14             	sub    $0x14,%esp
80106f67:	8b 45 08             	mov    0x8(%ebp),%eax
80106f6a:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106f6e:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
80106f72:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
80106f76:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
80106f7a:	ec                   	in     (%dx),%al
80106f7b:	89 c3                	mov    %eax,%ebx
80106f7d:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
80106f80:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
80106f84:	83 c4 14             	add    $0x14,%esp
80106f87:	5b                   	pop    %ebx
80106f88:	5d                   	pop    %ebp
80106f89:	c3                   	ret    
...
80106fb5:	00 
80106fb6:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106fbd:	e8 c8 ff ff ff       	call   80106f8a <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106fc2:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106fc9:	00 
80106fca:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106fd1:	e8 b4 ff ff ff       	call   80106f8a <outb>
  outb(COM1+0, 115200/9600);
80106fd6:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106fdd:	00 
80106fde:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106fe5:	e8 a0 ff ff ff       	call   80106f8a <outb>
  outb(COM1+1, 0);
80106fea:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106ff1:	00 
80106ff2:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106ff9:	e8 8c ff ff ff       	call   80106f8a <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106ffe:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80107005:	00 
80107006:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
8010700d:	e8 78 ff ff ff       	call   80106f8a <outb>
  outb(COM1+4, 0);
80107012:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107019:	00 
8010701a:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80107021:	e8 64 ff ff ff       	call   80106f8a <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80107026:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
8010702d:	00 
8010702e:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80107035:	e8 50 ff ff ff       	call   80106f8a <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
8010703a:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107041:	e8 1a ff ff ff       	call   80106f60 <inb>
80107046:	3c ff                	cmp    $0xff,%al
80107048:	74 6c                	je     801070b6 <uartinit+0x10e>
    return;
  uart = 1;
8010704a:	c7 05 6c c6 10 80 01 	movl   $0x1,0x8010c66c
80107051:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80107054:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
8010705b:	e8 00 ff ff ff       	call   80106f60 <inb>
  inb(COM1+0);
80107060:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107067:	e8 f4 fe ff ff       	call   80106f60 <inb>
  picenable(IRQ_COM1);
8010706c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107073:	e8 49 ca ff ff       	call   80103ac1 <picenable>
  ioapicenable(IRQ_COM1, 0);
80107078:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010707f:	00 
80107080:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107087:	e8 ea b8 ff ff       	call   80102976 <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
8010708c:	c7 45 f4 d8 8f 10 80 	movl   $0x80108fd8,-0xc(%ebp)
80107093:	eb 15                	jmp    801070aa <uartinit+0x102>
    uartputc(*p);
...
801070a1:	e8 13 00 00 00       	call   801070b9 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801070a6:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801070aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
801070ad:	0f b6 00             	movzbl (%eax),%eax
801070b0:	84 c0                	test   %al,%al
801070b2:	75 e1                	jne    80107095 <uartinit+0xed>
801070b4:	eb 01                	jmp    801070b7 <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
801070bc:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
801070bf:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
801070c4:	85 c0                	test   %eax,%eax
801070c6:	74 4d                	je     80107115 <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801070c8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801070cf:	eb 10                	jmp    801070e1 <uartputc+0x28>
    microdelay(10);
801070d1:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801070d8:	e8 31 be ff ff       	call   80102f0e <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801070dd:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801070e1:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
801070e5:	7f 16                	jg     801070fd <uartputc+0x44>
801070e7:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801070ee:	e8 6d fe ff ff       	call   80106f60 <inb>
801070f3:	0f b6 c0             	movzbl %al,%eax
801070f6:	83 e0 20             	and    $0x20,%eax
801070f9:	85 c0                	test   %eax,%eax
801070fb:	74 d4                	je     801070d1 <uartputc+0x18>
    microdelay(10);
  outb(COM1+0, c);
801070fd:	8b 45 08             	mov    0x8(%ebp),%eax
80107100:	0f b6 c0             	movzbl %al,%eax
80107103:	89 44 24 04          	mov    %eax,0x4(%esp)
80107107:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010710e:	e8 77 fe ff ff       	call   80106f8a <outb>
80107113:	eb 01                	jmp    80107116 <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
8010711b:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
8010711e:	a1 6c c6 10 80       	mov    0x8010c66c,%eax
80107123:	85 c0                	test   %eax,%eax
80107125:	75 07                	jne    8010712e <uartgetc+0x16>
    return -1;
80107127:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010712c:	eb 2c                	jmp    8010715a <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
8010712e:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80107135:	e8 26 fe ff ff       	call   80106f60 <inb>
8010713a:	0f b6 c0             	movzbl %al,%eax
8010713d:	83 e0 01             	and    $0x1,%eax
80107140:	85 c0                	test   %eax,%eax
80107142:	75 07                	jne    8010714b <uartgetc+0x33>
    return -1;
80107144:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107149:	eb 0f                	jmp    8010715a <uartgetc+0x42>
  return inb(COM1+0);
8010714b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80107152:	e8 09 fe ff ff       	call   80106f60 <inb>
...
8010715f:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
80107162:	c7 04 24 18 71 10 80 	movl   $0x80107118,(%esp)
80107169:	e8 3f 96 ff ff       	call   801007ad <consoleintr>
}
8010716e:	c9                   	leave  
8010716f:	c3                   	ret    
...
80107172:	6a 00                	push   $0x0
  jmp alltraps
80107174:	e9 67 f9 ff ff       	jmp    80106ae0 <alltraps>
...
8010717b:	6a 01                	push   $0x1
  jmp alltraps
8010717d:	e9 5e f9 ff ff       	jmp    80106ae0 <alltraps>
...
80107184:	6a 02                	push   $0x2
  jmp alltraps
80107186:	e9 55 f9 ff ff       	jmp    80106ae0 <alltraps>
...
8010718d:	6a 03                	push   $0x3
  jmp alltraps
8010718f:	e9 4c f9 ff ff       	jmp    80106ae0 <alltraps>
...
80107196:	6a 04                	push   $0x4
  jmp alltraps
80107198:	e9 43 f9 ff ff       	jmp    80106ae0 <alltraps>
...
8010719f:	6a 05                	push   $0x5
  jmp alltraps
801071a1:	e9 3a f9 ff ff       	jmp    80106ae0 <alltraps>
...
801071a8:	6a 06                	push   $0x6
  jmp alltraps
801071aa:	e9 31 f9 ff ff       	jmp    80106ae0 <alltraps>
...
801071b1:	6a 07                	push   $0x7
  jmp alltraps
801071b3:	e9 28 f9 ff ff       	jmp    80106ae0 <alltraps>
...
801071b8:	6a 08                	push   $0x8
  jmp alltraps
801071ba:	e9 21 f9 ff ff       	jmp    80106ae0 <alltraps>
...
801071c1:	6a 09                	push   $0x9
  jmp alltraps
801071c3:	e9 18 f9 ff ff       	jmp    80106ae0 <alltraps>
...
801071c8:	6a 0a                	push   $0xa
  jmp alltraps
801071ca:	e9 11 f9 ff ff       	jmp    80106ae0 <alltraps>
...
801071cf:	6a 0b                	push   $0xb
  jmp alltraps
801071d1:	e9 0a f9 ff ff       	jmp    80106ae0 <alltraps>
...
801071d6:	6a 0c                	push   $0xc
  jmp alltraps
801071d8:	e9 03 f9 ff ff       	jmp    80106ae0 <alltraps>
...
801071dd:	6a 0d                	push   $0xd
  jmp alltraps
801071df:	e9 fc f8 ff ff       	jmp    80106ae0 <alltraps>
...
801071e4:	6a 0e                	push   $0xe
  jmp alltraps
801071e6:	e9 f5 f8 ff ff       	jmp    80106ae0 <alltraps>
...
801071ed:	6a 0f                	push   $0xf
  jmp alltraps
801071ef:	e9 ec f8 ff ff       	jmp    80106ae0 <alltraps>
...
801071f6:	6a 10                	push   $0x10
  jmp alltraps
801071f8:	e9 e3 f8 ff ff       	jmp    80106ae0 <alltraps>
...
801071fd:	6a 11                	push   $0x11
  jmp alltraps
801071ff:	e9 dc f8 ff ff       	jmp    80106ae0 <alltraps>
...
80107206:	6a 12                	push   $0x12
  jmp alltraps
80107208:	e9 d3 f8 ff ff       	jmp    80106ae0 <alltraps>
...
8010720f:	6a 13                	push   $0x13
  jmp alltraps
80107211:	e9 ca f8 ff ff       	jmp    80106ae0 <alltraps>
...
80107218:	6a 14                	push   $0x14
  jmp alltraps
8010721a:	e9 c1 f8 ff ff       	jmp    80106ae0 <alltraps>
...
80107221:	6a 15                	push   $0x15
  jmp alltraps
80107223:	e9 b8 f8 ff ff       	jmp    80106ae0 <alltraps>
...
8010722a:	6a 16                	push   $0x16
  jmp alltraps
8010722c:	e9 af f8 ff ff       	jmp    80106ae0 <alltraps>
...
80107233:	6a 17                	push   $0x17
  jmp alltraps
80107235:	e9 a6 f8 ff ff       	jmp    80106ae0 <alltraps>
...
8010723c:	6a 18                	push   $0x18
  jmp alltraps
8010723e:	e9 9d f8 ff ff       	jmp    80106ae0 <alltraps>
...
80107245:	6a 19                	push   $0x19
  jmp alltraps
80107247:	e9 94 f8 ff ff       	jmp    80106ae0 <alltraps>
...
8010724e:	6a 1a                	push   $0x1a
  jmp alltraps
80107250:	e9 8b f8 ff ff       	jmp    80106ae0 <alltraps>
...
80107257:	6a 1b                	push   $0x1b
  jmp alltraps
80107259:	e9 82 f8 ff ff       	jmp    80106ae0 <alltraps>
...
80107260:	6a 1c                	push   $0x1c
  jmp alltraps
80107262:	e9 79 f8 ff ff       	jmp    80106ae0 <alltraps>
...
80107269:	6a 1d                	push   $0x1d
  jmp alltraps
8010726b:	e9 70 f8 ff ff       	jmp    80106ae0 <alltraps>
...
80107272:	6a 1e                	push   $0x1e
  jmp alltraps
80107274:	e9 67 f8 ff ff       	jmp    80106ae0 <alltraps>
...
8010727b:	6a 1f                	push   $0x1f
  jmp alltraps
8010727d:	e9 5e f8 ff ff       	jmp    80106ae0 <alltraps>
...
80107284:	6a 20                	push   $0x20
  jmp alltraps
80107286:	e9 55 f8 ff ff       	jmp    80106ae0 <alltraps>
...
8010728d:	6a 21                	push   $0x21
  jmp alltraps
8010728f:	e9 4c f8 ff ff       	jmp    80106ae0 <alltraps>
...
80107296:	6a 22                	push   $0x22
  jmp alltraps
80107298:	e9 43 f8 ff ff       	jmp    80106ae0 <alltraps>
...
8010729f:	6a 23                	push   $0x23
  jmp alltraps
801072a1:	e9 3a f8 ff ff       	jmp    80106ae0 <alltraps>
...
801072a8:	6a 24                	push   $0x24
  jmp alltraps
801072aa:	e9 31 f8 ff ff       	jmp    80106ae0 <alltraps>
...
801072b1:	6a 25                	push   $0x25
  jmp alltraps
801072b3:	e9 28 f8 ff ff       	jmp    80106ae0 <alltraps>
...
801072ba:	6a 26                	push   $0x26
  jmp alltraps
801072bc:	e9 1f f8 ff ff       	jmp    80106ae0 <alltraps>
...
801072c3:	6a 27                	push   $0x27
  jmp alltraps
801072c5:	e9 16 f8 ff ff       	jmp    80106ae0 <alltraps>
...
801072cc:	6a 28                	push   $0x28
  jmp alltraps
801072ce:	e9 0d f8 ff ff       	jmp    80106ae0 <alltraps>
...
801072d5:	6a 29                	push   $0x29
  jmp alltraps
801072d7:	e9 04 f8 ff ff       	jmp    80106ae0 <alltraps>
...
801072de:	6a 2a                	push   $0x2a
  jmp alltraps
801072e0:	e9 fb f7 ff ff       	jmp    80106ae0 <alltraps>
...
801072e7:	6a 2b                	push   $0x2b
  jmp alltraps
801072e9:	e9 f2 f7 ff ff       	jmp    80106ae0 <alltraps>
...
801072f0:	6a 2c                	push   $0x2c
  jmp alltraps
801072f2:	e9 e9 f7 ff ff       	jmp    80106ae0 <alltraps>
...
801072f9:	6a 2d                	push   $0x2d
  jmp alltraps
801072fb:	e9 e0 f7 ff ff       	jmp    80106ae0 <alltraps>
...
80107302:	6a 2e                	push   $0x2e
  jmp alltraps
80107304:	e9 d7 f7 ff ff       	jmp    80106ae0 <alltraps>
...
8010730b:	6a 2f                	push   $0x2f
  jmp alltraps
8010730d:	e9 ce f7 ff ff       	jmp    80106ae0 <alltraps>
...
80107314:	6a 30                	push   $0x30
  jmp alltraps
80107316:	e9 c5 f7 ff ff       	jmp    80106ae0 <alltraps>
...
8010731d:	6a 31                	push   $0x31
  jmp alltraps
8010731f:	e9 bc f7 ff ff       	jmp    80106ae0 <alltraps>
...
80107326:	6a 32                	push   $0x32
  jmp alltraps
80107328:	e9 b3 f7 ff ff       	jmp    80106ae0 <alltraps>
...
8010732f:	6a 33                	push   $0x33
  jmp alltraps
80107331:	e9 aa f7 ff ff       	jmp    80106ae0 <alltraps>
...
80107338:	6a 34                	push   $0x34
  jmp alltraps
8010733a:	e9 a1 f7 ff ff       	jmp    80106ae0 <alltraps>
...
80107341:	6a 35                	push   $0x35
  jmp alltraps
80107343:	e9 98 f7 ff ff       	jmp    80106ae0 <alltraps>
...
8010734a:	6a 36                	push   $0x36
  jmp alltraps
8010734c:	e9 8f f7 ff ff       	jmp    80106ae0 <alltraps>
...
80107353:	6a 37                	push   $0x37
  jmp alltraps
80107355:	e9 86 f7 ff ff       	jmp    80106ae0 <alltraps>
...
8010735c:	6a 38                	push   $0x38
  jmp alltraps
8010735e:	e9 7d f7 ff ff       	jmp    80106ae0 <alltraps>
...
80107365:	6a 39                	push   $0x39
  jmp alltraps
80107367:	e9 74 f7 ff ff       	jmp    80106ae0 <alltraps>
...
8010736e:	6a 3a                	push   $0x3a
  jmp alltraps
80107370:	e9 6b f7 ff ff       	jmp    80106ae0 <alltraps>
...
80107377:	6a 3b                	push   $0x3b
  jmp alltraps
80107379:	e9 62 f7 ff ff       	jmp    80106ae0 <alltraps>
...
80107380:	6a 3c                	push   $0x3c
  jmp alltraps
80107382:	e9 59 f7 ff ff       	jmp    80106ae0 <alltraps>
...
80107389:	6a 3d                	push   $0x3d
  jmp alltraps
8010738b:	e9 50 f7 ff ff       	jmp    80106ae0 <alltraps>
...
80107392:	6a 3e                	push   $0x3e
  jmp alltraps
80107394:	e9 47 f7 ff ff       	jmp    80106ae0 <alltraps>
...
8010739b:	6a 3f                	push   $0x3f
  jmp alltraps
8010739d:	e9 3e f7 ff ff       	jmp    80106ae0 <alltraps>
...
801073a4:	6a 40                	push   $0x40
  jmp alltraps
801073a6:	e9 35 f7 ff ff       	jmp    80106ae0 <alltraps>
...
801073ad:	6a 41                	push   $0x41
  jmp alltraps
801073af:	e9 2c f7 ff ff       	jmp    80106ae0 <alltraps>
...
801073b6:	6a 42                	push   $0x42
  jmp alltraps
801073b8:	e9 23 f7 ff ff       	jmp    80106ae0 <alltraps>
...
801073bf:	6a 43                	push   $0x43
  jmp alltraps
801073c1:	e9 1a f7 ff ff       	jmp    80106ae0 <alltraps>
...
801073c8:	6a 44                	push   $0x44
  jmp alltraps
801073ca:	e9 11 f7 ff ff       	jmp    80106ae0 <alltraps>
...
801073d1:	6a 45                	push   $0x45
  jmp alltraps
801073d3:	e9 08 f7 ff ff       	jmp    80106ae0 <alltraps>
...
801073da:	6a 46                	push   $0x46
  jmp alltraps
801073dc:	e9 ff f6 ff ff       	jmp    80106ae0 <alltraps>
...
801073e3:	6a 47                	push   $0x47
  jmp alltraps
801073e5:	e9 f6 f6 ff ff       	jmp    80106ae0 <alltraps>
...
801073ec:	6a 48                	push   $0x48
  jmp alltraps
801073ee:	e9 ed f6 ff ff       	jmp    80106ae0 <alltraps>
...
801073f5:	6a 49                	push   $0x49
  jmp alltraps
801073f7:	e9 e4 f6 ff ff       	jmp    80106ae0 <alltraps>
...
801073fe:	6a 4a                	push   $0x4a
  jmp alltraps
80107400:	e9 db f6 ff ff       	jmp    80106ae0 <alltraps>
...
80107407:	6a 4b                	push   $0x4b
  jmp alltraps
80107409:	e9 d2 f6 ff ff       	jmp    80106ae0 <alltraps>
...
80107410:	6a 4c                	push   $0x4c
  jmp alltraps
80107412:	e9 c9 f6 ff ff       	jmp    80106ae0 <alltraps>
...
80107419:	6a 4d                	push   $0x4d
  jmp alltraps
8010741b:	e9 c0 f6 ff ff       	jmp    80106ae0 <alltraps>
...
80107422:	6a 4e                	push   $0x4e
  jmp alltraps
80107424:	e9 b7 f6 ff ff       	jmp    80106ae0 <alltraps>
...
8010742b:	6a 4f                	push   $0x4f
  jmp alltraps
8010742d:	e9 ae f6 ff ff       	jmp    80106ae0 <alltraps>
...
80107434:	6a 50                	push   $0x50
  jmp alltraps
80107436:	e9 a5 f6 ff ff       	jmp    80106ae0 <alltraps>
...
8010743d:	6a 51                	push   $0x51
  jmp alltraps
8010743f:	e9 9c f6 ff ff       	jmp    80106ae0 <alltraps>
...
80107446:	6a 52                	push   $0x52
  jmp alltraps
80107448:	e9 93 f6 ff ff       	jmp    80106ae0 <alltraps>
...
8010744f:	6a 53                	push   $0x53
  jmp alltraps
80107451:	e9 8a f6 ff ff       	jmp    80106ae0 <alltraps>
...
80107458:	6a 54                	push   $0x54
  jmp alltraps
8010745a:	e9 81 f6 ff ff       	jmp    80106ae0 <alltraps>
...
80107461:	6a 55                	push   $0x55
  jmp alltraps
80107463:	e9 78 f6 ff ff       	jmp    80106ae0 <alltraps>
...
8010746a:	6a 56                	push   $0x56
  jmp alltraps
8010746c:	e9 6f f6 ff ff       	jmp    80106ae0 <alltraps>
...
80107473:	6a 57                	push   $0x57
  jmp alltraps
80107475:	e9 66 f6 ff ff       	jmp    80106ae0 <alltraps>
...
8010747c:	6a 58                	push   $0x58
  jmp alltraps
8010747e:	e9 5d f6 ff ff       	jmp    80106ae0 <alltraps>
...
80107485:	6a 59                	push   $0x59
  jmp alltraps
80107487:	e9 54 f6 ff ff       	jmp    80106ae0 <alltraps>
...
8010748e:	6a 5a                	push   $0x5a
  jmp alltraps
80107490:	e9 4b f6 ff ff       	jmp    80106ae0 <alltraps>
...
80107497:	6a 5b                	push   $0x5b
  jmp alltraps
80107499:	e9 42 f6 ff ff       	jmp    80106ae0 <alltraps>
...
801074a0:	6a 5c                	push   $0x5c
  jmp alltraps
801074a2:	e9 39 f6 ff ff       	jmp    80106ae0 <alltraps>
...
801074a9:	6a 5d                	push   $0x5d
  jmp alltraps
801074ab:	e9 30 f6 ff ff       	jmp    80106ae0 <alltraps>
...
801074b2:	6a 5e                	push   $0x5e
  jmp alltraps
801074b4:	e9 27 f6 ff ff       	jmp    80106ae0 <alltraps>
...
801074bb:	6a 5f                	push   $0x5f
  jmp alltraps
801074bd:	e9 1e f6 ff ff       	jmp    80106ae0 <alltraps>
...
801074c4:	6a 60                	push   $0x60
  jmp alltraps
801074c6:	e9 15 f6 ff ff       	jmp    80106ae0 <alltraps>
...
801074cd:	6a 61                	push   $0x61
  jmp alltraps
801074cf:	e9 0c f6 ff ff       	jmp    80106ae0 <alltraps>
...
801074d6:	6a 62                	push   $0x62
  jmp alltraps
801074d8:	e9 03 f6 ff ff       	jmp    80106ae0 <alltraps>
...
801074df:	6a 63                	push   $0x63
  jmp alltraps
801074e1:	e9 fa f5 ff ff       	jmp    80106ae0 <alltraps>
...
801074e8:	6a 64                	push   $0x64
  jmp alltraps
801074ea:	e9 f1 f5 ff ff       	jmp    80106ae0 <alltraps>
...
801074f1:	6a 65                	push   $0x65
  jmp alltraps
801074f3:	e9 e8 f5 ff ff       	jmp    80106ae0 <alltraps>
...
801074fa:	6a 66                	push   $0x66
  jmp alltraps
801074fc:	e9 df f5 ff ff       	jmp    80106ae0 <alltraps>
...
80107503:	6a 67                	push   $0x67
  jmp alltraps
80107505:	e9 d6 f5 ff ff       	jmp    80106ae0 <alltraps>
...
8010750c:	6a 68                	push   $0x68
  jmp alltraps
8010750e:	e9 cd f5 ff ff       	jmp    80106ae0 <alltraps>
...
80107515:	6a 69                	push   $0x69
  jmp alltraps
80107517:	e9 c4 f5 ff ff       	jmp    80106ae0 <alltraps>
...
8010751e:	6a 6a                	push   $0x6a
  jmp alltraps
80107520:	e9 bb f5 ff ff       	jmp    80106ae0 <alltraps>
...
80107527:	6a 6b                	push   $0x6b
  jmp alltraps
80107529:	e9 b2 f5 ff ff       	jmp    80106ae0 <alltraps>
...
80107530:	6a 6c                	push   $0x6c
  jmp alltraps
80107532:	e9 a9 f5 ff ff       	jmp    80106ae0 <alltraps>
...
80107539:	6a 6d                	push   $0x6d
  jmp alltraps
8010753b:	e9 a0 f5 ff ff       	jmp    80106ae0 <alltraps>
...
80107542:	6a 6e                	push   $0x6e
  jmp alltraps
80107544:	e9 97 f5 ff ff       	jmp    80106ae0 <alltraps>
...
8010754b:	6a 6f                	push   $0x6f
  jmp alltraps
8010754d:	e9 8e f5 ff ff       	jmp    80106ae0 <alltraps>
...
80107554:	6a 70                	push   $0x70
  jmp alltraps
80107556:	e9 85 f5 ff ff       	jmp    80106ae0 <alltraps>
...
8010755d:	6a 71                	push   $0x71
  jmp alltraps
8010755f:	e9 7c f5 ff ff       	jmp    80106ae0 <alltraps>
...
80107566:	6a 72                	push   $0x72
  jmp alltraps
80107568:	e9 73 f5 ff ff       	jmp    80106ae0 <alltraps>
...
8010756f:	6a 73                	push   $0x73
  jmp alltraps
80107571:	e9 6a f5 ff ff       	jmp    80106ae0 <alltraps>
...
80107578:	6a 74                	push   $0x74
  jmp alltraps
8010757a:	e9 61 f5 ff ff       	jmp    80106ae0 <alltraps>
...
80107581:	6a 75                	push   $0x75
  jmp alltraps
80107583:	e9 58 f5 ff ff       	jmp    80106ae0 <alltraps>
...
8010758a:	6a 76                	push   $0x76
  jmp alltraps
8010758c:	e9 4f f5 ff ff       	jmp    80106ae0 <alltraps>
...
80107593:	6a 77                	push   $0x77
  jmp alltraps
80107595:	e9 46 f5 ff ff       	jmp    80106ae0 <alltraps>
...
8010759c:	6a 78                	push   $0x78
  jmp alltraps
8010759e:	e9 3d f5 ff ff       	jmp    80106ae0 <alltraps>
...
801075a5:	6a 79                	push   $0x79
  jmp alltraps
801075a7:	e9 34 f5 ff ff       	jmp    80106ae0 <alltraps>
...
801075ae:	6a 7a                	push   $0x7a
  jmp alltraps
801075b0:	e9 2b f5 ff ff       	jmp    80106ae0 <alltraps>
...
801075b7:	6a 7b                	push   $0x7b
  jmp alltraps
801075b9:	e9 22 f5 ff ff       	jmp    80106ae0 <alltraps>
...
801075c0:	6a 7c                	push   $0x7c
  jmp alltraps
801075c2:	e9 19 f5 ff ff       	jmp    80106ae0 <alltraps>
...
801075c9:	6a 7d                	push   $0x7d
  jmp alltraps
801075cb:	e9 10 f5 ff ff       	jmp    80106ae0 <alltraps>
...
801075d2:	6a 7e                	push   $0x7e
  jmp alltraps
801075d4:	e9 07 f5 ff ff       	jmp    80106ae0 <alltraps>
...
801075db:	6a 7f                	push   $0x7f
  jmp alltraps
801075dd:	e9 fe f4 ff ff       	jmp    80106ae0 <alltraps>
...
801075e4:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801075e9:	e9 f2 f4 ff ff       	jmp    80106ae0 <alltraps>
...
801075f0:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801075f5:	e9 e6 f4 ff ff       	jmp    80106ae0 <alltraps>
...
801075fc:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107601:	e9 da f4 ff ff       	jmp    80106ae0 <alltraps>
...
80107608:	68 83 00 00 00       	push   $0x83
  jmp alltraps
8010760d:	e9 ce f4 ff ff       	jmp    80106ae0 <alltraps>
...
80107614:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107619:	e9 c2 f4 ff ff       	jmp    80106ae0 <alltraps>
...
80107620:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107625:	e9 b6 f4 ff ff       	jmp    80106ae0 <alltraps>
...
8010762c:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107631:	e9 aa f4 ff ff       	jmp    80106ae0 <alltraps>
...
80107638:	68 87 00 00 00       	push   $0x87
  jmp alltraps
8010763d:	e9 9e f4 ff ff       	jmp    80106ae0 <alltraps>
...
80107644:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107649:	e9 92 f4 ff ff       	jmp    80106ae0 <alltraps>
...
80107650:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107655:	e9 86 f4 ff ff       	jmp    80106ae0 <alltraps>
...
8010765c:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107661:	e9 7a f4 ff ff       	jmp    80106ae0 <alltraps>
...
80107668:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
8010766d:	e9 6e f4 ff ff       	jmp    80106ae0 <alltraps>
...
80107674:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107679:	e9 62 f4 ff ff       	jmp    80106ae0 <alltraps>
...
80107680:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107685:	e9 56 f4 ff ff       	jmp    80106ae0 <alltraps>
...
8010768c:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107691:	e9 4a f4 ff ff       	jmp    80106ae0 <alltraps>
...
80107698:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010769d:	e9 3e f4 ff ff       	jmp    80106ae0 <alltraps>
...
801076a4:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801076a9:	e9 32 f4 ff ff       	jmp    80106ae0 <alltraps>
...
801076b0:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801076b5:	e9 26 f4 ff ff       	jmp    80106ae0 <alltraps>
...
801076bc:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801076c1:	e9 1a f4 ff ff       	jmp    80106ae0 <alltraps>
...
801076c8:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801076cd:	e9 0e f4 ff ff       	jmp    80106ae0 <alltraps>
...
801076d4:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801076d9:	e9 02 f4 ff ff       	jmp    80106ae0 <alltraps>
...
801076e0:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801076e5:	e9 f6 f3 ff ff       	jmp    80106ae0 <alltraps>
...
801076ec:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801076f1:	e9 ea f3 ff ff       	jmp    80106ae0 <alltraps>
...
801076f8:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801076fd:	e9 de f3 ff ff       	jmp    80106ae0 <alltraps>
...
80107704:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107709:	e9 d2 f3 ff ff       	jmp    80106ae0 <alltraps>
...
80107710:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107715:	e9 c6 f3 ff ff       	jmp    80106ae0 <alltraps>
...
8010771c:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107721:	e9 ba f3 ff ff       	jmp    80106ae0 <alltraps>
...
80107728:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010772d:	e9 ae f3 ff ff       	jmp    80106ae0 <alltraps>
...
80107734:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107739:	e9 a2 f3 ff ff       	jmp    80106ae0 <alltraps>
...
80107740:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107745:	e9 96 f3 ff ff       	jmp    80106ae0 <alltraps>
...
8010774c:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107751:	e9 8a f3 ff ff       	jmp    80106ae0 <alltraps>
...
80107758:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
8010775d:	e9 7e f3 ff ff       	jmp    80106ae0 <alltraps>
...
80107764:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107769:	e9 72 f3 ff ff       	jmp    80106ae0 <alltraps>
...
80107770:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107775:	e9 66 f3 ff ff       	jmp    80106ae0 <alltraps>
...
8010777c:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107781:	e9 5a f3 ff ff       	jmp    80106ae0 <alltraps>
...
80107788:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010778d:	e9 4e f3 ff ff       	jmp    80106ae0 <alltraps>
...
80107794:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107799:	e9 42 f3 ff ff       	jmp    80106ae0 <alltraps>
...
801077a0:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801077a5:	e9 36 f3 ff ff       	jmp    80106ae0 <alltraps>
...
801077ac:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801077b1:	e9 2a f3 ff ff       	jmp    80106ae0 <alltraps>
...
801077b8:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801077bd:	e9 1e f3 ff ff       	jmp    80106ae0 <alltraps>
...
801077c4:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801077c9:	e9 12 f3 ff ff       	jmp    80106ae0 <alltraps>
...
801077d0:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801077d5:	e9 06 f3 ff ff       	jmp    80106ae0 <alltraps>
...
801077dc:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801077e1:	e9 fa f2 ff ff       	jmp    80106ae0 <alltraps>
...
801077e8:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801077ed:	e9 ee f2 ff ff       	jmp    80106ae0 <alltraps>
...
801077f4:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801077f9:	e9 e2 f2 ff ff       	jmp    80106ae0 <alltraps>
...
80107800:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107805:	e9 d6 f2 ff ff       	jmp    80106ae0 <alltraps>
...
8010780c:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107811:	e9 ca f2 ff ff       	jmp    80106ae0 <alltraps>
...
80107818:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
8010781d:	e9 be f2 ff ff       	jmp    80106ae0 <alltraps>
...
80107824:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107829:	e9 b2 f2 ff ff       	jmp    80106ae0 <alltraps>
...
80107830:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107835:	e9 a6 f2 ff ff       	jmp    80106ae0 <alltraps>
...
8010783c:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107841:	e9 9a f2 ff ff       	jmp    80106ae0 <alltraps>
...
80107848:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
8010784d:	e9 8e f2 ff ff       	jmp    80106ae0 <alltraps>
...
80107854:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107859:	e9 82 f2 ff ff       	jmp    80106ae0 <alltraps>
...
80107860:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107865:	e9 76 f2 ff ff       	jmp    80106ae0 <alltraps>
...
8010786c:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107871:	e9 6a f2 ff ff       	jmp    80106ae0 <alltraps>
...
80107878:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010787d:	e9 5e f2 ff ff       	jmp    80106ae0 <alltraps>
...
80107884:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107889:	e9 52 f2 ff ff       	jmp    80106ae0 <alltraps>
...
80107890:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107895:	e9 46 f2 ff ff       	jmp    80106ae0 <alltraps>
...
8010789c:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801078a1:	e9 3a f2 ff ff       	jmp    80106ae0 <alltraps>
...
801078a8:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801078ad:	e9 2e f2 ff ff       	jmp    80106ae0 <alltraps>
...
801078b4:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801078b9:	e9 22 f2 ff ff       	jmp    80106ae0 <alltraps>
...
801078c0:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801078c5:	e9 16 f2 ff ff       	jmp    80106ae0 <alltraps>
...
801078cc:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801078d1:	e9 0a f2 ff ff       	jmp    80106ae0 <alltraps>
...
801078d8:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801078dd:	e9 fe f1 ff ff       	jmp    80106ae0 <alltraps>
...
801078e4:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801078e9:	e9 f2 f1 ff ff       	jmp    80106ae0 <alltraps>
...
801078f0:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801078f5:	e9 e6 f1 ff ff       	jmp    80106ae0 <alltraps>
...
801078fc:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107901:	e9 da f1 ff ff       	jmp    80106ae0 <alltraps>
...
80107908:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
8010790d:	e9 ce f1 ff ff       	jmp    80106ae0 <alltraps>
...
80107914:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107919:	e9 c2 f1 ff ff       	jmp    80106ae0 <alltraps>
...
80107920:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107925:	e9 b6 f1 ff ff       	jmp    80106ae0 <alltraps>
...
8010792c:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107931:	e9 aa f1 ff ff       	jmp    80106ae0 <alltraps>
...
80107938:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
8010793d:	e9 9e f1 ff ff       	jmp    80106ae0 <alltraps>
...
80107944:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107949:	e9 92 f1 ff ff       	jmp    80106ae0 <alltraps>
...
80107950:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107955:	e9 86 f1 ff ff       	jmp    80106ae0 <alltraps>
...
8010795c:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107961:	e9 7a f1 ff ff       	jmp    80106ae0 <alltraps>
...
80107968:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
8010796d:	e9 6e f1 ff ff       	jmp    80106ae0 <alltraps>
...
80107974:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107979:	e9 62 f1 ff ff       	jmp    80106ae0 <alltraps>
...
80107980:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107985:	e9 56 f1 ff ff       	jmp    80106ae0 <alltraps>
...
8010798c:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107991:	e9 4a f1 ff ff       	jmp    80106ae0 <alltraps>
...
80107998:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
8010799d:	e9 3e f1 ff ff       	jmp    80106ae0 <alltraps>
...
801079a4:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801079a9:	e9 32 f1 ff ff       	jmp    80106ae0 <alltraps>
...
801079b0:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801079b5:	e9 26 f1 ff ff       	jmp    80106ae0 <alltraps>
...
801079bc:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801079c1:	e9 1a f1 ff ff       	jmp    80106ae0 <alltraps>
...
801079c8:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801079cd:	e9 0e f1 ff ff       	jmp    80106ae0 <alltraps>
...
801079d4:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801079d9:	e9 02 f1 ff ff       	jmp    80106ae0 <alltraps>
...
801079e0:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801079e5:	e9 f6 f0 ff ff       	jmp    80106ae0 <alltraps>
...
801079ec:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801079f1:	e9 ea f0 ff ff       	jmp    80106ae0 <alltraps>
...
801079f8:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801079fd:	e9 de f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a04:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107a09:	e9 d2 f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a10:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107a15:	e9 c6 f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a1c:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107a21:	e9 ba f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a28:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107a2d:	e9 ae f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a34:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107a39:	e9 a2 f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a40:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107a45:	e9 96 f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a4c:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107a51:	e9 8a f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a58:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107a5d:	e9 7e f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a64:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107a69:	e9 72 f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a70:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107a75:	e9 66 f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a7c:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107a81:	e9 5a f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a88:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107a8d:	e9 4e f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107a94:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107a99:	e9 42 f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107aa0:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107aa5:	e9 36 f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107aac:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107ab1:	e9 2a f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107ab8:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107abd:	e9 1e f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107ac4:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107ac9:	e9 12 f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107ad0:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107ad5:	e9 06 f0 ff ff       	jmp    80106ae0 <alltraps>
...
80107adc:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107ae1:	e9 fa ef ff ff       	jmp    80106ae0 <alltraps>
...
80107ae8:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107aed:	e9 ee ef ff ff       	jmp    80106ae0 <alltraps>
...
80107af4:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107af9:	e9 e2 ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b00:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107b05:	e9 d6 ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b0c:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107b11:	e9 ca ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b18:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107b1d:	e9 be ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b24:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107b29:	e9 b2 ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b30:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107b35:	e9 a6 ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b3c:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107b41:	e9 9a ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b48:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107b4d:	e9 8e ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b54:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107b59:	e9 82 ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b60:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107b65:	e9 76 ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b6c:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107b71:	e9 6a ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b78:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107b7d:	e9 5e ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b84:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107b89:	e9 52 ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b90:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107b95:	e9 46 ef ff ff       	jmp    80106ae0 <alltraps>
...
80107b9c:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107ba1:	e9 3a ef ff ff       	jmp    80106ae0 <alltraps>
...
80107ba8:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107bad:	e9 2e ef ff ff       	jmp    80106ae0 <alltraps>
...
80107bb4:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107bb9:	e9 22 ef ff ff       	jmp    80106ae0 <alltraps>
...
80107bc0:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107bc5:	e9 16 ef ff ff       	jmp    80106ae0 <alltraps>
...
80107bcc:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107bd1:	e9 0a ef ff ff       	jmp    80106ae0 <alltraps>
...
80107bd8:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107bdd:	e9 fe ee ff ff       	jmp    80106ae0 <alltraps>
	...
...
80107be7:	83 ec 10             	sub    $0x10,%esp
  ...
  pd[0] = size-1;
80107bea:	8b 45 0c             	mov    0xc(%ebp),%eax
80107bed:	83 e8 01             	sub    $0x1,%eax
80107bf0:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107bf4:	8b 45 08             	mov    0x8(%ebp),%eax
80107bf7:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80107bfb:	8b 45 08             	mov    0x8(%ebp),%eax
80107bfe:	c1 e8 10             	shr    $0x10,%eax
80107c01:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107c05:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107c08:	0f 01 10             	lgdtl  (%eax)
}
80107c0b:	c9                   	leave  
80107c0c:	c3                   	ret    
...
80107c56:	05 00 00 00 80       	add    $0x80000000,%eax
80107c5b:	5d                   	pop    %ebp
80107c5c:	c3                   	ret    
...
80107c61:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107c64:	e8 24 b2 ff ff       	call   80102e8d <cpunum>
80107c69:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107c6f:	05 40 09 11 80       	add    $0x80110940,%eax
80107c74:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80107c77:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c7a:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107c80:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c83:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80107c89:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c8c:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80107c90:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107c93:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107c97:	83 e2 f0             	and    $0xfffffff0,%edx
80107c9a:	83 ca 0a             	or     $0xa,%edx
80107c9d:	88 50 7d             	mov    %dl,0x7d(%eax)
80107ca0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ca3:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
80107ca7:	83 ca 10             	or     $0x10,%edx
...
80107cbd:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
...
80107d0b:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107d0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d12:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80107d19:	ff ff 
80107d1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d1e:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107d25:	00 00 
80107d27:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d2a:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107d31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d34:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107d3b:	83 e2 f0             	and    $0xfffffff0,%edx
80107d3e:	83 ca 02             	or     $0x2,%edx
80107d41:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107d47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d4a:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107d51:	83 ca 10             	or     $0x10,%edx
80107d54:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107d5a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d5d:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107d64:	83 e2 9f             	and    $0xffffff9f,%edx
80107d67:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107d6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d70:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
80107d77:	83 ca 80             	or     $0xffffff80,%edx
80107d7a:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107d80:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d83:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107d8a:	83 ca 0f             	or     $0xf,%edx
80107d8d:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107d93:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d96:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107d9d:	83 e2 ef             	and    $0xffffffef,%edx
80107da0:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107da6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107da9:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107db0:	83 e2 df             	and    $0xffffffdf,%edx
80107db3:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107db9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dbc:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107dc3:	83 ca 40             	or     $0x40,%edx
80107dc6:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107dcc:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dcf:	0f b6 90 86 00 00 00 	movzbl 0x86(%eax),%edx
80107dd6:	83 ca 80             	or     $0xffffff80,%edx
80107dd9:	88 90 86 00 00 00    	mov    %dl,0x86(%eax)
80107ddf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107de2:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80107de9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dec:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107df3:	ff ff 
80107df5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107df8:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107dff:	00 00 
80107e01:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e04:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80107e0b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e0e:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107e15:	83 e2 f0             	and    $0xfffffff0,%edx
80107e18:	83 ca 0a             	or     $0xa,%edx
80107e1b:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107e21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e24:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107e2b:	83 ca 10             	or     $0x10,%edx
80107e2e:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107e34:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e37:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107e3e:	83 ca 60             	or     $0x60,%edx
80107e41:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107e47:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e4a:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107e51:	83 ca 80             	or     $0xffffff80,%edx
80107e54:	88 90 95 00 00 00    	mov    %dl,0x95(%eax)
80107e5a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e5d:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e64:	83 ca 0f             	or     $0xf,%edx
80107e67:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107e6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e70:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e77:	83 e2 ef             	and    $0xffffffef,%edx
80107e7a:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107e80:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e83:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e8a:	83 e2 df             	and    $0xffffffdf,%edx
80107e8d:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107e93:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e96:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107e9d:	83 ca 40             	or     $0x40,%edx
80107ea0:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107ea6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ea9:	0f b6 90 96 00 00 00 	movzbl 0x96(%eax),%edx
80107eb0:	83 ca 80             	or     $0xffffff80,%edx
80107eb3:	88 90 96 00 00 00    	mov    %dl,0x96(%eax)
80107eb9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ebc:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80107ec3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ec6:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
80107ecd:	ff ff 
80107ecf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ed2:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
80107ed9:	00 00 
80107edb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ede:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
...
80107ef5:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107efb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107efe:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107f05:	83 ca 10             	or     $0x10,%edx
80107f08:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107f0e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f11:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107f18:	83 ca 60             	or     $0x60,%edx
80107f1b:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
80107f21:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f24:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107f2b:	83 ca 80             	or     $0xffffff80,%edx
80107f2e:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
...
80107f4a:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f51:	83 e2 ef             	and    $0xffffffef,%edx
80107f54:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107f5a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f5d:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f64:	83 e2 df             	and    $0xffffffdf,%edx
80107f67:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
80107f6d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f70:	0f b6 90 9e 00 00 00 	movzbl 0x9e(%eax),%edx
80107f77:	83 ca 40             	or     $0x40,%edx
80107f7a:	88 90 9e 00 00 00    	mov    %dl,0x9e(%eax)
...
80107f96:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107f9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fa0:	05 b4 00 00 00       	add    $0xb4,%eax
80107fa5:	89 c3                	mov    %eax,%ebx
80107fa7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107faa:	05 b4 00 00 00       	add    $0xb4,%eax
80107faf:	c1 e8 10             	shr    $0x10,%eax
80107fb2:	89 c1                	mov    %eax,%ecx
80107fb4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fb7:	05 b4 00 00 00       	add    $0xb4,%eax
80107fbc:	c1 e8 18             	shr    $0x18,%eax
80107fbf:	89 c2                	mov    %eax,%edx
80107fc1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fc4:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107fcb:	00 00 
80107fcd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fd0:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107fd7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fda:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107fe0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fe3:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107fea:	83 e1 f0             	and    $0xfffffff0,%ecx
80107fed:	83 c9 02             	or     $0x2,%ecx
80107ff0:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107ff6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ff9:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108000:	83 c9 10             	or     $0x10,%ecx
80108003:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80108009:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010800c:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108013:	83 e1 9f             	and    $0xffffff9f,%ecx
80108016:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010801c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010801f:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80108026:	83 c9 80             	or     $0xffffff80,%ecx
80108029:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
8010802f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108032:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108039:	83 e1 f0             	and    $0xfffffff0,%ecx
8010803c:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108042:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108045:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010804c:	83 e1 ef             	and    $0xffffffef,%ecx
8010804f:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108055:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108058:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
8010805f:	83 e1 df             	and    $0xffffffdf,%ecx
80108062:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
80108068:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010806b:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108072:	83 c9 40             	or     $0x40,%ecx
80108075:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010807b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010807e:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80108085:	83 c9 80             	or     $0xffffff80,%ecx
80108088:	88 88 8e 00 00 00    	mov    %cl,0x8e(%eax)
8010808e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108091:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80108097:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010809a:	83 c0 70             	add    $0x70,%eax
8010809d:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
801080a4:	00 
801080a5:	89 04 24             	mov    %eax,(%esp)
801080a8:	e8 37 fb ff ff       	call   80107be4 <lgdt>
  loadgs(SEG_KCPU << 3);
801080ad:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
801080b4:	e8 6a fb ff ff       	call   80107c23 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
801080b9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801080bc:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
801080c2:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
801080c9:	00 00 00 00 
}
...
801080d6:	83 ec 28             	sub    $0x28,%esp
  pde_t *pde;
  pte_t *pgtab;
...
801080df:	c1 e0 02             	shl    $0x2,%eax
801080e2:	03 45 08             	add    0x8(%ebp),%eax
801080e5:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
801080e8:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080eb:	8b 00                	mov    (%eax),%eax
801080ed:	83 e0 01             	and    $0x1,%eax
801080f0:	84 c0                	test   %al,%al
801080f2:	74 17                	je     8010810b <walkpgdir+0x38>
...
80108101:	e8 4a fb ff ff       	call   80107c50 <p2v>
80108106:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108109:	eb 4b                	jmp    80108156 <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
8010810b:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010810f:	74 0e                	je     8010811f <walkpgdir+0x4c>
80108111:	e8 e9 a9 ff ff       	call   80102aff <kalloc>
80108116:	89 45 f4             	mov    %eax,-0xc(%ebp)
80108119:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010811d:	75 07                	jne    80108126 <walkpgdir+0x53>
      return 0;
8010811f:	b8 00 00 00 00       	mov    $0x0,%eax
80108124:	eb 41                	jmp    80108167 <walkpgdir+0x94>
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80108126:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010812d:	00 
8010812e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108135:	00 
80108136:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108139:	89 04 24             	mov    %eax,(%esp)
8010813c:	e8 c9 d3 ff ff       	call   8010550a <memset>
...
80108147:	e8 f7 fa ff ff       	call   80107c43 <v2p>
8010814c:	89 c2                	mov    %eax,%edx
8010814e:	83 ca 07             	or     $0x7,%edx
...
80108161:	c1 e0 02             	shl    $0x2,%eax
80108164:	03 45 f4             	add    -0xc(%ebp),%eax
}
80108167:	c9                   	leave  
80108168:	c3                   	ret    
...
8010817d:	03 45 10             	add    0x10(%ebp),%eax
80108180:	83 e8 01             	sub    $0x1,%eax
80108183:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108188:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
8010818b:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80108192:	00 
...
801081a0:	e8 2e ff ff ff       	call   801080d3 <walkpgdir>
801081a5:	89 45 ec             	mov    %eax,-0x14(%ebp)
801081a8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801081ac:	75 07                	jne    801081b5 <mappages+0x4c>
      return -1;
801081ae:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801081b3:	eb 46                	jmp    801081fb <mappages+0x92>
    if(*pte & PTE_P)
801081b5:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081b8:	8b 00                	mov    (%eax),%eax
801081ba:	83 e0 01             	and    $0x1,%eax
801081bd:	84 c0                	test   %al,%al
801081bf:	74 0c                	je     801081cd <mappages+0x64>
      panic("remap");
801081c1:	c7 04 24 e0 8f 10 80 	movl   $0x80108fe0,(%esp)
801081c8:	e8 70 83 ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
801081cd:	8b 45 18             	mov    0x18(%ebp),%eax
801081d0:	0b 45 14             	or     0x14(%ebp),%eax
801081d3:	89 c2                	mov    %eax,%edx
801081d5:	83 ca 01             	or     $0x1,%edx
801081d8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081db:	89 10                	mov    %edx,(%eax)
    if(a == last)
801081dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081e0:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801081e3:	74 10                	je     801081f5 <mappages+0x8c>
      break;
    a += PGSIZE;
801081e5:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
801081ec:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
801081f3:	eb 96                	jmp    8010818b <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80108200:	53                   	push   %ebx
80108201:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80108204:	e8 f6 a8 ff ff       	call   80102aff <kalloc>
80108209:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010820c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108210:	75 0a                	jne    8010821c <setupkvm+0x1f>
    return 0;
80108212:	b8 00 00 00 00       	mov    $0x0,%eax
80108217:	e9 98 00 00 00       	jmp    801082b4 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
8010821c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108223:	00 
80108224:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010822b:	00 
8010822c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010822f:	89 04 24             	mov    %eax,(%esp)
80108232:	e8 d3 d2 ff ff       	call   8010550a <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80108237:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
8010823e:	e8 0d fa ff ff       	call   80107c50 <p2v>
80108243:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80108248:	76 0c                	jbe    80108256 <setupkvm+0x59>
    panic("PHYSTOP too high");
8010824a:	c7 04 24 e6 8f 10 80 	movl   $0x80108fe6,(%esp)
80108251:	e8 e7 82 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80108256:	c7 45 f4 c0 c4 10 80 	movl   $0x8010c4c0,-0xc(%ebp)
8010825d:	eb 49                	jmp    801082a8 <setupkvm+0xab>
...
8010825f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108262:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80108265:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80108268:	8b 50 04             	mov    0x4(%eax),%edx
8010826b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010826e:	8b 58 08             	mov    0x8(%eax),%ebx
80108271:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108274:	8b 40 04             	mov    0x4(%eax),%eax
80108277:	29 c3                	sub    %eax,%ebx
80108279:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010827c:	8b 00                	mov    (%eax),%eax
8010827e:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80108282:	89 54 24 0c          	mov    %edx,0xc(%esp)
80108286:	89 5c 24 08          	mov    %ebx,0x8(%esp)
8010828a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010828e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108291:	89 04 24             	mov    %eax,(%esp)
80108294:	e8 d0 fe ff ff       	call   80108169 <mappages>
80108299:	85 c0                	test   %eax,%eax
8010829b:	79 07                	jns    801082a4 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
8010829d:	b8 00 00 00 00       	mov    $0x0,%eax
801082a2:	eb 10                	jmp    801082b4 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
...
801082af:	72 ae                	jb     8010825f <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
801082b4:	83 c4 34             	add    $0x34,%esp
801082b7:	5b                   	pop    %ebx
801082b8:	5d                   	pop    %ebp
801082b9:	c3                   	ret    
...
801082bd:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801082c0:	e8 38 ff ff ff       	call   801081fd <setupkvm>
801082c5:	a3 58 44 11 80       	mov    %eax,0x80114458
  switchkvm();
801082ca:	e8 02 00 00 00       	call   801082d1 <switchkvm>
}
801082cf:	c9                   	leave  
801082d0:	c3                   	ret    
...
801082d7:	a1 58 44 11 80       	mov    0x80114458,%eax
801082dc:	89 04 24             	mov    %eax,(%esp)
801082df:	e8 5f f9 ff ff       	call   80107c43 <v2p>
801082e4:	89 04 24             	mov    %eax,(%esp)
801082e7:	e8 4c f9 ff ff       	call   80107c38 <lcr3>
}
801082ec:	c9                   	leave  
801082ed:	c3                   	ret    
...
801082f1:	53                   	push   %ebx
801082f2:	83 ec 14             	sub    $0x14,%esp
  pushcli();
801082f5:	e8 09 d1 ff ff       	call   80105403 <pushcli>
...
8010830a:	89 d3                	mov    %edx,%ebx
8010830c:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108313:	83 c2 08             	add    $0x8,%edx
80108316:	c1 ea 10             	shr    $0x10,%edx
80108319:	89 d1                	mov    %edx,%ecx
8010831b:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80108322:	83 c2 08             	add    $0x8,%edx
80108325:	c1 ea 18             	shr    $0x18,%edx
80108328:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
8010832f:	67 00 
80108331:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80108338:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
8010833e:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108345:	83 e1 f0             	and    $0xfffffff0,%ecx
80108348:	83 c9 09             	or     $0x9,%ecx
8010834b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108351:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108358:	83 c9 10             	or     $0x10,%ecx
8010835b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108361:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108368:	83 e1 9f             	and    $0xffffff9f,%ecx
8010836b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108371:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80108378:	83 c9 80             	or     $0xffffff80,%ecx
8010837b:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80108381:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108388:	83 e1 f0             	and    $0xfffffff0,%ecx
8010838b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80108391:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80108398:	83 e1 ef             	and    $0xffffffef,%ecx
8010839b:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801083a1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801083a8:	83 e1 df             	and    $0xffffffdf,%ecx
801083ab:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801083b1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801083b8:	83 c9 40             	or     $0x40,%ecx
801083bb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801083c1:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
801083c8:	83 e1 7f             	and    $0x7f,%ecx
801083cb:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
801083d1:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
...
8010840f:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80108412:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80108419:	e8 ef f7 ff ff       	call   80107c0d <ltr>
  if(p->pgdir == 0)
8010841e:	8b 45 08             	mov    0x8(%ebp),%eax
80108421:	8b 40 04             	mov    0x4(%eax),%eax
80108424:	85 c0                	test   %eax,%eax
80108426:	75 0c                	jne    80108434 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80108428:	c7 04 24 f7 8f 10 80 	movl   $0x80108ff7,(%esp)
...
8010843d:	e8 01 f8 ff ff       	call   80107c43 <v2p>
80108442:	89 04 24             	mov    %eax,(%esp)
80108445:	e8 ee f7 ff ff       	call   80107c38 <lcr3>
  popcli();
8010844a:	e8 fc cf ff ff       	call   8010544b <popcli>
}
8010844f:	83 c4 14             	add    $0x14,%esp
80108452:	5b                   	pop    %ebx
80108453:	5d                   	pop    %ebp
80108454:	c3                   	ret    
...
80108458:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
8010845b:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80108462:	76 0c                	jbe    80108470 <inituvm+0x1b>
    panic("inituvm: more than a page");
80108464:	c7 04 24 0b 90 10 80 	movl   $0x8010900b,(%esp)
8010846b:	e8 cd 80 ff ff       	call   8010053d <panic>
  mem = kalloc();
80108470:	e8 8a a6 ff ff       	call   80102aff <kalloc>
80108475:	89 45 f4             	mov    %eax,-0xc(%ebp)
  memset(mem, 0, PGSIZE);
80108478:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010847f:	00 
80108480:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108487:	00 
80108488:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010848b:	89 04 24             	mov    %eax,(%esp)
8010848e:	e8 77 d0 ff ff       	call   8010550a <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108493:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108496:	89 04 24             	mov    %eax,(%esp)
80108499:	e8 a5 f7 ff ff       	call   80107c43 <v2p>
8010849e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801084a5:	00 
801084a6:	89 44 24 0c          	mov    %eax,0xc(%esp)
801084aa:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801084b1:	00 
801084b2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801084b9:	00 
801084ba:	8b 45 08             	mov    0x8(%ebp),%eax
801084bd:	89 04 24             	mov    %eax,(%esp)
801084c0:	e8 a4 fc ff ff       	call   80108169 <mappages>
  memmove(mem, init, sz);
801084c5:	8b 45 10             	mov    0x10(%ebp),%eax
...
801084d9:	e8 ff d0 ff ff       	call   801055dd <memmove>
}
801084de:	c9                   	leave  
801084df:	c3                   	ret    
...
801084e4:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
801084e7:	8b 45 0c             	mov    0xc(%ebp),%eax
801084ea:	25 ff 0f 00 00       	and    $0xfff,%eax
801084ef:	85 c0                	test   %eax,%eax
801084f1:	74 0c                	je     801084ff <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
801084f3:	c7 04 24 28 90 10 80 	movl   $0x80109028,(%esp)
801084fa:	e8 3e 80 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
801084ff:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108506:	e9 ad 00 00 00       	jmp    801085b8 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010850b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010850e:	8b 55 0c             	mov    0xc(%ebp),%edx
80108511:	01 d0                	add    %edx,%eax
80108513:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010851a:	00 
8010851b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010851f:	8b 45 08             	mov    0x8(%ebp),%eax
80108522:	89 04 24             	mov    %eax,(%esp)
80108525:	e8 a9 fb ff ff       	call   801080d3 <walkpgdir>
8010852a:	89 45 ec             	mov    %eax,-0x14(%ebp)
8010852d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108531:	75 0c                	jne    8010853f <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80108533:	c7 04 24 4b 90 10 80 	movl   $0x8010904b,(%esp)
8010853a:	e8 fe 7f ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
8010853f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108542:	8b 00                	mov    (%eax),%eax
80108544:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108549:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
8010854c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010854f:	8b 55 18             	mov    0x18(%ebp),%edx
80108552:	89 d1                	mov    %edx,%ecx
80108554:	29 c1                	sub    %eax,%ecx
80108556:	89 c8                	mov    %ecx,%eax
80108558:	3d ff 0f 00 00       	cmp    $0xfff,%eax
8010855d:	77 11                	ja     80108570 <loaduvm+0x90>
      n = sz - i;
8010855f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108562:	8b 55 18             	mov    0x18(%ebp),%edx
80108565:	89 d1                	mov    %edx,%ecx
80108567:	29 c1                	sub    %eax,%ecx
80108569:	89 c8                	mov    %ecx,%eax
8010856b:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010856e:	eb 07                	jmp    80108577 <loaduvm+0x97>
    else
      n = PGSIZE;
80108570:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80108577:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010857a:	8b 55 14             	mov    0x14(%ebp),%edx
8010857d:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80108580:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108583:	89 04 24             	mov    %eax,(%esp)
80108586:	e8 c5 f6 ff ff       	call   80107c50 <p2v>
8010858b:	8b 55 f0             	mov    -0x10(%ebp),%edx
...
801085a0:	e8 b9 97 ff ff       	call   80101d5e <readi>
801085a5:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801085a8:	74 07                	je     801085b1 <loaduvm+0xd1>
      return -1;
801085aa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801085af:	eb 18                	jmp    801085c9 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
...
801085be:	0f 82 47 ff ff ff    	jb     8010850b <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
801085c9:	83 c4 24             	add    $0x24,%esp
801085cc:	5b                   	pop    %ebx
801085cd:	5d                   	pop    %ebp
801085ce:	c3                   	ret    
...
801085d2:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
801085da:	79 0a                	jns    801085e6 <allocuvm+0x17>
    return 0;
801085dc:	b8 00 00 00 00       	mov    $0x0,%eax
801085e1:	e9 c1 00 00 00       	jmp    801086a7 <allocuvm+0xd8>
  if(newsz < oldsz)
801085e6:	8b 45 10             	mov    0x10(%ebp),%eax
801085e9:	3b 45 0c             	cmp    0xc(%ebp),%eax
801085ec:	73 08                	jae    801085f6 <allocuvm+0x27>
    return oldsz;
801085ee:	8b 45 0c             	mov    0xc(%ebp),%eax
801085f1:	e9 b1 00 00 00       	jmp    801086a7 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
801085f6:	8b 45 0c             	mov    0xc(%ebp),%eax
801085f9:	05 ff 0f 00 00       	add    $0xfff,%eax
801085fe:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108603:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80108606:	e9 8d 00 00 00       	jmp    80108698 <allocuvm+0xc9>
    mem = kalloc();
8010860b:	e8 ef a4 ff ff       	call   80102aff <kalloc>
80108610:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108613:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108617:	75 2c                	jne    80108645 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108619:	c7 04 24 69 90 10 80 	movl   $0x80109069,(%esp)
80108620:	e8 7c 7d ff ff       	call   801003a1 <cprintf>
...
80108639:	e8 6b 00 00 00       	call   801086a9 <deallocuvm>
      return 0;
8010863e:	b8 00 00 00 00       	mov    $0x0,%eax
80108643:	eb 62                	jmp    801086a7 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108645:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010864c:	00 
8010864d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108654:	00 
80108655:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108658:	89 04 24             	mov    %eax,(%esp)
8010865b:	e8 aa ce ff ff       	call   8010550a <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108660:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108663:	89 04 24             	mov    %eax,(%esp)
80108666:	e8 d8 f5 ff ff       	call   80107c43 <v2p>
8010866b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010866e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108675:	00 
80108676:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010867a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108681:	00 
80108682:	89 54 24 04          	mov    %edx,0x4(%esp)
80108686:	8b 45 08             	mov    0x8(%ebp),%eax
80108689:	89 04 24             	mov    %eax,(%esp)
8010868c:	e8 d8 fa ff ff       	call   80108169 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
8010869b:	3b 45 10             	cmp    0x10(%ebp),%eax
8010869e:	0f 82 67 ff ff ff    	jb     8010860b <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
801086ac:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
  uint a, pa;
...
801086b5:	72 08                	jb     801086bf <deallocuvm+0x16>
    return oldsz;
801086b7:	8b 45 0c             	mov    0xc(%ebp),%eax
801086ba:	e9 a4 00 00 00       	jmp    80108763 <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
801086bf:	8b 45 10             	mov    0x10(%ebp),%eax
801086c2:	05 ff 0f 00 00       	add    $0xfff,%eax
801086c7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801086cc:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801086cf:	e9 80 00 00 00       	jmp    80108754 <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
801086d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801086d7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801086de:	00 
801086df:	89 44 24 04          	mov    %eax,0x4(%esp)
801086e3:	8b 45 08             	mov    0x8(%ebp),%eax
801086e6:	89 04 24             	mov    %eax,(%esp)
801086e9:	e8 e5 f9 ff ff       	call   801080d3 <walkpgdir>
801086ee:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
801086f1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801086f5:	75 09                	jne    80108700 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
801086f7:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
801086fe:	eb 4d                	jmp    8010874d <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108700:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108703:	8b 00                	mov    (%eax),%eax
80108705:	83 e0 01             	and    $0x1,%eax
80108708:	84 c0                	test   %al,%al
8010870a:	74 41                	je     8010874d <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
8010870c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010870f:	8b 00                	mov    (%eax),%eax
80108711:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108716:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108719:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010871d:	75 0c                	jne    8010872b <deallocuvm+0x82>
        panic("kfree");
8010871f:	c7 04 24 81 90 10 80 	movl   $0x80109081,(%esp)
80108726:	e8 12 7e ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
8010872b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010872e:	89 04 24             	mov    %eax,(%esp)
80108731:	e8 1a f5 ff ff       	call   80107c50 <p2v>
80108736:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108739:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010873c:	89 04 24             	mov    %eax,(%esp)
8010873f:	e8 22 a3 ff ff       	call   80102a66 <kfree>
      *pte = 0;
80108744:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108747:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
80108757:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010875a:	0f 82 74 ff ff ff    	jb     801086d4 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
80108768:	83 ec 28             	sub    $0x28,%esp
  uint i;

  if(pgdir == 0)
8010876b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010876f:	75 0c                	jne    8010877d <freevm+0x18>
    panic("freevm: no pgdir");
80108771:	c7 04 24 87 90 10 80 	movl   $0x80109087,(%esp)
80108778:	e8 c0 7d ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
8010877d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108784:	00 
80108785:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
8010878c:	80 
8010878d:	8b 45 08             	mov    0x8(%ebp),%eax
80108790:	89 04 24             	mov    %eax,(%esp)
80108793:	e8 11 ff ff ff       	call   801086a9 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108798:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010879f:	eb 3c                	jmp    801087dd <freevm+0x78>
    if(pgdir[i] & PTE_P){
801087a1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087a4:	c1 e0 02             	shl    $0x2,%eax
801087a7:	03 45 08             	add    0x8(%ebp),%eax
801087aa:	8b 00                	mov    (%eax),%eax
801087ac:	83 e0 01             	and    $0x1,%eax
801087af:	84 c0                	test   %al,%al
801087b1:	74 26                	je     801087d9 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
801087b3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801087b6:	c1 e0 02             	shl    $0x2,%eax
801087b9:	03 45 08             	add    0x8(%ebp),%eax
801087bc:	8b 00                	mov    (%eax),%eax
801087be:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801087c3:	89 04 24             	mov    %eax,(%esp)
801087c6:	e8 85 f4 ff ff       	call   80107c50 <p2v>
801087cb:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
801087ce:	8b 45 f0             	mov    -0x10(%ebp),%eax
801087d1:	89 04 24             	mov    %eax,(%esp)
801087d4:	e8 8d a2 ff ff       	call   80102a66 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801087d9:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
801087dd:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
801087e4:	76 bb                	jbe    801087a1 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
801087ec:	e8 75 a2 ff ff       	call   80102a66 <kfree>
}
801087f1:	c9                   	leave  
801087f2:	c3                   	ret    
...
8010880e:	e8 c0 f8 ff ff       	call   801080d3 <walkpgdir>
80108813:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108816:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010881a:	75 0c                	jne    80108828 <clearpteu+0x35>
    panic("clearpteu");
8010881c:	c7 04 24 98 90 10 80 	movl   $0x80109098,(%esp)
80108823:	e8 15 7d ff ff       	call   8010053d <panic>
  *pte &= ~PTE_U;
80108828:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010882b:	8b 00                	mov    (%eax),%eax
8010882d:	89 c2                	mov    %eax,%edx
8010882f:	83 e2 fb             	and    $0xfffffffb,%edx
80108832:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108835:	89 10                	mov    %edx,(%eax)
}
80108837:	c9                   	leave  
80108838:	c3                   	ret    
...
8010883c:	83 ec 48             	sub    $0x48,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010883f:	e8 b9 f9 ff ff       	call   801081fd <setupkvm>
80108844:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108847:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010884b:	75 0a                	jne    80108857 <copyuvm+0x1e>
    return 0;
8010884d:	b8 00 00 00 00       	mov    $0x0,%eax
80108852:	e9 f1 00 00 00       	jmp    80108948 <copyuvm+0x10f>
  for(i = 0; i < sz; i += PGSIZE){
80108857:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
8010885e:	e9 c0 00 00 00       	jmp    80108923 <copyuvm+0xea>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108863:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108866:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010886d:	00 
8010886e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108872:	8b 45 08             	mov    0x8(%ebp),%eax
80108875:	89 04 24             	mov    %eax,(%esp)
80108878:	e8 56 f8 ff ff       	call   801080d3 <walkpgdir>
8010887d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80108880:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80108884:	75 0c                	jne    80108892 <copyuvm+0x59>
      panic("copyuvm: pte should exist");
80108886:	c7 04 24 a2 90 10 80 	movl   $0x801090a2,(%esp)
8010888d:	e8 ab 7c ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
80108892:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108895:	8b 00                	mov    (%eax),%eax
80108897:	83 e0 01             	and    $0x1,%eax
8010889a:	85 c0                	test   %eax,%eax
8010889c:	75 0c                	jne    801088aa <copyuvm+0x71>
      panic("copyuvm: page not present");
8010889e:	c7 04 24 bc 90 10 80 	movl   $0x801090bc,(%esp)
801088a5:	e8 93 7c ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
801088aa:	8b 45 ec             	mov    -0x14(%ebp),%eax
801088ad:	8b 00                	mov    (%eax),%eax
801088af:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801088b4:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if((mem = kalloc()) == 0)
801088b7:	e8 43 a2 ff ff       	call   80102aff <kalloc>
801088bc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801088bf:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
801088c3:	74 6f                	je     80108934 <copyuvm+0xfb>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
801088c5:	8b 45 e8             	mov    -0x18(%ebp),%eax
801088c8:	89 04 24             	mov    %eax,(%esp)
801088cb:	e8 80 f3 ff ff       	call   80107c50 <p2v>
801088d0:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801088d7:	00 
801088d8:	89 44 24 04          	mov    %eax,0x4(%esp)
801088dc:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801088df:	89 04 24             	mov    %eax,(%esp)
801088e2:	e8 f6 cc ff ff       	call   801055dd <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
801088e7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801088ea:	89 04 24             	mov    %eax,(%esp)
801088ed:	e8 51 f3 ff ff       	call   80107c43 <v2p>
801088f2:	8b 55 f4             	mov    -0xc(%ebp),%edx
801088f5:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
801088fc:	00 
801088fd:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108901:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108908:	00 
80108909:	89 54 24 04          	mov    %edx,0x4(%esp)
8010890d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108910:	89 04 24             	mov    %eax,(%esp)
80108913:	e8 51 f8 ff ff       	call   80108169 <mappages>
80108918:	85 c0                	test   %eax,%eax
8010891a:	78 1b                	js     80108937 <copyuvm+0xfe>
  uint pa, i;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010891c:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108923:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108926:	3b 45 0c             	cmp    0xc(%ebp),%eax
80108929:	0f 82 34 ff ff ff    	jb     80108863 <copyuvm+0x2a>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
  ...
  return d;
8010892f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108932:	eb 14                	jmp    80108948 <copyuvm+0x10f>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
80108934:	90                   	nop
80108935:	eb 01                	jmp    80108938 <copyuvm+0xff>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), PTE_W|PTE_U) < 0)
      goto bad;
80108937:	90                   	nop
...
8010893e:	e8 22 fe ff ff       	call   80108765 <freevm>
  return 0;
...
8010894d:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;
...
8010895b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010895f:	8b 45 08             	mov    0x8(%ebp),%eax
80108962:	89 04 24             	mov    %eax,(%esp)
80108965:	e8 69 f7 ff ff       	call   801080d3 <walkpgdir>
...
801089a0:	e8 ab f2 ff ff       	call   80107c50 <p2v>
}
801089a5:	c9                   	leave  
801089a6:	c3                   	ret    
...
801089b0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801089b3:	e9 8b 00 00 00       	jmp    80108a43 <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
801089b8:	8b 45 0c             	mov    0xc(%ebp),%eax
801089bb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801089c0:	89 45 ec             	mov    %eax,-0x14(%ebp)
...
801089d0:	e8 75 ff ff ff       	call   8010894a <uva2ka>
801089d5:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
801089d8:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
801089dc:	75 07                	jne    801089e5 <copyout+0x3e>
      return -1;
801089de:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801089e3:	eb 6d                	jmp    80108a52 <copyout+0xab>
    n = PGSIZE - (va - va0);
801089e5:	8b 45 0c             	mov    0xc(%ebp),%eax
801089e8:	8b 55 ec             	mov    -0x14(%ebp),%edx
801089eb:	89 d1                	mov    %edx,%ecx
801089ed:	29 c1                	sub    %eax,%ecx
801089ef:	89 c8                	mov    %ecx,%eax
801089f1:	05 00 10 00 00       	add    $0x1000,%eax
801089f6:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
801089f9:	8b 45 f0             	mov    -0x10(%ebp),%eax
801089fc:	3b 45 14             	cmp    0x14(%ebp),%eax
801089ff:	76 06                	jbe    80108a07 <copyout+0x60>
      n = len;
80108a01:	8b 45 14             	mov    0x14(%ebp),%eax
80108a04:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108a07:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a0a:	8b 55 0c             	mov    0xc(%ebp),%edx
80108a0d:	89 d1                	mov    %edx,%ecx
80108a0f:	29 c1                	sub    %eax,%ecx
80108a11:	89 c8                	mov    %ecx,%eax
80108a13:	03 45 e8             	add    -0x18(%ebp),%eax
80108a16:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108a19:	89 54 24 08          	mov    %edx,0x8(%esp)
80108a1d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108a20:	89 54 24 04          	mov    %edx,0x4(%esp)
80108a24:	89 04 24             	mov    %eax,(%esp)
80108a27:	e8 b1 cb ff ff       	call   801055dd <memmove>
    len -= n;
80108a2c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a2f:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
80108a32:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108a35:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108a38:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108a3b:	05 00 10 00 00       	add    $0x1000,%eax
80108a40:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
80108a43:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108a47:	0f 85 6b ff ff ff    	jne    801089b8 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
