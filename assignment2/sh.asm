...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     20f:	c7 44 24 04 24 15 00 	movl   $0x1524,0x4(%esp)
     216:	00 
     ...
     286:	e9 ae 00 00 00       	jmp    339 <main+0xd2>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     292:	00 
     293:	c7 04 24 27 15 00 00 	movl   $0x1527,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2af:	0f b6 05 e0 1a 00 00 	movzbl 0x1ae0,%eax
     2b6:	3c 63                	cmp    $0x63,%al
     2b8:	75 5a                	jne    314 <main+0xad>
     2ba:	0f b6 05 e1 1a 00 00 	movzbl 0x1ae1,%eax
     2c1:	3c 64                	cmp    $0x64,%al
     2c3:	75 4f                	jne    314 <main+0xad>
     2c5:	0f b6 05 e2 1a 00 00 	movzbl 0x1ae2,%eax
     2cc:	3c 20                	cmp    $0x20,%al
     2ce:	75 44                	jne    314 <main+0xad>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2d0:	c7 04 24 e0 1a 00 00 	movl   $0x1ae0,(%esp)
     2d7:	e8 ba 0a 00 00       	call   d96 <strlen>
     2dc:	83 e8 01             	sub    $0x1,%eax
     2df:	c6 80 e0 1a 00 00 00 	movb   $0x0,0x1ae0(%eax)
      if(chdir(buf+3) < 0)
     2e6:	c7 04 24 e3 1a 00 00 	movl   $0x1ae3,(%esp)
     2ed:	e8 de 0c 00 00       	call   fd0 <chdir>
     2f2:	85 c0                	test   %eax,%eax
     2f4:	79 42                	jns    338 <main+0xd1>
        printf(2, "cannot cd %s\n", buf+3);
     2f6:	c7 44 24 08 e3 1a 00 	movl   $0x1ae3,0x8(%esp)
     2fd:	00 
     2fe:	c7 44 24 04 2f 15 00 	movl   $0x152f,0x4(%esp)
     305:	00 
    ...
    if(fork1() == 0)
     ...
     31b:	75 14                	jne    331 <main+0xca>
      runcmd(parsecmd(buf));
     31d:	c7 04 24 e0 1a 00 00 	movl   $0x1ae0,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     340:	00 
     341:	c7 04 24 e0 1a 00 00 	movl   $0x1ae0,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     367:	c7 44 24 04 3d 15 00 	movl   $0x153d,0x4(%esp)
     36e:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     394:	c7 04 24 41 15 00 00 	movl   $0x1541,(%esp)
     ...
     545:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55e:	c7 04 24 b0 1a 00 00 	movl   $0x1ab0,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     601:	c7 04 24 b0 1a 00 00 	movl   $0x1ab0,(%esp)
     ...
     61e:	c7 04 24 b6 1a 00 00 	movl   $0x1ab6,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 b0 1a 00 00 	movl   $0x1ab0,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 b0 1a 00 00 	movl   $0x1ab0,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b74:	74 0c                	je     b82 <parseexec+0xb0>
      panic("syntax");
     b76:	c7 04 24 56 15 00 00 	movl   $0x1556,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba7:	7e 0c                	jle    bb5 <parseexec+0xe3>
      panic("too many args");
     ba9:	c7 04 24 a5 15 00 00 	movl   $0x15a5,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd1:	c7 44 24 08 b3 15 00 	movl   $0x15b3,0x8(%esp)
     bd8:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3e:	8b 04 85 b8 15 00 00 	mov    0x15b8(,%eax,4),%eax
     c45:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1096:	0f b6 90 c0 1a 00 00 	movzbl 0x1ac0(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    11f5:	75 27                	jne    121e <printf+0x11f>
          s = "(null)";
    11f7:	c7 45 f4 d0 15 00 00 	movl   $0x15d0,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12c3:	a1 4c 1b 00 00       	mov    0x1b4c,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    1384:	a3 4c 1b 00 00       	mov    %eax,0x1b4c
}
    1389:	c9                   	leave  
    138a:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    13dc:	a1 4c 1b 00 00       	mov    0x1b4c,%eax
}
    13e1:	c9                   	leave  
    13e2:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    13f8:	a1 4c 1b 00 00       	mov    0x1b4c,%eax
    13fd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1400:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1404:	75 23                	jne    1429 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1406:	c7 45 f0 44 1b 00 00 	movl   $0x1b44,-0x10(%ebp)
    140d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1410:	a3 4c 1b 00 00       	mov    %eax,0x1b4c
    1415:	a1 4c 1b 00 00       	mov    0x1b4c,%eax
    141a:	a3 44 1b 00 00       	mov    %eax,0x1b44
    base.s.size = 0;
    141f:	c7 05 48 1b 00 00 00 	movl   $0x0,0x1b48
    1426:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    147c:	a3 4c 1b 00 00       	mov    %eax,0x1b4c
      return (void*)(p + 1);
    ...
    if(p == freep)
    1489:	a1 4c 1b 00 00       	mov    0x1b4c,%eax
