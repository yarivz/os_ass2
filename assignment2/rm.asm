...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 68 08 00 	movl   $0x868,0x4(%esp)
  16:	00 
  ...
  5a:	c7 44 24 04 7c 08 00 	movl   $0x87c,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41e:	0f b6 90 38 0b 00 00 	movzbl 0xb38(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 57d:	75 27                	jne    5a6 <printf+0x11f>
          s = "(null)";
 57f:	c7 45 f4 95 08 00 00 	movl   $0x895,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64b:	a1 54 0b 00 00       	mov    0xb54,%eax
...
free(void *ap)
{
 ...
 70c:	a3 54 0b 00 00       	mov    %eax,0xb54
}
 711:	c9                   	leave  
 712:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 75f:	e8 d8 fe ff ff       	call   63c <free>
  return freep;
 764:	a1 54 0b 00 00       	mov    0xb54,%eax
}
 769:	c9                   	leave  
 76a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 77d:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 780:	a1 54 0b 00 00       	mov    0xb54,%eax
 785:	89 45 f0             	mov    %eax,-0x10(%ebp)
 788:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 78c:	75 23                	jne    7b1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 78e:	c7 45 f0 4c 0b 00 00 	movl   $0xb4c,-0x10(%ebp)
 795:	8b 45 f0             	mov    -0x10(%ebp),%eax
 798:	a3 54 0b 00 00       	mov    %eax,0xb54
 79d:	a1 54 0b 00 00       	mov    0xb54,%eax
 7a2:	a3 4c 0b 00 00       	mov    %eax,0xb4c
    base.s.size = 0;
 7a7:	c7 05 50 0b 00 00 00 	movl   $0x0,0xb50
 7ae:	00 00 00 
  }
 ...
 804:	a3 54 0b 00 00       	mov    %eax,0xb54
      return (void*)(p + 1);
 ...
 80f:	eb 38                	jmp    849 <malloc+0xde>
    ...
    if(p == freep)
 811:	a1 54 0b 00 00       	mov    0xb54,%eax
...
struct semaphore* semaphore_create(int initial_semaphore_value)
{
 ...
 852:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
